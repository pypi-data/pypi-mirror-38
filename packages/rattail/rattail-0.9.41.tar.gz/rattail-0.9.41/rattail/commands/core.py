...
class DataSync(Subcommand):
    ...
    def add_parser_args(self, parser):
        ...
        check = subparsers.add_parser('check', help="General queue / health check")
        ...
        parser.add_argument('-T', '--timeout', metavar='MINUTES', type=int, default=0,
                            ...
                            "command will exit with nonzero code if any changes in the queue have been there "
                            "as long as, or longer than, the given timeout.")
