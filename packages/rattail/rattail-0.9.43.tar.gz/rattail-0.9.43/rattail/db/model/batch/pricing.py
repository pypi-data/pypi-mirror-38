...
class PricingBatchRow(ProductBatchRowMixin, Base):
    ...
    true_margin = sa.Column(sa.Numeric(precision=6, scale=3), nullable=True, doc="""
    ...
    price_margin = sa.Column(sa.Numeric(precision=6, scale=3), nullable=True, doc="""
    ...
    margin_diff = sa.Column(sa.Numeric(precision=6, scale=3), nullable=True, doc="""
