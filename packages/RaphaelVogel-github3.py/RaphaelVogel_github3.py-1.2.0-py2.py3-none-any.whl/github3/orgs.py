...
from .repos import Repository, ShortRepository, hook
...
class OrganizationHook(hook.Hook):
    """The representation of a hook on an organization.

    See also: https://developer.github.com/v3/orgs/hooks/

    This object has the same attributes as :class:`~github3.repos.hook.Hook`.
    It overrides method :meth:`edit`, since organization and repository hooks
    have different signatures.
    """

    class_name = "OrganizationHook"
