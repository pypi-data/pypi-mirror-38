...
class DynGraphPlot():
    ...
    def draw(self):
        ...
        # or if in interactive mode and the figure was closed
        elif self.mode == 'non-blocking' and len(plt.get_fignums()) == 0:
            self.setup_figure()
