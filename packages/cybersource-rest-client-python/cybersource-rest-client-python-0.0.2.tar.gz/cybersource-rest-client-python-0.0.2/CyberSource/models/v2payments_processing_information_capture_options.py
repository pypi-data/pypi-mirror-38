...
class V2paymentsProcessingInformationCaptureOptions(object):
    """
    ...
    def __init__(self, capture_sequence_number=None, total_capture_count=None, date_to_capture=None):
        """
        V2paymentsProcessingInformationCaptureOptions - a model defined in Swagger
        """
    ...
    def capture_sequence_number(self):
        """
        Gets the capture_sequence_number of this V2paymentsProcessingInformationCaptureOptions.
    ...
    def capture_sequence_number(self, capture_sequence_number):
        """
        Sets the capture_sequence_number of this V2paymentsProcessingInformationCaptureOptions.
        Capture number when requesting multiple partial captures for one payment. Used along with _totalCaptureCount_ to track which capture is being processed.  For example, the second of five captures would be passed to CyberSource as:   - _captureSequenceNumber_ = 2, and   - _totalCaptureCount_ = 5 

        :param capture_sequence_number: The capture_sequence_number of this V2paymentsProcessingInformationCaptureOptions.
        :type: float
        """
    ...
    def total_capture_count(self, total_capture_count):
        """
        Sets the total_capture_count of this V2paymentsProcessingInformationCaptureOptions.
        Total number of captures when requesting multiple partial captures for one payment. Used along with _captureSequenceNumber_ which capture is being processed.  For example, the second of five captures would be passed to CyberSource as:   - _captureSequenceNumber_ = 2, and   - _totalCaptureCount_ = 5 

        :param total_capture_count: The total_capture_count of this V2paymentsProcessingInformationCaptureOptions.
        :type: float
        """
    ...
    def date_to_capture(self):
        """
        Gets the date_to_capture of this V2paymentsProcessingInformationCaptureOptions.
        Date on which you want the capture to occur. This field is supported only for **CyberSource through VisaNet**. `Format: MMDD` 

        :return: The date_to_capture of this V2paymentsProcessingInformationCaptureOptions.
        :rtype: str
        """
    ...
    def date_to_capture(self, date_to_capture):
        """
        Sets the date_to_capture of this V2paymentsProcessingInformationCaptureOptions.
        Date on which you want the capture to occur. This field is supported only for **CyberSource through VisaNet**. `Format: MMDD` 

        :param date_to_capture: The date_to_capture of this V2paymentsProcessingInformationCaptureOptions.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsProcessingInformationCaptureOptions):
            return False
