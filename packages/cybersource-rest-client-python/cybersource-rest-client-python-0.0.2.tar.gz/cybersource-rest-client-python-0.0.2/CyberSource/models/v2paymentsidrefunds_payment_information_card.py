...
class V2paymentsidrefundsPaymentInformationCard(object):
    """
    ...
    def __init__(self, number=None, expiration_month=None, expiration_year=None, type=None, account_encoder_id=None, issue_number=None, start_month=None, start_year=None):
        """
        V2paymentsidrefundsPaymentInformationCard - a model defined in Swagger
        """
    ...
    def number(self):
        """
        Gets the number of this V2paymentsidrefundsPaymentInformationCard.
        ...
        :return: The number of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
        return self._number
    ...
    def number(self, number):
        """
        Sets the number of this V2paymentsidrefundsPaymentInformationCard.
        Customerâ€™s credit card number. Encoded Account Numbers when processing encoded account numbers, use this field for the encoded account number.  For processor-specific information, see the customer_cc_number field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param number: The number of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def expiration_month(self):
        """
        Gets the expiration_month of this V2paymentsidrefundsPaymentInformationCard.
        ...
        :return: The expiration_month of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
    ...
    def expiration_month(self, expiration_month):
        """
        Sets the expiration_month of this V2paymentsidrefundsPaymentInformationCard.
        Two-digit month in which the credit card expires. `Format: MM`. Possible values: 01 through 12.  **Encoded Account Numbers**  For encoded account numbers (_type_=039), if there is no expiration date on the card, use 12.  For processor-specific information, see the customer_cc_expmo field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param expiration_month: The expiration_month of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def expiration_year(self):
        """
        Gets the expiration_year of this V2paymentsidrefundsPaymentInformationCard.
        ...
        :return: The expiration_year of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
    ...
    def expiration_year(self, expiration_year):
        """
        Sets the expiration_year of this V2paymentsidrefundsPaymentInformationCard.
        Four-digit year in which the credit card expires. `Format: YYYY`.  **Encoded Account Numbers**  For encoded account numbers (_type_=039), if there is no expiration date on the card, use 2021.  For processor-specific information, see the customer_cc_expyr field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param expiration_year: The expiration_year of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def type(self):
        """
        Gets the type of this V2paymentsidrefundsPaymentInformationCard.
        Type of card to authorize. - 001 Visa - 002 Mastercard - 003 Amex - 004 Discover 

        :return: The type of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
        return self._type
    ...
    def type(self, type):
        """
        Sets the type of this V2paymentsidrefundsPaymentInformationCard.
        Type of card to authorize. - 001 Visa - 002 Mastercard - 003 Amex - 004 Discover 

        :param type: The type of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def account_encoder_id(self):
        """
        Gets the account_encoder_id of this V2paymentsidrefundsPaymentInformationCard.
        ...
        :return: The account_encoder_id of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
    ...
    def account_encoder_id(self, account_encoder_id):
        """
        Sets the account_encoder_id of this V2paymentsidrefundsPaymentInformationCard.
        Identifier for the issuing bank that provided the customerâ€™s encoded account number. Contact your processor for the bankâ€™s ID. 

        :param account_encoder_id: The account_encoder_id of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def issue_number(self):
        """
        Gets the issue_number of this V2paymentsidrefundsPaymentInformationCard.
        ...
        :return: The issue_number of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
    ...
    def issue_number(self, issue_number):
        """
        Sets the issue_number of this V2paymentsidrefundsPaymentInformationCard.
        Number of times a Maestro (UK Domestic) card has been issued to the account holder. The card might or might not have an issue number. The number can consist of one or two digits, and the first digit might be a zero. When you include this value in your request, include exactly what is printed on the card. A value of 2 is different than a value of 02. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card.  The issue number is not required for Maestro (UK Domestic) transactions. 

        :param issue_number: The issue_number of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def start_month(self):
        """
        Gets the start_month of this V2paymentsidrefundsPaymentInformationCard.
        ...
        :return: The start_month of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
    ...
    def start_month(self, start_month):
        """
        Sets the start_month of this V2paymentsidrefundsPaymentInformationCard.
        Month of the start of the Maestro (UK Domestic) card validity period. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card. `Format: MM`. Possible values: 01 through 12.  The start date is not required for Maestro (UK Domestic) transactions. 

        :param start_month: The start_month of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def start_year(self):
        """
        Gets the start_year of this V2paymentsidrefundsPaymentInformationCard.
        ...
        :return: The start_year of this V2paymentsidrefundsPaymentInformationCard.
        :rtype: str
        """
    ...
    def start_year(self, start_year):
        """
        Sets the start_year of this V2paymentsidrefundsPaymentInformationCard.
        Year of the start of the Maestro (UK Domestic) card validity period. Do not include the field, even with a blank value, if the card is not a Maestro (UK Domestic) card. `Format: YYYY`.  The start date is not required for Maestro (UK Domestic) transactions. 

        :param start_year: The start_year of this V2paymentsidrefundsPaymentInformationCard.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsidrefundsPaymentInformationCard):
            return False
