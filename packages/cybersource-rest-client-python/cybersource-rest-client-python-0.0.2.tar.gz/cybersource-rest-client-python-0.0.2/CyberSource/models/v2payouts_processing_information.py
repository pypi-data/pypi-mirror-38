...
class V2payoutsProcessingInformation(object):
    """
    ...
    def __init__(self, business_application_id=None, network_routing_order=None, commerce_indicator=None, reconciliation_id=None, payouts_options=None):
        """
        V2payoutsProcessingInformation - a model defined in Swagger
        """
    ...
    def business_application_id(self):
        """
        Gets the business_application_id of this V2payoutsProcessingInformation.
        ...
        :return: The business_application_id of this V2payoutsProcessingInformation.
        :rtype: str
        """
    ...
    def business_application_id(self, business_application_id):
        """
        Sets the business_application_id of this V2payoutsProcessingInformation.
        Payouts transaction type.  Applicable Processors: FDC Compass, Paymentech, CtV  Possible values:  **Credit Card Bill Payment**   - **CP**: credit card bill payment  **Funds Disbursement**   - **FD**: funds disbursement  - **GD**: government disbursement  - **MD**: merchant disbursement  **Money Transfer**   - **AA**: account to account. Sender and receiver are same person.  - **PP**: person to person. Sender and receiver are different.  **Prepaid Load**   - **TU**: top up 

        :param business_application_id: The business_application_id of this V2payoutsProcessingInformation.
        :type: str
        """
    ...
    def network_routing_order(self):
        """
        Gets the network_routing_order of this V2payoutsProcessingInformation.
        ...
        :return: The network_routing_order of this V2payoutsProcessingInformation.
        :rtype: str
        """
    ...
    def network_routing_order(self, network_routing_order):
        """
        Sets the network_routing_order of this V2payoutsProcessingInformation.
        This field is optionally used by Push Payments Gateway participants (merchants and acquirers) to get the attributes for specified networks only. The networks specified in this field must be a subset of the information provided during program enrollment. Refer to Sharing Group Code/Network Routing Order. Note: Supported only in US for domestic transactions involving Push Payments Gateway Service.  VisaNet checks to determine if there are issuer routing preferences for any of the networks specified by the network routing order. If an issuer preference exists for one of the specified debit networks, VisaNet makes a routing selection based on the issuerâ€™s preference.  If an issuer preference exists for more than one of the specified debit networks, or if no issuer preference exists, VisaNet makes a selection based on the acquirerâ€™s routing priorities.   See https://developer.visa.com/request_response_codes#network_id_and_sharing_group_code , under section 'Network ID and Sharing Group Code' on the left panel for available values 

        :param network_routing_order: The network_routing_order of this V2payoutsProcessingInformation.
        :type: str
        """
    ...
    def commerce_indicator(self):
        """
        Gets the commerce_indicator of this V2payoutsProcessingInformation.
        Type of transaction. Possible value for Fast Payments transactions:   - internet 

        :return: The commerce_indicator of this V2payoutsProcessingInformation.
        :rtype: str
        """
    ...
    def commerce_indicator(self, commerce_indicator):
        """
        Sets the commerce_indicator of this V2payoutsProcessingInformation.
        Type of transaction. Possible value for Fast Payments transactions:   - internet 

        :param commerce_indicator: The commerce_indicator of this V2payoutsProcessingInformation.
        :type: str
        """
    ...
    def reconciliation_id(self):
        """
        Gets the reconciliation_id of this V2payoutsProcessingInformation.
        Please check with Cybersource customer support to see if your merchant account is configured correctly so you can include this field in your request. * For Payouts: max length for FDCCompass is String (22). 

        :return: The reconciliation_id of this V2payoutsProcessingInformation.
        :rtype: str
        """
    ...
    def reconciliation_id(self, reconciliation_id):
        """
        Sets the reconciliation_id of this V2payoutsProcessingInformation.
        Please check with Cybersource customer support to see if your merchant account is configured correctly so you can include this field in your request. * For Payouts: max length for FDCCompass is String (22). 

        :param reconciliation_id: The reconciliation_id of this V2payoutsProcessingInformation.
        :type: str
        """
    ...
    def payouts_options(self):
        """
        Gets the payouts_options of this V2payoutsProcessingInformation.

        :return: The payouts_options of this V2payoutsProcessingInformation.
        :rtype: V2payoutsProcessingInformationPayoutsOptions
        """
    ...
    def payouts_options(self, payouts_options):
        """
        Sets the payouts_options of this V2payoutsProcessingInformation.

        :param payouts_options: The payouts_options of this V2payoutsProcessingInformation.
        :type: V2payoutsProcessingInformationPayoutsOptions
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2payoutsProcessingInformation):
            return False
