...
class V2paymentsidcapturesProcessingInformation(object):
    """
    ...
    def __init__(self, payment_solution=None, reconciliation_id=None, link_id=None, report_group=None, visa_checkout_id=None, purchase_level=None, issuer=None, authorization_options=None, capture_options=None):
        """
        V2paymentsidcapturesProcessingInformation - a model defined in Swagger
        """
    ...
    def payment_solution(self):
        """
        Gets the payment_solution of this V2paymentsidcapturesProcessingInformation.
        ...
        :return: The payment_solution of this V2paymentsidcapturesProcessingInformation.
        :rtype: str
        """
    ...
    def payment_solution(self, payment_solution):
        """
        Sets the payment_solution of this V2paymentsidcapturesProcessingInformation.
        Type of digital payment solution that is being used for the transaction. Possible Values:   - **visacheckout**: Visa Checkout.  - **001**: Apple Pay.  - **005**: Masterpass. Required for Masterpass transactions on OmniPay Direct.  - **006**: Android Pay.  - **008**: Samsung Pay. 

        :param payment_solution: The payment_solution of this V2paymentsidcapturesProcessingInformation.
        :type: str
        """
    ...
    def reconciliation_id(self):
        """
        Gets the reconciliation_id of this V2paymentsidcapturesProcessingInformation.
        Please check with Cybersource customer support to see if your merchant account is configured correctly so you can include this field in your request. * For Payouts: max length for FDCCompass is String (22). 

        :return: The reconciliation_id of this V2paymentsidcapturesProcessingInformation.
        :rtype: str
        """
    ...
    def reconciliation_id(self, reconciliation_id):
        """
        Sets the reconciliation_id of this V2paymentsidcapturesProcessingInformation.
        Please check with Cybersource customer support to see if your merchant account is configured correctly so you can include this field in your request. * For Payouts: max length for FDCCompass is String (22). 

        :param reconciliation_id: The reconciliation_id of this V2paymentsidcapturesProcessingInformation.
        :type: str
        """
    ...
    def link_id(self):
        """
        Gets the link_id of this V2paymentsidcapturesProcessingInformation.
        ...
        :return: The link_id of this V2paymentsidcapturesProcessingInformation.
        :rtype: str
        """
    ...
    def link_id(self, link_id):
        """
        Sets the link_id of this V2paymentsidcapturesProcessingInformation.
        Value that links the current payment request to the original request. Set this value to the ID that was returned in the reply message from the original payment request.  This value is used for:   - Partial authorizations.  - Split shipments. 

        :param link_id: The link_id of this V2paymentsidcapturesProcessingInformation.
        :type: str
        """
    ...
    def report_group(self):
        """
        Gets the report_group of this V2paymentsidcapturesProcessingInformation.
        Attribute that lets you define custom grouping for your processor reports. This field is supported only for **Litle**. 

        :return: The report_group of this V2paymentsidcapturesProcessingInformation.
        :rtype: str
        """
    ...
    def report_group(self, report_group):
        """
        Sets the report_group of this V2paymentsidcapturesProcessingInformation.
        Attribute that lets you define custom grouping for your processor reports. This field is supported only for **Litle**. 

        :param report_group: The report_group of this V2paymentsidcapturesProcessingInformation.
        :type: str
        """
    ...
    def visa_checkout_id(self):
        """
        Gets the visa_checkout_id of this V2paymentsidcapturesProcessingInformation.
        Identifier for the **Visa Checkout** order. Visa Checkout provides a unique order ID for every transaction in the Visa Checkout **callID** field. 

        :return: The visa_checkout_id of this V2paymentsidcapturesProcessingInformation.
        :rtype: str
        """
    ...
    def visa_checkout_id(self, visa_checkout_id):
        """
        Sets the visa_checkout_id of this V2paymentsidcapturesProcessingInformation.
        Identifier for the **Visa Checkout** order. Visa Checkout provides a unique order ID for every transaction in the Visa Checkout **callID** field. 

        :param visa_checkout_id: The visa_checkout_id of this V2paymentsidcapturesProcessingInformation.
        :type: str
        """
    ...
    def purchase_level(self):
        """
        Gets the purchase_level of this V2paymentsidcapturesProcessingInformation.
    ...
    def purchase_level(self, purchase_level):
        """
        Sets the purchase_level of this V2paymentsidcapturesProcessingInformation.
        Set this field to 3 to indicate that the request includes Level III data.
    ...
    def issuer(self):
        """
        Gets the issuer of this V2paymentsidcapturesProcessingInformation.
    ...
    def issuer(self, issuer):
        """
        Sets the issuer of this V2paymentsidcapturesProcessingInformation.
    ...
    def authorization_options(self):
        """
        Gets the authorization_options of this V2paymentsidcapturesProcessingInformation.

        :return: The authorization_options of this V2paymentsidcapturesProcessingInformation.
        :rtype: V2paymentsidcapturesProcessingInformationAuthorizationOptions
        """
    ...
    def authorization_options(self, authorization_options):
        """
        Sets the authorization_options of this V2paymentsidcapturesProcessingInformation.

        :param authorization_options: The authorization_options of this V2paymentsidcapturesProcessingInformation.
    ...
    def capture_options(self):
        """
        Gets the capture_options of this V2paymentsidcapturesProcessingInformation.

        :return: The capture_options of this V2paymentsidcapturesProcessingInformation.
        :rtype: V2paymentsidcapturesProcessingInformationCaptureOptions
        """
    ...
    def capture_options(self, capture_options):
        """
        Sets the capture_options of this V2paymentsidcapturesProcessingInformation.

        :param capture_options: The capture_options of this V2paymentsidcapturesProcessingInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsidcapturesProcessingInformation):
            return False
