...
class V2paymentsidcapturesOrderInformationInvoiceDetails(object):
    """
    ...
    def __init__(self, purchase_order_number=None, purchase_order_date=None, purchase_contact_name=None, taxable=None, vat_invoice_reference_number=None, commodity_code=None, transaction_advice_addendum=None):
        """
        V2paymentsidcapturesOrderInformationInvoiceDetails - a model defined in Swagger
        """
    ...
    def purchase_order_number(self):
        """
        Gets the purchase_order_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        ...
        :return: The purchase_order_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :rtype: str
        """
    ...
    def purchase_order_number(self, purchase_order_number):
        """
        Sets the purchase_order_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        Value used by your customer to identify the order. This value is typically a purchase order number. CyberSource recommends that you do not populate the field with all zeros or nines.  For processor-specific information, see the user_po field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param purchase_order_number: The purchase_order_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :type: str
        """
    ...
    def purchase_order_date(self):
        """
        Gets the purchase_order_date of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        ...
        :return: The purchase_order_date of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :rtype: str
        """
    ...
    def purchase_order_date(self, purchase_order_date):
        """
        Sets the purchase_order_date of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        Date the order was processed. `Format: YYYY-MM-DD`.  For processor-specific information, see the purchaser_order_date field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param purchase_order_date: The purchase_order_date of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :type: str
        """
    ...
    def purchase_contact_name(self):
        """
        Gets the purchase_contact_name of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        ...
        :return: The purchase_contact_name of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :rtype: str
        """
    ...
    def purchase_contact_name(self, purchase_contact_name):
        """
        Sets the purchase_contact_name of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        The name of the individual or the company contacted for company authorized purchases.  For processor-specific information, see the authorized_contact_name field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param purchase_contact_name: The purchase_contact_name of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :type: str
        """
    ...
    def taxable(self):
        """
        Gets the taxable of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        ...
        :return: The taxable of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :rtype: bool
        """
    ...
    def taxable(self, taxable):
        """
        Sets the taxable of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        Flag that indicates whether an order is taxable. This value must be true if the sum of all _lineItems[].taxAmount_ values > 0.  If you do not include any _lineItems[].taxAmount_ values in your request, CyberSource does not include _invoiceDetails.taxable_ in the data it sends to the processor.  For processor-specific information, see the tax_indicator field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param taxable: The taxable of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :type: bool
        """
    ...
    def vat_invoice_reference_number(self):
        """
        Gets the vat_invoice_reference_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        ...
        :return: The vat_invoice_reference_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :rtype: str
        """
    ...
    def vat_invoice_reference_number(self, vat_invoice_reference_number):
        """
        Sets the vat_invoice_reference_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        VAT invoice number associated with the transaction.  For processor-specific information, see the vat_invoice_ref_number field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param vat_invoice_reference_number: The vat_invoice_reference_number of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :type: str
        """
    ...
    def commodity_code(self):
        """
        Gets the commodity_code of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        ...
        :return: The commodity_code of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :rtype: str
        """
    ...
    def commodity_code(self, commodity_code):
        """
        Sets the commodity_code of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        International description code of the overall orderâ€™s goods or services or the Categorizes purchases for VAT reporting. Contact your acquirer for a list of codes.  For processor-specific information, see the summary_commodity_code field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param commodity_code: The commodity_code of this V2paymentsidcapturesOrderInformationInvoiceDetails.
        :type: str
        """
    ...
    def transaction_advice_addendum(self):
        """
        Gets the transaction_advice_addendum of this V2paymentsidcapturesOrderInformationInvoiceDetails.
    ...
    def transaction_advice_addendum(self, transaction_advice_addendum):
        """
        Sets the transaction_advice_addendum of this V2paymentsidcapturesOrderInformationInvoiceDetails.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsidcapturesOrderInformationInvoiceDetails):
            return False
