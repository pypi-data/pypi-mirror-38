...
class V2paymentsProcessingInformationRecurringOptions(object):
    """
    ...
    def __init__(self, loan_payment=False, first_recurring_payment=False):
        """
        V2paymentsProcessingInformationRecurringOptions - a model defined in Swagger
        """
    ...
    def loan_payment(self):
        """
        Gets the loan_payment of this V2paymentsProcessingInformationRecurringOptions.
        Flag that indicates whether this is a payment towards an existing contractual loan. 

        :return: The loan_payment of this V2paymentsProcessingInformationRecurringOptions.
        :rtype: bool
        """
    ...
    def loan_payment(self, loan_payment):
        """
        Sets the loan_payment of this V2paymentsProcessingInformationRecurringOptions.
        Flag that indicates whether this is a payment towards an existing contractual loan. 

        :param loan_payment: The loan_payment of this V2paymentsProcessingInformationRecurringOptions.
        :type: bool
        """
    ...
    def first_recurring_payment(self):
        """
        Gets the first_recurring_payment of this V2paymentsProcessingInformationRecurringOptions.
    ...
    def first_recurring_payment(self, first_recurring_payment):
        """
        Sets the first_recurring_payment of this V2paymentsProcessingInformationRecurringOptions.
        Flag that indicates whether this transaction is the first in a series of recurring payments. This field is supported only for **Atos**, **FDC Nashville Global**, and **OmniPay Direct**. 
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsProcessingInformationRecurringOptions):
            return False
