...
class V2paymentsRecipientInformation(object):
    """
    ...
    def __init__(self, account_id=None, last_name=None, postal_code=None):
        """
        V2paymentsRecipientInformation - a model defined in Swagger
        """
    ...
    def account_id(self):
        """
        Gets the account_id of this V2paymentsRecipientInformation.
        ...
        :return: The account_id of this V2paymentsRecipientInformation.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """
        Sets the account_id of this V2paymentsRecipientInformation.
        Identifier for the recipientâ€™s account. Use the first six digits and last four digits of the recipientâ€™s account number. This field is a pass-through, which means that CyberSource does not verify the value or modify it in any way before sending it to the processor. If the field is not required for the transaction, CyberSource does not forward it to the processor. 

        :param account_id: The account_id of this V2paymentsRecipientInformation.
        :type: str
        """
    ...
    def last_name(self):
        """
        Gets the last_name of this V2paymentsRecipientInformation.
        ...
        :return: The last_name of this V2paymentsRecipientInformation.
        :rtype: str
        """
    ...
    def last_name(self, last_name):
        """
        Sets the last_name of this V2paymentsRecipientInformation.
        Recipientâ€™s last name. This field is a passthrough, which means that CyberSource does not verify the value or modify it in any way before sending it to the processor. If the field is not required for the transaction, CyberSource does not forward it to the processor. 

        :param last_name: The last_name of this V2paymentsRecipientInformation.
        :type: str
        """
    ...
    def postal_code(self):
        """
        Gets the postal_code of this V2paymentsRecipientInformation.
        ...
        :return: The postal_code of this V2paymentsRecipientInformation.
        :rtype: str
        """
    ...
    def postal_code(self, postal_code):
        """
        Sets the postal_code of this V2paymentsRecipientInformation.
        Partial postal code for the recipientâ€™s address. For example, if the postal code is **NN5 7SG**, the value for this  field should be the first part of the postal code: **NN5**. This field is a pass-through, which means that CyberSource does not verify the value or modify it in any way before sending it to the processor. If the field is not required for the transaction, CyberSource does not forward it to the processor. 

        :param postal_code: The postal_code of this V2paymentsRecipientInformation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsRecipientInformation):
            return False
