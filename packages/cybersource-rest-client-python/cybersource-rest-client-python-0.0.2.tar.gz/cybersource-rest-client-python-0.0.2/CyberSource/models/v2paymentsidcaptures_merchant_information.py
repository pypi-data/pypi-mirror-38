...
class V2paymentsidcapturesMerchantInformation(object):
    """
    ...
    def __init__(self, merchant_descriptor=None, card_acceptor_reference_number=None, category_code=None, vat_registration_number=None):
        """
        V2paymentsidcapturesMerchantInformation - a model defined in Swagger
        """
    ...
    def merchant_descriptor(self):
        """
        Gets the merchant_descriptor of this V2paymentsidcapturesMerchantInformation.

        :return: The merchant_descriptor of this V2paymentsidcapturesMerchantInformation.
    ...
    def merchant_descriptor(self, merchant_descriptor):
        """
        Sets the merchant_descriptor of this V2paymentsidcapturesMerchantInformation.

        :param merchant_descriptor: The merchant_descriptor of this V2paymentsidcapturesMerchantInformation.
    ...
    def card_acceptor_reference_number(self):
        """
        Gets the card_acceptor_reference_number of this V2paymentsidcapturesMerchantInformation.
        ...
        :return: The card_acceptor_reference_number of this V2paymentsidcapturesMerchantInformation.
        :rtype: str
        """
    ...
    def card_acceptor_reference_number(self, card_acceptor_reference_number):
        """
        Sets the card_acceptor_reference_number of this V2paymentsidcapturesMerchantInformation.
        Reference number that facilitates card acceptor/corporation communication and record keeping.  For processor-specific information, see the card_acceptor_ref_number field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param card_acceptor_reference_number: The card_acceptor_reference_number of this V2paymentsidcapturesMerchantInformation.
        :type: str
        """
    ...
    def category_code(self):
        """
        Gets the category_code of this V2paymentsidcapturesMerchantInformation.
        Four-digit number that the payment card industry uses to classify merchants into market segments. Visa assigned one or more of these values to your business when you started accepting Visa cards.  If you do not include this field in your request, CyberSource uses the value in your CyberSource account.  For processor-specific information, see the merchant_category_code field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :return: The category_code of this V2paymentsidcapturesMerchantInformation.
        :rtype: int
        """
    ...
    def category_code(self, category_code):
        """
        Sets the category_code of this V2paymentsidcapturesMerchantInformation.
        Four-digit number that the payment card industry uses to classify merchants into market segments. Visa assigned one or more of these values to your business when you started accepting Visa cards.  If you do not include this field in your request, CyberSource uses the value in your CyberSource account.  For processor-specific information, see the merchant_category_code field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param category_code: The category_code of this V2paymentsidcapturesMerchantInformation.
        :type: int
        """
    ...
    def vat_registration_number(self):
        """
        Gets the vat_registration_number of this V2paymentsidcapturesMerchantInformation.
        ...
        :return: The vat_registration_number of this V2paymentsidcapturesMerchantInformation.
        :rtype: str
        """
    ...
    def vat_registration_number(self, vat_registration_number):
        """
        Sets the vat_registration_number of this V2paymentsidcapturesMerchantInformation.
        Your government-assigned tax identification number.  For CtV processors, the maximum length is 20.  For other processor-specific information, see the merchant_vat_registration_number field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param vat_registration_number: The vat_registration_number of this V2paymentsidcapturesMerchantInformation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsidcapturesMerchantInformation):
            return False
