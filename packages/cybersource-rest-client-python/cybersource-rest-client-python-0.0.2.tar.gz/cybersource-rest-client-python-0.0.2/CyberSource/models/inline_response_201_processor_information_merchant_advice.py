...
class InlineResponse201ProcessorInformationMerchantAdvice(object):
    """
    ...
    def __init__(self, code=None, code_raw=None):
        """
        InlineResponse201ProcessorInformationMerchantAdvice - a model defined in Swagger
        """
    ...
    def code(self):
        """
        Gets the code of this InlineResponse201ProcessorInformationMerchantAdvice.
        ...
        :return: The code of this InlineResponse201ProcessorInformationMerchantAdvice.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        """
        Sets the code of this InlineResponse201ProcessorInformationMerchantAdvice.
        Reason the recurring payment transaction was declined. For some processors, this field is used only for Mastercard. For other processors, this field is used for Visa and Mastercard. And for other processors, this field is not implemented.  Possible values:   - **00**: Response not provided.  - **01**: New account information is available. Obtain the new information.  - **02**: Try again later.  - **03**: Do not try again. Obtain another type of payment from the customer.  - **04**: Problem with a token or a partial shipment indicator.  - **21**: Recurring payment cancellation service.  - **99**: An unknown value was returned from the processor. 

        :param code: The code of this InlineResponse201ProcessorInformationMerchantAdvice.
        :type: str
        """
    ...
    def code_raw(self):
        """
        Gets the code_raw of this InlineResponse201ProcessorInformationMerchantAdvice.
        ...
        :return: The code_raw of this InlineResponse201ProcessorInformationMerchantAdvice.
        :rtype: str
        """
    ...
    def code_raw(self, code_raw):
        """
        Sets the code_raw of this InlineResponse201ProcessorInformationMerchantAdvice.
        Raw merchant advice code sent directly from the processor. This field is used only for Mastercard.  For processor-specific information, see the auth_merchant_advice_code_raw field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param code_raw: The code_raw of this InlineResponse201ProcessorInformationMerchantAdvice.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse201ProcessorInformationMerchantAdvice):
            return False
