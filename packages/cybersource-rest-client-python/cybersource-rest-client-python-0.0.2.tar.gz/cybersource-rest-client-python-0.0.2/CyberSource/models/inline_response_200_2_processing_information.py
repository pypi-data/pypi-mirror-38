...
class InlineResponse2002ProcessingInformation(object):
    """
    ...
    def __init__(self, payment_solution=None):
        """
        InlineResponse2002ProcessingInformation - a model defined in Swagger
        """
    ...
    def payment_solution(self):
        """
        Gets the payment_solution of this InlineResponse2002ProcessingInformation.
        ...
        :return: The payment_solution of this InlineResponse2002ProcessingInformation.
        :rtype: str
        """
    ...
    def payment_solution(self, payment_solution):
        """
        Sets the payment_solution of this InlineResponse2002ProcessingInformation.
        Type of digital payment solution that is being used for the transaction. Possible Values:   - **visacheckout**: Visa Checkout.  - **001**: Apple Pay.  - **005**: Masterpass. Required for Masterpass transactions on OmniPay Direct.  - **006**: Android Pay.  - **008**: Samsung Pay. 

        :param payment_solution: The payment_solution of this InlineResponse2002ProcessingInformation.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse2002ProcessingInformation):
            return False
