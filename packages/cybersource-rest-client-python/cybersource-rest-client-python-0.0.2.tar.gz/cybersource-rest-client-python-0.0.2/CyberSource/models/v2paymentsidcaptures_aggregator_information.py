...
class V2paymentsidcapturesAggregatorInformation(object):
    """
    ...
    def __init__(self, aggregator_id=None, name=None, sub_merchant=None):
        """
        V2paymentsidcapturesAggregatorInformation - a model defined in Swagger
        """
    ...
    def aggregator_id(self):
        """
        Gets the aggregator_id of this V2paymentsidcapturesAggregatorInformation.
        ...
        :return: The aggregator_id of this V2paymentsidcapturesAggregatorInformation.
        :rtype: str
        """
    ...
    def aggregator_id(self, aggregator_id):
        """
        Sets the aggregator_id of this V2paymentsidcapturesAggregatorInformation.
        Value that identifies you as a payment aggregator. Get this value from the processor.  For processor-specific information, see the aggregator_id field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param aggregator_id: The aggregator_id of this V2paymentsidcapturesAggregatorInformation.
        :type: str
        """
    ...
    def name(self):
        """
        Gets the name of this V2paymentsidcapturesAggregatorInformation.
        ...
        :return: The name of this V2paymentsidcapturesAggregatorInformation.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this V2paymentsidcapturesAggregatorInformation.
        Your payment aggregator business name.  For processor-specific information, see the aggregator_name field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param name: The name of this V2paymentsidcapturesAggregatorInformation.
        :type: str
        """
    ...
    def sub_merchant(self):
        """
        Gets the sub_merchant of this V2paymentsidcapturesAggregatorInformation.

        :return: The sub_merchant of this V2paymentsidcapturesAggregatorInformation.
        :rtype: V2paymentsidcapturesAggregatorInformationSubMerchant
        """
    ...
    def sub_merchant(self, sub_merchant):
        """
        Sets the sub_merchant of this V2paymentsidcapturesAggregatorInformation.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2paymentsidcapturesAggregatorInformation):
            return False
