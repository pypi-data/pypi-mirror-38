...
class V2payoutsProcessingInformationPayoutsOptions(object):
    """
    ...
    def __init__(self, acquirer_merchant_id=None, acquirer_bin=None, retrieval_reference_number=None, account_funding_reference_id=None):
        """
        V2payoutsProcessingInformationPayoutsOptions - a model defined in Swagger
        """
    ...
    def acquirer_merchant_id(self):
        """
        Gets the acquirer_merchant_id of this V2payoutsProcessingInformationPayoutsOptions.
        ...
        :return: The acquirer_merchant_id of this V2payoutsProcessingInformationPayoutsOptions.
        :rtype: str
        """
    ...
    def acquirer_merchant_id(self, acquirer_merchant_id):
        """
        Sets the acquirer_merchant_id of this V2payoutsProcessingInformationPayoutsOptions.
        This field identifies the card acceptor for defining the point of service terminal in both local and interchange environments. An acquirer-assigned code identifying the card acceptor for the transaction.  Depending on the acquirer and merchant billing and reporting requirements, the code can represent a merchant, a specific merchant location, or a specific merchant location terminal. Acquiring Institution Identification Code uniquely identifies the merchant. The value from the original is required in any subsequent messages, including reversals, chargebacks, and representments. * Applicable only for CTV for Payouts. 

        :param acquirer_merchant_id: The acquirer_merchant_id of this V2payoutsProcessingInformationPayoutsOptions.
        :type: str
        """
    ...
    def acquirer_bin(self):
        """
        Gets the acquirer_bin of this V2payoutsProcessingInformationPayoutsOptions.
        ...
        :return: The acquirer_bin of this V2payoutsProcessingInformationPayoutsOptions.
        :rtype: str
        """
    ...
    def acquirer_bin(self, acquirer_bin):
        """
        Sets the acquirer_bin of this V2payoutsProcessingInformationPayoutsOptions.
        This code identifies the financial institution acting as the acquirer of this customer transaction. The acquirer is the member or system user that signed the merchant or ADM or dispensed cash.  This number is usually Visa-assigned. * Applicable only for CTV for Payouts. 

        :param acquirer_bin: The acquirer_bin of this V2payoutsProcessingInformationPayoutsOptions.
        :type: str
        """
    ...
    def retrieval_reference_number(self):
        """
        Gets the retrieval_reference_number of this V2payoutsProcessingInformationPayoutsOptions.
        ...
        :return: The retrieval_reference_number of this V2payoutsProcessingInformationPayoutsOptions.
        :rtype: str
        """
    ...
    def retrieval_reference_number(self, retrieval_reference_number):
        """
        Sets the retrieval_reference_number of this V2payoutsProcessingInformationPayoutsOptions.
        This field contains a number that is used with other data elements as a key to identify and track all messages related to a given cardholder transaction; that is, to a given transaction set. * Applicable only for CTV for Payouts. 

        :param retrieval_reference_number: The retrieval_reference_number of this V2payoutsProcessingInformationPayoutsOptions.
        :type: str
        """
    ...
    def account_funding_reference_id(self):
        """
        Gets the account_funding_reference_id of this V2payoutsProcessingInformationPayoutsOptions.
        ...
        :return: The account_funding_reference_id of this V2payoutsProcessingInformationPayoutsOptions.
        :rtype: str
        """
    ...
    def account_funding_reference_id(self, account_funding_reference_id):
        """
        Sets the account_funding_reference_id of this V2payoutsProcessingInformationPayoutsOptions.
        Visa-generated transaction identifier (TID) that is unique for each original authorization and financial request. * Applicable only for CTV for Payouts. 

        :param account_funding_reference_id: The account_funding_reference_id of this V2payoutsProcessingInformationPayoutsOptions.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, V2payoutsProcessingInformationPayoutsOptions):
            return False
