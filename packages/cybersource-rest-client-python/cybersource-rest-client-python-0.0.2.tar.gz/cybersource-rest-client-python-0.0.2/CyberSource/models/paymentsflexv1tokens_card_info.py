...
class Paymentsflexv1tokensCardInfo(object):
    """
    ...
    def __init__(self, card_number=None, card_expiration_month=None, card_expiration_year=None, card_type=None):
        """
        Paymentsflexv1tokensCardInfo - a model defined in Swagger
        """
    ...
    def card_number(self):
        """
        Gets the card_number of this Paymentsflexv1tokensCardInfo.
        ...
        :return: The card_number of this Paymentsflexv1tokensCardInfo.
        :rtype: str
        """
    ...
    def card_number(self, card_number):
        """
        Sets the card_number of this Paymentsflexv1tokensCardInfo.
        Encrypted or plain text card number. If the encryption type of “None” was used in the Generate Key request, this value can be set to the plaintext card number/Personal Account Number (PAN). If the encryption type of RsaOaep256 was used in the Generate Key request, this value needs to be the RSA OAEP 256 encrypted card number. The card number should be encrypted on the cardholders’ device. The [WebCrypto API] (https://github.com/CyberSource/cybersource-flex-samples/blob/master/java/spring-boot/src/main/resources/public/flex.js) can be used with the JWK obtained in the Generate Key request.

        :param card_number: The card_number of this Paymentsflexv1tokensCardInfo.
        :type: str
        """
    ...
    def card_expiration_month(self):
        """
        Gets the card_expiration_month of this Paymentsflexv1tokensCardInfo.
        Two digit expiration month

        :return: The card_expiration_month of this Paymentsflexv1tokensCardInfo.
        :rtype: str
        """
    ...
    def card_expiration_month(self, card_expiration_month):
        """
        Sets the card_expiration_month of this Paymentsflexv1tokensCardInfo.
        Two digit expiration month

        :param card_expiration_month: The card_expiration_month of this Paymentsflexv1tokensCardInfo.
        :type: str
        """
    ...
    def card_expiration_year(self):
        """
        Gets the card_expiration_year of this Paymentsflexv1tokensCardInfo.
        Four digit expiration year

        :return: The card_expiration_year of this Paymentsflexv1tokensCardInfo.
        :rtype: str
        """
    ...
    def card_expiration_year(self, card_expiration_year):
        """
        Sets the card_expiration_year of this Paymentsflexv1tokensCardInfo.
        Four digit expiration year

        :param card_expiration_year: The card_expiration_year of this Paymentsflexv1tokensCardInfo.
        :type: str
        """
    ...
    def card_type(self, card_type):
        """
        Sets the card_type of this Paymentsflexv1tokensCardInfo.
        Card Type. This field is required. Refer to the CyberSource Credit Card Services documentation for supported card types.

        :param card_type: The card_type of this Paymentsflexv1tokensCardInfo.
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, Paymentsflexv1tokensCardInfo):
            return False
