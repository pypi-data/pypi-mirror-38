...
class InlineResponse2004OrderInformationAmountDetails(object):
    """
    ...
    def __init__(self, total_amount=None, currency=None, discount_amount=None, duty_amount=None, tax_amount=None, national_tax_included=None, freight_amount=None, tax_details=None):
        """
        InlineResponse2004OrderInformationAmountDetails - a model defined in Swagger
        """
    ...
    def total_amount(self):
        """
        Gets the total_amount of this InlineResponse2004OrderInformationAmountDetails.
        ...
        :return: The total_amount of this InlineResponse2004OrderInformationAmountDetails.
        :rtype: str
        """
    ...
    def total_amount(self, total_amount):
        """
        Sets the total_amount of this InlineResponse2004OrderInformationAmountDetails.
        Grand total for the order. You can include a decimal point (.), but no other special characters. CyberSource truncates the amount to the correct number of decimal places.  * CTV, FDCCompass, Paymentech (<= 12)  For processor-specific information, see the grand_total_amount field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html) 

        :param total_amount: The total_amount of this InlineResponse2004OrderInformationAmountDetails.
        :type: str
        """
    ...
    def currency(self):
        """
        Gets the currency of this InlineResponse2004OrderInformationAmountDetails.
        ...
        :return: The currency of this InlineResponse2004OrderInformationAmountDetails.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """
        Sets the currency of this InlineResponse2004OrderInformationAmountDetails.
        Currency used for the order. Use the three-character ISO Standard Currency Codes.  For an authorization reversal or a capture, you must use the same currency that you used in your request for Payment API. 

        :param currency: The currency of this InlineResponse2004OrderInformationAmountDetails.
        :type: str
        """
    ...
    def discount_amount(self):
        """
        Gets the discount_amount of this InlineResponse2004OrderInformationAmountDetails.
        ...
        :return: The discount_amount of this InlineResponse2004OrderInformationAmountDetails.
        :rtype: str
        """
    ...
    def discount_amount(self, discount_amount):
        """
        Sets the discount_amount of this InlineResponse2004OrderInformationAmountDetails.
        Total discount amount applied to the order.  For processor-specific information, see the order_discount_amount field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param discount_amount: The discount_amount of this InlineResponse2004OrderInformationAmountDetails.
        :type: str
        """
    ...
    def duty_amount(self):
        """
        Gets the duty_amount of this InlineResponse2004OrderInformationAmountDetails.
        ...
        :return: The duty_amount of this InlineResponse2004OrderInformationAmountDetails.
        :rtype: str
        """
    ...
    def duty_amount(self, duty_amount):
        """
        Sets the duty_amount of this InlineResponse2004OrderInformationAmountDetails.
        Total charges for any import or export duties included in the order.  For processor-specific information, see the duty_amount field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param duty_amount: The duty_amount of this InlineResponse2004OrderInformationAmountDetails.
        :type: str
        """
    ...
    def tax_amount(self):
        """
        Gets the tax_amount of this InlineResponse2004OrderInformationAmountDetails.
        ...
        :return: The tax_amount of this InlineResponse2004OrderInformationAmountDetails.
        :rtype: str
        """
    ...
    def tax_amount(self, tax_amount):
        """
        Sets the tax_amount of this InlineResponse2004OrderInformationAmountDetails.
        Total tax amount for all the items in the order.  For processor-specific information, see the total_tax_amount field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param tax_amount: The tax_amount of this InlineResponse2004OrderInformationAmountDetails.
        :type: str
        """
    ...
    def national_tax_included(self):
        """
        Gets the national_tax_included of this InlineResponse2004OrderInformationAmountDetails.
        ...
        :return: The national_tax_included of this InlineResponse2004OrderInformationAmountDetails.
        :rtype: str
        """
    ...
    def national_tax_included(self, national_tax_included):
        """
        Sets the national_tax_included of this InlineResponse2004OrderInformationAmountDetails.
        Flag that indicates whether a national tax is included in the order total.  Possible values:   - **0**: national tax not included  - **1**: national tax included  For processor-specific information, see the national_tax_indicator field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param national_tax_included: The national_tax_included of this InlineResponse2004OrderInformationAmountDetails.
        :type: str
        """
    ...
    def freight_amount(self):
        """
        Gets the freight_amount of this InlineResponse2004OrderInformationAmountDetails.
        Total freight or shipping and handling charges for the order. When you include this field in your request, you must also include the **totalAmount** field.  For processor-specific information, see the freight_amount field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :return: The freight_amount of this InlineResponse2004OrderInformationAmountDetails.
        :rtype: str
        """
    ...
    def freight_amount(self, freight_amount):
        """
        Sets the freight_amount of this InlineResponse2004OrderInformationAmountDetails.
        Total freight or shipping and handling charges for the order. When you include this field in your request, you must also include the **totalAmount** field.  For processor-specific information, see the freight_amount field in [Level II and Level III Processing Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/Level_2_3_SCMP_API/html) 

        :param freight_amount: The freight_amount of this InlineResponse2004OrderInformationAmountDetails.
        :type: str
        """
    ...
    def tax_details(self):
        """
        Gets the tax_details of this InlineResponse2004OrderInformationAmountDetails.
    ...
    def tax_details(self, tax_details):
        """
        Sets the tax_details of this InlineResponse2004OrderInformationAmountDetails.

        :param tax_details: The tax_details of this InlineResponse2004OrderInformationAmountDetails.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, InlineResponse2004OrderInformationAmountDetails):
            return False
