    ...
    def create_acme_certificates(self, subdomains):
        ...
        with fab_settings(warn_only=True):
            ...
            while attempt < MAX_ATTEMPTS:
                ...
                if return_code == 0:
                ...
                elif '"status": 429' in result:
                    logger.error("You have been ratelimited by let's encrypt - retry later")
                    exit(1)
                else:
                    ...
                    if attempt < MAX_ATTEMPTS:
                        attempt += 1
                        logger.info(
                            "Trying again in {WAIT_BETWEEN_ATTEMPTS} seconds. "
