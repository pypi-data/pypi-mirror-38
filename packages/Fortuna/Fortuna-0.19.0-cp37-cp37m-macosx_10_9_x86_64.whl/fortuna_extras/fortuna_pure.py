...
def distribution_timer(func: staticmethod, *args, call_sig=None, max_distribution=25, num_cycles=10000, **kwargs):
...
if __name__ == "__main__":
    t0 = datetime.now()
    print("Fortuna Pure Sample Distribution and Performance Test Suite\n")
