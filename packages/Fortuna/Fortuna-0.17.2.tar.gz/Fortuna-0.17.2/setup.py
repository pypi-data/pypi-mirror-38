...
setup(
    ...
    keywords=[
        ...
        "Random Value", "Gaussian Distribution", "Linear Geometric Distribution", "Truffle Shuffle", "MultiCat",
        "Percent True", "Zero Cool", "Quantum Monty", "Custom Distribution Patterns"
    ],
    python_requires='>=3.6',
)
