...
if __name__ == "__main__":
    t0 = datetime.now()
    print("\nFortuna 0.19.5 Sample Distribution and Performance Test Suite\n")
    ...
    distribution_timer(plus_or_minus_curve, 5, False)
    ...
    print(f"cumulative_choice = Fortuna.{cumulative_choice}\n")
    ...
    print(f"relative_choice = Fortuna.{relative_choice}\n")
    ...
    print(f"flex_cat = Fortuna.{flex_cat}\n")
