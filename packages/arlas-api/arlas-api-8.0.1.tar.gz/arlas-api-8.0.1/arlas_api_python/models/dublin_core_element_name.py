...
class DublinCoreElementName(object):
    ...
    def __init__(self, title=None, creator=None, subject=None, description=None, publisher=None, contributor=None, type=None, format=None, identifier=None, source=None, language=None, bbox=None, date=None, coverage=None):
        """
