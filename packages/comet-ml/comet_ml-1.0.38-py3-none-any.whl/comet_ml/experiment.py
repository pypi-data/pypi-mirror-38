...
from ._logging import (
    ...
    UPLOAD_ASSET_TOO_BIG, UPLOAD_FILE_OS_ERROR)
...
from .config import DEFAULT_UPLOAD_SIZE_LIMIT, DEFAULT_ASSET_UPLOAD_SIZE_LIMIT,  get_config
...
class BaseExperiment(object):
    ...
    def log_figure(self, figure_name=None, figure=None, overwrite=False):
        ...
        Args: figure_name: Optional. String - name of the figure figure:
            Optional. The figure you want to log. If not set, the global
            pyplot figure will be logged and uploaded overwrite. Optional.
            Boolean - if another figure with the same name exists, it will be
    ...
    def log_asset(self, file_path, file_name=None, overwrite=False):
        ...
        try:
            ...
            if file_size > self.asset_upload_limit:
                LOGGER.error(UPLOAD_ASSET_TOO_BIG, file_path, file_size, self.asset_upload_limit)
                return
    ...
    def _get_source_code(self):
        ...
        if self._in_jupyter_environment():
            ...
            for frame in inspect.stack(context=1):
                ...
                if module.__name__ not in ("comet_ml.experiment", "comet_ml"):
