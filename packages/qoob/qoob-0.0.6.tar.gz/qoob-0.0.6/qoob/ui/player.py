...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabLayout.addWidget(self.playButton, 0, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.collapseButton, 0, 4, 1, 1)
        self.expandButton = QtWidgets.QToolButton(self.frame_2)
        self.expandButton.setObjectName("expandButton")
        self.gridLayout.addWidget(self.expandButton, 0, 5, 1, 1)
        ...
        self.tabLayout.addWidget(self.previousButton, 0, 4, 1, 1)
        self.shuffleButton = QtWidgets.QToolButton(self.centralwidget)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/shuffle_off.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.shuffleButton.setIcon(icon2)
        self.shuffleButton.setObjectName("shuffleButton")
        self.tabLayout.addWidget(self.shuffleButton, 0, 6, 1, 1)
        ...
        self.tabLayout.addWidget(self.nextButton, 0, 5, 1, 1)
        ...
        self.tabLayout.addWidget(self.stopButton, 0, 2, 1, 1)
        self.slider = QtWidgets.QSlider(self.centralwidget)
        self.slider.setOrientation(QtCore.Qt.Horizontal)
        self.slider.setObjectName("slider")
        self.tabLayout.addWidget(self.slider, 0, 0, 1, 2)
