...
class TestJsonRequestDeserializer(TestCase):
    ...
    def test_init(self):
        ...
        self.assertEqual(req_deserializer.some_key3.some_nested_key1, some_nested_value1)
        self.assertEqual(req_deserializer.some_key3.some_nested_key2, some_nested_value2)
