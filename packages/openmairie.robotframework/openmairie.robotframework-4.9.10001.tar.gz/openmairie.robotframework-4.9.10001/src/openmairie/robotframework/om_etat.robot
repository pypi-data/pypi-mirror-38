...
Depuis le contexte de l'état dans le contexte de la collectivité
    [Tags]  om_etat  om_collectivite
    [Documentation]  Accède à la fiche de consultation de l'état dans le contexte de la colletivité.
...
Ajouter l'état depuis le menu
    [Tags]  om_etat
    [Documentation]  Ajoute un enregistrement de type 'état' (om_etat).
