...
cybuffer could always use more documentation, whether as part of the
official cybuffer docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
1. Fork the `cybuffer` repo on GitHub.
...
3. Install your local copy into an environment. Assuming you have conda installed, this is how you set up your fork for local development (on Windows drop `source`). Replace `"<some version>"` with the Python version used for testing.::
    ...
    $ conda create -n cybufferenv python="<some version>"
    $ source activate cybufferenv
...
3. The pull request should work for Python 2.7, 3.5, 3.6, and 3.7. Check
   https://travis-ci.org/jakirkham/cybuffer/pull_requests
...
To run a subset of tests::
    ...
    $ py.test tests/test_cybuffer.py
