...
class TestEruditPS2EruditAticle(unittest.TestCase):
    ...
    def test_journal_contrib_group_editeur(self):
        ...
        result_surname = [i.text for i in self.xml.xpath('admin/revue/editeurchef//nomfamille')]
        result_givennames = [i.text for i in self.xml.xpath('admin/revue/editeurchef//prenom')]
