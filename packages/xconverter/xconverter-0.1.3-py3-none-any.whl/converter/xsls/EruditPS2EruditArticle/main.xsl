...
<xsl:stylesheet
    ...
    <xsl:template match="article-meta" mode="issue">
        <numero>
            ...
            <xsl:apply-templates select="pub-date[@date-type='collection']" mode="pub"></xsl:apply-templates>
            <xsl:apply-templates select="pub-date[@date-type='pub']" mode="pubnum"></xsl:apply-templates>
            <xsl:apply-templates select="issue-title"></xsl:apply-templates>
        </numero>
    </xsl:template>
