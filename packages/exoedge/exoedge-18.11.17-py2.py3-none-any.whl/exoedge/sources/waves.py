    ...
    Parameters:
        ...
        precision:      Number of decimal points to return
                        ...
                        Inputs:
                            * any (default:2)
    """
    WAVES_LOG.critical("shape: {}".format(shape))
    WAVES_LOG.critical("period: {}".format(period))
    WAVES_LOG.critical("amplifier: {}".format(amplifier))
    WAVES_LOG.critical("envelope: {}".format(envelope))
    WAVES_LOG.critical("precision: {}".format(precision))
