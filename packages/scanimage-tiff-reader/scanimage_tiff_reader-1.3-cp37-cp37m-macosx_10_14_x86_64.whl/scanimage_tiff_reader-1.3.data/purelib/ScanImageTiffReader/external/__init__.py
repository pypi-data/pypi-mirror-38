...
_registry={
    'Windows': {'location':'ScanImageTiffReader-1.3-win64',  'name':"ScanImageTiffReaderAPI.dll"},      
    'Darwin' : {'location':'ScanImageTiffReader-1.3-Darwin', 'name':"libScanImageTiffReaderAPI.so"},         
    'Linux'  : {'location':'ScanImageTiffReader-1.3-Linux',  'name':"libScanImageTiffReaderAPI.so"},     
}
