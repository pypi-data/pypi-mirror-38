...
# platform.linux_distribution depreacted in py3.5 and removed in py3.8
# But it does not support python < 2.7 and we need to support py2.6
...
def dist_name():
    ...
    dist_name_2_alias["Red Hat Enterprise Linux"] = "RHEL"
...
def get_device_wwid(device):
    """
    Given a SCSI or multipath device, returns its WWID
    """
