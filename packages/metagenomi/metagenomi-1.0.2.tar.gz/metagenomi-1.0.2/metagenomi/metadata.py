...
def add_to_archive(mg_id, key, value, **dbargs):
    ...
    if 'dry_run' in dbargs and dbargs['dry_run']==True:
        ...
        if is_unique_mgid(mg_id, dbname):
...
def get_mg_id(filename, filetype):
...
def run_tests():
    ...
    # add_to_archive('HTSP_0004_ISL_SRA-read', 'bbmap_metadata', d,
