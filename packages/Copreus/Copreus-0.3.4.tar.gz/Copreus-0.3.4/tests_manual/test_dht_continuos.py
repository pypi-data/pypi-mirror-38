...
mqttclient.connect()
mqttclient.subscribe(config["device"]["topics-pub"]["temperature"], input_handler_temperature)
mqttclient.subscribe(config["device"]["topics-pub"]["humidity"], input_handler_humidity)
