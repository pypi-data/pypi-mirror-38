...
class Client(BaseClient):
    ...
    def create_delivery_stream(self, DeliveryStreamName: str, DeliveryStreamType: str = None, KinesisStreamSourceConfiguration: Dict = None, S3DestinationConfiguration: Dict = None, ExtendedS3DestinationConfiguration: Dict = None, RedshiftDestinationConfiguration: Dict = None, ElasticsearchDestinationConfiguration: Dict = None, SplunkDestinationConfiguration: Dict = None) -> Dict:
        pass
