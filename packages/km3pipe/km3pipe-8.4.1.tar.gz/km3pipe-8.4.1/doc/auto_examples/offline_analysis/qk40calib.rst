.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_offline_analysis_qk40calib.py>` to download the full example code
...
.. _sphx_glr_download_auto_examples_offline_analysis_qk40calib.py:
