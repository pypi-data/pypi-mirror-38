.. note::
    ...
    Click :ref:`here <sphx_glr_download_auto_examples_offline_analysis_trigger_contribution.py>` to download the full example code
...
.. _sphx_glr_download_auto_examples_offline_analysis_trigger_contribution.py:
