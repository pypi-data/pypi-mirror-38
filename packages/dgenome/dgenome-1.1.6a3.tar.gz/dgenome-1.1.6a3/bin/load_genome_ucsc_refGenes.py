...
def insert_transcripts(ref, gene_map, batch_size):
...
def insert_features(ref, trasc_map, batch_size):
...
if __name__ == '__main__':
    ...
    trasc_map = insert_transcripts(ref, gene_map, batch_size)
    insert_features(ref, trasc_map, batch_size)
