...
_LISTGROUPSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='order_by', full_name='charonrpc.ListGroupsRequest.order_by', index=2,
...
_LISTGROUPSREQUEST.fields_by_name['order_by'].message_type = charonrpc_dot_common__pb2._ORDER
...
Group = _reflection.GeneratedProtocolMessageType('Group', (_message.Message,), dict(
  DESCRIPTOR = _GROUP,
  __module__ = 'charonrpc.group_pb2'
