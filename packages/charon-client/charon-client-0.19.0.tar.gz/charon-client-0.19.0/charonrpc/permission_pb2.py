...
_LISTPERMISSIONSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='order_by', full_name='charonrpc.ListPermissionsRequest.order_by', index=8,
...
_LISTPERMISSIONSREQUEST.fields_by_name['order_by'].message_type = charonrpc_dot_common__pb2._ORDER
...
RegisterPermissionsRequest = _reflection.GeneratedProtocolMessageType('RegisterPermissionsRequest', (_message.Message,), dict(
  ...
  __module__ = 'charonrpc.permission_pb2'
