...
_LISTUSERSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='order_by', full_name='charonrpc.ListUsersRequest.order_by', index=6,
...
_LISTUSERSREQUEST.fields_by_name['order_by'].message_type = charonrpc_dot_common__pb2._ORDER
...
_LISTUSERGROUPSRESPONSE.fields_by_name['groups'].message_type = charonrpc_dot_group__pb2._GROUP
