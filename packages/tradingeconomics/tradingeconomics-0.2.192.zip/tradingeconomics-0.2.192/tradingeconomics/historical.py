...
#        credentials = 'guest:guest'
    linkAPI = 'http://api.tradingeconomics.com/historical/country/' + urllib.quote(country) + '/indicator/' + urllib.quote(indicator) + '?c='+glob.apikey;
...
#        credentials = 'guest:guest'
#    else:
    if glob.apikey !='guest:guest':
        fn.credCheck(glob.apikey)
