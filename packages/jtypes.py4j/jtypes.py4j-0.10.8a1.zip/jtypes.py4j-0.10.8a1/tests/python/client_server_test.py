...
from jt.py4j.java_gateway import GatewayConnectionGuard, is_instance_of, \
    GatewayParameters, DEFAULT_PORT, DEFAULT_PYTHON_PROXY_PORT
from jt.py4j.protocol import Py4JError, Py4JJavaError, smart_decode
from .java_callback_test import IHelloImpl, IHelloFailingImpl  # <AK> was: from py4j.tests.
