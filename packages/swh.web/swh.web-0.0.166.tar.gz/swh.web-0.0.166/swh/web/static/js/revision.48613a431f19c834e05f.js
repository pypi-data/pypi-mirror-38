...
/******/ 		return __webpack_require__.p + "js/" + ({"vendors":"vendors","highlightjs":"highlightjs"}[chunkId]||chunkId) + "." + {"vendors":"a62c0c7e07ce8076ba8d","highlightjs":"cc733be296a07feaf6d2"}[chunkId] + ".js"
/******/ 	}
/******/
...
/******/ 		var cssChunks = {"vendors":1,"highlightjs":1};
/******/ 		if(installedCssChunks[chunkId]) promises.push(installedCssChunks[chunkId]);
/******/ 		else if(installedCssChunks[chunkId] !== 0 && cssChunks[chunkId]) {
/******/ 			promises.push(installedCssChunks[chunkId] = new Promise(function(resolve, reject) {
/******/ 				var href = "css/" + ({"vendors":"vendors","highlightjs":"highlightjs"}[chunkId]||chunkId) + "." + {"vendors":"a62c0c7e07ce8076ba8d","highlightjs":"cc733be296a07feaf6d2"}[chunkId] + ".css";
...
/*!***********************************************************!*\
  !*** ./swh/web/assets/src/bundles/revision/diff-utils.js ***!
  \***********************************************************/
/*! exports provided: computeDiff, showUnifiedDiff, showSplittedDiff, computeAllDiffs, initRevisionDiff */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeDiff", function() { return computeDiff; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showUnifiedDiff", function() { return showUnifiedDiff; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showSplittedDiff", function() { return showSplittedDiff; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "computeAllDiffs", function() { return computeAllDiffs; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initRevisionDiff", function() { return initRevisionDiff; });
...
/* harmony import */ var utils_functions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! utils/functions */ "./swh/web/assets/src/utils/functions.js");
...
var swhSpinnerSrc = Object(utils_functions__WEBPACK_IMPORTED_MODULE_4__["staticAsset"])('img/swh-spinner.gif'); // number of changed files in the revision

var changes = null;
var nbChangedFiles = 0; // to track the number of already computed files diffs

var nbDiffsComputed = 0; // the no newline at end of file marker from Github

var noNewLineMarker = "<span class=\"no-nl-marker\" title=\"No newline at end of file\">\n                         <svg aria-hidden=\"true\" height=\"16\" version=\"1.1\" viewBox=\"0 0 16 16\" width=\"16\">\n                           <path fill-rule=\"evenodd\" d=\"M16 5v3c0 .55-.45 1-1 1h-3v2L9 8l3-3v2h2V5h2zM8 8c0 2.2-1.8 4-4 4s-4-1.8-4-4 1.8-4 4-4 4 1.8 4 4zM1.5 9.66L5.66 5.5C5.18 5.19 4.61 5 4 5 2.34 5 1 6.34 1 8c0 .61.19 1.17.5 1.66zM7 8c0-.61-.19-1.17-.5-1.66L2.34 10.5c.48.31 1.05.5 1.66.5 1.66 0 3-1.34 3-3z\"></path>\n                         </svg>\n                       </span>"; // to track the total number of added lines in files diffs

var nbAdditions = 0; // to track the total number of deleted lines in files diffs

var nbDeletions = 0; // to track the already computed diffs by id

var computedDiffs = {}; // map a diff id to its computation url

var diffsUrls = {}; // to check if a DOM element is in the viewport
...
function formatDiffLineNumbers(fromLine, toLine, maxNumberChars) {
  ...
  if (fromLine != null) {
    for (var i = 0; i < maxNumberChars - fromLine.length; ++i) {
      ret += ' ';
    }
  ...
  if (toLine != null) {
    for (var _i = 0; _i < maxNumberChars - toLine.length; ++_i) {
      ret += ' ';
    }
...
function computeDiff(diffUrl, diffId) {
  // force diff computation ?
  var force = diffUrl.indexOf('force=true') !== -1; // it no forced computation and diff already computed, do nothing
  ...
  $("#" + diffId + "-loading").css('visibility', 'visible'); // set spinner visible while requesting diff

  $("#" + diffId + "-loading").css('display', 'block');
  $("#" + diffId + "-highlightjs").css('display', 'none'); // request diff computation and process it

  fetch(diffUrl).then(function (response) {
    return response.json();
  }).then(function (data) {
    // increment number of computed diffs
    ++nbDiffsComputed; // toggle the 'Compute all diffs' button if all diffs have been computed
    ...
    if (data.diff_str.indexOf('Large diff') === 0) {
      $("#" + diffId)[0].innerHTML = data.diff_str + ("<br/><button class=\"btn btn-default btn-sm\" type=\"button\"\n           onclick=\"swh.revision.computeDiff('" + diffUrl + "&force=true', '" + diffId + "')\">\n           Request diff</button>");
      ...
      $("." + diffId).addClass(data.language); // set unified diff text

      $("#" + diffId).text(data.diff_str); // code highlighting for unified diff

      $("#" + diffId).each(function (i, block) {
      ...
      setTimeout(function () {
        ...
        var linesInfoRegExp = new RegExp(/^@@ -(\d+),(\d+) \+(\d+),(\d+) @@$/gm);
        var baseFromLine = '';
        var baseToLine = '';
        var fromToLines = [];
        var fromLines = [];
        var toLines = [];
        var maxNumberChars = 0;
        var diffFromStr = '';
        var diffToStr = '';
        var linesOffset = 0;
        $("#" + diffId + " .hljs-ln-numbers").each(function (i, lnElt) {
          var lnText = lnElt.nextSibling.innerText;
          var linesInfo = linesInfoRegExp.exec(lnText);
          var fromLine = '';
          var toLine = ''; // parsed lines info from the diff output

          if (linesInfo) {
            baseFromLine = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(linesInfo[1]) - 1;
            baseToLine = _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_2___default()(linesInfo[3]) - 1;
            linesOffset = 0;
            diffFromStr += lnText + '\n';
            diffToStr += lnText + '\n';
            fromLines.push('');
            toLines.push(''); // line removed in the from file
            ...
            ++nbDeletions;
            diffFromStr += lnText + '\n';
            ++linesOffset; // line added in the from file
          } else if (lnText.length > 0 && lnText[0] === '+') {
            ...
            ++nbAdditions;
            diffToStr += lnText + '\n';
            --linesOffset; // line present in both files
          } else {
            baseFromLine = baseFromLine + 1;
            baseToLine = baseToLine + 1;
            fromLine = baseFromLine.toString();
            ...
            for (var j = 0; j < Math.abs(linesOffset); ++j) {
              if (linesOffset > 0) {
                diffToStr += '\n';
                toLines.push('');
              } else {
        ...
        $("#" + diffId + "-to").text(diffToStr); // code highlighting for side-by-side diffs

        $("#" + diffId + "-from, #" + diffId + "-to").each(function (i, block) {
          hljs.highlightBlock(block);
          hljs.lineNumbersBlock(block);
        }); // hljs.lineNumbersBlock is asynchronous so we have to postpone our
        // next treatments by adding it at the end of the current js events queue
        ...
        setTimeout(function () {
          ...
          $("." + diffId + " .hljs-ln-numbers").each(function (i, lnElt) {
            ...
            if (linesInfo) {
              ...
              var linesInfoText = $(lnElt).parent().find('.hljs-ln-code .hljs-ln-line').text();
          ...
          $("#" + diffId + " .hljs-ln-numbers").each(function (i, lnElt) {
            $(lnElt).children().attr('data-line-number', formatDiffLineNumbers(fromToLines[i][0], fromToLines[i][1], maxNumberChars));
          }); // set line numbers for the from side-by-side diff

          $("#" + diffId + "-from .hljs-ln-numbers").each(function (i, lnElt) {
            $(lnElt).children().attr('data-line-number', formatDiffLineNumbers(fromLines[i], null, maxNumberChars));
          }); // set line numbers for the to side-by-side diff

          $("#" + diffId + "-to .hljs-ln-numbers").each(function (i, lnElt) {
            $(lnElt).children().attr('data-line-number', formatDiffLineNumbers(null, toLines[i], maxNumberChars));
          }); // last processings:
          ...
          $("." + diffId + " .hljs-ln-line").each(function (i, lnElt) {
            if (lnElt.firstChild) {
              if (lnElt.firstChild.nodeName !== '#text') {
                var lineText = lnElt.firstChild.innerHTML;

                if (lineText[0] === '-' || lineText[0] === '+') {
                  lnElt.firstChild.innerHTML = lineText.substr(1);
                  var newTextNode = document.createTextNode(lineText[0]);
                  $(lnElt).prepend(newTextNode);
                }
              }

              $(lnElt).contents().filter(function (i, elt) {
                return elt.nodeType === 3; // Node.TEXT_NODE
              }).each(function (i, textNode) {
                var swhNoNewLineMarker = '[swh-no-nl-marker]';
...
function setDiffVisible(diffId) {
  ...
  $("#" + diffId + "-highlightjs").css('display', 'block'); // update displayed counters

  $('#swh-revision-lines-added').text(nbAdditions + " additions");
  $('#swh-revision-lines-deleted').text(nbDeletions + " deletions");
  $('#swh-nb-diffs-computed').text(nbDiffsComputed); // refresh the waypoints triggering diffs computation as
...
function computeVisibleDiffs() {
  $('.swh-file-diff-panel').each(function (i, elt) {
    if (isInViewport(elt)) {
      var diffId = elt.id.replace('panel_', '');
...
function setupWaypoints() {
  for (var i = 0; i < changes.length; ++i) {
    var diffData = changes[i]; // create a waypoint that will trigger diff computation when
    // the top of the diff panel hits the bottom of the viewport

    $("#panel_" + diffData.id).waypoint({
      handler: function handler() {
        if (isInViewport(this.element)) {
          var diffId = this.element.id.replace('panel_', '');
          computeDiff(diffsUrls[diffId], diffId);
          this.destroy();
        }
      },
...
function showUnifiedDiff(event, diffId) {
...
function showSplittedDiff(event, diffId) {
...
function computeAllDiffs(event) {
  $(event.currentTarget).addClass('active');

  for (var diffId in diffsUrls) {
...
function initRevisionDiff(_x, _x2) {
  return _initRevisionDiff.apply(this, arguments);
}

function _initRevisionDiff() {
  _initRevisionDiff = _babel_runtime_corejs2_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(
  /*#__PURE__*/
  _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(revisionMessageBody, diffRevisionUrl) {
          ...
          case 2:
            ...
            $(document).on('shown.bs.tab', 'a[data-toggle="tab"]', function (e) {
              if (e.currentTarget.text.trim() === 'Changes') {
                ...
                fetch(diffRevisionUrl).then(function (response) {
                  return response.json();
                }).then(function (data) {
                  changes = data.changes;
                  nbChangedFiles = data.total_nb_changes;
                  var changedFilesText = nbChangedFiles + " changed file";
            ...
            $(document).ready(function () {
              ...
              var $root = $('html, body'); // callback when the user requests to scroll on a specific diff or back to top

              $('#swh-revision-changes-list a[href^="#"], #back-to-top a[href^="#"]').click(function (e) {
                var href = $.attr(e.currentTarget, 'href'); // disable waypoints while scrolling as we do not want to
                ...
                $root.animate({
                  ...
                  complete: function complete() {
                    window.location.hash = href; // enable waypoints back after scrolling

                    Waypoint.enableAll(); // compute diffs visible in the viewport
...
/***/ "./swh/web/assets/src/bundles/revision/index.js":
/*!******************************************************!*\
  !*** ./swh/web/assets/src/bundles/revision/index.js ***!
  \******************************************************/
/*! exports provided: computeDiff, showUnifiedDiff, showSplittedDiff, computeAllDiffs, initRevisionDiff */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _revision_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./revision.css */ "./swh/web/assets/src/bundles/revision/revision.css");
/* harmony import */ var _revision_css__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_revision_css__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _diff_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./diff-utils */ "./swh/web/assets/src/bundles/revision/diff-utils.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "computeDiff", function() { return _diff_utils__WEBPACK_IMPORTED_MODULE_1__["computeDiff"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "showUnifiedDiff", function() { return _diff_utils__WEBPACK_IMPORTED_MODULE_1__["showUnifiedDiff"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "showSplittedDiff", function() { return _diff_utils__WEBPACK_IMPORTED_MODULE_1__["showSplittedDiff"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "computeAllDiffs", function() { return _diff_utils__WEBPACK_IMPORTED_MODULE_1__["computeAllDiffs"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "initRevisionDiff", function() { return _diff_utils__WEBPACK_IMPORTED_MODULE_1__["initRevisionDiff"]; });
...
/***/ "./swh/web/assets/src/bundles/revision/revision.css":
/*!**********************************************************!*\
  !*** ./swh/web/assets/src/bundles/revision/revision.css ***!
  \**********************************************************/
/*! no static exports found */
...
/***/ 10:
/*!***************************************!*\
  !*** multi bundles/revision/index.js ***!
  \***************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! bundles/revision/index.js */"./swh/web/assets/src/bundles/revision/index.js");
...
//# revision.48613a431f19c834e05f.js.map