...
version = '.'.join(oauthkit_google.__version__.split('.')[:2])
# The full version, including alpha/beta/rc tags.
release = oauthkit_google.__version__
...
htmlhelp_basename = 'oauthkit-google'
