...
class GHLamps(object):
    """This class GHLamps provides a services to control the IoT Greenhouse LED lamps.
    """
    red = None
    white = None
    dual = None
...
class GHLamp(object):
    """This class GHLamp provides a services to control individual IoT Greenhouse LED lamp.
    """   
    LAMP_ON = False #active log
    LAMP_OFF = True
...
class GHLampDual(object):
    """This class GHLamp provides a services to control dual color IoT Greenhouse LED lamp.
    """   
    LAMP_OFF = 0
    LAMP_ON_YELLOW = 1
    LAMP_ON_GREEN = 2
    ...
    def __init__(self, pi, shared_gpio1, gpio2):
        """Constructor for class GHLampDual
