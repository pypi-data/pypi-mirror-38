...
class APIGenerator(UrlGenerator):
    ...
    def __init__( self, model, basis_fields, lookup_field='pk', methods=[], method_fields={}):
        self.model = model
