...
function setColor() {
    ...
    for (var idx in cew_count_arr) {
        ...
        if (ele.innerText != '0') {
            ele.innerHTML = '<strong style="font-size: 30px; color: red;">' + ele.innerText + '</strong>';
        }
    }
    ...
    for (var idx in log_count_arr) {
        ...
        if (ele.innerText != '0') {
            ele.innerHTML = '<strong style="font-size: 30px; color: orange;">' + ele.innerText + '</strong>';
        }
    }
    ...
    for (var idx in latest_time_arr) {
        ...
        if (result.indexOf('second') == -1 ) {
            ele.innerHTML = '<strong style="font-size: 30px; color: #409EFF;">' + result + '</strong>';
        } else {
