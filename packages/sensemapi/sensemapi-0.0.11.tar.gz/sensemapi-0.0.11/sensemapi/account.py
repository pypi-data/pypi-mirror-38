...
class SenseMapAccountCollection(collections.abc.MutableSequence, ReprObject):
    ...
    def accounts(self):
        """
        The underlying :any:`SenseMapAccount`s

        :type: any:`list`
        :setter: also adds the :any:`SenseMapCollection.client` to the
            given :any:`SenseMapAccount`s
        """
        try:
            self._accounts
        except AttributeError:
    ...
    def application(self):
        """
        The :any:`SenseMapApplication` these :any:`SenseMapAccount`s belong to.

        :type: :any:`SenseMapApplication` or :any:`None`
        :setter: sets the
        """
        return None
