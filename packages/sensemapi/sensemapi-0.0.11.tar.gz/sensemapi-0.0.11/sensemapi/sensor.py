...
class senseBoxSensor(ReprObject):
    ...
    def box(self):
        """
        The :any:`senseBox` this :any:`senseBoxSensor` belongs to.
    ...
    def delete(self, really=False):
        """
        Delete this :any:`senseBoxSensor`.
    ...
    def update_from_api_json(self, d):
        ...
        self.last_value = float(last_value) if last_value is not None else None
        self.last_time = str2date(last_time) if last_time is not None else None
    ...
    def upload_measurement(self):
        ...
        assert self.last_value, "the given sensor does not have a last_value"
        assert (
            self.box.client
    ...
    def __eq__(self, other):
        """
        Compare this :any:`senseBoxSensor` to another :any:`senseBoxsensor`
...
class senseBoxSensorCollection(collections.abc.MutableSequence, ReprObject):
    ...
    def box(self):
        """
        The corresponding :any:`senseBox` these :any:`senseBoxSensor`s belong
        to.

        :type: :any:`senseBox` or :any:`None`
        """
        return None
