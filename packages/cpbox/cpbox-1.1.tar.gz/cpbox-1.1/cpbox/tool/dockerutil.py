...
def base_docker_args(env=None, container_name=None, volumes=None, ports=None, current_user=False, envs=None, working_dir=None):
    hostname = socket.gethostname()
    args = '--name ' + container_name
    args += ' -h %s.docker.%s' % (container_name, hostname)
    args += ' -e PUPPY_HOSTNAME=' + hostname
