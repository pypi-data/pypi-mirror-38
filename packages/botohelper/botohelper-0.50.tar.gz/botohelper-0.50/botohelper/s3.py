...
class S3(botohelper.botohelpermain.Main):
    ...
    def does_s3_bucket_exsist(self, bucket):
        """
        ...
        """
        try:
            self.resource_s3.s3.meta.client.head_bucket(Bucket=bucket)
    ...
    def create_copy_of_s3_bucket(self, src_bucket, dest_bucket):
        """
