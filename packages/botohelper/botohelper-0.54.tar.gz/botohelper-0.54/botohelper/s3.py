...
class S3(botohelper.botohelpermain.Main):
    ...
    def create_copy_of_s3_bucket(self, src_bucket, dest_bucket, copy_only_mising_objects=False, copy_only_unencrypted_objects=False, dest_bucket_tags=False):
        """
