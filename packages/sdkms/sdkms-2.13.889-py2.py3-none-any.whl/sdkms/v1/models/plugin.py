...
class Plugin(object):
    ...
    def __init__(self, name=None, plugin_id=None, description=None, acct_id=None, groups=None, default_group=None, source=None, enabled=None, plugin_type=None, regions=None, creator=None, created_at=None, lastrun_at=None, lastupdated_at=None):
        """
    ...
    def regions(self):
        """
        Gets the regions of this Plugin.
    ...
    def regions(self, regions):
        """
        Sets the regions of this Plugin.
        The list of regions this plugin may run in.
        """
