...
class App(object):
    ...
    def __init__(self, name=None, app_id=None, auth_type=None, description=None, interface=None, acct_id=None, groups=None, default_group=None, enabled=None, app_type=None, regions=None, creator=None, created_at=None, lastused_at=None):
        """
