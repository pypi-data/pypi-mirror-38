...
def para_cmd ():
    ...
    parser.add_option("--cudaid", type="int", default=-1, help="id cuda to use (if '' or <0: use CPU), (default:'')") 
    ...
    parser.add_option('--path_vis_learn', type="string", default='',help="read config for generating images (for qtf/mms combine fill/manifolds") 
