...
class _RunWidgetBase(_DOMWidgetBase):
    ...
    run_process = Unicode().tag(sync=True)
...
@widgets.register
class _HyperDrive(_RunWidgetBase):
...
@widgets.register
class _Pipeline(_RunWidgetBase):
