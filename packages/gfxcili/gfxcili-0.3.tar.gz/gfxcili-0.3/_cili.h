...
char init_display_docstring[] = "init_display()";
char fill_rect_docstring[] = "fill_rect(x, y, x1, y1)";
char set_color_docstring[] = "set_color";
char set_backgroundcolor_docstring[] = "set_backgroundcolor";
char draw_pixel_docstring[] = "draw_pixel(x, y)";
char draw_line_docstring[] = "draw_line(x, y, x1, y1)";
char draw_circle_docstring[] = "draw_circle(x, y, radius)";
char draw_arc_docstring[] = "draw_arc(x, y, radius, start, end)";
char draw_rect_docstring[] = "draw_rect(x, y, x1, y1)";
char draw_image_docstring[] = "draw_image(x, y, PIL Image) \n draw_image(x, y, filename)";
char draw_text_docstring[] = "draw_text(x, y, text)";
...
PyMethodDef module_methods[] = {
    ...
    {"draw_text", (PyCFunction)ili_draw_text, METH_VARARGS, draw_text_docstring},
    {NULL, NULL, 0, NULL}
};
...
PyGetSetDef ili_getset[] = {
    ...
    {"font", (getter)magic_get_font, (setter)magic_set_font, "font", NULL},
    {NULL}
};
