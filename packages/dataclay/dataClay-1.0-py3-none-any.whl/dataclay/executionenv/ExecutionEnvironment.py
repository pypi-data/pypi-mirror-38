...
class ExecutionEnvironment(object):
    ...
    def federate(self, session_id, objects_to_persist, has_alias):
        ...
        :param objects_to_persist: objects to store.
        :param has_alias: indicates if the object has alias
        :returns: None
        :type session_id: Session ID
        :type objects_to_persist: [num_params, imm_objs, lang_objs, vol_params, pers_params]
        :type has_alias: boolean
        """
        ...
        for federated_obj in federated_objs:
            federated_obj._set_has_alias_internal(has_alias)  # no synchronization needed 
            try:
    ...
    def get_object_internal(self, oid, moving):
        ...
        try:
            ...
            if current_obj.is_pending_to_register():
                ...
                current_obj.set_pending_to_register(False)
            pending_objs = list()
