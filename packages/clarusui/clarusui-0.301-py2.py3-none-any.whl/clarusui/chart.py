...
#    def set_theme(self, theme):
        #self.layout['template'] = 'presentation+plotly_dark'
        #self.layout['template'] = theme
        
#    def _set_style(self, style):
#        if style.getChartTheme() is not None:
#            self.set_theme(style.getChartTheme())
#        super(Chart, self)._set_style(style)
