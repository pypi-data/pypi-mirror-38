...
class ContainerFileOutput(object):
    ...
    def __init__(self, id=None, name=None, type=None, mimetype=None, modality=None, classification=None, tags=None, info=None, origin=None, hash=None, created=None, modified=None, replaced=None, size=None, info_exists=None):  # noqa: E501
