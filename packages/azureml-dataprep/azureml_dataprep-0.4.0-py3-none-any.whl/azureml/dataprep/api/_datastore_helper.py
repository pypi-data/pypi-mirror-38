...
from .dataflow_generated import DatastoreValue
...
def datastore_to_dataflow(data_source: Datastore) -> 'Dataflow':
...
def get_datastore_value(data_source: Datastore) -> ('AbstractDatastore', DatastoreValue):
    _ensure_imported()
