...
class FileDataSource:
    ...
    @staticmethod
    def datasource_from_str(value: str) -> 'FileDataSource':
...
class FileOutput:
    ...
    @staticmethod
    def file_output_from_str(value: str) -> 'FileOutput':
        if blob_pattern.match(value):
            return BlobFileOutput(value)
        else:
            return LocalFileOutput(value)
