...
class SummaryColumnsValue:
    ...
    :param quantiles: Qunatile boundary values required for Qantiles summary function.
    """
    def __init__(self,
                 column_id: str,
...
class Dataflow:
    ...
    def random_split(self,
        ...
        new_name = split_dataflow_name if split_dataflow_name is not None else self._name + '_split'
...
# >>> BEGIN GENERATED METHODS
    ...
    def append_rows(self,
                    dataflows: List['DataflowReference']) -> 'Dataflow':
        """
        Appends the records in the specified dataflows to the current one. If the schemas of the dataflows are distinct,
