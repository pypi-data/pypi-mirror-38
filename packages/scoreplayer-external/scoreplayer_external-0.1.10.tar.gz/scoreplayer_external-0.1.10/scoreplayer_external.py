...
Python external for controlling the Decibel ScorePlayer canvas mode, v0.1.10
...
class scorePlayerExternal:
    ...
    def __init__(self):
        ...
        while True:
            try:
                server = osc_server.ThreadingOSCUDPServer(('0.0.0.0', self.listeningPort), self.dispatcher)
                break
            except:
