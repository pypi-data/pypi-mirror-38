...
if __name__ == '__main__':
    ...
    brass_bedpes = gdsc.import_brass_bedpes(samples=gdsc.BRCA_SAMPLES + ['NCI-H2087'])
    ascat_beds = gdsc.get_copy_number_segments_wgs(as_dict=True, samples=gdsc.BRCA_SAMPLES + ['NCI-H2087'])
