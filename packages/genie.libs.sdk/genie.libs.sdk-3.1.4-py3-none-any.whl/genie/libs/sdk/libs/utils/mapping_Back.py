...
def printer(base, requirements):
    ...
    # all_reqs is traversed, original is the one at the root of the dict
    all_reqs = original = {}
    all_reqs_name = set()
    ...
    log.info("Find {} '{}' that satisfy the following requirements:".format(a, base))
    for end in leafs:
