...
class Csv(Data):
    ...
    def save(self, context, result):
        ...
        return super(Csv, self).format(context, Result(self.filePath))
...
class Npy(Data):
    ...
    def save(self, context, result):
        utils.saveAsNpy(self.filePath, result.value)
        return super(Npy, self).format(context, Result(self.filePath))
...
class Image(File):
    ...
    def save(self, context, result):
        ...
        return super(Image, self).format(context, Result(self.filePath))
