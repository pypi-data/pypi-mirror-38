    ...
    def getArgList(self, request):
        inputArguments = itertools.chain(
            *[
                ...
                for i, arg in enumerate(self.getArguments("inputs")) if getattr(request, "in{}".format(i + 1), None) is not None
            ]
        )
        ...
        outputArguments = itertools.chain(
            *[
                ...
                for i, arg in enumerate(self.getArguments("outputs")) if output.get("out{}".format(i + 1)) is not None
            ]
        )
