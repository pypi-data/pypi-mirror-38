...
class ExperimentRun:
  ...
  thrift_spec = (
    ...
    (4, TType.STRING, 'sha', None, None, ), # 4
...
class MetadataKV:
  ...
  thrift_spec = (
    ...
    (3, TType.STRING, 'valueType', None, None, ), # 3
  )
...
class DataFrame:
  ...
  thrift_spec = (
    ...
    (6, TType.LIST, 'metadata', (TType.STRUCT,(MetadataKV, MetadataKV.thrift_spec)), None, ), # 6
  )
...
class TransformerSpec:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'hyperparameters', (TType.STRUCT,(HyperParameter, HyperParameter.thrift_spec)), None, ), # 3
    (4, TType.STRING, 'tag', None, "", ), # 4
  )
...
class FitEvent:
  ...
  thrift_spec = (
    ...
    (9, TType.STRING, 'metadata', None, None, ), # 9
  )
...
class ModelResponse:
  ...
  thrift_spec = (
    ...
    (15, TType.STRING, 'timestamp', None, None, ), # 15
    (16, TType.STRUCT, 'linearModelData', (LinearModel, LinearModel.thrift_spec), None, ), # 16
    (17, TType.STRING, 'metadata', None, None, ), # 17
  )
...
class TreeNode:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.prediction)
    value = (value * 31) ^ hash(self.impurity)
...
class TreeLink:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.parentIndex)
    value = (value * 31) ^ hash(self.childIndex)
    value = (value * 31) ^ hash(self.isLeft)
    return value
...
class TreeComponent:
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'nodes', (TType.STRUCT,(TreeNode, TreeNode.thrift_spec)), None, ), # 2
    (3, TType.LIST, 'links', (TType.STRUCT,(TreeLink, TreeLink.thrift_spec)), None, ), # 3
  )
...
class TreeModel:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'modelType', None, None, ), # 1
    (2, TType.LIST, 'components', (TType.STRUCT,(TreeComponent, TreeComponent.thrift_spec)), None, ), # 2
    (3, TType.LIST, 'featureImportances', (TType.DOUBLE,None), None, ), # 3
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.featureImportances)
    return value
...
class ModelAncestryResponse:
  ...
  thrift_spec = (
    ...
    (3, TType.LIST, 'transformEvents', (TType.STRUCT,(TransformEvent, TransformEvent.thrift_spec)), None, ), # 3
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.modelId)
    value = (value * 31) ^ hash(self.fitEvent)
    value = (value * 31) ^ hash(self.transformEvents)
    return value
...
class ExtractedPipelineResponse:
  """
  Attributes:
   - transformers
   - specs
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'transformers', (TType.STRUCT,(Transformer, Transformer.thrift_spec)), None, ), # 1
    (2, TType.LIST, 'specs', (TType.STRUCT,(TransformerSpec, TransformerSpec.thrift_spec)), None, ), # 2
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.transformers)
