...
class getProjectIds_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.MAP, 'keyValuePairs', (TType.STRING,None,TType.STRING,None), None, ), # 1
  )
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.keyValuePairs)
    return value
...
class createOrUpdateScalarField_args:
  """
  Attributes:
   - modelId
   - key
  ...
  thrift_spec = (
    ...
    (2, TType.STRING, 'key', None, None, ), # 2
    (3, TType.STRING, 'value', None, None, ), # 3
    (4, TType.STRING, 'valueType', None, None, ), # 4
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.valueType = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.valueType is not None:
      ...
      oprot.writeString(self.valueType)
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
    oprot.writeStructEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.key)
    value = (value * 31) ^ hash(self.value)
    value = (value * 31) ^ hash(self.valueType)
    return value
...
class createOrUpdateScalarField_result:
  """
  Attributes:
   - success
   - svEx
...
class createVectorField_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'modelId', None, None, ), # 1
    (2, TType.STRING, 'vectorName', None, None, ), # 2
    (3, TType.MAP, 'vectorConfig', (TType.STRING,None,TType.STRING,None), None, ), # 3
  )
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.STRING:
          self.vectorName = iprot.readString()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.MAP:
  ...
  def write(self, oprot):
    ...
    if self.vectorName is not None:
      ...
      oprot.writeString(self.vectorName)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.modelId)
    value = (value * 31) ^ hash(self.vectorName)
    value = (value * 31) ^ hash(self.vectorConfig)
    return value
...
class createVectorField_result:
  """
  Attributes:
   - success
   - svEx
...
class updateVectorField_args:
  ...
  thrift_spec = (
    ...
    (5, TType.STRING, 'valueType', None, None, ), # 5
  )
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.modelId)
    value = (value * 31) ^ hash(self.key)
    value = (value * 31) ^ hash(self.valueIndex)
    value = (value * 31) ^ hash(self.value)
    value = (value * 31) ^ hash(self.valueType)
    return value
...
class updateVectorField_result:
  """
  Attributes:
   - success
   - svEx
...
class appendToVectorField_args:
  """
  Attributes:
   - modelId
   - vectorName
...
class appendToVectorField_result:
  """
  Attributes:
   - success
   - svEx
...
class storePipelineTransformEvent_args:
  """
  Attributes:
   - te
  """
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'te', (TType.STRUCT,(TransformEvent, TransformEvent.thrift_spec)), None, ), # 1
  )
...
class storePipelineTransformEvent_result:
  """
  Attributes:
   - success
   - ierEx
  ...
  thrift_spec = (
    (0, TType.LIST, 'success', (TType.STRUCT,(TransformEventResponse, TransformEventResponse.thrift_spec)), None, ), # 0
    (1, TType.STRUCT, 'ierEx', (InvalidExperimentRunException, InvalidExperimentRunException.thrift_spec), None, ), # 1
    (2, TType.STRUCT, 'svEx', (ServerLogicException, ServerLogicException.thrift_spec), None, ), # 2
  )
...
class computeModelAncestry_args:
  """
  Attributes:
   - modelId
  """
...
class computeModelAncestry_result:
  """
  Attributes:
   - success
   - rnfEx
