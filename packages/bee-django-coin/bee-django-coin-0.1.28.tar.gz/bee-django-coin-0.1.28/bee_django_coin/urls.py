...
urlpatterns = [
    ...
    url(r'^custom_user/rank/list/$', views.CustomUserRankList.as_view(), name='user_rank_list'),
    ...
    url(r'^order/custom/user/list/(?P<user_id>[0-9]+)/$', views.OrderCustomUserList.as_view(), name='order_custom_user_list'),
