...
public class PyObjectTest {
    ...
    public void setUp() throws Exception {
        ...
        String importPath = new File("tests/python/fixtures").getCanonicalPath();
    ...
    public void testExecuteCode_Script() throws Exception {
        ...
        assertNotNull(localMap.get("jt.jpy"));
        assertNotNull(localMap.get("File"));
        assertNotNull(localMap.get("f"));
        assertEquals(PyObject.class, localMap.get("jt.jpy").getClass());
