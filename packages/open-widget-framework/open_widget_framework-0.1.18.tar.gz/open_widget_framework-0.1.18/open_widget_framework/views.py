...
def get_widget_lists(request):
    ...
    """
    return Response([widget_list['id'] for widget_list in WidgetList.objects.all().values('id')])
...
def get_widget_configurations(request):
    ...
    """
    return Response(get_widget_class_configurations())
...
class WidgetViewSet(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        return Response(serializer.render_with_title())
