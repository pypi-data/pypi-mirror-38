...
DEFAULTS = {
    ...
    'WIDGET_FRAMEWORK_AUTHENTICATION_BACKEND': AllowAllUsersModelBackend,

    'WIDGET_FRAMEWORK_PERMISSIONS_CLASSES': (DjangoObjectPermissions,),

    'WIDGET_LIST_EDIT_PERMISSION': 'change_widgetlist'
}
