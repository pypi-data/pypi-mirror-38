...
from open_widget_framework.widget_class_base import WidgetBaseToo
...
class WidgetListViewSet(ModelViewSet):
    lookup_field = 'widget_list_id'
    serializer_class = WidgetBaseToo
    ...
    #     """
    #     widget_list = get_object_or_404(WidgetList, id=kwargs.pop('widget_list_id'))
