...
class WidgetViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.request.method == 'POST':
            widget_list_id = self.request.data['widget_list_id']
        else:
            widget_list_id = get_object_or_404(WidgetInstance, self.kwargs['pk']).widget_list_id
        return get_object_or_404(WidgetList, pk=widget_list_id).get_widgets()
