...
class TextWidget(serializers.Serializer):
    """
    A basic text widget
...
class URLWidget(serializers.Serializer):
    """
    A basic url widget
...
class ManyUserWidget(serializers.Serializer):
    """
...
class FileWidget(serializers.Serializer):
    """
    UNIMPLEMENTED
