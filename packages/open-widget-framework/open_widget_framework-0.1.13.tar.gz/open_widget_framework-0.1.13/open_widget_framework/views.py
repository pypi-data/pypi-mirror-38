...
from open_widget_framework.widget_class_base import WidgetListSerializer
...
class WidgetListViewSet(ModelViewSet):
    ...
    def list(self, request, *args, **kwargs):
        ...
        """
        return JsonResponse([widget_list['id'] for widget_list in self.queryset.values('id')], safe=False)
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        """
        widget_list = get_object_or_404(WidgetList, id=args[0])
