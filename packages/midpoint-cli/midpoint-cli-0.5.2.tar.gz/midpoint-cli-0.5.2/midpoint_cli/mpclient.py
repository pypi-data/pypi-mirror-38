...
class MidpointTask(MidpointObject):
    ...
    def is_in_progress(self):
        return self['Result Status'] == 'in_progress'
...
class RestApiClient:
    ...
    def execute_action(self, element_class: str, element_oid: str, action: str) -> str:
        rest_type = self.resolve_rest_type(element_class)
    ...
    def put_element(self, xml_filename: str, patch_file: str, patch_write: bool) -> Tuple[str, str]:
        tree_root, namespaces = self._load_xml(xml_filename)
        ...
        with open(xml_filename, 'r') as xml_file:
            ...
            if patch_file is not None:
                xml_body = self._patch(xml_body, patch_file, patch_write)
    ...
    @staticmethod
    def _patch(xml_body: str, patch_file: str, patch_write: bool) -> str:
        ...
        with open(patch_file, 'r') as f:
            for line in f:
                ...
                if line != '' and not line[0] == '#':
                    ...
                    xml_body, subs = re.subn(pattern.strip(), replacement.strip(), xml_body)
...
class MidpointClient:
    ...
    def put_xml(self, xml_file: str, patch_file, patch_write: False) -> Tuple[str, str]:
        return self.api_client.put_element(xml_file, patch_file, patch_write)

    def delete(self, type: str, oid: str) -> None:
