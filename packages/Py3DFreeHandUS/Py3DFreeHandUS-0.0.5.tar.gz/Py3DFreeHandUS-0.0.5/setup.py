...
class _install(install):
    ...
    def run(self):
        ...
        if not os.path.isfile(os.path.join(tempdir, 'VTK-6.3.0-cp27-cp27m-win_amd64.whl')):
            check_call(("python -m wget -o %s/VTK-6.3.0-cp27-cp27m-win_amd64.whl https://download.lfd.uci.edu/pythonlibs/h2ufg7oq/VTK-6.3.0-cp27-cp27m-win_amd64.whl" % (tempdir,)).split())
