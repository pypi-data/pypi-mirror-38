...
Available events: """
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, className=Component.UNDEFINED, data=Component.UNDEFINED, prob=Component.UNDEFINED, filter=Component.UNDEFINED, width=Component.UNDEFINED, channel=Component.UNDEFINED, cell=Component.UNDEFINED, enhance=Component.UNDEFINED, clickData=Component.UNDEFINED, coordinate=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'className', 'data', 'prob', 'filter', 'width', 'channel', 'cell', 'enhance', 'clickData', 'coordinate']
        self._type = 'ImageBox'
        self._namespace = 'dashx'
        self._valid_wildcard_attributes =            []
        self.available_events = []
        self.available_properties = ['id', 'className', 'data', 'prob', 'filter', 'width', 'channel', 'cell', 'enhance', 'clickData', 'coordinate']
