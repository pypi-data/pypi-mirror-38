...
Available events: """
    @_explicitize_args
    def __init__(self, src=Component.UNDEFINED, width=Component.UNDEFINED, rect=Component.UNDEFINED, **kwargs):
        self._prop_names = ['src', 'width', 'rect']
        self._type = 'Cropper'
        self._namespace = 'dashx'
        self._valid_wildcard_attributes =            []
        self.available_events = []
        self.available_properties = ['src', 'width', 'rect']
