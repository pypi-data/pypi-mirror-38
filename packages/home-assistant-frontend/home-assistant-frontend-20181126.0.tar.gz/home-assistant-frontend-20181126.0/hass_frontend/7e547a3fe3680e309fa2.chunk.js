...
*/Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_5__.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[_paper_item_behavior_js__WEBPACK_IMPORTED_MODULE_6__.a]})},246:function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathround=Math.round,_Mathabs=Math.abs,_Mathceil=Math.ceil,_Mathfloor=Math.floor,_Mathmax=Math.max,_Mathmin=Math.min,spacing=__webpack_require__(237),style=__webpack_require__(241),overlay=__webpack_require__(372);const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="lumo-vaadin-overlay" theme-for="vaadin-overlay">
  <template>
    <style include="lumo-overlay">
      /* stylelint-disable no-empty-source */
    </style>
  </template>
</dom-module>`;document.head.appendChild($_documentContainer.content);var vaadin_overlay=__webpack_require__(310),menu_overlay=__webpack_require__(373);const vaadin_combo_box_dropdown_styles_$_documentContainer=document.createElement("template");vaadin_combo_box_dropdown_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-combo-box-overlay" theme-for="vaadin-combo-box-overlay">
  <template>
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_dropdown_styles_$_documentContainer.content);var color=__webpack_require__(248),font_icons=__webpack_require__(311),sizing=__webpack_require__(249),typography=__webpack_require__(255);const vaadin_item_styles_$_documentContainer=document.createElement("template");vaadin_item_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
</dom-module>`;document.head.appendChild(vaadin_item_styles_$_documentContainer.content);var polymer_element=__webpack_require__(4),vaadin_themable_mixin=__webpack_require__(238);/**
@license
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_item_styles_$_documentContainer.content);var vaadin_theme_property_mixin=__webpack_require__(312),utils_async=__webpack_require__(8),flush=__webpack_require__(20),templatize=__webpack_require__(28),iron_a11y_announcer=__webpack_require__(75),iron_a11y_keys_behavior=__webpack_require__(13),flattened_nodes_observer=__webpack_require__(61);/**
@license
...
//# sourceMappingURL=7e547a3fe3680e309fa2.chunk.js.map