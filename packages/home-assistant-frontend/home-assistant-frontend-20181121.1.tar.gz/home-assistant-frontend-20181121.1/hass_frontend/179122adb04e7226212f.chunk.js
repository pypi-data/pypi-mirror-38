...
*/Object(_polymer_polymer_lib_legacy_polymer_fn_js__WEBPACK_IMPORTED_MODULE_4__.a)({_template:_polymer_polymer_lib_utils_html_tag_js__WEBPACK_IMPORTED_MODULE_5__.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[_paper_item_behavior_js__WEBPACK_IMPORTED_MODULE_6__.a]})},200:function(module,__webpack_exports__,__webpack_require__){"use strict";var _Mathround=Math.round,_Mathabs=Math.abs,_Mathceil=Math.ceil,_Mathfloor=Math.floor,_Mathmax=Math.max,_Mathmin=Math.min,spacing=__webpack_require__(191),style=__webpack_require__(195),overlay=__webpack_require__(365);const $_documentContainer=document.createElement("template");$_documentContainer.innerHTML=`<dom-module id="lumo-vaadin-overlay" theme-for="vaadin-overlay">
  <template>
    <style include="lumo-overlay">
      /* stylelint-disable no-empty-source */
    </style>
  </template>
</dom-module>`;document.head.appendChild($_documentContainer.content);var vaadin_overlay=__webpack_require__(304),menu_overlay=__webpack_require__(366);const vaadin_combo_box_dropdown_styles_$_documentContainer=document.createElement("template");vaadin_combo_box_dropdown_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-combo-box-overlay" theme-for="vaadin-combo-box-overlay">
  <template>
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_dropdown_styles_$_documentContainer.content);var color=__webpack_require__(202),font_icons=__webpack_require__(305),sizing=__webpack_require__(203),typography=__webpack_require__(209);const vaadin_item_styles_$_documentContainer=document.createElement("template");vaadin_item_styles_$_documentContainer.innerHTML=`<dom-module id="lumo-item" theme-for="vaadin-item">
  <template>
    <style>
      :host {
        display: flex;
...
</dom-module>`;document.head.appendChild(vaadin_item_styles_$_documentContainer.content);var polymer_element=__webpack_require__(4),vaadin_themable_mixin=__webpack_require__(192);/**
@license
...
</dom-module>`;document.head.appendChild(vaadin_combo_box_item_styles_$_documentContainer.content);var vaadin_theme_property_mixin=__webpack_require__(306),utils_async=__webpack_require__(8),flush=__webpack_require__(20),templatize=__webpack_require__(28),iron_a11y_announcer=__webpack_require__(75),iron_a11y_keys_behavior=__webpack_require__(13),flattened_nodes_observer=__webpack_require__(61);/**
@license
...
Copyright (c) 2018 Vaadin Ltd.
This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/var polymer_legacy=__webpack_require__(2),iron_resizable_behavior=__webpack_require__(46),iron_scroll_target_behavior=__webpack_require__(246),mutable_data_behavior=__webpack_require__(107),polymer_fn=__webpack_require__(3),polymer_dom=__webpack_require__(1),templatizer_behavior=__webpack_require__(106),debounce=__webpack_require__(14),path=__webpack_require__(5),IOS=navigator.userAgent.match(/iP(?:hone|ad;(?: U;)? CPU) OS (\d+)/),IOS_TOUCH_SCROLLING=IOS&&8<=IOS[1],DEFAULT_PHYSICAL_COUNT=3,HIDDEN_Y="-10000px",SECRET_TABINDEX=-100,IS_V2=null!=flush.b,ANIMATION_FRAME=IS_V2?utils_async.a:0,IDLE_TIME=IS_V2?utils_async.b:1,MICRO_TASK=IS_V2?utils_async.c:2;/**
@license
...
//# sourceMappingURL=179122adb04e7226212f.chunk.js.map