...
class Screener(object):
    ...
    def get_charts(self, quantity=None, period='d', size='l', chart_type='c', ta=None, save_to=None):
    ...
    def __search_screener(self):  # Note that any dictionary key whose value is None will not be added to the URL’s query string.
