...
class XSGEExchangeCalendar(TradingCalendar):
    """
    Exchange calendar for the Shanghai Security Exchange

    First session: 9:00am - 10:15am, Asia/Shanghai
    Second session: 10:30am - 11:30am, Asia/Shanghai
    Lunch
    Third session: 13:30pm - 3:00pm, Asia/Shanghai

    NOTE: we are treating the three sessions per day as one session for now,
    ...
    def __init__(self, *args, **kwargs):
        super(XSGEExchangeCalendar, self).__init__(*args, **kwargs)
