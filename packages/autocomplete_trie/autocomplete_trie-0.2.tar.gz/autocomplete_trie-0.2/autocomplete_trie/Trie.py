...
class Trie:
    ...
    def __init__(self, file_name):
        """
        :param file_name: the name of a text file containing the data to load into the trie; type = string
        """
    ...
    def add_term(self, weight, word):
        """
        :param weight: weight of term; type = int
        :param word: the word itself; type = string
        :return: None
        """
    ...
    def update_weight(self, word, weight_function):
        ...
        type = int -> int
        :param word: the word whose weight we will update
        :return: None
        """
    ...
    def delete_term(self, word):
        """
        :param word: the word to delete from the database
        :return: None
        """
        ancestor_list = _search_ancestors(word, self.root)
    ...
    def _build_trie(self, file_name):
        ...
        vectors = TrieUtilities.read_file(file_name)  # read in the data via read_file function
...
def _k_greatest_descendants(node, k, prefix):
    ...
    queue = TrieUtilities.TrieQueue()  # initialize queue
