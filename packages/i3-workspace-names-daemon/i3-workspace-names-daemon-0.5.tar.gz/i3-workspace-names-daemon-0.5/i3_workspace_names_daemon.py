...
def build_rename(i3, app_icons, delimiter):
    ...
    delimiter: `str`
        Delimiter to use between app names/icons.
...
def main():
    ...
    parser.add_argument("-app-icons-path",
    ...
    parser.add_argument("-delimiter",
                        help="Shown between window names or icons.",
                        default="|",
                        required=False)
    args = parser.parse_args()

    app_icons = _get_app_icons(args.app_icons_path)
