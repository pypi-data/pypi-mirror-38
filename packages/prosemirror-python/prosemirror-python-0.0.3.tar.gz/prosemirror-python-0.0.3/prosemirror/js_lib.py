...
def PyJs_anonymous_1_(exports, this, arguments, var=var):
    ...
    def PyJsHoisted_createCommonjsModule_(fn, module, this, arguments, var=var):
        ...
        PyJs_Object_3_ = Js({})
        PyJs_Object_2_ = Js({u'exports':PyJs_Object_3_})
        return PyJsComma(PyJsComma(var.put(u'module', PyJs_Object_2_),var.get(u'fn')(var.get(u'module'), var.get(u'module').get(u'exports'))),var.get(u'module').get(u'exports'))
    ...
    @Js
    def PyJs_anonymous_7_(key, value, newKey, this, arguments, var=var):
    ...
    @Js
    def PyJs_anonymous_8_(key, this, arguments, var=var):
        var = Scope({u'this':this, u'arguments':arguments, u'key':key}, var)
    ...
    @Js
    def PyJs_anonymous_10_(key, value, this, arguments, var=var):
        var = Scope({u'this':this, u'value':value, u'key':key, u'arguments':arguments}, var)
    ...
    @Js
    def PyJs_anonymous_11_(place, key, value, this, arguments, var=var):
    ...
    @Js
    def PyJs_anonymous_15_(map, this, arguments, var=var):
        var = Scope({u'this':this, u'map':map, u'arguments':arguments}, var)
    ...
    PyJs_Object_4_ = Js({u'constructor':var.get(u'OrderedMap'),u'find':PyJs_anonymous_5_,u'get':PyJs_anonymous_6_,u'update':PyJs_anonymous_7_,u'remove':PyJs_anonymous_8_,u'addToStart':PyJs_anonymous_9_,u'addToEnd':PyJs_anonymous_10_,u'addBefore':PyJs_anonymous_11_,u'forEach':PyJs_anonymous_12_,u'prepend':PyJs_anonymous_13_,u'append':PyJs_anonymous_14_,u'subtract':PyJs_anonymous_15_})
    @Js
    ...
    PyJs_Object_4_.define_own_property(u'size', {"get":PyJs_anonymous_16_, "configurable":True, "enumerable":True})
    var.get(u'OrderedMap').put(u'prototype', PyJs_Object_4_)
    @Js
    ...
    var.get(u'OrderedMap').put(u'from', PyJs_anonymous_17_)
    var.put(u'orderedmap', var.get(u'OrderedMap'))
    @Js
    def PyJs_anonymous_18_(module, exports, this, arguments, var=var):
        ...
        def PyJsHoisted_gatherToDOM_(obj, this, arguments, var=var):
            ...
            PyJs_Object_355_ = Js({})
            var.put(u'result', PyJs_Object_355_)
        ...
        def PyJsHoisted_parseExprRange_(stream, expr, this, arguments, var=var):
            ...
            PyJs_Object_231_ = Js({u'type':Js(u'range'),u'min':var.get(u'min'),u'max':var.get(u'max'),u'expr':var.get(u'expr')})
            return PyJs_Object_231_
        ...
        def PyJsHoisted_parseExpr_(stream, this, arguments, var=var):
            ...
            while 1:
                ...
                if not var.get(u'stream').callprop(u'eat', Js(u'|')):
                    break
            PyJs_Object_226_ = Js({u'type':Js(u'choice'),u'exprs':var.get(u'exprs')})
        ...
        def PyJsHoisted_findDiffEnd_(a, b, posA, posB, this, arguments, var=var):
            ...
            while 1:
                if ((var.get(u'iA')==Js(0.0)) or (var.get(u'iB')==Js(0.0))):
                    ...
                    return (var.get(u"null") if (var.get(u'iA')==var.get(u'iB')) else PyJs_Object_20_)
                ...
                if (var.get(u'childA').get(u'isText') and (var.get(u'childA').get(u'text')!=var.get(u'childB').get(u'text'))):
                    ...
                    PyJs_Object_22_ = Js({u'a':var.get(u'posA'),u'b':var.get(u'posB')})
        ...
        def PyJsHoisted_parseExprSeq_(stream, this, arguments, var=var):
            ...
            while 1:
                ...
                if not ((var.get(u'stream').get(u'next') and (var.get(u'stream').get(u'next')!=Js(u')'))) and (var.get(u'stream').get(u'next')!=Js(u'|'))):
                    break
            PyJs_Object_227_ = Js({u'type':Js(u'seq'),u'exprs':var.get(u'exprs')})
            return (var.get(u'exprs').get(u'0') if (var.get(u'exprs').get(u'length')==Js(1.0)) else PyJs_Object_227_)
        ...
        def PyJsHoisted_dfa_(nfa, this, arguments, var=var):
            ...
            def PyJsHoisted_explore_(states, this, arguments, var=var):
                ...
                var.put(u'out', Js([]))
                @Js
                def PyJs_anonymous_238_(node, this, arguments, var=var):
                    var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
                    var.registers([u'node'])
                    @Js
                    def PyJs_anonymous_239_(ref, this, arguments, var=var):
                        ...
                        @Js
                        def PyJs_anonymous_240_(node, this, arguments, var=var):
                            var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
                            var.registers([u'node'])
                        ...
                        var.get(u'nullFrom')(var.get(u'nfa'), var.get(u'to')).callprop(u'forEach', PyJs_anonymous_240_)
                    PyJs_anonymous_239_._set_name(u'anonymous')
                    var.get(u'nfa').get(var.get(u'node')).callprop(u'forEach', PyJs_anonymous_239_)
                PyJs_anonymous_238_._set_name(u'anonymous')
                var.get(u'states').callprop(u'forEach', PyJs_anonymous_238_)
        ...
        def PyJsHoisted_parseExprAtom_(stream, this, arguments, var=var):
            ...
            if var.get(u'stream').callprop(u'eat', Js(u'(')):
                ...
                if JsRegExp(u'/\\W/').callprop(u'test', var.get(u'stream').get(u'next')).neg():
                    @Js
                    def PyJs_anonymous_232_(type, this, arguments, var=var):
                        ...
                        PyJs_Object_233_ = Js({u'type':Js(u'name'),u'value':var.get(u'type')})
                        return PyJs_Object_233_
                    PyJs_anonymous_232_._set_name(u'anonymous')
                    var.put(u'exprs', var.get(u'resolveName')(var.get(u'stream'), var.get(u'stream').get(u'next')).callprop(u'map', PyJs_anonymous_232_))
                    (var.get(u'stream').put(u'pos',Js(var.get(u'stream').get(u'pos').to_number())+Js(1))-Js(1))
                    PyJs_Object_234_ = Js({u'type':Js(u'choice'),u'exprs':var.get(u'exprs')})
                    return (var.get(u'exprs').get(u'0') if (var.get(u'exprs').get(u'length')==Js(1.0)) else PyJs_Object_234_)
                else:
        ...
        def PyJsHoisted_copy_(obj, this, arguments, var=var):
            ...
            PyJs_Object_333_ = Js({})
            var.put(u'copy', PyJs_Object_333_)
            for PyJsTemp in var.get(u'obj'):
                var.put(u'prop', PyJsTemp)
        ...
        def PyJsHoisted_nfa_(expr, this, arguments, var=var):
            ...
            def PyJsHoisted_compile_(expr, PyJsArg_66726f6d_, this, arguments, var=var):
                ...
                if (var.get(u'expr').get(u'type')==Js(u'choice')):
                    @Js
                    def PyJs_anonymous_237_(out, expr, this, arguments, var=var):
                    ...
                    return var.get(u'expr').get(u'exprs').callprop(u'reduce', PyJs_anonymous_237_, Js([]))
                else:
            ...
            def PyJsHoisted_edge_(PyJsArg_66726f6d_, to, term, this, arguments, var=var):
                ...
                PyJs_Object_235_ = Js({u'term':var.get(u'term'),u'to':var.get(u'to')})
                var.put(u'edge', PyJs_Object_235_)
            ...
            def PyJsHoisted_connect_(edges, to, this, arguments, var=var):
                ...
                @Js
                def PyJs_anonymous_236_(edge, this, arguments, var=var):
                ...
                var.get(u'edges').callprop(u'forEach', PyJs_anonymous_236_)
        ...
        def PyJsHoisted_parseExprSubscript_(stream, this, arguments, var=var):
            ...
            while 1:
                if var.get(u'stream').callprop(u'eat', Js(u'+')):
                    PyJs_Object_228_ = Js({u'type':Js(u'plus'),u'expr':var.get(u'expr')})
                    var.put(u'expr', PyJs_Object_228_)
                else:
                    if var.get(u'stream').callprop(u'eat', Js(u'*')):
                        PyJs_Object_229_ = Js({u'type':Js(u'star'),u'expr':var.get(u'expr')})
                        var.put(u'expr', PyJs_Object_229_)
                    else:
                        if var.get(u'stream').callprop(u'eat', Js(u'?')):
                            PyJs_Object_230_ = Js({u'type':Js(u'opt'),u'expr':var.get(u'expr')})
                            var.put(u'expr', PyJs_Object_230_)
                        else:
                            if var.get(u'stream').callprop(u'eat', Js(u'{')):
            ...
            while (var.get(u'i')>=Js(0.0)):
                try:
                    var.put(u'node', var.get(u'$along').callprop(u'node', var.get(u'i')).callprop(u'copy', var.get(u'Fragment').callprop(u'from', var.get(u'node'))))
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())-Js(1))+Js(1))
            PyJs_Object_79_ = Js({u'start':var.get(u'node').callprop(u'resolveNoCache', (var.get(u'slice').get(u'openStart')+var.get(u'extra'))),u'end':var.get(u'node').callprop(u'resolveNoCache', ((var.get(u'node').get(u'content').get(u'size')-var.get(u'slice').get(u'openEnd'))-var.get(u'extra')))})
        ...
        PyJs_Object_19_ = Js({u'value':Js(True)})
        var.get(u'Object').callprop(u'defineProperty', var.get(u'exports'), Js(u'__esModule'), PyJs_Object_19_)
        pass
        var.put(u'OrderedMap', var.get(u'_interopDefault')(var.get(u'orderedmap')))
        pass
        pass
        @Js
        def PyJs_Fragment_23_(content, size, this, arguments, var=var):
            var = Scope({u'content':content, u'this':this, u'Fragment':PyJs_Fragment_23_, u'arguments':arguments, u'size':size}, var)
                ...
                while (var.get(u'i')<var.get(u'content').get(u'length')):
                    try:
                        var.get(u'this$1').put(u'size', var.get(u'content').get(var.get(u'i')).get(u'nodeSize'), u'+')
                            ...
                            (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_Fragment_23_._set_name(u'Fragment')
        var.put(u'Fragment', PyJs_Fragment_23_)
        PyJs_Object_25_ = Js({})
        PyJs_Object_26_ = Js({})
        PyJs_Object_27_ = Js({})
        PyJs_Object_24_ = Js({u'firstChild':PyJs_Object_25_,u'lastChild':PyJs_Object_26_,u'childCount':PyJs_Object_27_})
        var.put(u'prototypeAccessors$1', PyJs_Object_24_)
        @Js
        def PyJs_nodesBetween_28_(PyJsArg_66726f6d_, to, f, nodeStart, parent, this, arguments, var=var):
            var = Scope({u'to':to, u'from':PyJsArg_66726f6d_, u'arguments':arguments, u'parent':parent, u'f':f, u'this':this, u'nodeStart':nodeStart, u'nodesBetween':PyJs_nodesBetween_28_}, var)
            ...
            while (var.get(u'pos')<var.get(u'to')):
                try:
                    ...
                    var.put(u'pos', var.get(u'end'))
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_nodesBetween_28_._set_name(u'nodesBetween')
        var.get(u'Fragment').get(u'prototype').put(u'nodesBetween', PyJs_nodesBetween_28_)
        @Js
        def PyJs_descendants_29_(f, this, arguments, var=var):
            var = Scope({u'this':this, u'descendants':PyJs_descendants_29_, u'arguments':arguments, u'f':f}, var)
            var.registers([u'f'])
            var.get(u"this").callprop(u'nodesBetween', Js(0.0), var.get(u"this").get(u'size'), var.get(u'f'))
        PyJs_descendants_29_._set_name(u'descendants')
        var.get(u'Fragment').get(u'prototype').put(u'descendants', PyJs_descendants_29_)
        @Js
        def PyJs_textBetween_30_(PyJsArg_66726f6d_, to, blockSeparator, leafText, this, arguments, var=var):
            var = Scope({u'to':to, u'from':PyJsArg_66726f6d_, u'leafText':leafText, u'blockSeparator':blockSeparator, u'this':this, u'textBetween':PyJs_textBetween_30_, u'arguments':arguments}, var)
            var.registers([u'separated', u'from', u'leafText', u'blockSeparator', u'text', u'to'])
            var.put(u'text', Js(u''))
            var.put(u'separated', Js(True))
            @Js
            def PyJs_anonymous_31_(node, pos, this, arguments, var=var):
            ...
            var.get(u"this").callprop(u'nodesBetween', var.get(u'from'), var.get(u'to'), PyJs_anonymous_31_, Js(0.0))
            return var.get(u'text')
        PyJs_textBetween_30_._set_name(u'textBetween')
        var.get(u'Fragment').get(u'prototype').put(u'textBetween', PyJs_textBetween_30_)
        @Js
        def PyJs_append_32_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'arguments':arguments, u'append':PyJs_append_32_}, var)
        ...
        PyJs_append_32_._set_name(u'append')
        var.get(u'Fragment').get(u'prototype').put(u'append', PyJs_append_32_)
        @Js
        def PyJs_cut_33_(PyJsArg_66726f6d_, to, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'cut':PyJs_cut_33_, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
        ...
        PyJs_cut_33_._set_name(u'cut')
        var.get(u'Fragment').get(u'prototype').put(u'cut', PyJs_cut_33_)
        @Js
        def PyJs_cutByIndex_34_(PyJsArg_66726f6d_, to, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'cutByIndex':PyJs_cutByIndex_34_, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
        ...
        PyJs_cutByIndex_34_._set_name(u'cutByIndex')
        var.get(u'Fragment').get(u'prototype').put(u'cutByIndex', PyJs_cutByIndex_34_)
        @Js
        def PyJs_replaceChild_35_(index, node, this, arguments, var=var):
            var = Scope({u'node':node, u'index':index, u'this':this, u'arguments':arguments, u'replaceChild':PyJs_replaceChild_35_}, var)
        ...
        PyJs_replaceChild_35_._set_name(u'replaceChild')
        var.get(u'Fragment').get(u'prototype').put(u'replaceChild', PyJs_replaceChild_35_)
        @Js
        def PyJs_addToStart_36_(node, this, arguments, var=var):
            var = Scope({u'node':node, u'this':this, u'arguments':arguments, u'addToStart':PyJs_addToStart_36_}, var)
            var.registers([u'node'])
        ...
        PyJs_addToStart_36_._set_name(u'addToStart')
        var.get(u'Fragment').get(u'prototype').put(u'addToStart', PyJs_addToStart_36_)
        @Js
        def PyJs_addToEnd_37_(node, this, arguments, var=var):
            var = Scope({u'node':node, u'this':this, u'arguments':arguments, u'addToEnd':PyJs_addToEnd_37_}, var)
            var.registers([u'node'])
        ...
        PyJs_addToEnd_37_._set_name(u'addToEnd')
        var.get(u'Fragment').get(u'prototype').put(u'addToEnd', PyJs_addToEnd_37_)
        @Js
        def PyJs_eq_38_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'eq':PyJs_eq_38_, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'content').get(u'length')):
                try:
                    if var.get(u'this$1').get(u'content').get(var.get(u'i')).callprop(u'eq', var.get(u'other').get(u'content').get(var.get(u'i'))).neg():
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return Js(True)
        PyJs_eq_38_._set_name(u'eq')
        var.get(u'Fragment').get(u'prototype').put(u'eq', PyJs_eq_38_)
        @Js
        ...
        var.get(u'prototypeAccessors$1').get(u'firstChild').put(u'get', PyJs_anonymous_39_)
        @Js
        ...
        var.get(u'prototypeAccessors$1').get(u'lastChild').put(u'get', PyJs_anonymous_40_)
        @Js
        ...
        var.get(u'prototypeAccessors$1').get(u'childCount').put(u'get', PyJs_anonymous_41_)
        @Js
        def PyJs_child_42_(index, this, arguments, var=var):
            var = Scope({u'this':this, u'index':index, u'arguments':arguments, u'child':PyJs_child_42_}, var)
            ...
            if var.get(u'found').neg():
                ...
                raise PyJsTempException
            return var.get(u'found')
        PyJs_child_42_._set_name(u'child')
        var.get(u'Fragment').get(u'prototype').put(u'child', PyJs_child_42_)
        @Js
        def PyJs_maybeChild_43_(index, this, arguments, var=var):
            var = Scope({u'this':this, u'index':index, u'maybeChild':PyJs_maybeChild_43_, u'arguments':arguments}, var)
            var.registers([u'index'])
            return var.get(u"this").get(u'content').get(var.get(u'index'))
        PyJs_maybeChild_43_._set_name(u'maybeChild')
        var.get(u'Fragment').get(u'prototype').put(u'maybeChild', PyJs_maybeChild_43_)
        @Js
        def PyJs_forEach_44_(f, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'forEach':PyJs_forEach_44_, u'f':f}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'content').get(u'length')):
                try:
                    ...
                    var.put(u'p', var.get(u'child').get(u'nodeSize'), u'+')
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_forEach_44_._set_name(u'forEach')
        var.get(u'Fragment').get(u'prototype').put(u'forEach', PyJs_forEach_44_)
        @Js
        def PyJs_InlineNonPyName_45_(other, pos, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'pos':pos, u'findDiffStart$1':PyJs_InlineNonPyName_45_, u'arguments':arguments}, var)
        ...
        PyJs_InlineNonPyName_45_._set_name(u'findDiffStart$1')
        var.get(u'Fragment').get(u'prototype').put(u'findDiffStart', PyJs_InlineNonPyName_45_)
        @Js
        def PyJs_InlineNonPyName_46_(other, pos, otherPos, this, arguments, var=var):
            var = Scope({u'this':this, u'pos':pos, u'otherPos':otherPos, u'other':other, u'arguments':arguments, u'findDiffEnd$1':PyJs_InlineNonPyName_46_}, var)
        ...
        PyJs_InlineNonPyName_46_._set_name(u'findDiffEnd$1')
        var.get(u'Fragment').get(u'prototype').put(u'findDiffEnd', PyJs_InlineNonPyName_46_)
        @Js
        def PyJs_findIndex_47_(pos, round, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'findIndex':PyJs_findIndex_47_, u'pos':pos, u'round':round}, var)
            ...
            while 1:
                try:
                    ...
                    var.put(u'curPos', var.get(u'end'))
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_findIndex_47_._set_name(u'findIndex')
        var.get(u'Fragment').get(u'prototype').put(u'findIndex', PyJs_findIndex_47_)
        @Js
        def PyJs_toString_48_(this, arguments, var=var):
            var = Scope({u'this':this, u'toString':PyJs_toString_48_, u'arguments':arguments}, var)
            var.registers([])
            return ((Js(u'<')+var.get(u"this").callprop(u'toStringInner'))+Js(u'>'))
        PyJs_toString_48_._set_name(u'toString')
        var.get(u'Fragment').get(u'prototype').put(u'toString', PyJs_toString_48_)
        @Js
        def PyJs_toStringInner_49_(this, arguments, var=var):
            var = Scope({u'this':this, u'toStringInner':PyJs_toStringInner_49_, u'arguments':arguments}, var)
            var.registers([])
            return var.get(u"this").get(u'content').callprop(u'join', Js(u', '))
        PyJs_toStringInner_49_._set_name(u'toStringInner')
        var.get(u'Fragment').get(u'prototype').put(u'toStringInner', PyJs_toStringInner_49_)
        @Js
        def PyJs_toJSON_50_(this, arguments, var=var):
            var = Scope({u'this':this, u'toJSON':PyJs_toJSON_50_, u'arguments':arguments}, var)
            var.registers([])
            @Js
            ...
            return (var.get(u"this").get(u'content').callprop(u'map', PyJs_anonymous_51_) if var.get(u"this").get(u'content').get(u'length') else var.get(u"null"))
        PyJs_toJSON_50_._set_name(u'toJSON')
        var.get(u'Fragment').get(u'prototype').put(u'toJSON', PyJs_toJSON_50_)
        @Js
        def PyJs_fromJSON_52_(schema, value, this, arguments, var=var):
            var = Scope({u'this':this, u'fromJSON':PyJs_fromJSON_52_, u'arguments':arguments, u'value':value, u'schema':schema}, var)
        ...
        PyJs_fromJSON_52_._set_name(u'fromJSON')
        var.get(u'Fragment').put(u'fromJSON', PyJs_fromJSON_52_)
        @Js
        def PyJs_fromArray_53_(array, this, arguments, var=var):
            var = Scope({u'this':this, u'array':array, u'arguments':arguments, u'fromArray':PyJs_fromArray_53_}, var)
        ...
        PyJs_fromArray_53_._set_name(u'fromArray')
        var.get(u'Fragment').put(u'fromArray', PyJs_fromArray_53_)
        @Js
        def PyJs_InlineNonPyName_54_(nodes, this, arguments, var=var):
            var = Scope({u'this':this, u'nodes':nodes, u'from':PyJs_InlineNonPyName_54_, u'arguments':arguments}, var)
        ...
        PyJs_InlineNonPyName_54_._set_name(u'from')
        var.get(u'Fragment').put(u'from', PyJs_InlineNonPyName_54_)
        var.get(u'Object').callprop(u'defineProperties', var.get(u'Fragment').get(u'prototype'), var.get(u'prototypeAccessors$1'))
        PyJs_Object_55_ = Js({u'index':Js(0.0),u'offset':Js(0.0)})
        var.put(u'found', PyJs_Object_55_)
        pass
        var.get(u'Fragment').put(u'empty', var.get(u'Fragment').create(Js([]), Js(0.0)))
        pass
        @Js
        def PyJs_Mark_56_(type, attrs, this, arguments, var=var):
            var = Scope({u'this':this, u'Mark':PyJs_Mark_56_, u'type':type, u'attrs':attrs, u'arguments':arguments}, var)
            var.registers([u'type', u'attrs'])
            var.get(u"this").put(u'type', var.get(u'type'))
            var.get(u"this").put(u'attrs', var.get(u'attrs'))
        PyJs_Mark_56_._set_name(u'Mark')
        var.put(u'Mark', PyJs_Mark_56_)
        @Js
        def PyJs_addToSet_57_(set, this, arguments, var=var):
            var = Scope({u'this':this, u'addToSet':PyJs_addToSet_57_, u'set':set, u'arguments':arguments}, var)
            ...
            return var.get(u'copy')
        PyJs_addToSet_57_._set_name(u'addToSet')
        var.get(u'Mark').get(u'prototype').put(u'addToSet', PyJs_addToSet_57_)
        @Js
        def PyJs_removeFromSet_58_(set, this, arguments, var=var):
            var = Scope({u'this':this, u'set':set, u'arguments':arguments, u'removeFromSet':PyJs_removeFromSet_58_}, var)
            ...
            while (var.get(u'i')<var.get(u'set').get(u'length')):
                try:
                    if var.get(u'this$1').callprop(u'eq', var.get(u'set').get(var.get(u'i'))):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return var.get(u'set')
        PyJs_removeFromSet_58_._set_name(u'removeFromSet')
        var.get(u'Mark').get(u'prototype').put(u'removeFromSet', PyJs_removeFromSet_58_)
        @Js
        def PyJs_isInSet_59_(set, this, arguments, var=var):
            var = Scope({u'this':this, u'isInSet':PyJs_isInSet_59_, u'set':set, u'arguments':arguments}, var)
            var.registers([u'i', u'set', u'this$1'])
            var.put(u'this$1', var.get(u"this"))
            #for JS loop
            var.put(u'i', Js(0.0))
            while (var.get(u'i')<var.get(u'set').get(u'length')):
                try:
                    if var.get(u'this$1').callprop(u'eq', var.get(u'set').get(var.get(u'i'))):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return Js(False)
        PyJs_isInSet_59_._set_name(u'isInSet')
        var.get(u'Mark').get(u'prototype').put(u'isInSet', PyJs_isInSet_59_)
        @Js
        def PyJs_eq_60_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'eq':PyJs_eq_60_, u'arguments':arguments}, var)
        ...
        PyJs_eq_60_._set_name(u'eq')
        var.get(u'Mark').get(u'prototype').put(u'eq', PyJs_eq_60_)
        @Js
        def PyJs_toJSON_61_(this, arguments, var=var):
            var = Scope({u'this':this, u'toJSON':PyJs_toJSON_61_, u'arguments':arguments}, var)
            var.registers([u'obj', u'_', u'this$1'])
            var.put(u'this$1', var.get(u"this"))
            PyJs_Object_62_ = Js({u'type':var.get(u"this").get(u'type').get(u'name')})
            var.put(u'obj', PyJs_Object_62_)
        ...
        PyJs_toJSON_61_._set_name(u'toJSON')
        var.get(u'Mark').get(u'prototype').put(u'toJSON', PyJs_toJSON_61_)
        @Js
        def PyJs_fromJSON_63_(schema, json, this, arguments, var=var):
            var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_63_, u'schema':schema}, var)
        ...
        PyJs_fromJSON_63_._set_name(u'fromJSON')
        var.get(u'Mark').put(u'fromJSON', PyJs_fromJSON_63_)
        @Js
        def PyJs_sameSet_64_(a, b, this, arguments, var=var):
            var = Scope({u'a':a, u'this':this, u'b':b, u'arguments':arguments, u'sameSet':PyJs_sameSet_64_}, var)
            ...
            while (var.get(u'i')<var.get(u'a').get(u'length')):
                try:
                    if var.get(u'a').get(var.get(u'i')).callprop(u'eq', var.get(u'b').get(var.get(u'i'))).neg():
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return Js(True)
        PyJs_sameSet_64_._set_name(u'sameSet')
        var.get(u'Mark').put(u'sameSet', PyJs_sameSet_64_)
        @Js
        def PyJs_setFrom_65_(marks, this, arguments, var=var):
            var = Scope({u'this':this, u'setFrom':PyJs_setFrom_65_, u'arguments':arguments, u'marks':marks}, var)
            ...
            var.get(u'copy').callprop(u'sort', PyJs_anonymous_66_)
            return var.get(u'copy')
        PyJs_setFrom_65_._set_name(u'setFrom')
        var.get(u'Mark').put(u'setFrom', PyJs_setFrom_65_)
        ...
        @Js
        def PyJs_Slice_67_(content, openStart, openEnd, this, arguments, var=var):
            var = Scope({u'Slice':PyJs_Slice_67_, u'this':this, u'content':content, u'openStart':openStart, u'openEnd':openEnd, u'arguments':arguments}, var)
        ...
        PyJs_Slice_67_._set_name(u'Slice')
        var.put(u'Slice', PyJs_Slice_67_)
        PyJs_Object_69_ = Js({})
        PyJs_Object_68_ = Js({u'size':PyJs_Object_69_})
        var.put(u'prototypeAccessors$2', PyJs_Object_68_)
        @Js
        ...
        var.get(u'prototypeAccessors$2').get(u'size').put(u'get', PyJs_anonymous_70_)
        @Js
        def PyJs_insertAt_71_(pos, fragment, this, arguments, var=var):
            var = Scope({u'fragment':fragment, u'this':this, u'insertAt':PyJs_insertAt_71_, u'pos':pos, u'arguments':arguments}, var)
        ...
        PyJs_insertAt_71_._set_name(u'insertAt')
        var.get(u'Slice').get(u'prototype').put(u'insertAt', PyJs_insertAt_71_)
        @Js
        def PyJs_removeBetween_72_(PyJsArg_66726f6d_, to, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'from':PyJsArg_66726f6d_, u'arguments':arguments, u'removeBetween':PyJs_removeBetween_72_}, var)
            var.registers([u'to', u'from'])
        ...
        PyJs_removeBetween_72_._set_name(u'removeBetween')
        var.get(u'Slice').get(u'prototype').put(u'removeBetween', PyJs_removeBetween_72_)
        @Js
        def PyJs_eq_73_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'eq':PyJs_eq_73_, u'arguments':arguments}, var)
            var.registers([u'other'])
        ...
        PyJs_eq_73_._set_name(u'eq')
        var.get(u'Slice').get(u'prototype').put(u'eq', PyJs_eq_73_)
        @Js
        def PyJs_toString_74_(this, arguments, var=var):
            var = Scope({u'this':this, u'toString':PyJs_toString_74_, u'arguments':arguments}, var)
            var.registers([])
            return (((((var.get(u"this").get(u'content')+Js(u'('))+var.get(u"this").get(u'openStart'))+Js(u','))+var.get(u"this").get(u'openEnd'))+Js(u')'))
        PyJs_toString_74_._set_name(u'toString')
        var.get(u'Slice').get(u'prototype').put(u'toString', PyJs_toString_74_)
        @Js
        def PyJs_toJSON_75_(this, arguments, var=var):
            var = Scope({u'this':this, u'toJSON':PyJs_toJSON_75_, u'arguments':arguments}, var)
            var.registers([u'json'])
            if var.get(u"this").get(u'content').get(u'size').neg():
                return var.get(u"null")
            PyJs_Object_76_ = Js({u'content':var.get(u"this").get(u'content').callprop(u'toJSON')})
            var.put(u'json', PyJs_Object_76_)
        ...
        PyJs_toJSON_75_._set_name(u'toJSON')
        var.get(u'Slice').get(u'prototype').put(u'toJSON', PyJs_toJSON_75_)
        @Js
        def PyJs_fromJSON_77_(schema, json, this, arguments, var=var):
            var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_77_, u'schema':schema}, var)
        ...
        PyJs_fromJSON_77_._set_name(u'fromJSON')
        var.get(u'Slice').put(u'fromJSON', PyJs_fromJSON_77_)
        @Js
        def PyJs_maxOpen_78_(fragment, openIsolating, this, arguments, var=var):
            var = Scope({u'fragment':fragment, u'this':this, u'openIsolating':openIsolating, u'arguments':arguments, u'maxOpen':PyJs_maxOpen_78_}, var)
        ...
        PyJs_maxOpen_78_._set_name(u'maxOpen')
        var.get(u'Slice').put(u'maxOpen', PyJs_maxOpen_78_)
        ...
        pass
        @Js
        def PyJs_ResolvedPos_80_(pos, path, parentOffset, this, arguments, var=var):
            var = Scope({u'this':this, u'pos':pos, u'parentOffset':parentOffset, u'arguments':arguments, u'path':path, u'ResolvedPos':PyJs_ResolvedPos_80_}, var)
        ...
        PyJs_ResolvedPos_80_._set_name(u'ResolvedPos')
        var.put(u'ResolvedPos', PyJs_ResolvedPos_80_)
        PyJs_Object_82_ = Js({})
        PyJs_Object_83_ = Js({})
        PyJs_Object_84_ = Js({})
        PyJs_Object_85_ = Js({})
        PyJs_Object_86_ = Js({})
        PyJs_Object_81_ = Js({u'parent':PyJs_Object_82_,u'doc':PyJs_Object_83_,u'textOffset':PyJs_Object_84_,u'nodeAfter':PyJs_Object_85_,u'nodeBefore':PyJs_Object_86_})
        var.put(u'prototypeAccessors$3', PyJs_Object_81_)
        @Js
        def PyJs_resolveDepth_87_(val, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'val':val, u'resolveDepth':PyJs_resolveDepth_87_}, var)
            var.registers([u'val'])
        ...
        PyJs_resolveDepth_87_._set_name(u'resolveDepth')
        var.get(u'ResolvedPos').get(u'prototype').put(u'resolveDepth', PyJs_resolveDepth_87_)
        @Js
        ...
        var.get(u'prototypeAccessors$3').get(u'parent').put(u'get', PyJs_anonymous_88_)
        @Js
        ...
        var.get(u'prototypeAccessors$3').get(u'doc').put(u'get', PyJs_anonymous_89_)
        @Js
        def PyJs_node_90_(depth, this, arguments, var=var):
            var = Scope({u'this':this, u'node':PyJs_node_90_, u'depth':depth, u'arguments':arguments}, var)
            var.registers([u'depth'])
            return var.get(u"this").get(u'path').get((var.get(u"this").callprop(u'resolveDepth', var.get(u'depth'))*Js(3.0)))
        PyJs_node_90_._set_name(u'node')
        var.get(u'ResolvedPos').get(u'prototype').put(u'node', PyJs_node_90_)
        @Js
        def PyJs_index_91_(depth, this, arguments, var=var):
            var = Scope({u'this':this, u'index':PyJs_index_91_, u'depth':depth, u'arguments':arguments}, var)
            var.registers([u'depth'])
            return var.get(u"this").get(u'path').get(((var.get(u"this").callprop(u'resolveDepth', var.get(u'depth'))*Js(3.0))+Js(1.0)))
        PyJs_index_91_._set_name(u'index')
        var.get(u'ResolvedPos').get(u'prototype').put(u'index', PyJs_index_91_)
        @Js
        def PyJs_indexAfter_92_(depth, this, arguments, var=var):
            var = Scope({u'this':this, u'indexAfter':PyJs_indexAfter_92_, u'depth':depth, u'arguments':arguments}, var)
            var.registers([u'depth'])
        ...
        PyJs_indexAfter_92_._set_name(u'indexAfter')
        var.get(u'ResolvedPos').get(u'prototype').put(u'indexAfter', PyJs_indexAfter_92_)
        @Js
        def PyJs_start_93_(depth, this, arguments, var=var):
            var = Scope({u'this':this, u'start':PyJs_start_93_, u'depth':depth, u'arguments':arguments}, var)
            var.registers([u'depth'])
            var.put(u'depth', var.get(u"this").callprop(u'resolveDepth', var.get(u'depth')))
            return (Js(0.0) if (var.get(u'depth')==Js(0.0)) else (var.get(u"this").get(u'path').get(((var.get(u'depth')*Js(3.0))-Js(1.0)))+Js(1.0)))
        PyJs_start_93_._set_name(u'start')
        var.get(u'ResolvedPos').get(u'prototype').put(u'start', PyJs_start_93_)
        @Js
        def PyJs_end_94_(depth, this, arguments, var=var):
            var = Scope({u'this':this, u'depth':depth, u'end':PyJs_end_94_, u'arguments':arguments}, var)
            var.registers([u'depth'])
            var.put(u'depth', var.get(u"this").callprop(u'resolveDepth', var.get(u'depth')))
        ...
        PyJs_end_94_._set_name(u'end')
        var.get(u'ResolvedPos').get(u'prototype').put(u'end', PyJs_end_94_)
        @Js
        def PyJs_before_95_(depth, this, arguments, var=var):
            var = Scope({u'this':this, u'depth':depth, u'arguments':arguments, u'before':PyJs_before_95_}, var)
            var.registers([u'depth'])
            var.put(u'depth', var.get(u"this").callprop(u'resolveDepth', var.get(u'depth')))
        ...
        PyJs_before_95_._set_name(u'before')
        var.get(u'ResolvedPos').get(u'prototype').put(u'before', PyJs_before_95_)
        @Js
        def PyJs_after_96_(depth, this, arguments, var=var):
            var = Scope({u'this':this, u'depth':depth, u'after':PyJs_after_96_, u'arguments':arguments}, var)
            var.registers([u'depth'])
            var.put(u'depth', var.get(u"this").callprop(u'resolveDepth', var.get(u'depth')))
            if var.get(u'depth').neg():
        ...
        PyJs_after_96_._set_name(u'after')
        var.get(u'ResolvedPos').get(u'prototype').put(u'after', PyJs_after_96_)
        @Js
        ...
        var.get(u'prototypeAccessors$3').get(u'textOffset').put(u'get', PyJs_anonymous_97_)
        @Js
        ...
        var.get(u'prototypeAccessors$3').get(u'nodeAfter').put(u'get', PyJs_anonymous_98_)
        @Js
        ...
        var.get(u'prototypeAccessors$3').get(u'nodeBefore').put(u'get', PyJs_anonymous_99_)
        @Js
        def PyJs_marks_100_(this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'marks':PyJs_marks_100_}, var)
        ...
        PyJs_marks_100_._set_name(u'marks')
        var.get(u'ResolvedPos').get(u'prototype').put(u'marks', PyJs_marks_100_)
        @Js
        def PyJs_marksAcross_101_(PyJsArg_24656e64_, this, arguments, var=var):
            var = Scope({u'this':this, u'marksAcross':PyJs_marksAcross_101_, u'arguments':arguments, u'$end':PyJsArg_24656e64_}, var)
            ...
            while (var.get(u'i')<var.get(u'marks').get(u'length')):
                try:
                    if (PyJsStrictEq(var.get(u'marks').get(var.get(u'i')).get(u'type').get(u'spec').get(u'inclusive'),Js(False)) and (var.get(u'next').neg() or var.get(u'marks').get(var.get(u'i')).callprop(u'isInSet', var.get(u'next').get(u'marks')).neg())):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return var.get(u'marks')
        PyJs_marksAcross_101_._set_name(u'marksAcross')
        var.get(u'ResolvedPos').get(u'prototype').put(u'marksAcross', PyJs_marksAcross_101_)
        @Js
        def PyJs_sharedDepth_102_(pos, this, arguments, var=var):
            var = Scope({u'this':this, u'sharedDepth':PyJs_sharedDepth_102_, u'pos':pos, u'arguments':arguments}, var)
            ...
            return Js(0.0)
        PyJs_sharedDepth_102_._set_name(u'sharedDepth')
        var.get(u'ResolvedPos').get(u'prototype').put(u'sharedDepth', PyJs_sharedDepth_102_)
        @Js
        def PyJs_blockRange_103_(other, pred, this, arguments, var=var):
            var = Scope({u'this':this, u'pred':pred, u'other':other, u'blockRange':PyJs_blockRange_103_, u'arguments':arguments}, var)
        ...
        PyJs_blockRange_103_._set_name(u'blockRange')
        var.get(u'ResolvedPos').get(u'prototype').put(u'blockRange', PyJs_blockRange_103_)
        @Js
        def PyJs_sameParent_104_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'sameParent':PyJs_sameParent_104_, u'other':other, u'arguments':arguments}, var)
            var.registers([u'other'])
        ...
        PyJs_sameParent_104_._set_name(u'sameParent')
        var.get(u'ResolvedPos').get(u'prototype').put(u'sameParent', PyJs_sameParent_104_)
        @Js
        def PyJs_max_105_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'max':PyJs_max_105_, u'other':other, u'arguments':arguments}, var)
            var.registers([u'other'])
            return (var.get(u'other') if (var.get(u'other').get(u'pos')>var.get(u"this").get(u'pos')) else var.get(u"this"))
        PyJs_max_105_._set_name(u'max')
        var.get(u'ResolvedPos').get(u'prototype').put(u'max', PyJs_max_105_)
        @Js
        def PyJs_min_106_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'arguments':arguments, u'min':PyJs_min_106_}, var)
            var.registers([u'other'])
            return (var.get(u'other') if (var.get(u'other').get(u'pos')<var.get(u"this").get(u'pos')) else var.get(u"this"))
        PyJs_min_106_._set_name(u'min')
        var.get(u'ResolvedPos').get(u'prototype').put(u'min', PyJs_min_106_)
        @Js
        def PyJs_toString_107_(this, arguments, var=var):
            var = Scope({u'this':this, u'toString':PyJs_toString_107_, u'arguments':arguments}, var)
        ...
        PyJs_toString_107_._set_name(u'toString')
        var.get(u'ResolvedPos').get(u'prototype').put(u'toString', PyJs_toString_107_)
        @Js
        def PyJs_resolve_108_(doc, pos, this, arguments, var=var):
            var = Scope({u'this':this, u'doc':doc, u'resolve':PyJs_resolve_108_, u'pos':pos, u'arguments':arguments}, var)
        ...
        PyJs_resolve_108_._set_name(u'resolve')
        var.get(u'ResolvedPos').put(u'resolve', PyJs_resolve_108_)
        @Js
        def PyJs_resolveCached_109_(doc, pos, this, arguments, var=var):
            var = Scope({u'this':this, u'doc':doc, u'resolveCached':PyJs_resolveCached_109_, u'pos':pos, u'arguments':arguments}, var)
            ...
            return var.get(u'result')
        PyJs_resolveCached_109_._set_name(u'resolveCached')
        var.get(u'ResolvedPos').put(u'resolveCached', PyJs_resolveCached_109_)
        ...
        @Js
        def PyJs_NodeRange_110_(PyJsArg_2466726f6d_, PyJsArg_24746f_, depth, this, arguments, var=var):
            var = Scope({u'NodeRange':PyJs_NodeRange_110_, u'$to':PyJsArg_24746f_, u'this':this, u'$from':PyJsArg_2466726f6d_, u'depth':depth, u'arguments':arguments}, var)
        ...
        PyJs_NodeRange_110_._set_name(u'NodeRange')
        var.put(u'NodeRange', PyJs_NodeRange_110_)
        PyJs_Object_112_ = Js({})
        PyJs_Object_113_ = Js({})
        PyJs_Object_114_ = Js({})
        PyJs_Object_115_ = Js({})
        PyJs_Object_116_ = Js({})
        PyJs_Object_111_ = Js({u'start':PyJs_Object_112_,u'end':PyJs_Object_113_,u'parent':PyJs_Object_114_,u'startIndex':PyJs_Object_115_,u'endIndex':PyJs_Object_116_})
        var.put(u'prototypeAccessors$1$1', PyJs_Object_111_)
        @Js
        ...
        var.get(u'prototypeAccessors$1$1').get(u'start').put(u'get', PyJs_anonymous_117_)
        @Js
        ...
        var.get(u'prototypeAccessors$1$1').get(u'end').put(u'get', PyJs_anonymous_118_)
        @Js
        ...
        var.get(u'prototypeAccessors$1$1').get(u'parent').put(u'get', PyJs_anonymous_119_)
        @Js
        ...
        var.get(u'prototypeAccessors$1$1').get(u'startIndex').put(u'get', PyJs_anonymous_120_)
        @Js
        ...
        var.get(u'prototypeAccessors$1$1').get(u'endIndex').put(u'get', PyJs_anonymous_121_)
        ...
        @Js
        def PyJs_Node_122_(type, attrs, content, marks, this, arguments, var=var):
            var = Scope({u'content':content, u'Node':PyJs_Node_122_, u'attrs':attrs, u'marks':marks, u'this':this, u'type':type, u'arguments':arguments}, var)
        ...
        PyJs_Node_122_._set_name(u'Node')
        var.put(u'Node', PyJs_Node_122_)
        PyJs_Object_124_ = Js({})
        PyJs_Object_125_ = Js({})
        PyJs_Object_126_ = Js({})
        PyJs_Object_127_ = Js({})
        ...
        PyJs_Object_134_ = Js({})
        PyJs_Object_135_ = Js({})
        PyJs_Object_123_ = Js({u'nodeSize':PyJs_Object_124_,u'childCount':PyJs_Object_125_,u'textContent':PyJs_Object_126_,u'firstChild':PyJs_Object_127_,u'lastChild':PyJs_Object_128_,u'isBlock':PyJs_Object_129_,u'isTextblock':PyJs_Object_130_,u'inlineContent':PyJs_Object_131_,u'isInline':PyJs_Object_132_,u'isText':PyJs_Object_133_,u'isLeaf':PyJs_Object_134_,u'isAtom':PyJs_Object_135_})
        var.put(u'prototypeAccessors', PyJs_Object_123_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'nodeSize').put(u'get', PyJs_anonymous_136_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'childCount').put(u'get', PyJs_anonymous_137_)
        @Js
        def PyJs_child_138_(index, this, arguments, var=var):
            var = Scope({u'this':this, u'index':index, u'arguments':arguments, u'child':PyJs_child_138_}, var)
            var.registers([u'index'])
            return var.get(u"this").get(u'content').callprop(u'child', var.get(u'index'))
        PyJs_child_138_._set_name(u'child')
        var.get(u'Node').get(u'prototype').put(u'child', PyJs_child_138_)
        @Js
        def PyJs_maybeChild_139_(index, this, arguments, var=var):
            var = Scope({u'this':this, u'index':index, u'maybeChild':PyJs_maybeChild_139_, u'arguments':arguments}, var)
            var.registers([u'index'])
            return var.get(u"this").get(u'content').callprop(u'maybeChild', var.get(u'index'))
        PyJs_maybeChild_139_._set_name(u'maybeChild')
        var.get(u'Node').get(u'prototype').put(u'maybeChild', PyJs_maybeChild_139_)
        @Js
        def PyJs_forEach_140_(f, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'forEach':PyJs_forEach_140_, u'f':f}, var)
            var.registers([u'f'])
            var.get(u"this").get(u'content').callprop(u'forEach', var.get(u'f'))
        PyJs_forEach_140_._set_name(u'forEach')
        var.get(u'Node').get(u'prototype').put(u'forEach', PyJs_forEach_140_)
        @Js
        def PyJs_nodesBetween_141_(PyJsArg_66726f6d_, to, f, startPos, this, arguments, var=var):
            var = Scope({u'to':to, u'from':PyJsArg_66726f6d_, u'arguments':arguments, u'f':f, u'this':this, u'startPos':startPos, u'nodesBetween':PyJs_nodesBetween_141_}, var)
        ...
        PyJs_nodesBetween_141_._set_name(u'nodesBetween')
        var.get(u'Node').get(u'prototype').put(u'nodesBetween', PyJs_nodesBetween_141_)
        @Js
        def PyJs_descendants_142_(f, this, arguments, var=var):
            var = Scope({u'this':this, u'descendants':PyJs_descendants_142_, u'arguments':arguments, u'f':f}, var)
            var.registers([u'f'])
            var.get(u"this").callprop(u'nodesBetween', Js(0.0), var.get(u"this").get(u'content').get(u'size'), var.get(u'f'))
        PyJs_descendants_142_._set_name(u'descendants')
        var.get(u'Node').get(u'prototype').put(u'descendants', PyJs_descendants_142_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'textContent').put(u'get', PyJs_anonymous_143_)
        @Js
        def PyJs_textBetween_144_(PyJsArg_66726f6d_, to, blockSeparator, leafText, this, arguments, var=var):
            var = Scope({u'to':to, u'from':PyJsArg_66726f6d_, u'leafText':leafText, u'blockSeparator':blockSeparator, u'this':this, u'textBetween':PyJs_textBetween_144_, u'arguments':arguments}, var)
        ...
        PyJs_textBetween_144_._set_name(u'textBetween')
        var.get(u'Node').get(u'prototype').put(u'textBetween', PyJs_textBetween_144_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'firstChild').put(u'get', PyJs_anonymous_145_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'lastChild').put(u'get', PyJs_anonymous_146_)
        @Js
        def PyJs_eq_147_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'eq':PyJs_eq_147_, u'arguments':arguments}, var)
            var.registers([u'other'])
        ...
        PyJs_eq_147_._set_name(u'eq')
        var.get(u'Node').get(u'prototype').put(u'eq', PyJs_eq_147_)
        @Js
        def PyJs_sameMarkup_148_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'sameMarkup':PyJs_sameMarkup_148_, u'arguments':arguments}, var)
            var.registers([u'other'])
        ...
        PyJs_sameMarkup_148_._set_name(u'sameMarkup')
        var.get(u'Node').get(u'prototype').put(u'sameMarkup', PyJs_sameMarkup_148_)
        @Js
        def PyJs_hasMarkup_149_(type, attrs, marks, this, arguments, var=var):
            var = Scope({u'this':this, u'hasMarkup':PyJs_hasMarkup_149_, u'arguments':arguments, u'marks':marks, u'type':type, u'attrs':attrs}, var)
        ...
        PyJs_hasMarkup_149_._set_name(u'hasMarkup')
        var.get(u'Node').get(u'prototype').put(u'hasMarkup', PyJs_hasMarkup_149_)
        @Js
        def PyJs_copy_150_(content, this, arguments, var=var):
            var = Scope({u'content':content, u'this':this, u'copy':PyJs_copy_150_, u'arguments':arguments}, var)
            var.registers([u'content'])
        ...
        PyJs_copy_150_._set_name(u'copy')
        var.get(u'Node').get(u'prototype').put(u'copy', PyJs_copy_150_)
        @Js
        def PyJs_mark_151_(marks, this, arguments, var=var):
            var = Scope({u'this':this, u'mark':PyJs_mark_151_, u'arguments':arguments, u'marks':marks}, var)
        ...
        PyJs_mark_151_._set_name(u'mark')
        var.get(u'Node').get(u'prototype').put(u'mark', PyJs_mark_151_)
        @Js
        def PyJs_cut_152_(PyJsArg_66726f6d_, to, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'cut':PyJs_cut_152_, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
            var.registers([u'to', u'from'])
        ...
        PyJs_cut_152_._set_name(u'cut')
        var.get(u'Node').get(u'prototype').put(u'cut', PyJs_cut_152_)
        @Js
        def PyJs_slice_153_(PyJsArg_66726f6d_, to, includeParents, this, arguments, var=var):
            var = Scope({u'includeParents':includeParents, u'slice':PyJs_slice_153_, u'from':PyJsArg_66726f6d_, u'this':this, u'to':to, u'arguments':arguments}, var)
        ...
        PyJs_slice_153_._set_name(u'slice')
        var.get(u'Node').get(u'prototype').put(u'slice', PyJs_slice_153_)
        @Js
        def PyJs_InlineNonPyName_154_(PyJsArg_66726f6d_, to, slice, this, arguments, var=var):
            var = Scope({u'slice':slice, u'from':PyJsArg_66726f6d_, u'this':this, u'replace$1':PyJs_InlineNonPyName_154_, u'to':to, u'arguments':arguments}, var)
        ...
        PyJs_InlineNonPyName_154_._set_name(u'replace$1')
        var.get(u'Node').get(u'prototype').put(u'replace', PyJs_InlineNonPyName_154_)
        @Js
        def PyJs_nodeAt_155_(pos, this, arguments, var=var):
            var = Scope({u'this':this, u'nodeAt':PyJs_nodeAt_155_, u'pos':pos, u'arguments':arguments}, var)
        ...
        PyJs_nodeAt_155_._set_name(u'nodeAt')
        var.get(u'Node').get(u'prototype').put(u'nodeAt', PyJs_nodeAt_155_)
        @Js
        def PyJs_childAfter_156_(pos, this, arguments, var=var):
            var = Scope({u'this':this, u'pos':pos, u'childAfter':PyJs_childAfter_156_, u'arguments':arguments}, var)
            var.registers([u'index', u'ref', u'pos', u'offset'])
            var.put(u'ref', var.get(u"this").get(u'content').callprop(u'findIndex', var.get(u'pos')))
            var.put(u'index', var.get(u'ref').get(u'index'))
            var.put(u'offset', var.get(u'ref').get(u'offset'))
            PyJs_Object_157_ = Js({u'node':var.get(u"this").get(u'content').callprop(u'maybeChild', var.get(u'index')),u'index':var.get(u'index'),u'offset':var.get(u'offset')})
            return PyJs_Object_157_
        PyJs_childAfter_156_._set_name(u'childAfter')
        var.get(u'Node').get(u'prototype').put(u'childAfter', PyJs_childAfter_156_)
        @Js
        def PyJs_childBefore_158_(pos, this, arguments, var=var):
            var = Scope({u'this':this, u'childBefore':PyJs_childBefore_158_, u'pos':pos, u'arguments':arguments}, var)
            var.registers([u'node', u'index', u'ref', u'pos', u'offset'])
            if (var.get(u'pos')==Js(0.0)):
                PyJs_Object_159_ = Js({u'node':var.get(u"null"),u'index':Js(0.0),u'offset':Js(0.0)})
                return PyJs_Object_159_
            var.put(u'ref', var.get(u"this").get(u'content').callprop(u'findIndex', var.get(u'pos')))
            var.put(u'index', var.get(u'ref').get(u'index'))
            var.put(u'offset', var.get(u'ref').get(u'offset'))
            if (var.get(u'offset')<var.get(u'pos')):
                PyJs_Object_160_ = Js({u'node':var.get(u"this").get(u'content').callprop(u'child', var.get(u'index')),u'index':var.get(u'index'),u'offset':var.get(u'offset')})
                return PyJs_Object_160_
            var.put(u'node', var.get(u"this").get(u'content').callprop(u'child', (var.get(u'index')-Js(1.0))))
            PyJs_Object_161_ = Js({u'node':var.get(u'node'),u'index':(var.get(u'index')-Js(1.0)),u'offset':(var.get(u'offset')-var.get(u'node').get(u'nodeSize'))})
            return PyJs_Object_161_
        PyJs_childBefore_158_._set_name(u'childBefore')
        var.get(u'Node').get(u'prototype').put(u'childBefore', PyJs_childBefore_158_)
        @Js
        def PyJs_resolve_162_(pos, this, arguments, var=var):
            var = Scope({u'this':this, u'resolve':PyJs_resolve_162_, u'pos':pos, u'arguments':arguments}, var)
            var.registers([u'pos'])
            return var.get(u'ResolvedPos').callprop(u'resolveCached', var.get(u"this"), var.get(u'pos'))
        PyJs_resolve_162_._set_name(u'resolve')
        var.get(u'Node').get(u'prototype').put(u'resolve', PyJs_resolve_162_)
        @Js
        def PyJs_resolveNoCache_163_(pos, this, arguments, var=var):
            var = Scope({u'this':this, u'resolveNoCache':PyJs_resolveNoCache_163_, u'pos':pos, u'arguments':arguments}, var)
            var.registers([u'pos'])
            return var.get(u'ResolvedPos').callprop(u'resolve', var.get(u"this"), var.get(u'pos'))
        PyJs_resolveNoCache_163_._set_name(u'resolveNoCache')
        var.get(u'Node').get(u'prototype').put(u'resolveNoCache', PyJs_resolveNoCache_163_)
        @Js
        def PyJs_rangeHasMark_164_(PyJsArg_66726f6d_, to, type, this, arguments, var=var):
            var = Scope({u'from':PyJsArg_66726f6d_, u'this':this, u'to':to, u'arguments':arguments, u'type':type, u'rangeHasMark':PyJs_rangeHasMark_164_}, var)
            var.registers([u'found', u'type', u'from', u'to'])
            var.put(u'found', Js(False))
            if (var.get(u'to')>var.get(u'from')):
                @Js
                def PyJs_anonymous_165_(node, this, arguments, var=var):
                    var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
                    var.registers([u'node'])
                ...
                var.get(u"this").callprop(u'nodesBetween', var.get(u'from'), var.get(u'to'), PyJs_anonymous_165_)
            return var.get(u'found')
        PyJs_rangeHasMark_164_._set_name(u'rangeHasMark')
        var.get(u'Node').get(u'prototype').put(u'rangeHasMark', PyJs_rangeHasMark_164_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'isBlock').put(u'get', PyJs_anonymous_166_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'isTextblock').put(u'get', PyJs_anonymous_167_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'inlineContent').put(u'get', PyJs_anonymous_168_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'isInline').put(u'get', PyJs_anonymous_169_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'isText').put(u'get', PyJs_anonymous_170_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'isLeaf').put(u'get', PyJs_anonymous_171_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'isAtom').put(u'get', PyJs_anonymous_172_)
        @Js
        def PyJs_toString_173_(this, arguments, var=var):
            var = Scope({u'this':this, u'toString':PyJs_toString_173_, u'arguments':arguments}, var)
        ...
        PyJs_toString_173_._set_name(u'toString')
        var.get(u'Node').get(u'prototype').put(u'toString', PyJs_toString_173_)
        @Js
        def PyJs_contentMatchAt_174_(index, this, arguments, var=var):
            var = Scope({u'this':this, u'index':index, u'arguments':arguments, u'contentMatchAt':PyJs_contentMatchAt_174_}, var)
        ...
        PyJs_contentMatchAt_174_._set_name(u'contentMatchAt')
        var.get(u'Node').get(u'prototype').put(u'contentMatchAt', PyJs_contentMatchAt_174_)
        @Js
        def PyJs_canReplace_175_(PyJsArg_66726f6d_, to, replacement, start, end, this, arguments, var=var):
            var = Scope({u'canReplace':PyJs_canReplace_175_, u'to':to, u'end':end, u'arguments':arguments, u'start':start, u'this':this, u'from':PyJsArg_66726f6d_, u'replacement':replacement}, var)
            ...
            while (var.get(u'i')<var.get(u'end')):
                try:
                    if var.get(u'this$1').get(u'type').callprop(u'allowsMarks', var.get(u'replacement').callprop(u'child', var.get(u'i')).get(u'marks')).neg():
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return Js(True)
        PyJs_canReplace_175_._set_name(u'canReplace')
        var.get(u'Node').get(u'prototype').put(u'canReplace', PyJs_canReplace_175_)
        @Js
        def PyJs_canReplaceWith_176_(PyJsArg_66726f6d_, to, type, marks, this, arguments, var=var):
            var = Scope({u'canReplaceWith':PyJs_canReplaceWith_176_, u'to':to, u'from':PyJsArg_66726f6d_, u'arguments':arguments, u'marks':marks, u'this':this, u'type':type}, var)
        ...
        PyJs_canReplaceWith_176_._set_name(u'canReplaceWith')
        var.get(u'Node').get(u'prototype').put(u'canReplaceWith', PyJs_canReplaceWith_176_)
        @Js
        def PyJs_canAppend_177_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'canAppend':PyJs_canAppend_177_, u'arguments':arguments}, var)
            var.registers([u'other'])
        ...
        PyJs_canAppend_177_._set_name(u'canAppend')
        var.get(u'Node').get(u'prototype').put(u'canAppend', PyJs_canAppend_177_)
        @Js
        def PyJs_defaultContentType_178_(at, this, arguments, var=var):
            var = Scope({u'this':this, u'defaultContentType':PyJs_defaultContentType_178_, u'at':at, u'arguments':arguments}, var)
            var.registers([u'at'])
            return var.get(u"this").callprop(u'contentMatchAt', var.get(u'at')).get(u'defaultType')
        PyJs_defaultContentType_178_._set_name(u'defaultContentType')
        var.get(u'Node').get(u'prototype').put(u'defaultContentType', PyJs_defaultContentType_178_)
        @Js
        def PyJs_check_179_(this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'check':PyJs_check_179_}, var)
            var.registers([])
            if var.get(u"this").get(u'type').callprop(u'validContent', var.get(u"this").get(u'content')).neg():
                ...
                raise PyJsTempException
            @Js
            def PyJs_anonymous_180_(node, this, arguments, var=var):
                var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
                var.registers([u'node'])
                return var.get(u'node').callprop(u'check')
            PyJs_anonymous_180_._set_name(u'anonymous')
            var.get(u"this").get(u'content').callprop(u'forEach', PyJs_anonymous_180_)
        PyJs_check_179_._set_name(u'check')
        var.get(u'Node').get(u'prototype').put(u'check', PyJs_check_179_)
        @Js
        def PyJs_toJSON_181_(this, arguments, var=var):
            var = Scope({u'this':this, u'toJSON':PyJs_toJSON_181_, u'arguments':arguments}, var)
            var.registers([u'obj', u'_', u'this$1'])
            var.put(u'this$1', var.get(u"this"))
            PyJs_Object_182_ = Js({u'type':var.get(u"this").get(u'type').get(u'name')})
            var.put(u'obj', PyJs_Object_182_)
            for PyJsTemp in var.get(u'this$1').get(u'attrs'):
                var.put(u'_', PyJsTemp)
                var.get(u'obj').put(u'attrs', var.get(u'this$1').get(u'attrs'))
                break
            ...
            if var.get(u"this").get(u'marks').get(u'length'):
                @Js
                def PyJs_anonymous_183_(n, this, arguments, var=var):
                    var = Scope({u'this':this, u'arguments':arguments, u'n':n}, var)
                    var.registers([u'n'])
                    return var.get(u'n').callprop(u'toJSON')
                PyJs_anonymous_183_._set_name(u'anonymous')
                var.get(u'obj').put(u'marks', var.get(u"this").get(u'marks').callprop(u'map', PyJs_anonymous_183_))
            return var.get(u'obj')
        PyJs_toJSON_181_._set_name(u'toJSON')
        var.get(u'Node').get(u'prototype').put(u'toJSON', PyJs_toJSON_181_)
        @Js
        def PyJs_fromJSON_184_(schema, json, this, arguments, var=var):
            var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_184_, u'schema':schema}, var)
        ...
        PyJs_fromJSON_184_._set_name(u'fromJSON')
        var.get(u'Node').put(u'fromJSON', PyJs_fromJSON_184_)
        var.get(u'Object').callprop(u'defineProperties', var.get(u'Node').get(u'prototype'), var.get(u'prototypeAccessors'))
        @Js
        def PyJs_anonymous_185_(Node, this, arguments, var=var):
            var = Scope({u'Node':Node, u'this':this, u'arguments':arguments}, var)
            ...
            PyJs_Object_187_ = Js({})
            PyJs_Object_188_ = Js({})
            PyJs_Object_186_ = Js({u'textContent':PyJs_Object_187_,u'nodeSize':PyJs_Object_188_})
            var.put(u'prototypeAccessors$1', PyJs_Object_186_)
            @Js
            def PyJs_toString_189_(this, arguments, var=var):
                var = Scope({u'this':this, u'toString':PyJs_toString_189_, u'arguments':arguments}, var)
                var.registers([])
                if var.get(u"this").get(u'type').get(u'spec').get(u'toDebugString'):
                    return var.get(u"this").get(u'type').get(u'spec').callprop(u'toDebugString', var.get(u"this"))
                return var.get(u'wrapMarks')(var.get(u"this").get(u'marks'), var.get(u'JSON').callprop(u'stringify', var.get(u"this").get(u'text')))
            PyJs_toString_189_._set_name(u'toString')
            var.get(u'TextNode').get(u'prototype').put(u'toString', PyJs_toString_189_)
            @Js
            ...
            var.get(u'prototypeAccessors$1').get(u'textContent').put(u'get', PyJs_anonymous_190_)
            @Js
            def PyJs_textBetween_191_(PyJsArg_66726f6d_, to, this, arguments, var=var):
                var = Scope({u'this':this, u'to':to, u'textBetween':PyJs_textBetween_191_, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
                var.registers([u'to', u'from'])
                return var.get(u"this").get(u'text').callprop(u'slice', var.get(u'from'), var.get(u'to'))
            PyJs_textBetween_191_._set_name(u'textBetween')
            var.get(u'TextNode').get(u'prototype').put(u'textBetween', PyJs_textBetween_191_)
            @Js
            ...
            var.get(u'prototypeAccessors$1').get(u'nodeSize').put(u'get', PyJs_anonymous_192_)
            @Js
            def PyJs_mark_193_(marks, this, arguments, var=var):
                var = Scope({u'this':this, u'mark':PyJs_mark_193_, u'arguments':arguments, u'marks':marks}, var)
                var.registers([u'marks'])
            ...
            PyJs_mark_193_._set_name(u'mark')
            var.get(u'TextNode').get(u'prototype').put(u'mark', PyJs_mark_193_)
            @Js
            def PyJs_withText_194_(text, this, arguments, var=var):
                var = Scope({u'this':this, u'text':text, u'arguments':arguments, u'withText':PyJs_withText_194_}, var)
            ...
            PyJs_withText_194_._set_name(u'withText')
            var.get(u'TextNode').get(u'prototype').put(u'withText', PyJs_withText_194_)
            @Js
            def PyJs_cut_195_(PyJsArg_66726f6d_, to, this, arguments, var=var):
                var = Scope({u'this':this, u'to':to, u'cut':PyJs_cut_195_, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
                var.registers([u'to', u'from'])
            ...
            PyJs_cut_195_._set_name(u'cut')
            var.get(u'TextNode').get(u'prototype').put(u'cut', PyJs_cut_195_)
            @Js
            def PyJs_eq_196_(other, this, arguments, var=var):
                var = Scope({u'this':this, u'other':other, u'eq':PyJs_eq_196_, u'arguments':arguments}, var)
                var.registers([u'other'])
                return (var.get(u"this").callprop(u'sameMarkup', var.get(u'other')) and (var.get(u"this").get(u'text')==var.get(u'other').get(u'text')))
            PyJs_eq_196_._set_name(u'eq')
            var.get(u'TextNode').get(u'prototype').put(u'eq', PyJs_eq_196_)
            @Js
            def PyJs_toJSON_197_(this, arguments, var=var):
                var = Scope({u'this':this, u'toJSON':PyJs_toJSON_197_, u'arguments':arguments}, var)
            ...
            PyJs_toJSON_197_._set_name(u'toJSON')
            var.get(u'TextNode').get(u'prototype').put(u'toJSON', PyJs_toJSON_197_)
        ...
        var.put(u'TextNode', PyJs_anonymous_185_(var.get(u'Node')))
        pass
        @Js
        def PyJs_ContentMatch_198_(validEnd, this, arguments, var=var):
            var = Scope({u'this':this, u'validEnd':validEnd, u'ContentMatch':PyJs_ContentMatch_198_, u'arguments':arguments}, var)
        ...
        PyJs_ContentMatch_198_._set_name(u'ContentMatch')
        var.put(u'ContentMatch', PyJs_ContentMatch_198_)
        PyJs_Object_200_ = Js({})
        PyJs_Object_201_ = Js({})
        PyJs_Object_202_ = Js({})
        PyJs_Object_199_ = Js({u'inlineContent':PyJs_Object_200_,u'defaultType':PyJs_Object_201_,u'edgeCount':PyJs_Object_202_})
        var.put(u'prototypeAccessors$5', PyJs_Object_199_)
        @Js
        def PyJs_parse_203_(string, nodeTypes, this, arguments, var=var):
            var = Scope({u'this':this, u'parse':PyJs_parse_203_, u'string':string, u'nodeTypes':nodeTypes, u'arguments':arguments}, var)
            ...
            return var.get(u'match')
        PyJs_parse_203_._set_name(u'parse')
        var.get(u'ContentMatch').put(u'parse', PyJs_parse_203_)
        @Js
        def PyJs_matchType_204_(type, this, arguments, var=var):
            var = Scope({u'this':this, u'matchType':PyJs_matchType_204_, u'type':type, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'next').get(u'length')):
                try:
                    if (var.get(u'this$1').get(u'next').get(var.get(u'i'))==var.get(u'type')):
                        ...
                        var.put(u'i', Js(2.0), u'+')
            return var.get(u"null")
        PyJs_matchType_204_._set_name(u'matchType')
        var.get(u'ContentMatch').get(u'prototype').put(u'matchType', PyJs_matchType_204_)
        @Js
        def PyJs_matchFragment_205_(frag, start, end, this, arguments, var=var):
            var = Scope({u'frag':frag, u'end':end, u'this':this, u'start':start, u'arguments':arguments, u'matchFragment':PyJs_matchFragment_205_}, var)
        ...
        PyJs_matchFragment_205_._set_name(u'matchFragment')
        var.get(u'ContentMatch').get(u'prototype').put(u'matchFragment', PyJs_matchFragment_205_)
        @Js
        ...
        var.get(u'prototypeAccessors$5').get(u'inlineContent').put(u'get', PyJs_anonymous_206_)
        @Js
        ...
        var.get(u'prototypeAccessors$5').get(u'defaultType').put(u'get', PyJs_anonymous_207_)
        @Js
        def PyJs_compatible_208_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'compatible':PyJs_compatible_208_, u'other':other, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'next').get(u'length')):
                try:
                    ...
                    while (var.get(u'j')<var.get(u'other').get(u'next').get(u'length')):
                        ...
                        var.put(u'i', Js(2.0), u'+')
            return Js(False)
        PyJs_compatible_208_._set_name(u'compatible')
        var.get(u'ContentMatch').get(u'prototype').put(u'compatible', PyJs_compatible_208_)
        @Js
        def PyJs_fillBefore_209_(after, toEnd, startIndex, this, arguments, var=var):
            var = Scope({u'fillBefore':PyJs_fillBefore_209_, u'this':this, u'after':after, u'toEnd':toEnd, u'startIndex':startIndex, u'arguments':arguments}, var)
            ...
            def PyJsHoisted_search_(match, types, this, arguments, var=var):
                ...
                if (var.get(u'finished') and (var.get(u'toEnd').neg() or var.get(u'finished').get(u'validEnd'))):
                    @Js
                    def PyJs_anonymous_210_(tp, this, arguments, var=var):
                    ...
                    return var.get(u'Fragment').callprop(u'from', var.get(u'types').callprop(u'map', PyJs_anonymous_210_))
                #for JS loop
                var.put(u'i', Js(0.0))
        ...
        PyJs_fillBefore_209_._set_name(u'fillBefore')
        var.get(u'ContentMatch').get(u'prototype').put(u'fillBefore', PyJs_fillBefore_209_)
        @Js
        def PyJs_findWrapping_211_(target, this, arguments, var=var):
            var = Scope({u'this':this, u'findWrapping':PyJs_findWrapping_211_, u'target':target, u'arguments':arguments}, var)
        ...
        PyJs_findWrapping_211_._set_name(u'findWrapping')
        var.get(u'ContentMatch').get(u'prototype').put(u'findWrapping', PyJs_findWrapping_211_)
        @Js
        def PyJs_computeWrapping_212_(target, this, arguments, var=var):
            var = Scope({u'this':this, u'computeWrapping':PyJs_computeWrapping_212_, u'target':target, u'arguments':arguments}, var)
            ...
            PyJs_Object_213_ = Js({u'match':var.get(u"this"),u'type':var.get(u"null"),u'via':var.get(u"null")})
            var.put(u'active', Js([PyJs_Object_213_]))
                ...
                while (var.get(u'i')<var.get(u'match').get(u'next').get(u'length')):
                    try:
                        ...
                        if (((var.get(u'type').get(u'isLeaf').neg() and var.get(u'type').callprop(u'hasRequiredAttrs').neg()) and var.get(u'seen').contains(var.get(u'type').get(u'name')).neg()) and (var.get(u'current').get(u'type').neg() or var.get(u'match').get(u'next').get((var.get(u'i')+Js(1.0))).get(u'validEnd'))):
                            PyJs_Object_214_ = Js({u'match':var.get(u'type').get(u'contentMatch'),u'type':var.get(u'type'),u'via':var.get(u'current')})
                            var.get(u'active').callprop(u'push', PyJs_Object_214_)
                            var.get(u'seen').put(var.get(u'type').get(u'name'), Js(True))
                    finally:
                            var.put(u'i', Js(2.0), u'+')
        PyJs_computeWrapping_212_._set_name(u'computeWrapping')
        var.get(u'ContentMatch').get(u'prototype').put(u'computeWrapping', PyJs_computeWrapping_212_)
        @Js
        ...
        var.get(u'prototypeAccessors$5').get(u'edgeCount').put(u'get', PyJs_anonymous_215_)
        @Js
        def PyJs_edge_216_(n, this, arguments, var=var):
            var = Scope({u'this':this, u'edge':PyJs_edge_216_, u'arguments':arguments, u'n':n}, var)
            ...
            if (var.get(u'i')>var.get(u"this").get(u'next').get(u'length')):
                ...
                raise PyJsTempException
            PyJs_Object_217_ = Js({u'type':var.get(u"this").get(u'next').get(var.get(u'i')),u'next':var.get(u"this").get(u'next').get((var.get(u'i')+Js(1.0)))})
            return PyJs_Object_217_
        PyJs_edge_216_._set_name(u'edge')
        var.get(u'ContentMatch').get(u'prototype').put(u'edge', PyJs_edge_216_)
        @Js
        def PyJs_toString_218_(this, arguments, var=var):
            var = Scope({u'this':this, u'toString':PyJs_toString_218_, u'arguments':arguments}, var)
            ...
            @Js
            def PyJs_anonymous_219_(m, i, this, arguments, var=var):
            ...
            return var.get(u'seen').callprop(u'map', PyJs_anonymous_219_).callprop(u'join', Js(u'\n'))
        PyJs_toString_218_._set_name(u'toString')
        var.get(u'ContentMatch').get(u'prototype').put(u'toString', PyJs_toString_218_)
        ...
        @Js
        def PyJs_TokenStream_220_(string, nodeTypes, this, arguments, var=var):
            var = Scope({u'this':this, u'TokenStream':PyJs_TokenStream_220_, u'string':string, u'nodeTypes':nodeTypes, u'arguments':arguments}, var)
        ...
        PyJs_TokenStream_220_._set_name(u'TokenStream')
        var.put(u'TokenStream', PyJs_TokenStream_220_)
        PyJs_Object_222_ = Js({})
        PyJs_Object_221_ = Js({u'next':PyJs_Object_222_})
        var.put(u'prototypeAccessors$1$3', PyJs_Object_221_)
        @Js
        def PyJs_anonymous_223_(this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments}, var)
            var.registers([])
            return var.get(u"this").get(u'tokens').get(var.get(u"this").get(u'pos'))
        PyJs_anonymous_223_._set_name(u'anonymous')
        var.get(u'prototypeAccessors$1$3').get(u'next').put(u'get', PyJs_anonymous_223_)
        @Js
        def PyJs_eat_224_(tok, this, arguments, var=var):
            var = Scope({u'this':this, u'tok':tok, u'arguments':arguments, u'eat':PyJs_eat_224_}, var)
            var.registers([u'tok'])
        ...
        PyJs_eat_224_._set_name(u'eat')
        var.get(u'TokenStream').get(u'prototype').put(u'eat', PyJs_eat_224_)
        @Js
        def PyJs_err_225_(str, this, arguments, var=var):
            var = Scope({u'this':this, u'err':PyJs_err_225_, u'arguments':arguments, u'str':str}, var)
            var.registers([u'str'])
            ...
            raise PyJsTempException
        PyJs_err_225_._set_name(u'err')
        var.get(u'TokenStream').get(u'prototype').put(u'err', PyJs_err_225_)
        ...
        pass
        @Js
        def PyJs_NodeType_241_(name, schema, spec, this, arguments, var=var):
            var = Scope({u'NodeType':PyJs_NodeType_241_, u'name':name, u'this':this, u'arguments':arguments, u'spec':spec, u'schema':schema}, var)
        ...
        PyJs_NodeType_241_._set_name(u'NodeType')
        var.put(u'NodeType', PyJs_NodeType_241_)
        PyJs_Object_243_ = Js({})
        PyJs_Object_244_ = Js({})
        PyJs_Object_245_ = Js({})
        PyJs_Object_246_ = Js({})
        PyJs_Object_242_ = Js({u'isInline':PyJs_Object_243_,u'isTextblock':PyJs_Object_244_,u'isLeaf':PyJs_Object_245_,u'isAtom':PyJs_Object_246_})
        var.put(u'prototypeAccessors$4', PyJs_Object_242_)
        @Js
        ...
        var.get(u'prototypeAccessors$4').get(u'isInline').put(u'get', PyJs_anonymous_247_)
        @Js
        ...
        var.get(u'prototypeAccessors$4').get(u'isTextblock').put(u'get', PyJs_anonymous_248_)
        @Js
        ...
        var.get(u'prototypeAccessors$4').get(u'isLeaf').put(u'get', PyJs_anonymous_249_)
        @Js
        ...
        var.get(u'prototypeAccessors$4').get(u'isAtom').put(u'get', PyJs_anonymous_250_)
        @Js
        def PyJs_hasRequiredAttrs_251_(ignore, this, arguments, var=var):
            var = Scope({u'ignore':ignore, u'this':this, u'arguments':arguments, u'hasRequiredAttrs':PyJs_hasRequiredAttrs_251_}, var)
            ...
            for PyJsTemp in var.get(u'this$1').get(u'attrs'):
                ...
                if (var.get(u'this$1').get(u'attrs').get(var.get(u'n')).get(u'isRequired') and (var.get(u'ignore').neg() or var.get(u'ignore').contains(var.get(u'n')).neg())):
                    return Js(True)
            return Js(False)
        PyJs_hasRequiredAttrs_251_._set_name(u'hasRequiredAttrs')
        var.get(u'NodeType').get(u'prototype').put(u'hasRequiredAttrs', PyJs_hasRequiredAttrs_251_)
        @Js
        def PyJs_compatibleContent_252_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'other':other, u'compatibleContent':PyJs_compatibleContent_252_, u'arguments':arguments}, var)
            var.registers([u'other'])
        ...
        PyJs_compatibleContent_252_._set_name(u'compatibleContent')
        var.get(u'NodeType').get(u'prototype').put(u'compatibleContent', PyJs_compatibleContent_252_)
        @Js
        def PyJs_InlineNonPyName_253_(attrs, this, arguments, var=var):
            var = Scope({u'this':this, u'attrs':attrs, u'computeAttrs$1':PyJs_InlineNonPyName_253_, u'arguments':arguments}, var)
        ...
        PyJs_InlineNonPyName_253_._set_name(u'computeAttrs$1')
        var.get(u'NodeType').get(u'prototype').put(u'computeAttrs', PyJs_InlineNonPyName_253_)
        @Js
        def PyJs_create_254_(attrs, content, marks, this, arguments, var=var):
            var = Scope({u'this':this, u'create':PyJs_create_254_, u'content':content, u'attrs':attrs, u'marks':marks, u'arguments':arguments}, var)
        ...
        PyJs_create_254_._set_name(u'create')
        var.get(u'NodeType').get(u'prototype').put(u'create', PyJs_create_254_)
        @Js
        def PyJs_createChecked_255_(attrs, content, marks, this, arguments, var=var):
            var = Scope({u'createChecked':PyJs_createChecked_255_, u'this':this, u'content':content, u'attrs':attrs, u'marks':marks, u'arguments':arguments}, var)
            var.registers([u'content', u'attrs', u'marks'])
        ...
        PyJs_createChecked_255_._set_name(u'createChecked')
        var.get(u'NodeType').get(u'prototype').put(u'createChecked', PyJs_createChecked_255_)
        @Js
        def PyJs_createAndFill_256_(attrs, content, marks, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'content':content, u'createAndFill':PyJs_createAndFill_256_, u'marks':marks, u'attrs':attrs}, var)
        ...
        PyJs_createAndFill_256_._set_name(u'createAndFill')
        var.get(u'NodeType').get(u'prototype').put(u'createAndFill', PyJs_createAndFill_256_)
        @Js
        def PyJs_validContent_257_(content, this, arguments, var=var):
            var = Scope({u'content':content, u'this':this, u'arguments':arguments, u'validContent':PyJs_validContent_257_}, var)
            ...
            while (var.get(u'i')<var.get(u'content').get(u'childCount')):
                try:
                    if var.get(u'this$1').callprop(u'allowsMarks', var.get(u'content').callprop(u'child', var.get(u'i')).get(u'marks')).neg():
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return Js(True)
        PyJs_validContent_257_._set_name(u'validContent')
        var.get(u'NodeType').get(u'prototype').put(u'validContent', PyJs_validContent_257_)
        @Js
        def PyJs_allowsMarkType_258_(markType, this, arguments, var=var):
            var = Scope({u'this':this, u'markType':markType, u'allowsMarkType':PyJs_allowsMarkType_258_, u'arguments':arguments}, var)
        ...
        PyJs_allowsMarkType_258_._set_name(u'allowsMarkType')
        var.get(u'NodeType').get(u'prototype').put(u'allowsMarkType', PyJs_allowsMarkType_258_)
        @Js
        def PyJs_allowsMarks_259_(marks, this, arguments, var=var):
            var = Scope({u'this':this, u'allowsMarks':PyJs_allowsMarks_259_, u'arguments':arguments, u'marks':marks}, var)
            ...
            while (var.get(u'i')<var.get(u'marks').get(u'length')):
                try:
                    if var.get(u'this$1').callprop(u'allowsMarkType', var.get(u'marks').get(var.get(u'i')).get(u'type')).neg():
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return Js(True)
        PyJs_allowsMarks_259_._set_name(u'allowsMarks')
        var.get(u'NodeType').get(u'prototype').put(u'allowsMarks', PyJs_allowsMarks_259_)
        @Js
        def PyJs_allowedMarks_260_(marks, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'allowedMarks':PyJs_allowedMarks_260_, u'marks':marks}, var)
        ...
        PyJs_allowedMarks_260_._set_name(u'allowedMarks')
        var.get(u'NodeType').get(u'prototype').put(u'allowedMarks', PyJs_allowedMarks_260_)
        @Js
        def PyJs_compile_261_(nodes, schema, this, arguments, var=var):
            var = Scope({u'this':this, u'compile':PyJs_compile_261_, u'nodes':nodes, u'arguments':arguments, u'schema':schema}, var)
            var.registers([u'_', u'nodes', u'result', u'topType', u'schema'])
            var.put(u'result', var.get(u'Object').callprop(u'create', var.get(u"null")))
            @Js
            def PyJs_anonymous_262_(name, spec, this, arguments, var=var):
            ...
            var.get(u'nodes').callprop(u'forEach', PyJs_anonymous_262_)
            ...
            for PyJsTemp in var.get(u'result').get(u'text').get(u'attrs'):
                ...
                raise PyJsTempException
            return var.get(u'result')
        PyJs_compile_261_._set_name(u'compile')
        var.get(u'NodeType').put(u'compile', PyJs_compile_261_)
        var.get(u'Object').callprop(u'defineProperties', var.get(u'NodeType').get(u'prototype'), var.get(u'prototypeAccessors$4'))
        @Js
        def PyJs_Attribute_263_(options, this, arguments, var=var):
            var = Scope({u'this':this, u'Attribute':PyJs_Attribute_263_, u'options':options, u'arguments':arguments}, var)
            var.registers([u'options'])
        ...
        PyJs_Attribute_263_._set_name(u'Attribute')
        var.put(u'Attribute', PyJs_Attribute_263_)
        PyJs_Object_265_ = Js({})
        PyJs_Object_264_ = Js({u'isRequired':PyJs_Object_265_})
        var.put(u'prototypeAccessors$1$2', PyJs_Object_264_)
        @Js
        ...
        var.get(u'prototypeAccessors$1$2').get(u'isRequired').put(u'get', PyJs_anonymous_266_)
        var.get(u'Object').callprop(u'defineProperties', var.get(u'Attribute').get(u'prototype'), var.get(u'prototypeAccessors$1$2'))
        @Js
        def PyJs_MarkType_267_(name, rank, schema, spec, this, arguments, var=var):
            var = Scope({u'name':name, u'this':this, u'arguments':arguments, u'MarkType':PyJs_MarkType_267_, u'spec':spec, u'rank':rank, u'schema':schema}, var)
        ...
        PyJs_MarkType_267_._set_name(u'MarkType')
        var.put(u'MarkType', PyJs_MarkType_267_)
        @Js
        def PyJs_create_268_(attrs, this, arguments, var=var):
            var = Scope({u'this':this, u'create':PyJs_create_268_, u'attrs':attrs, u'arguments':arguments}, var)
            var.registers([u'attrs'])
        ...
        PyJs_create_268_._set_name(u'create')
        var.get(u'MarkType').get(u'prototype').put(u'create', PyJs_create_268_)
        @Js
        def PyJs_compile_269_(marks, schema, this, arguments, var=var):
            var = Scope({u'this':this, u'compile':PyJs_compile_269_, u'schema':schema, u'arguments':arguments, u'marks':marks}, var)
            var.registers([u'schema', u'result', u'rank', u'marks'])
            var.put(u'result', var.get(u'Object').callprop(u'create', var.get(u"null")))
            var.put(u'rank', Js(0.0))
            @Js
            def PyJs_anonymous_270_(name, spec, this, arguments, var=var):
                var = Scope({u'this':this, u'arguments':arguments, u'name':name, u'spec':spec}, var)
                var.registers([u'name', u'spec'])
            ...
            var.get(u'marks').callprop(u'forEach', PyJs_anonymous_270_)
            return var.get(u'result')
        PyJs_compile_269_._set_name(u'compile')
        var.get(u'MarkType').put(u'compile', PyJs_compile_269_)
        @Js
        def PyJs_removeFromSet_271_(set, this, arguments, var=var):
            var = Scope({u'this':this, u'set':set, u'arguments':arguments, u'removeFromSet':PyJs_removeFromSet_271_}, var)
            var.registers([u'i', u'set', u'this$1'])
            var.put(u'this$1', var.get(u"this"))
            #for JS loop
            var.put(u'i', Js(0.0))
            while (var.get(u'i')<var.get(u'set').get(u'length')):
                try:
                    if (var.get(u'set').get(var.get(u'i')).get(u'type')==var.get(u'this$1')):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return var.get(u'set')
        PyJs_removeFromSet_271_._set_name(u'removeFromSet')
        var.get(u'MarkType').get(u'prototype').put(u'removeFromSet', PyJs_removeFromSet_271_)
        @Js
        def PyJs_isInSet_272_(set, this, arguments, var=var):
            var = Scope({u'this':this, u'isInSet':PyJs_isInSet_272_, u'set':set, u'arguments':arguments}, var)
            var.registers([u'i', u'set', u'this$1'])
            var.put(u'this$1', var.get(u"this"))
            #for JS loop
            var.put(u'i', Js(0.0))
            while (var.get(u'i')<var.get(u'set').get(u'length')):
                try:
                    if (var.get(u'set').get(var.get(u'i')).get(u'type')==var.get(u'this$1')):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_isInSet_272_._set_name(u'isInSet')
        var.get(u'MarkType').get(u'prototype').put(u'isInSet', PyJs_isInSet_272_)
        @Js
        def PyJs_excludes_273_(other, this, arguments, var=var):
            var = Scope({u'this':this, u'excludes':PyJs_excludes_273_, u'other':other, u'arguments':arguments}, var)
            var.registers([u'other'])
            return (var.get(u"this").get(u'excluded').callprop(u'indexOf', var.get(u'other'))>(-Js(1.0)))
        PyJs_excludes_273_._set_name(u'excludes')
        var.get(u'MarkType').get(u'prototype').put(u'excludes', PyJs_excludes_273_)
        @Js
        def PyJs_Schema_274_(spec, this, arguments, var=var):
            var = Scope({u'this':this, u'Schema':PyJs_Schema_274_, u'spec':spec, u'arguments':arguments}, var)
            ...
            var.put(u'this$1', var.get(u"this"))
            PyJs_Object_275_ = Js({})
            var.get(u"this").put(u'spec', PyJs_Object_275_)
        ...
        PyJs_Schema_274_._set_name(u'Schema')
        var.put(u'Schema', PyJs_Schema_274_)
        @Js
        def PyJs_node_276_(type, attrs, content, marks, this, arguments, var=var):
            var = Scope({u'content':content, u'node':PyJs_node_276_, u'attrs':attrs, u'marks':marks, u'this':this, u'type':type, u'arguments':arguments}, var)
            var.registers([u'content', u'type', u'attrs', u'marks'])
        ...
        PyJs_node_276_._set_name(u'node')
        var.get(u'Schema').get(u'prototype').put(u'node', PyJs_node_276_)
        @Js
        def PyJs_text_277_(PyJsArg_746578742431_, marks, this, arguments, var=var):
            var = Scope({u'this':this, u'text':PyJs_text_277_, u'arguments':arguments, u'text$1':PyJsArg_746578742431_, u'marks':marks}, var)
        ...
        PyJs_text_277_._set_name(u'text')
        var.get(u'Schema').get(u'prototype').put(u'text', PyJs_text_277_)
        @Js
        def PyJs_mark_278_(type, attrs, this, arguments, var=var):
            var = Scope({u'this':this, u'mark':PyJs_mark_278_, u'type':type, u'attrs':attrs, u'arguments':arguments}, var)
            var.registers([u'type', u'attrs'])
            if (var.get(u'type',throw=False).typeof()==Js(u'string')):
                var.put(u'type', var.get(u"this").get(u'marks').get(var.get(u'type')))
            return var.get(u'type').callprop(u'create', var.get(u'attrs'))
        PyJs_mark_278_._set_name(u'mark')
        var.get(u'Schema').get(u'prototype').put(u'mark', PyJs_mark_278_)
        @Js
        def PyJs_nodeFromJSON_279_(json, this, arguments, var=var):
            var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'nodeFromJSON':PyJs_nodeFromJSON_279_}, var)
            var.registers([u'json'])
            return var.get(u'Node').callprop(u'fromJSON', var.get(u"this"), var.get(u'json'))
        PyJs_nodeFromJSON_279_._set_name(u'nodeFromJSON')
        var.get(u'Schema').get(u'prototype').put(u'nodeFromJSON', PyJs_nodeFromJSON_279_)
        @Js
        def PyJs_markFromJSON_280_(json, this, arguments, var=var):
            var = Scope({u'this':this, u'markFromJSON':PyJs_markFromJSON_280_, u'json':json, u'arguments':arguments}, var)
            var.registers([u'json'])
            return var.get(u'Mark').callprop(u'fromJSON', var.get(u"this"), var.get(u'json'))
        PyJs_markFromJSON_280_._set_name(u'markFromJSON')
        var.get(u'Schema').get(u'prototype').put(u'markFromJSON', PyJs_markFromJSON_280_)
        @Js
        def PyJs_nodeType_281_(name, this, arguments, var=var):
            var = Scope({u'this':this, u'nodeType':PyJs_nodeType_281_, u'name':name, u'arguments':arguments}, var)
            ...
            if var.get(u'found').neg():
                ...
                raise PyJsTempException
            return var.get(u'found')
        PyJs_nodeType_281_._set_name(u'nodeType')
        var.get(u'Schema').get(u'prototype').put(u'nodeType', PyJs_nodeType_281_)
        pass
        @Js
        def PyJs_DOMParser_282_(schema, rules, this, arguments, var=var):
            var = Scope({u'rules':rules, u'this':this, u'DOMParser':PyJs_DOMParser_282_, u'arguments':arguments, u'schema':schema}, var)
            ...
            @Js
            def PyJs_anonymous_283_(rule, this, arguments, var=var):
            ...
            var.get(u'rules').callprop(u'forEach', PyJs_anonymous_283_)
        PyJs_DOMParser_282_._set_name(u'DOMParser')
        var.put(u'DOMParser', PyJs_DOMParser_282_)
        @Js
        def PyJs_parse_284_(dom, options, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'parse':PyJs_parse_284_, u'options':options, u'dom':dom}, var)
            var.registers([u'options', u'context', u'dom'])
            if PyJsStrictEq(var.get(u'options'),PyJsComma(Js(0.0), Js(None))):
                PyJs_Object_285_ = Js({})
                var.put(u'options', PyJs_Object_285_)
        ...
        PyJs_parse_284_._set_name(u'parse')
        var.get(u'DOMParser').get(u'prototype').put(u'parse', PyJs_parse_284_)
        @Js
        def PyJs_parseSlice_286_(dom, options, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'parseSlice':PyJs_parseSlice_286_, u'options':options, u'dom':dom}, var)
            var.registers([u'options', u'context', u'dom'])
            if PyJsStrictEq(var.get(u'options'),PyJsComma(Js(0.0), Js(None))):
                PyJs_Object_287_ = Js({})
                var.put(u'options', PyJs_Object_287_)
        ...
        PyJs_parseSlice_286_._set_name(u'parseSlice')
        var.get(u'DOMParser').get(u'prototype').put(u'parseSlice', PyJs_parseSlice_286_)
        @Js
        def PyJs_matchTag_288_(dom, context, this, arguments, var=var):
            var = Scope({u'this':this, u'matchTag':PyJs_matchTag_288_, u'arguments':arguments, u'context':context, u'dom':dom}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'tags').get(u'length')):
                try:
                    ...
                    if ((var.get(u'matches')(var.get(u'dom'), var.get(u'rule').get(u'tag')) and (PyJsStrictEq(var.get(u'rule').get(u'namespace'),var.get(u'undefined')) or (var.get(u'dom').get(u'namespaceURI')==var.get(u'rule').get(u'namespace')))) and (var.get(u'rule').get(u'context').neg() or var.get(u'context').callprop(u'matchesContext', var.get(u'rule').get(u'context')))):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_matchTag_288_._set_name(u'matchTag')
        var.get(u'DOMParser').get(u'prototype').put(u'matchTag', PyJs_matchTag_288_)
        @Js
        def PyJs_matchStyle_289_(prop, value, context, this, arguments, var=var):
            var = Scope({u'this':this, u'matchStyle':PyJs_matchStyle_289_, u'value':value, u'prop':prop, u'arguments':arguments, u'context':context}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'styles').get(u'length')):
                try:
                    ...
                    return var.get(u'rule')
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_matchStyle_289_._set_name(u'matchStyle')
        var.get(u'DOMParser').get(u'prototype').put(u'matchStyle', PyJs_matchStyle_289_)
        @Js
        def PyJs_schemaRules_291_(schema, this, arguments, var=var):
            var = Scope({u'this':this, u'schemaRules':PyJs_schemaRules_291_, u'arguments':arguments, u'schema':schema}, var)
            ...
            pass
            @Js
            def PyJs_anonymous_292_(name, this, arguments, var=var):
                ...
                if var.get(u'rules'):
                    @Js
                    def PyJs_anonymous_293_(rule, this, arguments, var=var):
                        var = Scope({u'this':this, u'arguments':arguments, u'rule':rule}, var)
                        var.registers([u'rule'])
                    ...
                    var.get(u'rules').callprop(u'forEach', PyJs_anonymous_293_)
            PyJs_anonymous_292_._set_name(u'anonymous')
            var.put(u'loop', PyJs_anonymous_292_)
            for PyJsTemp in var.get(u'schema').get(u'marks'):
                var.put(u'name', PyJsTemp)
                var.get(u'loop')(var.get(u'name'))
            @Js
            def PyJs_anonymous_294_(name, this, arguments, var=var):
                var = Scope({u'this':this, u'name':name, u'arguments':arguments}, var)
                ...
                if var.get(u'rules$1'):
                    @Js
                    def PyJs_anonymous_295_(rule, this, arguments, var=var):
                        var = Scope({u'this':this, u'arguments':arguments, u'rule':rule}, var)
                        var.registers([u'rule'])
                        var.get(u'insert')(var.put(u'rule', var.get(u'copy')(var.get(u'rule'))))
                        var.get(u'rule').put(u'node', var.get(u'name$1'))
                    PyJs_anonymous_295_._set_name(u'anonymous')
                    var.get(u'rules$1').callprop(u'forEach', PyJs_anonymous_295_)
            PyJs_anonymous_294_._set_name(u'anonymous')
            var.put(u'loop$1', PyJs_anonymous_294_)
            for PyJsTemp in var.get(u'schema').get(u'nodes'):
                var.put(u'name$1', PyJsTemp)
                var.get(u'loop$1')(var.get(u'name'))
            return var.get(u'result')
        PyJs_schemaRules_291_._set_name(u'schemaRules')
        var.get(u'DOMParser').put(u'schemaRules', PyJs_schemaRules_291_)
        @Js
        def PyJs_fromSchema_296_(schema, this, arguments, var=var):
            var = Scope({u'this':this, u'fromSchema':PyJs_fromSchema_296_, u'arguments':arguments, u'schema':schema}, var)
        ...
        PyJs_fromSchema_296_._set_name(u'fromSchema')
        var.get(u'DOMParser').put(u'fromSchema', PyJs_fromSchema_296_)
        PyJs_Object_297_ = Js({u'address':Js(True),u'article':Js(True),u'aside':Js(True),u'blockquote':Js(True),u'canvas':Js(True),u'dd':Js(True),u'div':Js(True),u'dl':Js(True),u'fieldset':Js(True),u'figcaption':Js(True),u'figure':Js(True),u'footer':Js(True),u'form':Js(True),u'h1':Js(True),u'h2':Js(True),u'h3':Js(True),u'h4':Js(True),u'h5':Js(True),u'h6':Js(True),u'header':Js(True),u'hgroup':Js(True),u'hr':Js(True),u'li':Js(True),u'noscript':Js(True),u'ol':Js(True),u'output':Js(True),u'p':Js(True),u'pre':Js(True),u'section':Js(True),u'table':Js(True),u'tfoot':Js(True),u'ul':Js(True)})
        var.put(u'blockTags', PyJs_Object_297_)
        PyJs_Object_298_ = Js({u'head':Js(True),u'noscript':Js(True),u'object':Js(True),u'script':Js(True),u'style':Js(True),u'title':Js(True)})
        var.put(u'ignoreTags', PyJs_Object_298_)
        PyJs_Object_299_ = Js({u'ol':Js(True),u'ul':Js(True)})
        var.put(u'listTags', PyJs_Object_299_)
        var.put(u'OPT_PRESERVE_WS', Js(1.0))
        var.put(u'OPT_PRESERVE_WS_FULL', Js(2.0))
        var.put(u'OPT_OPEN_LEFT', Js(4.0))
        pass
        @Js
        def PyJs_NodeContext_300_(type, attrs, marks, solid, match, options, this, arguments, var=var):
            var = Scope({u'solid':solid, u'NodeContext':PyJs_NodeContext_300_, u'this':this, u'attrs':attrs, u'marks':marks, u'type':type, u'options':options, u'match':match, u'arguments':arguments}, var)
        ...
        PyJs_NodeContext_300_._set_name(u'NodeContext')
        var.put(u'NodeContext', PyJs_NodeContext_300_)
        @Js
        def PyJs_findWrapping_301_(node, this, arguments, var=var):
            var = Scope({u'node':node, u'this':this, u'arguments':arguments, u'findWrapping':PyJs_findWrapping_301_}, var)
        ...
        PyJs_findWrapping_301_._set_name(u'findWrapping')
        var.get(u'NodeContext').get(u'prototype').put(u'findWrapping', PyJs_findWrapping_301_)
        @Js
        def PyJs_finish_302_(openEnd, this, arguments, var=var):
            var = Scope({u'openEnd':openEnd, u'this':this, u'finish':PyJs_finish_302_, u'arguments':arguments}, var)
        ...
        PyJs_finish_302_._set_name(u'finish')
        var.get(u'NodeContext').get(u'prototype').put(u'finish', PyJs_finish_302_)
        @Js
        def PyJs_ParseContext_303_(parser, options, open, this, arguments, var=var):
            var = Scope({u'this':this, u'parser':parser, u'arguments':arguments, u'open':open, u'options':options, u'ParseContext':PyJs_ParseContext_303_}, var)
        ...
        PyJs_ParseContext_303_._set_name(u'ParseContext')
        var.put(u'ParseContext', PyJs_ParseContext_303_)
        PyJs_Object_305_ = Js({})
        PyJs_Object_306_ = Js({})
        PyJs_Object_304_ = Js({u'top':PyJs_Object_305_,u'currentPos':PyJs_Object_306_})
        var.put(u'prototypeAccessors$6', PyJs_Object_304_)
        @Js
        ...
        var.get(u'prototypeAccessors$6').get(u'top').put(u'get', PyJs_anonymous_307_)
        @Js
        def PyJs_addDOM_308_(dom, this, arguments, var=var):
            var = Scope({u'this':this, u'addDOM':PyJs_addDOM_308_, u'arguments':arguments, u'dom':dom}, var)
                        ...
                        while (var.get(u'i$1')<var.get(u'marks').get(u'length')):
                            try:
                                var.get(u'this$1').callprop(u'removePendingMark', var.get(u'marks').get(var.get(u'i$1')))
                                    ...
                                    (var.put(u'i$1',Js(var.get(u'i$1').to_number())+Js(1))-Js(1))
        PyJs_addDOM_308_._set_name(u'addDOM')
        var.get(u'ParseContext').get(u'prototype').put(u'addDOM', PyJs_addDOM_308_)
        @Js
        def PyJs_addTextNode_309_(dom, this, arguments, var=var):
            var = Scope({u'this':this, u'addTextNode':PyJs_addTextNode_309_, u'arguments':arguments, u'dom':dom}, var)
        ...
        PyJs_addTextNode_309_._set_name(u'addTextNode')
        var.get(u'ParseContext').get(u'prototype').put(u'addTextNode', PyJs_addTextNode_309_)
        @Js
        def PyJs_addElement_310_(dom, this, arguments, var=var):
            var = Scope({u'this':this, u'addElement':PyJs_addElement_310_, u'arguments':arguments, u'dom':dom}, var)
        ...
        PyJs_addElement_310_._set_name(u'addElement')
        var.get(u'ParseContext').get(u'prototype').put(u'addElement', PyJs_addElement_310_)
        @Js
        def PyJs_readStyles_311_(styles, this, arguments, var=var):
            var = Scope({u'styles':styles, u'this':this, u'readStyles':PyJs_readStyles_311_, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u'styles').get(u'length')):
                try:
                    ...
                    var.put(u'marks', var.get(u'this$1').get(u'parser').get(u'schema').get(u'marks').get(var.get(u'rule').get(u'mark')).callprop(u'create', var.get(u'rule').get(u'attrs')).callprop(u'addToSet', var.get(u'marks')))
                        ...
                        var.put(u'i', Js(2.0), u'+')
            return var.get(u'marks')
        PyJs_readStyles_311_._set_name(u'readStyles')
        var.get(u'ParseContext').get(u'prototype').put(u'readStyles', PyJs_readStyles_311_)
        @Js
        def PyJs_addElementByRule_312_(dom, rule, this, arguments, var=var):
            var = Scope({u'this':this, u'addElementByRule':PyJs_addElementByRule_312_, u'arguments':arguments, u'rule':rule, u'dom':dom}, var)
            ...
            if (var.get(u'nodeType') and var.get(u'nodeType').get(u'isLeaf')):
                ...
                if var.get(u'rule').get(u'getContent'):
                    var.get(u"this").callprop(u'findInside', var.get(u'dom'))
                    @Js
                    def PyJs_anonymous_313_(node, this, arguments, var=var):
                        var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
                        var.registers([u'node'])
                        return var.get(u'this$1').callprop(u'insertNode', var.get(u'node'))
                    PyJs_anonymous_313_._set_name(u'anonymous')
                    var.get(u'rule').callprop(u'getContent', var.get(u'dom'), var.get(u"this").get(u'parser').get(u'schema')).callprop(u'forEach', PyJs_anonymous_313_)
                else:
            ...
            return Js(True)
        PyJs_addElementByRule_312_._set_name(u'addElementByRule')
        var.get(u'ParseContext').get(u'prototype').put(u'addElementByRule', PyJs_addElementByRule_312_)
        @Js
        def PyJs_addAll_314_(parent, sync, startIndex, endIndex, this, arguments, var=var):
            var = Scope({u'endIndex':endIndex, u'startIndex':startIndex, u'addAll':PyJs_addAll_314_, u'arguments':arguments, u'parent':parent, u'this':this, u'sync':sync}, var)
        ...
        PyJs_addAll_314_._set_name(u'addAll')
        var.get(u'ParseContext').get(u'prototype').put(u'addAll', PyJs_addAll_314_)
        @Js
        def PyJs_findPlace_315_(node, this, arguments, var=var):
            var = Scope({u'node':node, u'this':this, u'arguments':arguments, u'findPlace':PyJs_findPlace_315_}, var)
            ...
            while (var.get(u'i')<var.get(u'route').get(u'length')):
                try:
                    var.get(u'this$1').callprop(u'enterInner', var.get(u'route').get(var.get(u'i')), var.get(u"null"), Js(False))
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return Js(True)
        PyJs_findPlace_315_._set_name(u'findPlace')
        var.get(u'ParseContext').get(u'prototype').put(u'findPlace', PyJs_findPlace_315_)
        @Js
        def PyJs_insertNode_316_(node, this, arguments, var=var):
            var = Scope({u'node':node, u'this':this, u'arguments':arguments, u'insertNode':PyJs_insertNode_316_}, var)
        ...
        PyJs_insertNode_316_._set_name(u'insertNode')
        var.get(u'ParseContext').get(u'prototype').put(u'insertNode', PyJs_insertNode_316_)
        @Js
        def PyJs_applyPendingMarks_317_(top, this, arguments, var=var):
            var = Scope({u'this':this, u'applyPendingMarks':PyJs_applyPendingMarks_317_, u'top':top, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'pendingMarks').get(u'length')):
                try:
                    ...
                    if ((var.get(u'top').get(u'type').neg() or var.get(u'top').get(u'type').callprop(u'allowsMarkType', var.get(u'mark').get(u'type'))) and var.get(u'mark').get(u'type').callprop(u'isInSet', var.get(u'top').get(u'activeMarks')).neg()):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_applyPendingMarks_317_._set_name(u'applyPendingMarks')
        var.get(u'ParseContext').get(u'prototype').put(u'applyPendingMarks', PyJs_applyPendingMarks_317_)
        @Js
        def PyJs_enter_318_(type, attrs, preserveWS, this, arguments, var=var):
            var = Scope({u'this':this, u'preserveWS':preserveWS, u'attrs':attrs, u'enter':PyJs_enter_318_, u'type':type, u'arguments':arguments}, var)
            ...
            return var.get(u'ok')
        PyJs_enter_318_._set_name(u'enter')
        var.get(u'ParseContext').get(u'prototype').put(u'enter', PyJs_enter_318_)
        @Js
        def PyJs_enterInner_319_(type, attrs, solid, preserveWS, this, arguments, var=var):
            var = Scope({u'this':this, u'enterInner':PyJs_enterInner_319_, u'preserveWS':preserveWS, u'attrs':attrs, u'solid':solid, u'type':type, u'arguments':arguments}, var)
            ...
            (var.get(u"this").put(u'open',Js(var.get(u"this").get(u'open').to_number())+Js(1))-Js(1))
        PyJs_enterInner_319_._set_name(u'enterInner')
        var.get(u'ParseContext').get(u'prototype').put(u'enterInner', PyJs_enterInner_319_)
        @Js
        def PyJs_closeExtra_320_(openEnd, this, arguments, var=var):
            var = Scope({u'openEnd':openEnd, u'this':this, u'closeExtra':PyJs_closeExtra_320_, u'arguments':arguments}, var)
        ...
        PyJs_closeExtra_320_._set_name(u'closeExtra')
        var.get(u'ParseContext').get(u'prototype').put(u'closeExtra', PyJs_closeExtra_320_)
        @Js
        def PyJs_finish_321_(this, arguments, var=var):
            var = Scope({u'this':this, u'finish':PyJs_finish_321_, u'arguments':arguments}, var)
            var.registers([])
            var.get(u"this").put(u'open', Js(0.0))
        ...
        PyJs_finish_321_._set_name(u'finish')
        var.get(u'ParseContext').get(u'prototype').put(u'finish', PyJs_finish_321_)
        @Js
        def PyJs_sync_322_(to, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'arguments':arguments, u'sync':PyJs_sync_322_}, var)
            ...
            while (var.get(u'i')>=Js(0.0)):
                try:
                    if (var.get(u'this$1').get(u'nodes').get(var.get(u'i'))==var.get(u'to')):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())-Js(1))+Js(1))
        PyJs_sync_322_._set_name(u'sync')
        var.get(u'ParseContext').get(u'prototype').put(u'sync', PyJs_sync_322_)
        @Js
        def PyJs_addPendingMark_323_(mark, this, arguments, var=var):
            var = Scope({u'this':this, u'addPendingMark':PyJs_addPendingMark_323_, u'arguments':arguments, u'mark':mark}, var)
            var.registers([u'mark'])
            var.get(u"this").get(u'pendingMarks').callprop(u'push', var.get(u'mark'))
        PyJs_addPendingMark_323_._set_name(u'addPendingMark')
        var.get(u'ParseContext').get(u'prototype').put(u'addPendingMark', PyJs_addPendingMark_323_)
        @Js
        def PyJs_removePendingMark_324_(mark, this, arguments, var=var):
            var = Scope({u'this':this, u'removePendingMark':PyJs_removePendingMark_324_, u'arguments':arguments, u'mark':mark}, var)
        ...
        PyJs_removePendingMark_324_._set_name(u'removePendingMark')
        var.get(u'ParseContext').get(u'prototype').put(u'removePendingMark', PyJs_removePendingMark_324_)
        @Js
        ...
        var.get(u'prototypeAccessors$6').get(u'currentPos').put(u'get', PyJs_anonymous_325_)
        @Js
        def PyJs_findAtPoint_326_(parent, offset, this, arguments, var=var):
            var = Scope({u'this':this, u'findAtPoint':PyJs_findAtPoint_326_, u'arguments':arguments, u'parent':parent, u'offset':offset}, var)
                ...
                while (var.get(u'i')<var.get(u"this").get(u'find').get(u'length')):
                    try:
                        if ((var.get(u'this$1').get(u'find').get(var.get(u'i')).get(u'node')==var.get(u'parent')) and (var.get(u'this$1').get(u'find').get(var.get(u'i')).get(u'offset')==var.get(u'offset'))):
                            ...
                            (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_findAtPoint_326_._set_name(u'findAtPoint')
        var.get(u'ParseContext').get(u'prototype').put(u'findAtPoint', PyJs_findAtPoint_326_)
        @Js
        def PyJs_findInside_327_(parent, this, arguments, var=var):
            var = Scope({u'this':this, u'findInside':PyJs_findInside_327_, u'arguments':arguments, u'parent':parent}, var)
                ...
                while (var.get(u'i')<var.get(u"this").get(u'find').get(u'length')):
                    try:
                        if (((var.get(u'this$1').get(u'find').get(var.get(u'i')).get(u'pos')==var.get(u"null")) and (var.get(u'parent').get(u'nodeType')==Js(1.0))) and var.get(u'parent').callprop(u'contains', var.get(u'this$1').get(u'find').get(var.get(u'i')).get(u'node'))):
                            ...
                            (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_findInside_327_._set_name(u'findInside')
        var.get(u'ParseContext').get(u'prototype').put(u'findInside', PyJs_findInside_327_)
        @Js
        def PyJs_findAround_328_(parent, content, before, this, arguments, var=var):
            var = Scope({u'parent':parent, u'this':this, u'content':content, u'arguments':arguments, u'findAround':PyJs_findAround_328_, u'before':before}, var)
                ...
                while (var.get(u'i')<var.get(u"this").get(u'find').get(u'length')):
                    try:
                        if (((var.get(u'this$1').get(u'find').get(var.get(u'i')).get(u'pos')==var.get(u"null")) and (var.get(u'parent').get(u'nodeType')==Js(1.0))) and var.get(u'parent').callprop(u'contains', var.get(u'this$1').get(u'find').get(var.get(u'i')).get(u'node'))):
                            ...
                            (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_findAround_328_._set_name(u'findAround')
        var.get(u'ParseContext').get(u'prototype').put(u'findAround', PyJs_findAround_328_)
        @Js
        def PyJs_findInText_329_(textNode, this, arguments, var=var):
            var = Scope({u'this':this, u'findInText':PyJs_findInText_329_, u'textNode':textNode, u'arguments':arguments}, var)
                ...
                while (var.get(u'i')<var.get(u"this").get(u'find').get(u'length')):
                    try:
                        if (var.get(u'this$1').get(u'find').get(var.get(u'i')).get(u'node')==var.get(u'textNode')):
                            ...
                            (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_findInText_329_._set_name(u'findInText')
        var.get(u'ParseContext').get(u'prototype').put(u'findInText', PyJs_findInText_329_)
        @Js
        def PyJs_matchesContext_330_(context, this, arguments, var=var):
            var = Scope({u'this':this, u'matchesContext':PyJs_matchesContext_330_, u'arguments':arguments, u'context':context}, var)
            ...
            @Js
            def PyJs_anonymous_331_(i, depth, this, arguments, var=var):
            ...
            var.put(u'match', PyJs_anonymous_331_)
            return var.get(u'match')((var.get(u'parts').get(u'length')-Js(1.0)), var.get(u"this").get(u'open'))
        PyJs_matchesContext_330_._set_name(u'matchesContext')
        var.get(u'ParseContext').get(u'prototype').put(u'matchesContext', PyJs_matchesContext_330_)
        @Js
        def PyJs_textblockFromContext_332_(this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'textblockFromContext':PyJs_textblockFromContext_332_}, var)
            ...
            for PyJsTemp in var.get(u'this$1').get(u'parser').get(u'schema').get(u'nodes'):
                ...
                if (var.get(u'type').get(u'isTextblock') and var.get(u'type').get(u'defaultAttrs')):
                    return var.get(u'type')
        PyJs_textblockFromContext_332_._set_name(u'textblockFromContext')
        var.get(u'ParseContext').get(u'prototype').put(u'textblockFromContext', PyJs_textblockFromContext_332_)
        ...
        pass
        @Js
        def PyJs_DOMSerializer_334_(nodes, marks, this, arguments, var=var):
            var = Scope({u'this':this, u'nodes':nodes, u'DOMSerializer':PyJs_DOMSerializer_334_, u'arguments':arguments, u'marks':marks}, var)
            var.registers([u'nodes', u'marks'])
            PyJs_Object_335_ = Js({})
            var.get(u"this").put(u'nodes', (var.get(u'nodes') or PyJs_Object_335_))
            PyJs_Object_336_ = Js({})
            var.get(u"this").put(u'marks', (var.get(u'marks') or PyJs_Object_336_))
        PyJs_DOMSerializer_334_._set_name(u'DOMSerializer')
        var.put(u'DOMSerializer', PyJs_DOMSerializer_334_)
        @Js
        def PyJs_serializeFragment_337_(fragment, options, target, this, arguments, var=var):
            var = Scope({u'serializeFragment':PyJs_serializeFragment_337_, u'target':target, u'fragment':fragment, u'this':this, u'arguments':arguments, u'options':options}, var)
            var.registers([u'target', u'fragment', u'top', u'this$1', u'active', u'options'])
            var.put(u'this$1', var.get(u"this"))
            if PyJsStrictEq(var.get(u'options'),PyJsComma(Js(0.0), Js(None))):
                PyJs_Object_338_ = Js({})
                var.put(u'options', PyJs_Object_338_)
            ...
            @Js
            def PyJs_anonymous_339_(node, this, arguments, var=var):
                var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
            ...
            var.get(u'fragment').callprop(u'forEach', PyJs_anonymous_339_)
            return var.get(u'target')
        PyJs_serializeFragment_337_._set_name(u'serializeFragment')
        var.get(u'DOMSerializer').get(u'prototype').put(u'serializeFragment', PyJs_serializeFragment_337_)
        @Js
        def PyJs_serializeNode_340_(node, options, this, arguments, var=var):
            var = Scope({u'node':node, u'this':this, u'serializeNode':PyJs_serializeNode_340_, u'options':options, u'arguments':arguments}, var)
            var.registers([u'node', u'contentDOM', u'ref', u'options', u'dom'])
            if PyJsStrictEq(var.get(u'options'),PyJsComma(Js(0.0), Js(None))):
                PyJs_Object_341_ = Js({})
                var.put(u'options', PyJs_Object_341_)
        ...
        PyJs_serializeNode_340_._set_name(u'serializeNode')
        var.get(u'DOMSerializer').get(u'prototype').put(u'serializeNode', PyJs_serializeNode_340_)
        @Js
        def PyJs_serializeNodeAndMarks_342_(node, options, this, arguments, var=var):
            var = Scope({u'node':node, u'this':this, u'options':options, u'serializeNodeAndMarks':PyJs_serializeNodeAndMarks_342_, u'arguments':arguments}, var)
            var.registers([u'node', u'dom', u'i', u'this$1', u'wrap', u'options'])
            var.put(u'this$1', var.get(u"this"))
            if PyJsStrictEq(var.get(u'options'),PyJsComma(Js(0.0), Js(None))):
                PyJs_Object_343_ = Js({})
                var.put(u'options', PyJs_Object_343_)
            ...
            while (var.get(u'i')>=Js(0.0)):
                try:
                    ...
                    if var.get(u'wrap'):
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())-Js(1))+Js(1))
            return var.get(u'dom')
        PyJs_serializeNodeAndMarks_342_._set_name(u'serializeNodeAndMarks')
        var.get(u'DOMSerializer').get(u'prototype').put(u'serializeNodeAndMarks', PyJs_serializeNodeAndMarks_342_)
        @Js
        def PyJs_serializeMark_344_(mark, inline, options, this, arguments, var=var):
            var = Scope({u'this':this, u'mark':mark, u'serializeMark':PyJs_serializeMark_344_, u'arguments':arguments, u'inline':inline, u'options':options}, var)
            var.registers([u'toDOM', u'inline', u'options', u'mark'])
            if PyJsStrictEq(var.get(u'options'),PyJsComma(Js(0.0), Js(None))):
                PyJs_Object_345_ = Js({})
                var.put(u'options', PyJs_Object_345_)
        ...
        PyJs_serializeMark_344_._set_name(u'serializeMark')
        var.get(u'DOMSerializer').get(u'prototype').put(u'serializeMark', PyJs_serializeMark_344_)
        @Js
        def PyJs_renderSpec_346_(doc, structure, this, arguments, var=var):
            var = Scope({u'this':this, u'doc':doc, u'renderSpec':PyJs_renderSpec_346_, u'arguments':arguments, u'structure':structure}, var)
            ...
            if (var.get(u'structure',throw=False).typeof()==Js(u'string')):
                PyJs_Object_347_ = Js({u'dom':var.get(u'doc').callprop(u'createTextNode', var.get(u'structure'))})
                return PyJs_Object_347_
            if (var.get(u'structure').get(u'nodeType')!=var.get(u"null")):
                PyJs_Object_348_ = Js({u'dom':var.get(u'structure')})
                ...
                try:
                    ...
                    if PyJsStrictEq(var.get(u'child'),Js(0.0)):
                        if ((var.get(u'i')<(var.get(u'structure').get(u'length')-Js(1.0))) or (var.get(u'i')>var.get(u'start'))):
                            ...
                            raise PyJsTempException
                        PyJs_Object_349_ = Js({u'dom':var.get(u'dom'),u'contentDOM':var.get(u'dom')})
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            PyJs_Object_350_ = Js({u'dom':var.get(u'dom'),u'contentDOM':var.get(u'contentDOM')})
            return PyJs_Object_350_
        PyJs_renderSpec_346_._set_name(u'renderSpec')
        var.get(u'DOMSerializer').put(u'renderSpec', PyJs_renderSpec_346_)
        @Js
        def PyJs_fromSchema_351_(schema, this, arguments, var=var):
            var = Scope({u'this':this, u'fromSchema':PyJs_fromSchema_351_, u'arguments':arguments, u'schema':schema}, var)
            var.registers([u'schema'])
        ...
        PyJs_fromSchema_351_._set_name(u'fromSchema')
        var.get(u'DOMSerializer').put(u'fromSchema', PyJs_fromSchema_351_)
        @Js
        def PyJs_nodesFromSchema_352_(schema, this, arguments, var=var):
            var = Scope({u'this':this, u'nodesFromSchema':PyJs_nodesFromSchema_352_, u'arguments':arguments, u'schema':schema}, var)
            var.registers([u'result', u'schema'])
            var.put(u'result', var.get(u'gatherToDOM')(var.get(u'schema').get(u'nodes')))
            if var.get(u'result').get(u'text').neg():
                @Js
                def PyJs_anonymous_353_(node, this, arguments, var=var):
                    var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
                    var.registers([u'node'])
                    return var.get(u'node').get(u'text')
                PyJs_anonymous_353_._set_name(u'anonymous')
                var.get(u'result').put(u'text', PyJs_anonymous_353_)
            return var.get(u'result')
        PyJs_nodesFromSchema_352_._set_name(u'nodesFromSchema')
        var.get(u'DOMSerializer').put(u'nodesFromSchema', PyJs_nodesFromSchema_352_)
        @Js
        def PyJs_marksFromSchema_354_(schema, this, arguments, var=var):
            var = Scope({u'this':this, u'marksFromSchema':PyJs_marksFromSchema_354_, u'arguments':arguments, u'schema':schema}, var)
            var.registers([u'schema'])
            return var.get(u'gatherToDOM')(var.get(u'schema').get(u'marks'))
        PyJs_marksFromSchema_354_._set_name(u'marksFromSchema')
        var.get(u'DOMSerializer').put(u'marksFromSchema', PyJs_marksFromSchema_354_)
        pass
        pass
    ...
    var.put(u'dist', var.get(u'createCommonjsModule')(PyJs_anonymous_18_))
    ...
    @Js
    def PyJs_anonymous_356_(module, exports, this, arguments, var=var):
        var = Scope({u'this':this, u'exports':exports, u'arguments':arguments, u'module':module}, var)
        ...
        def PyJsHoisted_withAttrs_(type, this, arguments, var=var):
            var = Scope({u'this':this, u'type':type, u'arguments':arguments}, var)
            var.registers([u'type'])
            PyJs_Object_425_ = Js({u'type':var.get(u'type'),u'attrs':var.get(u"null")})
        ...
        def PyJsHoisted_findWrapping_(range, nodeType, attrs, innerRange, this, arguments, var=var):
            ...
            if var.get(u'inner').neg():
                return var.get(u"null")
            PyJs_Object_424_ = Js({u'type':var.get(u'nodeType'),u'attrs':var.get(u'attrs')})
            return var.get(u'around').callprop(u'map', var.get(u'withAttrs')).callprop(u'concat', PyJs_Object_424_).callprop(u'concat', var.get(u'inner').callprop(u'map', var.get(u'withAttrs')))
        ...
        def PyJsHoisted_fitLeftInner_(PyJsArg_2466726f6d_, depth, placed, placedBelow, this, arguments, var=var):
            ...
            if var.get(u'placedBelow'):
                ...
                var.put(u'openEnd', Js(0.0))
            PyJs_Object_465_ = Js({u'content':var.get(u'content'),u'openEnd':var.get(u'openEnd')})
            return PyJs_Object_465_
        PyJsHoisted_fitLeftInner_.func_name = u'fitLeftInner'
        var.put(u'fitLeftInner', PyJsHoisted_fitLeftInner_)
        PyJs_Object_357_ = Js({u'value':Js(True)})
        var.get(u'Object').callprop(u'defineProperty', var.get(u'exports'), Js(u'__esModule'), PyJs_Object_357_)
        ...
        pass
        @Js
        def PyJs_MapResult_358_(pos, deleted, recover, this, arguments, var=var):
            var = Scope({u'deleted':deleted, u'MapResult':PyJs_MapResult_358_, u'pos':pos, u'this':this, u'arguments':arguments, u'recover':recover}, var)
        ...
        PyJs_MapResult_358_._set_name(u'MapResult')
        var.put(u'MapResult', PyJs_MapResult_358_)
        @Js
        def PyJs_StepMap_359_(ranges, inverted, this, arguments, var=var):
            var = Scope({u'ranges':ranges, u'this':this, u'StepMap':PyJs_StepMap_359_, u'arguments':arguments, u'inverted':inverted}, var)
        ...
        PyJs_StepMap_359_._set_name(u'StepMap')
        var.put(u'StepMap', PyJs_StepMap_359_)
        @Js
        def PyJs_recover_360_(value, this, arguments, var=var):
            var = Scope({u'this':this, u'recover':PyJs_recover_360_, u'arguments':arguments, u'value':value}, var)
        ...
        PyJs_recover_360_._set_name(u'recover')
        var.get(u'StepMap').get(u'prototype').put(u'recover', PyJs_recover_360_)
        @Js
        def PyJs_mapResult_361_(pos, assoc, this, arguments, var=var):
            var = Scope({u'this':this, u'mapResult':PyJs_mapResult_361_, u'assoc':assoc, u'pos':pos, u'arguments':arguments}, var)
        ...
        PyJs_mapResult_361_._set_name(u'mapResult')
        var.get(u'StepMap').get(u'prototype').put(u'mapResult', PyJs_mapResult_361_)
        @Js
        def PyJs_map_362_(pos, assoc, this, arguments, var=var):
            var = Scope({u'this':this, u'map':PyJs_map_362_, u'assoc':assoc, u'pos':pos, u'arguments':arguments}, var)
            var.registers([u'assoc', u'pos'])
            if PyJsStrictEq(var.get(u'assoc'),PyJsComma(Js(0.0), Js(None))):
                var.put(u'assoc', Js(1.0))
            return var.get(u"this").callprop(u'_map', var.get(u'pos'), var.get(u'assoc'), Js(True))
        PyJs_map_362_._set_name(u'map')
        var.get(u'StepMap').get(u'prototype').put(u'map', PyJs_map_362_)
        @Js
        def PyJs__map_363_(pos, assoc, simple, this, arguments, var=var):
            var = Scope({u'_map':PyJs__map_363_, u'simple':simple, u'pos':pos, u'this':this, u'assoc':assoc, u'arguments':arguments}, var)
        ...
        PyJs__map_363_._set_name(u'_map')
        var.get(u'StepMap').get(u'prototype').put(u'_map', PyJs__map_363_)
        @Js
        def PyJs_touches_364_(pos, recover, this, arguments, var=var):
            var = Scope({u'this':this, u'touches':PyJs_touches_364_, u'recover':recover, u'pos':pos, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'ranges').get(u'length')):
                try:
                    ...
                    var.put(u'diff', (var.get(u'this$1').get(u'ranges').get((var.get(u'i')+var.get(u'newIndex')))-var.get(u'oldSize')), u'+')
                        ...
                        var.put(u'i', Js(3.0), u'+')
            return Js(False)
        PyJs_touches_364_._set_name(u'touches')
        var.get(u'StepMap').get(u'prototype').put(u'touches', PyJs_touches_364_)
        @Js
        def PyJs_forEach_365_(f, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'forEach':PyJs_forEach_365_, u'f':f}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'ranges').get(u'length')):
                try:
                    ...
                    var.put(u'diff', (var.get(u'newSize')-var.get(u'oldSize')), u'+')
                        ...
                        var.put(u'i', Js(3.0), u'+')
        PyJs_forEach_365_._set_name(u'forEach')
        var.get(u'StepMap').get(u'prototype').put(u'forEach', PyJs_forEach_365_)
        @Js
        def PyJs_invert_366_(this, arguments, var=var):
            var = Scope({u'this':this, u'invert':PyJs_invert_366_, u'arguments':arguments}, var)
            var.registers([])
            return var.get(u'StepMap').create(var.get(u"this").get(u'ranges'), var.get(u"this").get(u'inverted').neg())
        PyJs_invert_366_._set_name(u'invert')
        var.get(u'StepMap').get(u'prototype').put(u'invert', PyJs_invert_366_)
        @Js
        def PyJs_toString_367_(this, arguments, var=var):
            var = Scope({u'this':this, u'toString':PyJs_toString_367_, u'arguments':arguments}, var)
            var.registers([])
            return ((Js(u'-') if var.get(u"this").get(u'inverted') else Js(u''))+var.get(u'JSON').callprop(u'stringify', var.get(u"this").get(u'ranges')))
        PyJs_toString_367_._set_name(u'toString')
        var.get(u'StepMap').get(u'prototype').put(u'toString', PyJs_toString_367_)
        @Js
        def PyJs_offset_368_(n, this, arguments, var=var):
            var = Scope({u'this':this, u'offset':PyJs_offset_368_, u'arguments':arguments, u'n':n}, var)
            var.registers([u'n'])
        ...
        PyJs_offset_368_._set_name(u'offset')
        var.get(u'StepMap').put(u'offset', PyJs_offset_368_)
        var.get(u'StepMap').put(u'empty', var.get(u'StepMap').create(Js([])))
        @Js
        def PyJs_Mapping_369_(maps, mirror, PyJsArg_66726f6d_, to, this, arguments, var=var):
            var = Scope({u'maps':maps, u'from':PyJsArg_66726f6d_, u'arguments':arguments, u'to':to, u'this':this, u'mirror':mirror, u'Mapping':PyJs_Mapping_369_}, var)
        ...
        PyJs_Mapping_369_._set_name(u'Mapping')
        var.put(u'Mapping', PyJs_Mapping_369_)
        @Js
        def PyJs_slice_370_(PyJsArg_66726f6d_, to, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'slice':PyJs_slice_370_, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
            var.registers([u'to', u'from'])
            if PyJsStrictEq(var.get(u'from'),PyJsComma(Js(0.0), Js(None))):
                var.put(u'from', Js(0.0))
            if PyJsStrictEq(var.get(u'to'),PyJsComma(Js(0.0), Js(None))):
        ...
        PyJs_slice_370_._set_name(u'slice')
        var.get(u'Mapping').get(u'prototype').put(u'slice', PyJs_slice_370_)
        @Js
        def PyJs_copy_371_(this, arguments, var=var):
            var = Scope({u'this':this, u'copy':PyJs_copy_371_, u'arguments':arguments}, var)
            var.registers([])
        ...
        PyJs_copy_371_._set_name(u'copy')
        var.get(u'Mapping').get(u'prototype').put(u'copy', PyJs_copy_371_)
        @Js
        def PyJs_appendMap_372_(map, mirrors, this, arguments, var=var):
            var = Scope({u'this':this, u'map':map, u'appendMap':PyJs_appendMap_372_, u'arguments':arguments, u'mirrors':mirrors}, var)
        ...
        PyJs_appendMap_372_._set_name(u'appendMap')
        var.get(u'Mapping').get(u'prototype').put(u'appendMap', PyJs_appendMap_372_)
        @Js
        def PyJs_appendMapping_373_(mapping, this, arguments, var=var):
            var = Scope({u'this':this, u'appendMapping':PyJs_appendMapping_373_, u'mapping':mapping, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u'mapping').get(u'maps').get(u'length')):
                try:
                    ...
                    var.get(u'this$1').callprop(u'appendMap', var.get(u'mapping').get(u'maps').get(var.get(u'i')), ((var.get(u'startSize')+var.get(u'mirr')) if ((var.get(u'mirr')!=var.get(u"null")) and (var.get(u'mirr')<var.get(u'i'))) else var.get(u"null")))
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_appendMapping_373_._set_name(u'appendMapping')
        var.get(u'Mapping').get(u'prototype').put(u'appendMapping', PyJs_appendMapping_373_)
        @Js
        def PyJs_getMirror_374_(n, this, arguments, var=var):
            var = Scope({u'this':this, u'getMirror':PyJs_getMirror_374_, u'arguments':arguments, u'n':n}, var)
                ...
                while (var.get(u'i')<var.get(u"this").get(u'mirror').get(u'length')):
                    try:
                        if (var.get(u'this$1').get(u'mirror').get(var.get(u'i'))==var.get(u'n')):
                            ...
                            (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
        PyJs_getMirror_374_._set_name(u'getMirror')
        var.get(u'Mapping').get(u'prototype').put(u'getMirror', PyJs_getMirror_374_)
        @Js
        def PyJs_setMirror_375_(n, m, this, arguments, var=var):
            var = Scope({u'this':this, u'setMirror':PyJs_setMirror_375_, u'm':m, u'arguments':arguments, u'n':n}, var)
        ...
        PyJs_setMirror_375_._set_name(u'setMirror')
        var.get(u'Mapping').get(u'prototype').put(u'setMirror', PyJs_setMirror_375_)
        @Js
        def PyJs_appendMappingInverted_376_(mapping, this, arguments, var=var):
            var = Scope({u'this':this, u'appendMappingInverted':PyJs_appendMappingInverted_376_, u'mapping':mapping, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')>=Js(0.0)):
                try:
                    ...
                    var.get(u'this$1').callprop(u'appendMap', var.get(u'mapping').get(u'maps').get(var.get(u'i')).callprop(u'invert'), (((var.get(u'totalSize')-var.get(u'mirr'))-Js(1.0)) if ((var.get(u'mirr')!=var.get(u"null")) and (var.get(u'mirr')>var.get(u'i'))) else var.get(u"null")))
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())-Js(1))+Js(1))
        PyJs_appendMappingInverted_376_._set_name(u'appendMappingInverted')
        var.get(u'Mapping').get(u'prototype').put(u'appendMappingInverted', PyJs_appendMappingInverted_376_)
        @Js
        def PyJs_invert_377_(this, arguments, var=var):
            var = Scope({u'this':this, u'invert':PyJs_invert_377_, u'arguments':arguments}, var)
        ...
        PyJs_invert_377_._set_name(u'invert')
        var.get(u'Mapping').get(u'prototype').put(u'invert', PyJs_invert_377_)
        @Js
        def PyJs_map_378_(pos, assoc, this, arguments, var=var):
            var = Scope({u'this':this, u'map':PyJs_map_378_, u'assoc':assoc, u'pos':pos, u'arguments':arguments}, var)
            ...
            while (var.get(u'i')<var.get(u"this").get(u'to')):
                try:
                    var.put(u'pos', var.get(u'this$1').get(u'maps').get(var.get(u'i')).callprop(u'map', var.get(u'pos'), var.get(u'assoc')))
                        ...
                        (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            return var.get(u'pos')
        PyJs_map_378_._set_name(u'map')
        var.get(u'Mapping').get(u'prototype').put(u'map', PyJs_map_378_)
        @Js
        def PyJs_mapResult_379_(pos, assoc, this, arguments, var=var):
            var = Scope({u'this':this, u'mapResult':PyJs_mapResult_379_, u'assoc':assoc, u'pos':pos, u'arguments':arguments}, var)
            var.registers([u'assoc', u'pos'])
            if PyJsStrictEq(var.get(u'assoc'),PyJsComma(Js(0.0), Js(None))):
                var.put(u'assoc', Js(1.0))
            return var.get(u"this").callprop(u'_map', var.get(u'pos'), var.get(u'assoc'), Js(False))
        PyJs_mapResult_379_._set_name(u'mapResult')
        var.get(u'Mapping').get(u'prototype').put(u'mapResult', PyJs_mapResult_379_)
        @Js
        def PyJs__map_380_(pos, assoc, simple, this, arguments, var=var):
            var = Scope({u'_map':PyJs__map_380_, u'simple':simple, u'pos':pos, u'this':this, u'assoc':assoc, u'arguments':arguments}, var)
        ...
        PyJs__map_380_._set_name(u'_map')
        var.get(u'Mapping').get(u'prototype').put(u'_map', PyJs__map_380_)
        pass
        ...
        @Js
        def PyJs_Transform_381_(doc, this, arguments, var=var):
            var = Scope({u'this':this, u'doc':doc, u'arguments':arguments, u'Transform':PyJs_Transform_381_}, var)
            var.registers([u'doc'])
        ...
        PyJs_Transform_381_._set_name(u'Transform')
        var.put(u'Transform', PyJs_Transform_381_)
        PyJs_Object_383_ = Js({})
        PyJs_Object_384_ = Js({})
        PyJs_Object_382_ = Js({u'before':PyJs_Object_383_,u'docChanged':PyJs_Object_384_})
        var.put(u'prototypeAccessors', PyJs_Object_382_)
        @Js
        ...
        var.get(u'prototypeAccessors').get(u'before').put(u'get', PyJs_anonymous_385_)
        @Js
        def PyJs_step_386_(object, this, arguments, var=var):
            var = Scope({u'this':this, u'step':PyJs_step_386_, u'object':object, u'arguments':arguments}, var)
            ...
            if var.get(u'result').get(u'failed'):
                ...
                raise PyJsTempException
            return var.get(u"this")
        PyJs_step_386_._set_name(u'step')
        var.get(u'Transform').get(u'prototype').put(u'step', PyJs_step_386_)
        @Js
        def PyJs_maybeStep_387_(step, this, arguments, var=var):
            var = Scope({u'this':this, u'step':step, u'maybeStep':PyJs_maybeStep_387_, u'arguments':arguments}, var)
            ...
            return var.get(u'result')
        PyJs_maybeStep_387_._set_name(u'maybeStep')
        var.get(u'Transform').get(u'prototype').put(u'maybeStep', PyJs_maybeStep_387_)
        @Js
        def PyJs_anonymous_388_(this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments}, var)
            var.registers([])
            return (var.get(u"this").get(u'steps').get(u'length')>Js(0.0))
        PyJs_anonymous_388_._set_name(u'anonymous')
        var.get(u'prototypeAccessors').get(u'docChanged').put(u'get', PyJs_anonymous_388_)
        @Js
        def PyJs_addStep_389_(step, doc, this, arguments, var=var):
            var = Scope({u'this':this, u'doc':doc, u'step':step, u'addStep':PyJs_addStep_389_, u'arguments':arguments}, var)
            ...
            var.get(u"this").put(u'doc', var.get(u'doc'))
        PyJs_addStep_389_._set_name(u'addStep')
        var.get(u'Transform').get(u'prototype').put(u'addStep', PyJs_addStep_389_)
        ...
        @Js
        def PyJs_Step_390_(this, arguments, var=var):
            var = Scope({u'this':this, u'Step':PyJs_Step_390_, u'arguments':arguments}, var)
            var.registers([])
            pass
        PyJs_Step_390_._set_name(u'Step')
        var.put(u'Step', PyJs_Step_390_)
        @Js
        def PyJs_apply_391_(_doc, this, arguments, var=var):
            var = Scope({u'this':this, u'apply':PyJs_apply_391_, u'_doc':_doc, u'arguments':arguments}, var)
            var.registers([u'_doc'])
            return var.get(u'mustOverride')()
        PyJs_apply_391_._set_name(u'apply')
        var.get(u'Step').get(u'prototype').put(u'apply', PyJs_apply_391_)
        @Js
        def PyJs_getMap_392_(this, arguments, var=var):
            var = Scope({u'this':this, u'getMap':PyJs_getMap_392_, u'arguments':arguments}, var)
            var.registers([])
            return var.get(u'StepMap').get(u'empty')
        PyJs_getMap_392_._set_name(u'getMap')
        var.get(u'Step').get(u'prototype').put(u'getMap', PyJs_getMap_392_)
        @Js
        def PyJs_invert_393_(_doc, this, arguments, var=var):
            var = Scope({u'this':this, u'invert':PyJs_invert_393_, u'_doc':_doc, u'arguments':arguments}, var)
            var.registers([u'_doc'])
            return var.get(u'mustOverride')()
        PyJs_invert_393_._set_name(u'invert')
        var.get(u'Step').get(u'prototype').put(u'invert', PyJs_invert_393_)
        @Js
        def PyJs_map_394_(_mapping, this, arguments, var=var):
            var = Scope({u'this':this, u'map':PyJs_map_394_, u'arguments':arguments, u'_mapping':_mapping}, var)
            var.registers([u'_mapping'])
            return var.get(u'mustOverride')()
        PyJs_map_394_._set_name(u'map')
        var.get(u'Step').get(u'prototype').put(u'map', PyJs_map_394_)
        @Js
        def PyJs_merge_395_(_other, this, arguments, var=var):
            var = Scope({u'this':this, u'_other':_other, u'arguments':arguments, u'merge':PyJs_merge_395_}, var)
            var.registers([u'_other'])
            return var.get(u"null")
        PyJs_merge_395_._set_name(u'merge')
        var.get(u'Step').get(u'prototype').put(u'merge', PyJs_merge_395_)
        @Js
        def PyJs_toJSON_396_(this, arguments, var=var):
            var = Scope({u'this':this, u'toJSON':PyJs_toJSON_396_, u'arguments':arguments}, var)
            var.registers([])
            return var.get(u'mustOverride')()
        PyJs_toJSON_396_._set_name(u'toJSON')
        var.get(u'Step').get(u'prototype').put(u'toJSON', PyJs_toJSON_396_)
        @Js
        def PyJs_fromJSON_397_(schema, json, this, arguments, var=var):
            var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_397_, u'schema':schema}, var)
            var.registers([u'json', u'type', u'schema'])
        ...
        PyJs_fromJSON_397_._set_name(u'fromJSON')
        var.get(u'Step').put(u'fromJSON', PyJs_fromJSON_397_)
        @Js
        def PyJs_jsonID_398_(id, stepClass, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'jsonID':PyJs_jsonID_398_, u'id':id, u'stepClass':stepClass}, var)
        ...
        PyJs_jsonID_398_._set_name(u'jsonID')
        var.get(u'Step').put(u'jsonID', PyJs_jsonID_398_)
        @Js
        def PyJs_StepResult_399_(doc, failed, this, arguments, var=var):
            var = Scope({u'this':this, u'doc':doc, u'StepResult':PyJs_StepResult_399_, u'arguments':arguments, u'failed':failed}, var)
            var.registers([u'doc', u'failed'])
            var.get(u"this").put(u'doc', var.get(u'doc'))
            var.get(u"this").put(u'failed', var.get(u'failed'))
        PyJs_StepResult_399_._set_name(u'StepResult')
        var.put(u'StepResult', PyJs_StepResult_399_)
        @Js
        def PyJs_ok_400_(doc, this, arguments, var=var):
            var = Scope({u'this':this, u'doc':doc, u'ok':PyJs_ok_400_, u'arguments':arguments}, var)
            var.registers([u'doc'])
            return var.get(u'StepResult').create(var.get(u'doc'), var.get(u"null"))
        PyJs_ok_400_._set_name(u'ok')
        var.get(u'StepResult').put(u'ok', PyJs_ok_400_)
        @Js
        def PyJs_fail_401_(message, this, arguments, var=var):
            var = Scope({u'this':this, u'fail':PyJs_fail_401_, u'message':message, u'arguments':arguments}, var)
            var.registers([u'message'])
            return var.get(u'StepResult').create(var.get(u"null"), var.get(u'message'))
        PyJs_fail_401_._set_name(u'fail')
        var.get(u'StepResult').put(u'fail', PyJs_fail_401_)
        @Js
        def PyJs_fromReplace_402_(doc, PyJsArg_66726f6d_, to, slice, this, arguments, var=var):
            var = Scope({u'to':to, u'slice':slice, u'from':PyJsArg_66726f6d_, u'arguments':arguments, u'this':this, u'doc':doc, u'fromReplace':PyJs_fromReplace_402_}, var)
            ...
            try:
                ...
                PyJsHolder_65_99495201 = var.own.get(u'e')
                ...
                try:
                    ...
                    if PyJsHolder_65_99495201 is not None:
                        var.own[u'e'] = PyJsHolder_65_99495201
                    else:
                        del var.own[u'e']
                    del PyJsHolder_65_99495201
        PyJs_fromReplace_402_._set_name(u'fromReplace')
        var.get(u'StepResult').put(u'fromReplace', PyJs_fromReplace_402_)
        @Js
        def PyJs_anonymous_403_(PyJsArg_53746570242431_, this, arguments, var=var):
            ...
            @Js
            def PyJs_apply_404_(doc, this, arguments, var=var):
                var = Scope({u'this':this, u'doc':doc, u'arguments':arguments, u'apply':PyJs_apply_404_}, var)
                var.registers([u'doc'])
            ...
            PyJs_apply_404_._set_name(u'apply')
            var.get(u'ReplaceStep').get(u'prototype').put(u'apply', PyJs_apply_404_)
            @Js
            def PyJs_getMap_405_(this, arguments, var=var):
                var = Scope({u'this':this, u'getMap':PyJs_getMap_405_, u'arguments':arguments}, var)
                var.registers([])
            ...
            PyJs_getMap_405_._set_name(u'getMap')
            var.get(u'ReplaceStep').get(u'prototype').put(u'getMap', PyJs_getMap_405_)
            @Js
            def PyJs_invert_406_(doc, this, arguments, var=var):
                var = Scope({u'this':this, u'doc':doc, u'invert':PyJs_invert_406_, u'arguments':arguments}, var)
                var.registers([u'doc'])
            ...
            PyJs_invert_406_._set_name(u'invert')
            var.get(u'ReplaceStep').get(u'prototype').put(u'invert', PyJs_invert_406_)
            @Js
            def PyJs_map_407_(mapping, this, arguments, var=var):
                var = Scope({u'this':this, u'map':PyJs_map_407_, u'mapping':mapping, u'arguments':arguments}, var)
            ...
            PyJs_map_407_._set_name(u'map')
            var.get(u'ReplaceStep').get(u'prototype').put(u'map', PyJs_map_407_)
            @Js
            def PyJs_merge_408_(other, this, arguments, var=var):
                var = Scope({u'this':this, u'merge':PyJs_merge_408_, u'other':other, u'arguments':arguments}, var)
                ...
                if ((((var.get(u"this").get(u'from')+var.get(u"this").get(u'slice').get(u'size'))==var.get(u'other').get(u'from')) and var.get(u"this").get(u'slice').get(u'openEnd').neg()) and var.get(u'other').get(u'slice').get(u'openStart').neg()):
                    ...
                    var.put(u'slice', PyJs_LONG_409_())
                    ...
                    if (((var.get(u'other').get(u'to')==var.get(u"this").get(u'from')) and var.get(u"this").get(u'slice').get(u'openStart').neg()) and var.get(u'other').get(u'slice').get(u'openEnd').neg()):
                        ...
                        var.put(u'slice$1', PyJs_LONG_410_())
                        ...
                        return var.get(u"null")
            PyJs_merge_408_._set_name(u'merge')
            var.get(u'ReplaceStep').get(u'prototype').put(u'merge', PyJs_merge_408_)
            @Js
            def PyJs_toJSON_411_(this, arguments, var=var):
                var = Scope({u'this':this, u'toJSON':PyJs_toJSON_411_, u'arguments':arguments}, var)
                var.registers([u'json'])
                PyJs_Object_412_ = Js({u'stepType':Js(u'replace'),u'from':var.get(u"this").get(u'from'),u'to':var.get(u"this").get(u'to')})
                var.put(u'json', PyJs_Object_412_)
                ...
                return var.get(u'json')
            PyJs_toJSON_411_._set_name(u'toJSON')
            var.get(u'ReplaceStep').get(u'prototype').put(u'toJSON', PyJs_toJSON_411_)
            @Js
            def PyJs_fromJSON_413_(schema, json, this, arguments, var=var):
                var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_413_, u'schema':schema}, var)
            ...
            PyJs_fromJSON_413_._set_name(u'fromJSON')
            var.get(u'ReplaceStep').put(u'fromJSON', PyJs_fromJSON_413_)
            return var.get(u'ReplaceStep')
        PyJs_anonymous_403_._set_name(u'anonymous')
        var.put(u'ReplaceStep', PyJs_anonymous_403_(var.get(u'Step')))
        var.get(u'Step').callprop(u'jsonID', Js(u'replace'), var.get(u'ReplaceStep'))
        @Js
        def PyJs_anonymous_414_(PyJsArg_53746570242431_, this, arguments, var=var):
            var = Scope({u'this':this, u'Step$$1':PyJsArg_53746570242431_, u'arguments':arguments}, var)
            ...
            @Js
            def PyJs_apply_415_(doc, this, arguments, var=var):
                var = Scope({u'this':this, u'doc':doc, u'arguments':arguments, u'apply':PyJs_apply_415_}, var)
            ...
            PyJs_apply_415_._set_name(u'apply')
            var.get(u'ReplaceAroundStep').get(u'prototype').put(u'apply', PyJs_apply_415_)
            @Js
            def PyJs_getMap_416_(this, arguments, var=var):
                var = Scope({u'this':this, u'getMap':PyJs_getMap_416_, u'arguments':arguments}, var)
                var.registers([])
            ...
            PyJs_getMap_416_._set_name(u'getMap')
            var.get(u'ReplaceAroundStep').get(u'prototype').put(u'getMap', PyJs_getMap_416_)
            @Js
            def PyJs_invert_417_(doc, this, arguments, var=var):
                var = Scope({u'this':this, u'doc':doc, u'invert':PyJs_invert_417_, u'arguments':arguments}, var)
                ...
                return PyJs_LONG_418_()
            PyJs_invert_417_._set_name(u'invert')
            var.get(u'ReplaceAroundStep').get(u'prototype').put(u'invert', PyJs_invert_417_)
            @Js
            def PyJs_map_419_(mapping, this, arguments, var=var):
                var = Scope({u'this':this, u'map':PyJs_map_419_, u'mapping':mapping, u'arguments':arguments}, var)
            ...
            PyJs_map_419_._set_name(u'map')
            var.get(u'ReplaceAroundStep').get(u'prototype').put(u'map', PyJs_map_419_)
            @Js
            def PyJs_toJSON_420_(this, arguments, var=var):
                var = Scope({u'this':this, u'toJSON':PyJs_toJSON_420_, u'arguments':arguments}, var)
                var.registers([u'json'])
                PyJs_Object_421_ = Js({u'stepType':Js(u'replaceAround'),u'from':var.get(u"this").get(u'from'),u'to':var.get(u"this").get(u'to'),u'gapFrom':var.get(u"this").get(u'gapFrom'),u'gapTo':var.get(u"this").get(u'gapTo'),u'insert':var.get(u"this").get(u'insert')})
                var.put(u'json', PyJs_Object_421_)
                if var.get(u"this").get(u'slice').get(u'size'):
                    var.get(u'json').put(u'slice', var.get(u"this").get(u'slice').callprop(u'toJSON'))
                if var.get(u"this").get(u'structure'):
                    var.get(u'json').put(u'structure', Js(True))
                return var.get(u'json')
            PyJs_toJSON_420_._set_name(u'toJSON')
            var.get(u'ReplaceAroundStep').get(u'prototype').put(u'toJSON', PyJs_toJSON_420_)
            @Js
            def PyJs_fromJSON_422_(schema, json, this, arguments, var=var):
                var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_422_, u'schema':schema}, var)
                var.registers([u'json', u'schema'])
            ...
            PyJs_fromJSON_422_._set_name(u'fromJSON')
            var.get(u'ReplaceAroundStep').put(u'fromJSON', PyJs_fromJSON_422_)
            return var.get(u'ReplaceAroundStep')
        PyJs_anonymous_414_._set_name(u'anonymous')
        var.put(u'ReplaceAroundStep', PyJs_anonymous_414_(var.get(u'Step')))
        var.get(u'Step').callprop(u'jsonID', Js(u'replaceAround'), var.get(u'ReplaceAroundStep'))
        pass
        pass
        pass
        @Js
        def PyJs_anonymous_423_(range, target, this, arguments, var=var):
        ...
        PyJs_anonymous_423_._set_name(u'anonymous')
        var.get(u'Transform').get(u'prototype').put(u'lift', PyJs_anonymous_423_)
        pass
        pass
        pass
        pass
        @Js
        def PyJs_anonymous_426_(range, wrappers, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'wrap', PyJs_anonymous_426_)
        @Js
        def PyJs_anonymous_427_(PyJsArg_66726f6d_, to, type, attrs, this, arguments, var=var):
            ...
            @Js
            def PyJs_anonymous_428_(node, pos, this, arguments, var=var):
                var = Scope({u'node':node, u'this':this, u'pos':pos, u'arguments':arguments}, var)
            ...
            var.get(u"this").get(u'doc').callprop(u'nodesBetween', var.get(u'from'), var.get(u'to'), PyJs_anonymous_428_)
            return var.get(u"this")
        PyJs_anonymous_427_._set_name(u'anonymous')
        var.get(u'Transform').get(u'prototype').put(u'setBlockType', PyJs_anonymous_427_)
        pass
        @Js
        def PyJs_anonymous_430_(pos, type, attrs, marks, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'setNodeMarkup', PyJs_anonymous_430_)
        pass
        @Js
        def PyJs_anonymous_432_(pos, depth, typesAfter, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'split', PyJs_anonymous_432_)
        pass
        pass
        pass
        @Js
        def PyJs_anonymous_433_(pos, depth, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'join', PyJs_anonymous_433_)
        pass
        pass
        pass
        @Js
        def PyJs_anonymous_434_(PyJsArg_53746570242431_, this, arguments, var=var):
            var = Scope({u'this':this, u'Step$$1':PyJsArg_53746570242431_, u'arguments':arguments}, var)
            ...
            @Js
            def PyJs_apply_435_(doc, this, arguments, var=var):
                var = Scope({u'this':this, u'doc':doc, u'arguments':arguments, u'apply':PyJs_apply_435_}, var)
                ...
                @Js
                def PyJs_anonymous_436_(node, parent, this, arguments, var=var):
                ...
                var.put(u'slice', var.get(u'dist').get(u'Slice').create(var.get(u'mapFragment')(var.get(u'oldSlice').get(u'content'), PyJs_anonymous_436_, var.get(u'parent')), var.get(u'oldSlice').get(u'openStart'), var.get(u'oldSlice').get(u'openEnd')))
            ...
            PyJs_apply_435_._set_name(u'apply')
            var.get(u'AddMarkStep').get(u'prototype').put(u'apply', PyJs_apply_435_)
            @Js
            def PyJs_invert_437_(this, arguments, var=var):
                var = Scope({u'this':this, u'invert':PyJs_invert_437_, u'arguments':arguments}, var)
                var.registers([])
                return var.get(u'RemoveMarkStep').create(var.get(u"this").get(u'from'), var.get(u"this").get(u'to'), var.get(u"this").get(u'mark'))
            PyJs_invert_437_._set_name(u'invert')
            var.get(u'AddMarkStep').get(u'prototype').put(u'invert', PyJs_invert_437_)
            @Js
            def PyJs_map_438_(mapping, this, arguments, var=var):
                var = Scope({u'this':this, u'map':PyJs_map_438_, u'mapping':mapping, u'arguments':arguments}, var)
                var.registers([u'to', u'from', u'mapping'])
                var.put(u'from', var.get(u'mapping').callprop(u'mapResult', var.get(u"this").get(u'from'), Js(1.0)))
                var.put(u'to', var.get(u'mapping').callprop(u'mapResult', var.get(u"this").get(u'to'), (-Js(1.0))))
            ...
            PyJs_map_438_._set_name(u'map')
            var.get(u'AddMarkStep').get(u'prototype').put(u'map', PyJs_map_438_)
            @Js
            def PyJs_merge_439_(other, this, arguments, var=var):
                var = Scope({u'this':this, u'merge':PyJs_merge_439_, u'other':other, u'arguments':arguments}, var)
                var.registers([u'other'])
            ...
            PyJs_merge_439_._set_name(u'merge')
            var.get(u'AddMarkStep').get(u'prototype').put(u'merge', PyJs_merge_439_)
            @Js
            def PyJs_toJSON_440_(this, arguments, var=var):
                var = Scope({u'this':this, u'toJSON':PyJs_toJSON_440_, u'arguments':arguments}, var)
                var.registers([])
                PyJs_Object_441_ = Js({u'stepType':Js(u'addMark'),u'mark':var.get(u"this").get(u'mark').callprop(u'toJSON'),u'from':var.get(u"this").get(u'from'),u'to':var.get(u"this").get(u'to')})
                return PyJs_Object_441_
            PyJs_toJSON_440_._set_name(u'toJSON')
            var.get(u'AddMarkStep').get(u'prototype').put(u'toJSON', PyJs_toJSON_440_)
            @Js
            def PyJs_fromJSON_442_(schema, json, this, arguments, var=var):
                var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_442_, u'schema':schema}, var)
                var.registers([u'json', u'schema'])
                if ((var.get(u'json').get(u'from').typeof()!=Js(u'number')) or (var.get(u'json').get(u'to').typeof()!=Js(u'number'))):
            ...
            PyJs_fromJSON_442_._set_name(u'fromJSON')
            var.get(u'AddMarkStep').put(u'fromJSON', PyJs_fromJSON_442_)
            return var.get(u'AddMarkStep')
        PyJs_anonymous_434_._set_name(u'anonymous')
        var.put(u'AddMarkStep', PyJs_anonymous_434_(var.get(u'Step')))
        var.get(u'Step').callprop(u'jsonID', Js(u'addMark'), var.get(u'AddMarkStep'))
        @Js
        def PyJs_anonymous_443_(PyJsArg_53746570242431_, this, arguments, var=var):
            var = Scope({u'this':this, u'Step$$1':PyJsArg_53746570242431_, u'arguments':arguments}, var)
            ...
            @Js
            def PyJs_apply_444_(doc, this, arguments, var=var):
                var = Scope({u'this':this, u'doc':doc, u'arguments':arguments, u'apply':PyJs_apply_444_}, var)
                var.registers([u'doc', u'oldSlice', u'slice', u'this$1'])
                var.put(u'this$1', var.get(u"this"))
                var.put(u'oldSlice', var.get(u'doc').callprop(u'slice', var.get(u"this").get(u'from'), var.get(u"this").get(u'to')))
                @Js
                def PyJs_anonymous_445_(node, this, arguments, var=var):
                    var = Scope({u'node':node, u'this':this, u'arguments':arguments}, var)
                    var.registers([u'node'])
                ...
                var.put(u'slice', var.get(u'dist').get(u'Slice').create(var.get(u'mapFragment')(var.get(u'oldSlice').get(u'content'), PyJs_anonymous_445_), var.get(u'oldSlice').get(u'openStart'), var.get(u'oldSlice').get(u'openEnd')))
                return var.get(u'StepResult').callprop(u'fromReplace', var.get(u'doc'), var.get(u"this").get(u'from'), var.get(u"this").get(u'to'), var.get(u'slice'))
            PyJs_apply_444_._set_name(u'apply')
            var.get(u'RemoveMarkStep').get(u'prototype').put(u'apply', PyJs_apply_444_)
            @Js
            def PyJs_invert_446_(this, arguments, var=var):
                var = Scope({u'this':this, u'invert':PyJs_invert_446_, u'arguments':arguments}, var)
                var.registers([])
                return var.get(u'AddMarkStep').create(var.get(u"this").get(u'from'), var.get(u"this").get(u'to'), var.get(u"this").get(u'mark'))
            PyJs_invert_446_._set_name(u'invert')
            var.get(u'RemoveMarkStep').get(u'prototype').put(u'invert', PyJs_invert_446_)
            @Js
            def PyJs_map_447_(mapping, this, arguments, var=var):
                var = Scope({u'this':this, u'map':PyJs_map_447_, u'mapping':mapping, u'arguments':arguments}, var)
                var.registers([u'to', u'from', u'mapping'])
                var.put(u'from', var.get(u'mapping').callprop(u'mapResult', var.get(u"this").get(u'from'), Js(1.0)))
                var.put(u'to', var.get(u'mapping').callprop(u'mapResult', var.get(u"this").get(u'to'), (-Js(1.0))))
                if ((var.get(u'from').get(u'deleted') and var.get(u'to').get(u'deleted')) or (var.get(u'from').get(u'pos')>=var.get(u'to').get(u'pos'))):
            ...
            PyJs_map_447_._set_name(u'map')
            var.get(u'RemoveMarkStep').get(u'prototype').put(u'map', PyJs_map_447_)
            @Js
            def PyJs_merge_448_(other, this, arguments, var=var):
                var = Scope({u'this':this, u'merge':PyJs_merge_448_, u'other':other, u'arguments':arguments}, var)
                var.registers([u'other'])
            ...
            PyJs_merge_448_._set_name(u'merge')
            var.get(u'RemoveMarkStep').get(u'prototype').put(u'merge', PyJs_merge_448_)
            @Js
            def PyJs_toJSON_449_(this, arguments, var=var):
                var = Scope({u'this':this, u'toJSON':PyJs_toJSON_449_, u'arguments':arguments}, var)
                var.registers([])
                PyJs_Object_450_ = Js({u'stepType':Js(u'removeMark'),u'mark':var.get(u"this").get(u'mark').callprop(u'toJSON'),u'from':var.get(u"this").get(u'from'),u'to':var.get(u"this").get(u'to')})
                return PyJs_Object_450_
            PyJs_toJSON_449_._set_name(u'toJSON')
            var.get(u'RemoveMarkStep').get(u'prototype').put(u'toJSON', PyJs_toJSON_449_)
            @Js
            def PyJs_fromJSON_451_(schema, json, this, arguments, var=var):
                var = Scope({u'this':this, u'json':json, u'arguments':arguments, u'fromJSON':PyJs_fromJSON_451_, u'schema':schema}, var)
                var.registers([u'json', u'schema'])
                if ((var.get(u'json').get(u'from').typeof()!=Js(u'number')) or (var.get(u'json').get(u'to').typeof()!=Js(u'number'))):
            ...
            PyJs_fromJSON_451_._set_name(u'fromJSON')
            var.get(u'RemoveMarkStep').put(u'fromJSON', PyJs_fromJSON_451_)
            return var.get(u'RemoveMarkStep')
        PyJs_anonymous_443_._set_name(u'anonymous')
        var.put(u'RemoveMarkStep', PyJs_anonymous_443_(var.get(u'Step')))
        ...
        def PyJs_anonymous_452_(PyJsArg_66726f6d_, to, mark, this, arguments, var=var):
            ...
            @Js
            def PyJs_anonymous_453_(node, pos, parent, this, arguments, var=var):
            ...
            var.get(u"this").get(u'doc').callprop(u'nodesBetween', var.get(u'from'), var.get(u'to'), PyJs_anonymous_453_)
            @Js
            ...
            var.get(u'removed').callprop(u'forEach', PyJs_anonymous_454_)
            @Js
            def PyJs_anonymous_455_(s, this, arguments, var=var):
                var = Scope({u'this':this, u's':s, u'arguments':arguments}, var)
                var.registers([u's'])
                return var.get(u'this$1').callprop(u'step', var.get(u's'))
            PyJs_anonymous_455_._set_name(u'anonymous')
            var.get(u'added').callprop(u'forEach', PyJs_anonymous_455_)
            return var.get(u"this")
        PyJs_anonymous_452_._set_name(u'anonymous')
        var.get(u'Transform').get(u'prototype').put(u'addMark', PyJs_anonymous_452_)
        @Js
        def PyJs_anonymous_456_(PyJsArg_66726f6d_, to, mark, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'from':PyJsArg_66726f6d_, u'arguments':arguments, u'mark':mark}, var)
            ...
            @Js
            def PyJs_anonymous_457_(node, pos, this, arguments, var=var):
                var = Scope({u'node':node, u'this':this, u'pos':pos, u'arguments':arguments}, var)
                    ...
                    while (var.get(u'i')<var.get(u'toRemove').get(u'length')):
                        try:
                            ...
                            if var.get(u'found$1'):
                                ...
                                PyJs_Object_458_ = Js({u'style':var.get(u'style'),u'from':var.get(u'Math').callprop(u'max', var.get(u'pos'), var.get(u'from')),u'to':var.get(u'end'),u'step':var.get(u'step')})
                                var.get(u'matched').callprop(u'push', PyJs_Object_458_)
                        finally:
                                (var.put(u'i',Js(var.get(u'i').to_number())+Js(1))-Js(1))
            PyJs_anonymous_457_._set_name(u'anonymous')
            var.get(u"this").get(u'doc').callprop(u'nodesBetween', var.get(u'from'), var.get(u'to'), PyJs_anonymous_457_)
            @Js
            def PyJs_anonymous_459_(m, this, arguments, var=var):
                var = Scope({u'this':this, u'm':m, u'arguments':arguments}, var)
                var.registers([u'm'])
            ...
            var.get(u'matched').callprop(u'forEach', PyJs_anonymous_459_)
            return var.get(u"this")
        PyJs_anonymous_456_._set_name(u'anonymous')
        var.get(u'Transform').get(u'prototype').put(u'removeMark', PyJs_anonymous_456_)
        @Js
        def PyJs_anonymous_460_(pos, parentType, match, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'clearIncompatible', PyJs_anonymous_460_)
        pass
        @Js
        def PyJs_anonymous_461_(PyJsArg_66726f6d_, to, slice, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'replace', PyJs_anonymous_461_)
        @Js
        def PyJs_anonymous_462_(PyJsArg_66726f6d_, to, content, this, arguments, var=var):
            var = Scope({u'content':content, u'to':to, u'this':this, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
        ...
        var.get(u'Transform').get(u'prototype').put(u'replaceWith', PyJs_anonymous_462_)
        @Js
        def PyJs_anonymous_463_(PyJsArg_66726f6d_, to, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'delete', PyJs_anonymous_463_)
        @Js
        def PyJs_anonymous_464_(pos, content, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'insert', PyJs_anonymous_464_)
        pass
        pass
        pass
        pass
        ...
        pass
        @Js
        def PyJs_Frontier_466_(PyJsArg_24706f73_, this, arguments, var=var):
            var = Scope({u'this':this, u'arguments':arguments, u'$pos':PyJsArg_24706f73_, u'Frontier':PyJs_Frontier_466_}, var)
            ...
            while (var.get(u'd')<=var.get(u'$pos').get(u'depth')):
                try:
                    ...
                    PyJs_Object_467_ = Js({u'parent':var.get(u'parent'),u'match':var.get(u'match'),u'content':var.get(u'dist').get(u'Fragment').get(u'empty'),u'wrapper':Js(False),u'openEnd':Js(0.0),u'depth':var.get(u'd')})
                    var.get(u'this$1').get(u'open').callprop(u'push', PyJs_Object_467_)
                finally:
                        (var.put(u'd',Js(var.get(u'd').to_number())+Js(1))-Js(1))
            var.get(u"this").put(u'placed', Js([]))
        PyJs_Frontier_466_._set_name(u'Frontier')
        var.put(u'Frontier', PyJs_Frontier_466_)
        @Js
        def PyJs_placeSlice_468_(fragment, openStart, openEnd, PyJsArg_70617373_, parent, this, arguments, var=var):
            var = Scope({u'openEnd':openEnd, u'placeSlice':PyJs_placeSlice_468_, u'openStart':openStart, u'parent':parent, u'pass':PyJsArg_70617373_, u'fragment':fragment, u'this':this, u'arguments':arguments}, var)
            ...
            return var.get(u'result')
        PyJs_placeSlice_468_._set_name(u'placeSlice')
        var.get(u'Frontier').get(u'prototype').put(u'placeSlice', PyJs_placeSlice_468_)
        @Js
        def PyJs_placeContent_469_(fragment, openStart, openEnd, PyJsArg_70617373_, parent, this, arguments, var=var):
            var = Scope({u'placeContent':PyJs_placeContent_469_, u'openEnd':openEnd, u'openStart':openStart, u'parent':parent, u'pass':PyJsArg_70617373_, u'fragment':fragment, u'this':this, u'arguments':arguments}, var)
                            ...
                            if (((var.get(u'pass')>Js(1.0)) and var.put(u'wrap', var.get(u'open').get(u'match').callprop(u'findWrapping', var.get(u'child').get(u'type')))) and ((var.get(u'parent') and var.get(u'wrap').get(u'length')) and (var.get(u'wrap').get((var.get(u'wrap').get(u'length')-Js(1.0)))==var.get(u'parent').get(u'type'))).neg()):
                                ...
                                while (var.get(u'w')<var.get(u'wrap').get(u'length')):
                                    try:
                                        ...
                                        (var.put(u'd',Js(var.get(u'd').to_number())+Js(1))-Js(1))
                                        PyJs_Object_470_ = Js({u'parent':var.get(u'wrap').get(var.get(u'w')).callprop(u'create'),u'match':var.get(u'wrap').get(var.get(u'w')).get(u'contentMatch'),u'content':var.get(u'dist').get(u'Fragment').get(u'empty'),u'wrapper':Js(True),u'openEnd':Js(0.0),u'depth':(var.get(u'd')+var.get(u'w'))})
                                        var.put(u'open', PyJs_Object_470_)
        ...
        PyJs_placeContent_469_._set_name(u'placeContent')
        var.get(u'Frontier').get(u'prototype').put(u'placeContent', PyJs_placeContent_469_)
        @Js
        def PyJs_addNode_471_(open, node, openEnd, this, arguments, var=var):
            var = Scope({u'node':node, u'addNode':PyJs_addNode_471_, u'this':this, u'arguments':arguments, u'openEnd':openEnd, u'open':open}, var)
        ...
        PyJs_addNode_471_._set_name(u'addNode')
        var.get(u'Frontier').get(u'prototype').put(u'addNode', PyJs_addNode_471_)
        @Js
        def PyJs_closeNode_472_(this, arguments, var=var):
            var = Scope({u'this':this, u'closeNode':PyJs_closeNode_472_, u'arguments':arguments}, var)
            ...
            if (var.get(u'open').get(u'content').get(u'size')==Js(0.0)):
                ...
                if var.get(u'open').get(u'wrapper'):
                    ...
                    PyJs_Object_473_ = Js({u'depth':var.get(u'open').get(u'depth'),u'content':var.get(u'open').get(u'content'),u'openEnd':var.get(u'open').get(u'openEnd')})
                    var.get(u"this").get(u'placed').put(var.get(u'open').get(u'depth'), PyJs_Object_473_)
        PyJs_closeNode_472_._set_name(u'closeNode')
        var.get(u'Frontier').get(u'prototype').put(u'closeNode', PyJs_closeNode_472_)
        pass
        pass
        pass
        @Js
        def PyJs_anonymous_474_(PyJsArg_66726f6d_, to, slice, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'slice':slice, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
        ...
        var.get(u'Transform').get(u'prototype').put(u'replaceRange', PyJs_anonymous_474_)
        pass
        @Js
        def PyJs_anonymous_477_(PyJsArg_66726f6d_, to, node, this, arguments, var=var):
        ...
        var.get(u'Transform').get(u'prototype').put(u'replaceRangeWith', PyJs_anonymous_477_)
        @Js
        def PyJs_anonymous_478_(PyJsArg_66726f6d_, to, this, arguments, var=var):
            var = Scope({u'this':this, u'to':to, u'from':PyJsArg_66726f6d_, u'arguments':arguments}, var)
        ...
        PyJs_anonymous_478_._set_name(u'anonymous')
        var.get(u'Transform').get(u'prototype').put(u'deleteRange', PyJs_anonymous_478_)
        pass
    ...
    var.put(u'dist$1', var.get(u'createCommonjsModule')(PyJs_anonymous_356_))
    ...
    @Js
    def PyJs_anonymous_480_(doc_data, spec_data, this, arguments, var=var):
        var = Scope({u'this':this, u'doc_data':doc_data, u'spec_data':spec_data, u'arguments':arguments}, var)
        var.registers([u'node', u'doc_data', u'spec_data', u'schemaSpec', u'schema'])
        PyJs_Object_481_ = Js({u'marks':var.get(u'orderedmap').create(var.get(u'spec_data').get(u'marks').get(u'content')),u'nodes':var.get(u'orderedmap').create(var.get(u'spec_data').get(u'nodes').get(u'content'))})
        var.put(u'schemaSpec', PyJs_Object_481_)
        var.put(u'schema', var.get(u'dist_8').create(var.get(u'schemaSpec')))
        var.put(u'node', var.get(u'schema').callprop(u'nodeFromJSON', var.get(u'doc_data')))
        return var.get(u'node')
    PyJs_anonymous_480_._set_name(u'anonymous')
    var.put(u'create_doc', PyJs_anonymous_480_)
    @Js
    def PyJs_anonymous_482_(steps_data, doc, this, arguments, var=var):
        ...
        var.get(u'steps').callprop(u'forEach', PyJs_anonymous_484_)
        return var.get(u'transform').get(u'doc')
    PyJs_anonymous_482_._set_name(u'anonymous')
    var.put(u'transform_doc', PyJs_anonymous_482_)
...
var.put(u'prosemirror', PyJs_anonymous_1_(PyJs_Object_0_))
pass
