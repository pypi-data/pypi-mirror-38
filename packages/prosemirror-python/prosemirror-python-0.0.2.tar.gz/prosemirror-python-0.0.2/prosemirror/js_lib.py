...
def PyJs_anonymous_1_(exports, this, arguments, var=var):
    ...
    def PyJs_anonymous_356_(module, exports, this, arguments, var=var):
        ...
        def PyJs_fromReplace_402_(doc, PyJsArg_66726f6d_, to, slice, this, arguments, var=var):
            ...
            try:
                ...
                PyJsHolder_65_43715238 = var.own.get(u'e')
                ...
                try:
                    ...
                    if PyJsHolder_65_43715238 is not None:
                        var.own[u'e'] = PyJsHolder_65_43715238
                    else:
                        del var.own[u'e']
                    del PyJsHolder_65_43715238
    ...
    @Js
    def PyJs_anonymous_480_(doc_data, schema_spec, this, arguments, var=var):
    ...
    @Js
    def PyJs_anonymous_481_(steps_data, doc, this, arguments, var=var):
        ...
        var.put(u'steps', var.get(u'steps_data').callprop(u'map', PyJs_anonymous_482_))
        var.put(u'transform', var.get(u'dist_1$1').create(var.get(u'doc')))
        @Js
        def PyJs_anonymous_483_(step, this, arguments, var=var):
        ...
        var.get(u'steps').callprop(u'forEach', PyJs_anonymous_483_)
        return var.get(u'transform').get(u'doc')
    PyJs_anonymous_481_._set_name(u'anonymous')
    var.put(u'transform_doc', PyJs_anonymous_481_)
