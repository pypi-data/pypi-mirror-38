...
# Form implementation generated from reading ui file '/home/travis/build/henriquegemignani/randovania/randovania/gui/layout_generator_window.ui'
#
...
class Ui_LayoutGeneratorWindow(object):
    def setupUi(self, LayoutGeneratorWindow):
        ...
        self.scroll_area_widget_contents.setGeometry(QtCore.QRect(0, 0, 765, 1313))
        ...
        self.gridLayout_2.addWidget(self.itemquantity_description_label, 0, 0, 1, 3)
...
"Since there aren\'t many checks, out of bounds tricks will probably be necessary for many items."))
        ...
        self.itemquantity_description_label.setText(_translate("LayoutGeneratorWindow", "Choose how many of each item will appear in the game. Adding more than one for major upgrades makes it more likely you\'ll find that upgrade, but additional copies are useless.\n"
"\n"
"The total of configured items must be less than how many spots are in the game: trying to add more will fail when generating.\n"
"If removing items, the remaning spots are filled with Energy Transfer Module.\n"
"\n"
"Removing required items, like Screw Attack or all beams, will cause the generation to go infinitely."))
