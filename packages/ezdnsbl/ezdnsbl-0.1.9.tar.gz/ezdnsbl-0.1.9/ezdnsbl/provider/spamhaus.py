...
class Zen(dnsbl.DNSBL_Base):
    ...
    def __str__(self):
        ...
        if self.detailed_results:
            detailed_results_string =  ' Detailed Results: {}, More Info: {}'.format(self.detailed_results, self.category_info)
        return('IP {}\n    {}.\n        {}'.format(self.ip, match_text, detailed_results_string))


class DBL(dnsbl.DNSBL_Base):
