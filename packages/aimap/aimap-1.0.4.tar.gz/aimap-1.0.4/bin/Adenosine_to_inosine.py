...
def parse_cmdline():
    ...
    parser.add_argument("-n", "--number", dest="reads number",
...
if __name__ == '__main__':
    ...
    if args.model == "paired":
        ...
        aimap_tools.get_a_i_position(all_info_file1,all_info_file2,args.outdirname,args.outfile_name,args.number)
