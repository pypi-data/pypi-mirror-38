...
class mouseClick():
	def __init__(self,name,_id,x,y,clicking):
		...
		self.down = clicking
	def __str__(self):
		if self.type in ['click','click 2','middle mouse']:
...
def parseMouseCode():
	...
	mousenames = {0:'click',33:'mouse up',32:'mouse dragged',2:'mouse 2',34:'mouse 2 dragged',64:'scroll up',65:'scroll down',1:'middle mouse',33:'middle mouse scroll',4:'forward button down',36:'forward button still down',35:'back button down'}
