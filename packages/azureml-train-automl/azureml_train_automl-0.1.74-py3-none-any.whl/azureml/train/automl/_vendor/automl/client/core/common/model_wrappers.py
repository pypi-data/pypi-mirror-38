...
class LightGBMClassifier(ClassifierMixin, _AbstractModelWrapper):
    ...
    def get_params(self, deep=True):
        ...
        params[self._min_data_str] = self.params[self._min_data_str]
...
class FastICA(TransformerMixin, _AbstractModelWrapper):
    """
    Fast ICA class.
    :param random_state:
        RandomState instance or None, optional (default=None)
    ...
    def fit(self, X, y=None):
        """
        Fit function for Fast ICA model.
        ...
        local_params['n_components'] = int(local_params['n_components'] * N)
        self.model = sklearn.decomposition.FastICA(**local_params)
        self.model.fit(X, y)

    def get_params(self):
        """
        Return parameters for Fast ICA model.

        :return: Parameters for the Fast ICA model
        """
        return self.params

    def transform(self, X, y=None):
        """
        Transform function for Fast ICA.

        :param X: Input data.
        :type X: numpy.ndarray
        :param y: Input target values.
        :type y: numpy.ndarray
        :return: Transformed data using Fast ICA model.
        """
        return self.model.transform(X)

    def fit_transform(self, X, y=None, **kwargs):
        """
        Fit Transform function for Fast ICA.

        :param X: Input data.
        :type X: numpy.ndarray
        :param y: Input target values.
        :type y: numpy.ndarray
        :param kwargs: Dictionary of keyword arguments (ignored).
        :return: Transformed data after fitted Fast ICA model.
        """
        self.fit(X)
    ...
    def predict(self, X):
        """
        Prediction function for Fast ICA model.

        :param X: Input data.
        :type X: numpy.ndarray
        :return: Prediction values from Fast ICA model.
        """
        return self.model.predict(X)
...
class SparseNormalizer(TransformerMixin, _AbstractModelWrapper):
    ...
    def get_params(self):
        ...
        :return: Parameters for Sparse Normalizer model.
        """
        return {self.norm_str: self.norm}
