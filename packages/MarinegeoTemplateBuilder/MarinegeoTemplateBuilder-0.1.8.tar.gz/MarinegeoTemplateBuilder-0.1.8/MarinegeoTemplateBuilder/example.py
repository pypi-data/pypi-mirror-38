...
# columns to add
fields_csv = 'sheet,fieldName,fieldDefinition,fieldType,formatString,lookup,unit,minValue,maxValue,warnLevel\n' \
...
main('TestTemplate_v0.0.1.xlsx', fields, vocab, "Test Template", 'DEFAULT', protect=True, metadataValues=metadataValues, dryrun=True)
