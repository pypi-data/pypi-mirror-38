...
class Field:
    ...
    def __init__(self, sheet=None, fieldName=None, fieldDefinition=None, fieldType="string", formatString=None,
                 lookup=None, unit=None, minValue=None, maxValue=None, warnLevel="warning"):
...
class Vocab:
    ...
    def __repr__(self):
        return '(fieldName: {}, code: {}, definition: {})'.format(self.fieldName, self.code, self.definition)
