...
"""
A setuptools based setup module for dino.
...
with open(path.join(here, 'dino', 'client.py'), encoding='utf-8') as f:
    lines = f.readlines()
    for l in lines:
...
setup(
    name='dino',
    version=__version__,
    description='A python API client for Dino monitoring service',
    long_description=long_description,
    url='https://github.com/EnergieID/dino',
    author='EnergieID',
