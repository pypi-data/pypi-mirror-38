...
Verify Ping from uut to helper
    run testcase    examples.genie.demo10_robot.pyats_loopback_reachability.PingTestcase    device=uut
Verify Ping from helper to uut
    run testcase    examples.genie.demo10_robot.pyats_loopback_reachability.NxosPingTestcase    device=helper
...
Testcase UnconfigureBgpNeighbor
    run testcase    examples.genie.demo10_robot.pyats_loopback_reachability.DeleteBgpNeighbor    device=uut  number=1
...
Recover the testbed
    run testcase    examples.genie.demo10_robot.pyats_loopback_reachability.RestoreDevice    device=uut
