...
Verify Ping from uut to helper
    run testcase    examples.genie.demo10_robot.pyats_loopback_reachability.NxosPingTestcase    device=uut
Verify Ping from helper to uut
    run testcase    examples.genie.demo10_robot.pyats_loopback_reachability.PingTestcase    device=helper
