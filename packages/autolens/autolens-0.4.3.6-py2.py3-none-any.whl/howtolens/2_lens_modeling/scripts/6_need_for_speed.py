...
# Of course, there are ways that we can reduce the number of image-pixels we incorrect_fit. That's what masking does. If we mask
...
#    lens galaxy parameters. Can you setup phases that incorrect_fit each galaxy individiually, before fitting them jointly?
