...
# Now lets incorrect_fit it using a phase, noting that indeed the galaxy-model corresponds to the one above.
...
# Create a lensing image to make the incorrect_fit - the mask we used above was a 3" circle (we'll come back to this later)
...
# Now, lets incorrect_fit the lensing image with the tracer and plot the incorrect_fit. It looks a lot better than above, doesn't it?
