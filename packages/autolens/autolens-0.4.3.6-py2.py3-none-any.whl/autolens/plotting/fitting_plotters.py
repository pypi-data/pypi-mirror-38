...
def plot_fitting_subplot(fit, mask=None, positions=None,
                        ...
                        titlesize=10, xlabelsize=10, ylabelsize=10, xyticksize=10,
                         ...
                         output_path=None, output_filename='incorrect_fit', output_format='show', ignore_config=True):
...
def plot_fitting_subplot_lens_plane_only(fit, mask=None, positions=None,
                                         ...
                                         titlesize=10, xlabelsize=10, ylabelsize=10, xyticksize=10,
                                         mask_pointsize=10, position_pointsize=10.0, grid_pointsize=1,
                                         output_path=None, output_filename='incorrect_fit', output_format='show'):
...
def plot_model_image(fit, as_subplot=False,
    ...
    tools_array.plot_array(array=fit.model_data, as_subplot=as_subplot,
                           units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                           cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max,
