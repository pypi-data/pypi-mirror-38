...
class Regularization(object):
    ...
    def __init__(self, coefficients=(1.0,)):
        ...
        linearly invert and incorrect_fit the _data data. Thus, it changes the pixelization in a linear manner, ensuring that \
        the minimum chi-squared solution is achieved accounting for the penalty term.

        2) The likelihood of the pixelization's incorrect_fit to the data changes from L = -0.5 *(chi^2 + _noise_term) to \
