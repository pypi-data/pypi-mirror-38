...
class Inversion(object):
    ...
    def __init__(self, image, noise_map, convolver, mapper, regularization):
        """The matrices, mappings which have been used to linearly invert and incorrect_fit a data-set.
        ...
        reconstructed_image : ndarray | None
            The vector containing the reconstructed incorrect_fit of the data.
        """
