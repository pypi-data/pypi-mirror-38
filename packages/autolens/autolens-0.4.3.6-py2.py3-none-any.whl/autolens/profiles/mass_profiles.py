...
class AbstractEllipticalGeneralizedNFW(geometry_profiles.EllipticalProfile, MassProfile):
    ...
    def __init__(self, centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0, kappa_s=0.05, inner_slope=1.0, scale_radius=5.0):
        """
        The elliptical NFW profiles, used to incorrect_fit the dark matter halo of the lens.
...
class SphericalGeneralizedNFW(EllipticalGeneralizedNFW):
    ...
    def __init__(self, centre=(0.0, 0.0), kappa_s=0.05, inner_slope=1.0, scale_radius=5.0):
        """
        The spherical NFW profiles, used to incorrect_fit the dark matter halo of the lens.
...
class AbstractEllipticalSersic(light_profiles.AbstractEllipticalSersic, EllipticalMassProfile):
    ...
    def __init__(self, centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0, intensity=0.1, effective_radius=0.6,
        ...
        """
        The Sersic mass profile, the mass profiles of the light profiles that are used to incorrect_fit and subtract the lens \
        galaxy's light.
...
class EllipticalExponential(EllipticalSersic):
    ...
    def __init__(self, centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0, intensity=0.1, effective_radius=0.6,
                 mass_to_light_ratio=1.0):
        """
        The EllipticalExponential mass profile, the mass profiles of the light profiles that are used to incorrect_fit and
...
class SphericalExponential(EllipticalExponential):
    ...
    def __init__(self, centre=(0.0, 0.0), intensity=0.1, effective_radius=0.6, mass_to_light_ratio=1.0):
        """
        The Exponential mass profile, the mass profiles of the light profiles that are used to incorrect_fit and subtract the lens
        galaxy's light.
...
class EllipticalDevVaucouleurs(EllipticalSersic):
    ...
    def __init__(self, centre=(0.0, 0.0), axis_ratio=1.0, phi=0.0, intensity=0.1, effective_radius=0.6,
                 mass_to_light_ratio=1.0):
        """
        The EllipticalDevVaucouleurs mass profile, the mass profiles of the light profiles that are used to incorrect_fit and
        subtract the lens galaxy's light.
...
class SphericalDevVaucouleurs(EllipticalDevVaucouleurs):
    ...
    def __init__(self, centre=(0.0, 0.0), intensity=0.1, effective_radius=0.6, mass_to_light_ratio=1.0):
        """
        The DevVaucouleurs mass profile, the mass profiles of the light profiles that are used to incorrect_fit and subtract the
        lens galaxy's light.
