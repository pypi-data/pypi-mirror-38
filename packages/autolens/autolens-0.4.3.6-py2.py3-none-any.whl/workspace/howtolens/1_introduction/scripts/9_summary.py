...
# lens system. Lets get a 'incorrect_fit' to a strong lens, by setting up an image, mask, tracer, etc.
...
# The incorrect_fit contains our tracer, which contains our planes, which contain our grids and galaxies, which contain our
# profiles:
print(fit)
print(fit.tracer)
...
# break-up the different components of the incorrect_fit and tracer.
