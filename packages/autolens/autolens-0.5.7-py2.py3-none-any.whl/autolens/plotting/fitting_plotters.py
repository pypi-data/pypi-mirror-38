...
def plot_fitting_subplot(fit, should_plot_mask=True, positions=None,
                        ...
                        titlesize=10, xlabelsize=10, ylabelsize=10, xyticksize=10,
                         ...
                         output_path=None, output_filename='fit_normal', output_format='show', ignore_config=True):
...
def plot_fitting_subplot_lens_plane_only(fit, should_plot_mask=True, positions=None,
                                         ...
                                         titlesize=10, xlabelsize=10, ylabelsize=10, xyticksize=10,
                                         mask_pointsize=10, position_pointsize=10.0, grid_pointsize=1,
                                         output_path=None, output_filename='fit_normal', output_format='show'):
...
def plot_model_image(fit, mask=None, as_subplot=False,
    ...
    tools_array.plot_array(array=fit.model_datas, mask=mask, as_subplot=as_subplot,
                           units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                           cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max,
...
def plot_scaled_model_image(fit, mask=None, as_subplot=False,
    ...
    tools_array.plot_array(array=fit.scaled_model_images, mask=mask, as_subplot=as_subplot,
                           units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                           cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max,
                           linthresh=linthresh, linscale=linscale,
                           cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
...
def plot_scaled_noise_map(fit, mask=None, as_subplot=False,
    ...
    tools_array.plot_array(array=fit.scaled_noise_maps, mask=mask, as_subplot=as_subplot,
                           units=units, kpc_per_arcsec=kpc_per_arcsec, figsize=figsize, aspect=aspect,
                           cmap=cmap, norm=norm, norm_min=norm_min, norm_max=norm_max,
                           linthresh=linthresh, linscale=linscale,
                           cb_ticksize=cb_ticksize, cb_fraction=cb_fraction, cb_pad=cb_pad,
