...
class GalaxyModel(model_mapper.AbstractPriorModel):
    ...
    def __init__(self,
        ...
        light_profile_classes: [LightProfile]
            The classes for which light profile instances are generated for this model_galaxy
        ...
        if pixelization is not None and regularization is None:
            raise exc.PriorException('If the model_galaxy prior has a pixelization, it must also have a regularization.')
        if pixelization is None and regularization is not None:
            raise exc.PriorException('If the model_galaxy prior has a regularization, it must also have a pixelization.')
    ...
    def prior_models(self):
        ...
        prior_models: [model_mapper.PriorModel]
            A list of the prior models (e.g. variable profiles) attached to this model_galaxy prior
        """
    ...
    def prior_tuples(self):
        ...
        -------
        priors: [PriorTuple]
            A list of priors associated with prior models in this model_galaxy prior.
        """
    ...
    def constant_tuples(self):
        ...
        constant: [ConstantTuple]
            A list of constants associated with prior models in this model_galaxy prior.
        """
    ...
    def gaussian_prior_model_for_arguments(self, arguments):
        """
        Create a new model_galaxy prior from a set of arguments, replacing the priors of some of this model_galaxy prior's prior
    ...
    def from_galaxy(cls, g, **kwargs):
        """
        Create a new model_galaxy prior with constants taken from a model_galaxy.
