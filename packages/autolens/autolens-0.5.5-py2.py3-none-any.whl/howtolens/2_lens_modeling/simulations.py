...
path = "{}".format(os.path.dirname(os.path.realpath(__file__))) # Setup path so we can output the simulated datas.
im.output_imaging_to_fits(image=image_simulated, image_path=path+'/datas/1_non_linear_search_image.fits',
                                                 noise_map_path=path+'/datas/1_non_linear_search_noise_map.fits',
                                                 psf_path=path+'/datas/1_non_linear_search_psf.fits',
                          overwrite=True)
...
path = "{}".format(os.path.dirname(os.path.realpath(__file__))) # Setup path so we can output the simulated datas.
im.output_imaging_to_fits(image=image_simulated, image_path=path+'/datas/3_realism_and_complexity_image.fits',
                                                 noise_map_path=path+'/datas/3_realism_and_complexity_noise_map.fits',
                                                 psf_path=path+'/datas/3_realism_and_complexity_psf.fits',
                          overwrite=True)
