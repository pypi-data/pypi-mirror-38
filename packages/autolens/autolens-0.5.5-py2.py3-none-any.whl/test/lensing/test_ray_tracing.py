...
class TestTracerImagePlane(object):
    ...
    class TestImagePlaneImage:
        ...
        def test__1_plane__single_plane_tracer(self, imaging_grids):
            ...
            assert (tracer.image_plane_images_ == image_plane.image_plane_images_).all()

            image_plane_image_2d = imaging_grids.image.scaled_array_from_array_1d(image_plane.image_plane_images_)
            assert image_plane_image_2d.shape == (3, 4)
            assert (image_plane_image_2d == tracer.image_plane_images).all()
    ...
    class TestImagePlaneBlurringImages:
        ...
        def test__1_plane__single_plane_tracer(self, imaging_grids):
            ...
            assert (tracer.image_plane_blurring_images_ == image_plane.image_plane_blurring_images_).all()
...
class TestTracerImageSourcePlanes(object):
    ...
    class TestImagePlaneImages:
        ...
        def test__galaxy_light__no_mass__image_sum_of_image_and_source_plane(self, imaging_grids):
            ...
            image_plane_image_1d = image_plane.image_plane_images_ + source_plane.image_plane_images_
            assert (image_plane_image_1d == tracer.image_plane_images_).all()

            image_plane_image_2d = imaging_grids.image.scaled_array_from_array_1d(image_plane.image_plane_images_) + \
                                   imaging_grids.image.scaled_array_from_array_1d(source_plane.image_plane_images_)
            assert image_plane_image_2d.shape == (3, 4)
            assert (image_plane_image_2d == tracer.image_plane_images).all()
        ...
        def test__image_plane_image_same_as_above(self, imaging_grids):
            ...
            assert (tracer.image_plane_images_ == g0_image + g1_image + g2_image).all()

            assert (tracer.image_plane_images == imaging_grids.image.scaled_array_from_array_1d(g0_image) +
        ...
        def test__2_planes__returns_image_plane_image_of_each_plane(self, imaging_grids):
            ...
            assert (tracer.image_plane_images_ == image_plane.image_plane_images_ + source_plane.image_plane_images_).all()
        ...
        def test__padded_2d_image_from_plane__mapped_correctly(self, padded_grids, galaxy_light, galaxy_mass):
            ...
            image_plane_image_2d = padded_grids.image.scaled_array_from_array_1d(tracer.image_plane.image_plane_images_) + \
                                   padded_grids.image.scaled_array_from_array_1d(tracer.source_plane.image_plane_images_)
        ...
        def test__padded_2d_image_for_simulation__mapped_correctly_not_trimmed(self, padded_grids, galaxy_light,
            ...
            image_plane_image_2d = padded_grids.image.map_to_2d_keep_padded(tracer.image_plane.image_plane_images_) + \
                                   padded_grids.image.map_to_2d_keep_padded(tracer.source_plane.image_plane_images_)

            assert image_plane_image_2d.shape == (3, 4)
            assert (image_plane_image_2d == tracer.image_plane_images_for_simulation).all()
    ...
    class TestImagePlaneBlurringImages:
        ...
        def test__galaxy_light__no_mass__image_sum_of_image_and_source_plane(self, imaging_grids):
            ...
            plane_image_plane_blurring_image = image_plane.image_plane_blurring_images_ + \
                                               source_plane.image_plane_blurring_images_

            tracer = ray_tracing.TracerImageSourcePlanes(lens_galaxies=[g0], source_galaxies=[g1],
                                                         image_plane_grids=imaging_grids)

            assert (plane_image_plane_blurring_image == tracer.image_plane_blurring_images_).all()
        ...
        def test__galaxy_entered_3_times__diffferent_intensities_for_each(self, imaging_grids):
            ...
            assert (tracer.image_plane_blurring_images_ == g0_image + g1_image + g2_image).all()
...
class TestMultiTracer(object):
    ...
    class TestImagePlaneImages:
        ...
        def test__x1_galaxy_light_no_mass_in_each_plane__image_of_each_plane_is_galaxy_image(self, imaging_grids):
            ...
            image_plane_image = plane_0.image_plane_images + plane_1.image_plane_images + plane_2.image_plane_images

            assert image_plane_image.shape == (3, 4)
            assert (image_plane_image == tracer.image_plane_images).all()
        ...
        def test__padded_2d_image_for_simulation__mapped_correctly_not_trimmed(self, padded_grids):
            ...
            image_plane_image_for_simulation = plane_0.image_plane_images_for_simulation + \
                                               plane_1.image_plane_images_for_simulation + \
                                               plane_2.image_plane_images_for_simulation

            assert image_plane_image_for_simulation.shape == (3,4)
            assert (image_plane_image_for_simulation == tracer.image_plane_images_for_simulation).all()
    ...
    class TestImagePlaneBlurringImages:
        ...
        def test__x1_galaxy_light_no_mass_in_each_plane__image_of_each_plane_is_galaxy_image(self, imaging_grids):
            ...
            image_plane_blurring_image = plane_0.image_plane_blurring_images_ + plane_1.image_plane_blurring_images_ + \
                                         plane_2.image_plane_blurring_images_

            assert (image_plane_blurring_image == tracer.image_plane_blurring_images_).all()
