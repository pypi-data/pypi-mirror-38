...
# In the previous example, we used a non-linear search to infer the best-incorrect_fit lens model to a strong lens image. In this
...
# source model_galaxy models, using the same image as the previous tutorial.
...
class CustomPhase(ph.LensSourcePlanePhase):
    ...
    def pass_priors(self, previous_results):
        ...
        # The 0 index in 'lens_galaxies[0]' signifies it is the first lens model_galaxy in the list we input to create
