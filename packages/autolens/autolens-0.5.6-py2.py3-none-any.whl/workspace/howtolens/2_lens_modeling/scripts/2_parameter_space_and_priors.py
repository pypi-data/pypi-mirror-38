...
# f(x_mp, y_mp, R_mp, x_lp, y_lp, I_lp, R_lp) = a likelihood from AutoLens's tracer_without_subhalo / fitting modules
...
# This function simulates the image we'll incorrect_fit in this tutorial - which is identical to the previous tutorial.
def simulate():
