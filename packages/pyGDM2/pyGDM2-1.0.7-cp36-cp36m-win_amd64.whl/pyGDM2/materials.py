...
class fromFile(object):
    ...
    def __init__(self, refindex_file, unit_wl='micron', interpolate_order=1):
...
class silver(object):
    ...
    def __init__(self, interpolate_order=1):
        """silver dispersion"""
        self.wl =     np.array([ 0.1879 , 0.1916 , 0.1953 , 0.1993 , 0.2033 , 0.2073 , 0.2119 , 0.2164 , 0.2214 , 0.2262 , 0.2313 , 
