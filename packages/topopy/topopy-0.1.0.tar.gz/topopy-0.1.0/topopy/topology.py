...
class PairVector(_object):
    ...
    def iterator(self):
        return _topology.PairVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _topology.PairVector___nonzero__(self)

    def __bool__(self):
        return _topology.PairVector___bool__(self)

    def __len__(self):
        return _topology.PairVector___len__(self)

    def __getslice__(self, i, j):
        return _topology.PairVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _topology.PairVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _topology.PairVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _topology.PairVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _topology.PairVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _topology.PairVector___setitem__(self, *args)

    def pop(self):
        return _topology.PairVector_pop(self)

    def append(self, x):
        return _topology.PairVector_append(self, x)

    def empty(self):
        return _topology.PairVector_empty(self)

    def size(self):
        return _topology.PairVector_size(self)

    def swap(self, v):
        return _topology.PairVector_swap(self, v)

    def begin(self):
        return _topology.PairVector_begin(self)

    def end(self):
        return _topology.PairVector_end(self)

    def rbegin(self):
        return _topology.PairVector_rbegin(self)

    def rend(self):
        return _topology.PairVector_rend(self)

    def clear(self):
        return _topology.PairVector_clear(self)

    def get_allocator(self):
        return _topology.PairVector_get_allocator(self)

    def pop_back(self):
        return _topology.PairVector_pop_back(self)

    def erase(self, *args):
        return _topology.PairVector_erase(self, *args)

    def __init__(self, *args):
        this = _topology.new_PairVector(*args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _topology.PairVector_push_back(self, x)

    def front(self):
        return _topology.PairVector_front(self)

    def back(self):
        return _topology.PairVector_back(self)

    def assign(self, n, x):
        return _topology.PairVector_assign(self, n, x)

    def resize(self, *args):
        return _topology.PairVector_resize(self, *args)

    def insert(self, *args):
        return _topology.PairVector_insert(self, *args)

    def reserve(self, n):
        return _topology.PairVector_reserve(self, n)

    def capacity(self):
        return _topology.PairVector_capacity(self)
    __swig_destroy__ = _topology.delete_PairVector
    __del__ = lambda self: None
PairVector_swigregister = _topology.PairVector_swigregister
