...
class ValidateConfig:
    def __init__(
        ...
        # Path to the facial recognition model
        self.model_path = model_path
        # Filename of pairs.txt
        self.pairs_file_name = pairs_file_name
        # Set this flag if the model is insightface
        self.is_insightface = is_insightface
        # Specify if the images have already been aligned.
        self.prealigned_flag = prealigned_flag
