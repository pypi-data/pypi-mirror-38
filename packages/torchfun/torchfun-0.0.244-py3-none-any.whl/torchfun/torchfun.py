...
class ArgparseListType(list):
    ...
    def __call__(self,opt_str):
        ...
        return [self.element_type(i) for i in elems]

list_of_int = ArgparseListType()
