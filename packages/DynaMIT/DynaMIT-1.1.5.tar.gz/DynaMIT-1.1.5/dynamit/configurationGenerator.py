...
class DynamitConfigurationGenerator(tk.Frame):
	...
	def __createSearcherLineWidgets(self):
		...
		self.searchersNameBox = tkinter.ttk.Combobox(self.searchersFrame,
	...
	def __createStrategyLineWidgets(self):
		...
		self.integrationNameBox = tkinter.ttk.Combobox(self.integrationFrame,
	...
	def __createPrinterLineWidgets(self):
		...
		self.printersNameBox = tkinter.ttk.Combobox(self.printersFrame,
	...
	def open(self):
		...
		if self.generatedConfigListBox.size() > 0:
			answer = tkinter.messagebox.askyesno("DynaMIT",
	...
	def about(self):
		...
		"""
		tkinter.messagebox.showinfo(self.master.title(),
