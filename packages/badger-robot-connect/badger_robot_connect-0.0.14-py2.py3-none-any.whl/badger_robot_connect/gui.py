...
class GUI(QWidget):
    def __init__(self, parent=None):
        ...
        img_logo = QLabel()
        img_logo.setPixmap(QPixmap(r'./images/BADGER.png'))
...
class RotatedSvg(QWidget):
    ...
    def paintEvent(self, event):
        ...
        svg = QSvgRenderer(r'./images/Pitch_Indicator_Back.svg')
        svg.render(painter)
        ...
        svg_top = QSvgRenderer(r'./images/Pitch_Indicator_Needle.svg')
