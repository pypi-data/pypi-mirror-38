...
##  synthetically generated noisy height data, but with the proviso that the Jacobian
##  must be calculated through the partial-derivatives of the model functional as
##  supplied by the user through the constructor option 'partials_for_jacobian' for
##  the OptimizeSurfaceFit class.
##
...
##
##  Call syntax:  grad_descent_partial_derivatives.py
...
print("\n\n\nRESULTS RETURNED BY grad_descent_with_partial_derivatives.py:")       #(J)
