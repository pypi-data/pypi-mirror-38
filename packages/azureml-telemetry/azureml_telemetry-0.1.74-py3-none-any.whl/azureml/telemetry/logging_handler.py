...
class AppInsightsLoggingHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        properties = {'level': record.levelname, 'loggerName': record.name, 'sessionId': _ClientSessionId}
        ...
        if record.exc_info:
            self._synchronous_client.track_exception(*record.exc_info, properties=properties)
            return
