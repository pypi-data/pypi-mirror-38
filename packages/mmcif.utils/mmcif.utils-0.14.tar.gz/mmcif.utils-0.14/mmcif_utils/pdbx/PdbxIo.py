...
class PdbxEntryInfoIo(PdbxStyleIoUtil):
    ...
    def __getStatusDetails(self):
        ...
        try:
            ...
            if catObj is not None:
                ...
                return (statusCode, authReleaseCode, initialDepositionDate, holdCoordinatesDate, coordinatesDate, approvalType, annotatorInitials, depositSite, processSite)
            else:
                return ('', '', '', '', '', '', '', '', '')
        except Exception as e:
            if (self.__verbose):
    ...
    def __getInfoGeneral(self):
        ...
        try:
            ...
            statusCode, authReleaseCode, initialDepositionDate, holdCoordinatesDate, coordinatesDate, approvalType, annotatorInitials, depositSite, processSite = self.__getStatusDetails()
