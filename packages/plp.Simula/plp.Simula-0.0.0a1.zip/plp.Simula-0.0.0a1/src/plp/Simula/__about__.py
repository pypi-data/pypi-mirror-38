...
__title__        = "plp.Simula"
__summary__      = "Parser for Simula67 programming language."
__uri__          = "http://pypi.python.org/pypi/plp.Simula/"
...
__copyright__    = "Copyright 2003-2018 {0}".format(__author__)
