...
long_description_path = path.join(here, 'README.rst')
...
setup(
    ...
    description='planningalerts morph.io data layer Python client package',
    long_description=long_description,

    # The project's main homepage.
    url='https://bitbucket.org/otherchirps/morph_planningalerts',
