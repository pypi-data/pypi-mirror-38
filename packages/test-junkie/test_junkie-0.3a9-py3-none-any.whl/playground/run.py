...
runner = Runner([TestSuiteD, TestSuiteB, TestSuiteA, TestSuiteC], monitor_resources=True,
                html_report="E:\Development\\test_junkie\\playground\\report.html")

aggregator = runner.run(test_multithreading_limit=3, suite_multithreading_limit=4)
