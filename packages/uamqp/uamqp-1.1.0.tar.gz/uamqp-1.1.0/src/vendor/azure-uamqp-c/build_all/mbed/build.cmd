...
call "%repo-build-root%\deps\azure-c-shared-utility\tools\compilembed\build.cmd" --clean
...
call %repo-build-root%\deps\azure-c-shared-utility\tools\mbed_build_scripts\release_mbed_project.cmd %repo-build-root%\build_all
if not !ERRORLEVEL!==0 exit /b !ERRORLEVEL!
