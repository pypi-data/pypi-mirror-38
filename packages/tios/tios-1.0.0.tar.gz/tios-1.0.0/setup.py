...
setup_args = {
    'name':             "tios",
    'version':          verstr,
    'description':      "The internet of things, for MD simulations.",
    'long_description': "The internet of things, for MD simulations.",
    'author':           "Charlie Laughton",
    'author_email':     "charles.laughton@nottingham.ac.uk",
    'url':              "https://bitbucket.org/claughton/tios/wiki/Home",
    'download_url':     "https://bitbucket.org/claughton/tios",
    'license':          "BSD license.",
    ...
    'scripts': ['scripts/tios-add_user',
                'scripts/tios-add_guest',
                'scripts/tios-collect',
                'scripts/tios-config',
                'scripts/tios-config_admin',
                'scripts/tios-cp',
                'scripts/tios-download',
                'scripts/tios-info',
                'scripts/tios-list_users',
                'scripts/tios-ls',
                'scripts/tios-passwd',
                'scripts/tios-remove_user',
                'scripts/tios-reset',
                'scripts/tios-restart',
                'scripts/tios-rm',
                'scripts/tios-run',
                'scripts/tios-stop',
                'scripts/tios-submit'],
