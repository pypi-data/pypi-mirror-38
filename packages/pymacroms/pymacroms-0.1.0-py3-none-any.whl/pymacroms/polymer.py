...
class Polymer:
    ...
    def __init__(self, endgroupPairs, monomers, adductIon = "H+", charge = 1, minRelAbundance = 0.01, minRepeatingUnits = None, maxRepeatingUnits = None, mzRange = None, firstMonomerMajor: bool = False, comonomersToFirstMaxRatio: float = 1, lastMonomerMinor: bool = False):
        """
        ...
        # self.endgroup1 = pymacroms.getFormulaStrFromCounter(endgroup1)
        # self.endgroup2 = pymacroms.getFormulaStrFromCounter(endgroup2)
        ...
        print("    (filtering and calculating the isotopic pattern of the rest might take a while)")
        ...
        macromolecules.sort(key=itemgetter("repUnitsTotal"))
        print("--> Number of macromolecules retained based on restrictions: " + str(len(macromolecules)))
