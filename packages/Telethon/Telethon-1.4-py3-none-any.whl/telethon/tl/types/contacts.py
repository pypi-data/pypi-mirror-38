...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypePeer, TypePopularContact, TypeContactBlocked, TypeContact, TypeChat, TypeTopPeerCategoryPeers, TypeContactLink, TypeImportedContact
