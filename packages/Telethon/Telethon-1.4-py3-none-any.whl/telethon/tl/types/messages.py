...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeUser, TypeEncryptedFile, TypeStickerSetCovered, TypeDocument, TypeHighScore, TypeStickerPack, TypeBotInlineResult, TypeChat, TypeChatFull, TypeMessage, TypeStickerSet, TypeFoundGif, TypeInlineBotSwitchPM, TypeDialog
