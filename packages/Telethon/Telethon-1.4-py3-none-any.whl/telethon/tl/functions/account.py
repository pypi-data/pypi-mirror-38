...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputPrivacyRule, TypeSecureValueHash, TypeInputPeer, TypeInputPeerNotifySettings, TypeInputSecureValue, TypeInputPrivacyKey, TypeSecureValueType, TypeSecureCredentialsEncrypted, TypeAccountDaysTTL, TypeInputNotifyPeer, TypeReportReason
