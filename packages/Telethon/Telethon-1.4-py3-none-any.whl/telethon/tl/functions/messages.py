...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeMessagesFilter, TypeInputStickerSet, TypeInputBotInlineMessageID, TypeInlineBotSwitchPM, TypeInputEncryptedChat, TypeInputStickeredMedia, TypeInputMessage, TypeInputBotInlineResult, TypeInputChatPhoto, TypeInputEncryptedFile, TypeInputMedia, TypeReportReason, TypeInputGeoPoint, TypeInputDocument, TypeReplyMarkup, TypeInputDialogPeer, TypeSendMessageAction, TypeInputSingleMedia, TypeInputUser, TypeInputPeer, TypeShippingOption, TypeMessageEntity
