...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeBool, TypeChannelBannedRights, TypeChannelAdminLogEventsFilter, TypeInputUser, TypeInputMessage, TypeInputChatPhoto, TypeInputStickerSet, TypeChannelAdminRights, TypeChannelParticipantsFilter
