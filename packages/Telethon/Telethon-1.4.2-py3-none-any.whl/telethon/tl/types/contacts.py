...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypePopularContact, TypeImportedContact, TypeUser, TypeContactLink, TypeTopPeerCategoryPeers, TypeContactBlocked, TypeChat, TypeContact
