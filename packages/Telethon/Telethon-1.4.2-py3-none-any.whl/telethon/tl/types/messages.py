...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSetCovered, TypeMessage, TypeDialog, TypeDocument, TypeFoundGif, TypeUser, TypeInlineBotSwitchPM, TypeHighScore, TypeEncryptedFile, TypeStickerSet, TypeStickerPack, TypeBotInlineResult, TypeChatFull, TypeChat
