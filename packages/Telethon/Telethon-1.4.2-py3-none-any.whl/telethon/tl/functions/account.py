...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeSecureCredentialsEncrypted, TypeInputPrivacyRule, TypeBool, TypeReportReason, TypeInputPrivacyKey, TypeInputPeerNotifySettings, TypeSecureValueHash, TypeInputPeer, TypeAccountDaysTTL, TypeInputNotifyPeer, TypeInputSecureValue, TypeSecureValueType
