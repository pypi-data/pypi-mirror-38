...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeInputMessage, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeSendMessageAction, TypeMessagesFilter, TypeInputEncryptedChat, TypeShippingOption, TypeInputGeoPoint, TypeReportReason, TypeInputUser, TypeInlineBotSwitchPM, TypeBool, TypeInputSingleMedia, TypeInputChatPhoto, TypeReplyMarkup, TypeInputDialogPeer, TypeInputPeer, TypeInputStickeredMedia, TypeMessageEntity, TypeInputMedia, TypeInputBotInlineResult, TypeInputDocument
