...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeTopPeerCategoryPeers, TypePeer, TypeImportedContact, TypeUser, TypePopularContact, TypeContactBlocked, TypeChat, TypeContactLink, TypeContact
