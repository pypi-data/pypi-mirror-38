...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSetCovered, TypeEncryptedFile, TypeChatFull, TypeUser, TypeInlineBotSwitchPM, TypeBotInlineResult, TypeMessage, TypeDialog, TypeStickerPack, TypeStickerSet, TypeDocument, TypeFoundGif, TypeChat, TypeHighScore
