...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputNotifyPeer, TypeAccountDaysTTL, TypeSecureCredentialsEncrypted, TypeInputPeerNotifySettings, TypeSecureValueType, TypeReportReason, TypeInputSecureValue, TypeSecureValueHash, TypeInputPeer, TypeBool, TypeInputPrivacyRule, TypeInputPrivacyKey
