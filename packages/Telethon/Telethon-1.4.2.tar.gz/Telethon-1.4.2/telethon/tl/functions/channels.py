...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputStickerSet, TypeChannelBannedRights, TypeInputChannel, TypeChannelAdminRights, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeBool, TypeInputMessage, TypeInputChatPhoto
