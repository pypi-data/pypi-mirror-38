...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedChat, TypeReplyMarkup, TypeShippingOption, TypeInputBotInlineResult, TypeInputStickerSet, TypeInputDialogPeer, TypeInputPeer, TypeInputChatPhoto, TypeInputSingleMedia, TypeInputBotInlineMessageID, TypeInputUser, TypeInputStickeredMedia, TypeSendMessageAction, TypeMessagesFilter, TypeBool, TypeInputMessage, TypeMessageEntity, TypeInputGeoPoint, TypeInputMedia, TypeReportReason, TypeInputDocument, TypeInlineBotSwitchPM, TypeInputEncryptedFile
