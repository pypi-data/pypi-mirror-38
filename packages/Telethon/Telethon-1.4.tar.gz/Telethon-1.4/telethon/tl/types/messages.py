...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInlineBotSwitchPM, TypeEncryptedFile, TypeChatFull, TypeChat, TypeBotInlineResult, TypeUser, TypeDialog, TypeStickerPack, TypeMessage, TypeHighScore, TypeFoundGif, TypeStickerSetCovered, TypeDocument, TypeStickerSet
