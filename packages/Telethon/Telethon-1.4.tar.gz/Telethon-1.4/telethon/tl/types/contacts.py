...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeContactBlocked, TypeChat, TypeUser, TypeTopPeerCategoryPeers, TypeContact, TypePopularContact, TypeContactLink, TypeImportedContact
