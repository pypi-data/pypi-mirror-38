...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputPrivacyKey, TypeInputSecureValue, TypeAccountDaysTTL, TypeInputPeerNotifySettings, TypeInputPeer, TypeInputNotifyPeer, TypeReportReason, TypeSecureValueHash, TypeInputPrivacyRule, TypeSecureValueType, TypeSecureCredentialsEncrypted
