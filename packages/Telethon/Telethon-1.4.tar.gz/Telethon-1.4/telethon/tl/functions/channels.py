...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputStickerSet, TypeInputUser, TypeChannelParticipantsFilter, TypeInputMessage, TypeChannelAdminRights, TypeInputChannel, TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights
