...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReplyMarkup, TypeInputSingleMedia, TypeMessagesFilter, TypeInputEncryptedFile, TypeShippingOption, TypeInputDialogPeer, TypeBool, TypeInputMedia, TypeInputUser, TypeSendMessageAction, TypeInputBotInlineMessageID, TypeInputEncryptedChat, TypeInputChatPhoto, TypeMessageEntity, TypeInputGeoPoint, TypeInlineBotSwitchPM, TypeInputMessage, TypeInputStickeredMedia, TypeInputBotInlineResult, TypeInputStickerSet, TypeInputDocument, TypeInputPeer, TypeReportReason
