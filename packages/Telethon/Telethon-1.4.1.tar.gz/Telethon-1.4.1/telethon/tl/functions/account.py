...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPrivacyRule, TypeInputNotifyPeer, TypeSecureValueHash, TypeSecureValueType, TypeInputPeerNotifySettings, TypeInputPrivacyKey, TypeAccountDaysTTL, TypeSecureCredentialsEncrypted, TypeBool, TypeReportReason, TypeInputSecureValue, TypeInputPeer
