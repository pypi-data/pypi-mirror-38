...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputBotInlineMessageID, TypeInputDocument, TypeBool, TypeInputStickerSet, TypeInputEncryptedFile, TypeInputMedia, TypeInputSingleMedia, TypeInputStickeredMedia, TypeInlineBotSwitchPM, TypeMessagesFilter, TypeReportReason, TypeInputUser, TypeInputChatPhoto, TypeSendMessageAction, TypeShippingOption, TypeInputPeer, TypeInputMessage, TypeMessageEntity, TypeInputDialogPeer, TypeInputGeoPoint, TypeReplyMarkup, TypeInputBotInlineResult, TypeInputEncryptedChat
