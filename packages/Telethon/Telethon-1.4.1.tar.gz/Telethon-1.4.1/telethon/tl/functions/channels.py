...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights, TypeInputChannel, TypeInputStickerSet, TypeChannelAdminRights, TypeBool, TypeInputMessage, TypeInputUser, TypeInputChatPhoto
