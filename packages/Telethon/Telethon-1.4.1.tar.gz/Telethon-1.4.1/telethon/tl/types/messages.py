...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeInlineBotSwitchPM, TypeDialog, TypeMessage, TypeEncryptedFile, TypeStickerSet, TypeDocument, TypeBotInlineResult, TypeStickerSetCovered, TypeChatFull, TypeStickerPack, TypeFoundGif, TypeHighScore, TypeUser
