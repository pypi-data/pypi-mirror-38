...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeTopPeerCategoryPeers, TypeContactBlocked, TypePeer, TypeContact, TypeContactLink, TypeUser, TypeImportedContact, TypePopularContact
