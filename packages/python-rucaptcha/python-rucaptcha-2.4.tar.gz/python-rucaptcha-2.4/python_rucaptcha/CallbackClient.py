...
'''
print(CallbackClient(task_id='60657442675').captcha_handler())

print(CallbackClient(task_id='60657442675', queue_name='ba86e77f9007a106c2eb2d7436e7444060657442674', call_type='queue').captcha_handler(requests_timeout=0.5,
                                                                                                   auth_params = {
                                                                                                    'port': '8001',
                                                                                                    'rtmq_username': 'hardworker_1',
                                                                                                    'rtmq_password': 'password',
