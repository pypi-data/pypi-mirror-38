...
# This file is part of List-Questions.
...
# List-Questions is distributed in the hope that it will be useful,
...
setup(
    ...
    description="A list of functions for a list of questions",
