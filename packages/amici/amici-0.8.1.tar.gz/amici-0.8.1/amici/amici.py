...
class ScalingVector(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, ScalingVector, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, ScalingVector, name)
    __repr__ = _swig_repr

    def iterator(self):
        return _amici.ScalingVector_iterator(self)
    def __iter__(self):
        return self.iterator()

    def __nonzero__(self):
        return _amici.ScalingVector___nonzero__(self)

    def __bool__(self):
        return _amici.ScalingVector___bool__(self)

    def __len__(self):
        return _amici.ScalingVector___len__(self)

    def __getslice__(self, i, j):
        return _amici.ScalingVector___getslice__(self, i, j)

    def __setslice__(self, *args):
        return _amici.ScalingVector___setslice__(self, *args)

    def __delslice__(self, i, j):
        return _amici.ScalingVector___delslice__(self, i, j)

    def __delitem__(self, *args):
        return _amici.ScalingVector___delitem__(self, *args)

    def __getitem__(self, *args):
        return _amici.ScalingVector___getitem__(self, *args)

    def __setitem__(self, *args):
        return _amici.ScalingVector___setitem__(self, *args)

    def pop(self):
        return _amici.ScalingVector_pop(self)

    def append(self, x):
        return _amici.ScalingVector_append(self, x)

    def empty(self):
        return _amici.ScalingVector_empty(self)

    def size(self):
        return _amici.ScalingVector_size(self)

    def swap(self, v):
        return _amici.ScalingVector_swap(self, v)

    def begin(self):
        return _amici.ScalingVector_begin(self)

    def end(self):
        return _amici.ScalingVector_end(self)

    def rbegin(self):
        return _amici.ScalingVector_rbegin(self)

    def rend(self):
        return _amici.ScalingVector_rend(self)

    def clear(self):
        return _amici.ScalingVector_clear(self)

    def get_allocator(self):
        return _amici.ScalingVector_get_allocator(self)

    def pop_back(self):
        return _amici.ScalingVector_pop_back(self)

    def erase(self, *args):
        return _amici.ScalingVector_erase(self, *args)

    def __init__(self, *args):
        this = _amici.new_ScalingVector(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def push_back(self, x):
        return _amici.ScalingVector_push_back(self, x)

    def front(self):
        return _amici.ScalingVector_front(self)

    def back(self):
        return _amici.ScalingVector_back(self)

    def assign(self, n, x):
        return _amici.ScalingVector_assign(self, n, x)

    def resize(self, *args):
        return _amici.ScalingVector_resize(self, *args)

    def insert(self, *args):
        return _amici.ScalingVector_insert(self, *args)

    def reserve(self, n):
        return _amici.ScalingVector_reserve(self, n)

    def capacity(self):
        return _amici.ScalingVector_capacity(self)
    __swig_destroy__ = _amici.delete_ScalingVector
    __del__ = lambda self: None
ScalingVector_swigregister = _amici.ScalingVector_swigregister
ScalingVector_swigregister(ScalingVector)
