...
Implementation of the `BERT <https://arxiv.org/pdf/1810.04805.pdf>`_. Official pre-trained models could be loaded for feature extraction.
...
See `load model demo <./demo/load_model>`_. You should be able to get the same feature extraction result as the official model.
