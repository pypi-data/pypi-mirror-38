...
# -------------------------------------------------
#   @File_Name： TestMapCollectAddPoi.py
#   @Author：    YanYi
...
class TestMapCollectAddPoi(unittest.TestCase):
    u"""测试接口：增加POI收藏记录"""
    ...
    def test_addpoi_1(self):
        u"""字段输入异常 poi_id 未输入"""
        ip = "http://47.100.220.189:8888"
        url = "/map/collect/addpoi"
        headers = {'Vin': 'LSJA1234567890118', 'User_id': '123456'}
        data = {"poi_id": "", "timestamp": 1515377061.875, "location": "121.842506,31.779192"}
    ...
    def test_addpoi_3(self):
        u"""字段输入正确"""
        ip = "http://47.100.220.189:8888"
        url = "/map/collect/addpoi"
        headers = {'Vin': 'LSJA1234567890118', 'User_id': '123456'}
        data = {"poi_id": "B0FFHP6I9M", "timestamp": 1515377061.875, "location": "121.842506,31.779192"}
        start_time = datetime.datetime.now()
        self.um.interface_requests(ip, url, headers=headers, body=data)
        end_time = datetime.datetime.now()
        print()
