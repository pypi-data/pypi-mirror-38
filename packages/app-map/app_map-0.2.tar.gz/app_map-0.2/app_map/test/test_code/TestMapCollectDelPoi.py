...
# -------------------------------------------------
#   @File_Name： TestMapCollectDelPoi.py
#   @Author：    YanYi
...
class TestMapCollectDelPoi(unittest.TestCase):
    u"""测试接口：删除POI收藏记录"""
    ...
    def test_delpoi_1(self):
        u"""字段输入异常 poi_id 未输入"""
        ip = "http://47.100.220.189:8888"
        url = "/map/collect/delpoi"
