            ...
            for group in stix_objects:
             ...
             for software in stix_objects:
                software_dict = {
                    ...
                    'platform': self.try_except(software, 'x_mitre_platforms')
                }
        ...
        for gr in all_groups_relationships:
            for s in software:
                if s['id'] == gr['target_object']:
                    ...
                    all_groups_software_use.append(s)
