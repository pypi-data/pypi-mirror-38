...
def read_tfrec(filenames, batch_size=None, num_epochs=-1, shuffle=True):
...
@input_func_dec
def read_tfrec_func(filenames, batch_size=None, num_epochs=-1, shuffle=True):
    return read_tfrec(filenames, batch_size, num_epochs, shuffle)


def read_tfrec_img(filenames, shape, batch_size=None, num_epochs=-1, shuffle=True,
                   shape_enlarge=True, normalization=True):
    if isinstance(filenames, str):
        filenames = [filenames]
    filename_parsed = parse_tfrec_name(filenames[0])
    ds_shape = filename_parsed[1]
...
def read_raw_tfimgrec(filenames, num_epochs=-1):
    if isinstance(filenames, str):
        filenames = [filenames]
    filename_parsed = parse_tfrec_name(filenames[0])
    is_pred = not filename_parsed[0]
...
@input_func_dec
def read_raw_tfimgrec_func(filenames, num_epochs=-1):
    return read_raw_tfimgrec(filenames, num_epochs)
...
def read_tfrec_array(arrs, batch_size=None, num_epochs=-1, shuffle=True, is_reg=False):
...
@input_func_dec
def read_tfrec_array_func(arrs, batch_size=None, num_epochs=-1, shuffle=True, is_reg=False):
    return read_tfrec_array(arrs, batch_size, num_epochs, shuffle, is_reg)
