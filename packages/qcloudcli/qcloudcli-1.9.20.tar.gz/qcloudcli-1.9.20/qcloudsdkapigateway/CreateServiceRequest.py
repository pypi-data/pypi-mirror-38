...
class CreateServiceRequest(Request):
    ...
    def get_exclusiveSetName(self):
        return self.get_params().get('exclusiveSetName')

    def set_exclusiveSetName(self, exclusiveSetName):
        self.add_param('exclusiveSetName', exclusiveSetName)
