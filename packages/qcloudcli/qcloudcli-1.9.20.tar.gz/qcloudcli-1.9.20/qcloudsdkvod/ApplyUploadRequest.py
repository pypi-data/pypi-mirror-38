...
class ApplyUploadRequest(Request):
    ...
    def get_notifyDefinition(self):
        return self.get_params().get('notifyDefinition')

    def set_notifyDefinition(self, notifyDefinition):
        self.add_param('notifyDefinition', notifyDefinition)
    ...
    def get_taskNotifyMode(self):
        return self.get_params().get('taskNotifyMode')

    def set_taskNotifyMode(self, taskNotifyMode):
        self.add_param('taskNotifyMode', taskNotifyMode)

    def get_taskPriority(self):
        return self.get_params().get('taskPriority')

    def set_taskPriority(self, taskPriority):
        self.add_param('taskPriority', taskPriority)
