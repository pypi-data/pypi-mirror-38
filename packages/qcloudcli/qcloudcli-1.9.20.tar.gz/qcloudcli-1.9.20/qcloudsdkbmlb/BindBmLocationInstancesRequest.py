...
class BindBmLocationInstancesRequest(Request):

    def __init__(self):
        super(BindBmLocationInstancesRequest, self).__init__(
            'bmlb', 'qcloudcliV1', 'BindBmLocationInstances', 'bmlb.api.qcloud.com')
