...
class CreateLoadBalancerRequest(Request):
    ...
    def get_anycastZone(self):
        return self.get_params().get('anycastZone')

    def set_anycastZone(self, anycastZone):
        self.add_param('anycastZone', anycastZone)
    ...
    def get_slaId(self):
        return self.get_params().get('slaId')

    def set_slaId(self, slaId):
        self.add_param('slaId', slaId)
