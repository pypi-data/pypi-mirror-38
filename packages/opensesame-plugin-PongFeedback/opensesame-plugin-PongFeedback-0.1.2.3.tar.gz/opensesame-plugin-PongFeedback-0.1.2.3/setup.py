...
setup(
	...
	name='opensesame-plugin-PongFeedback',
	version='0.1.2.3',
	description='Create a Pong Feeback Item',
	author='Mark Span',
	author_email='m.m.span@rug.nl',
	url='https://github.com/markspan/Pong_Feedback',
