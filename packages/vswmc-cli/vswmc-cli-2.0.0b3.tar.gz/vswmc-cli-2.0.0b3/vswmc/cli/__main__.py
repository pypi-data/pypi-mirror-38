...
from vswmc.cli import (configurations, cp, logs, ls, models, ps, rm, run, save,
                       stop)
...
def main():
    ...
    configurations_parser = subparsers.add_parser('configurations', help='List configurations')
    configurations.configure_parser(configurations_parser)
