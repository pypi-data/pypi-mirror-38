...
class VswmcClient(object):
    ...
    def list_configurations(self):
        path = '{}/configurations'.format(self.api_root)
        return self._request('get', path=path).json()

    def get_configuration(self, id_):
        path = '{}/configurations/{}'.format(self.api_root, id_)
        return self._request('get', path=path).json()

    def delete_configuration(self, id_):
        path = '{}/configurations/{}/delete'.format(self.api_root, id_)
    ...
    def start_run(self, configuration, parameters=None):
        path = '{}/configurations/{}/runs'.format(self.api_root, configuration)
        data = {
