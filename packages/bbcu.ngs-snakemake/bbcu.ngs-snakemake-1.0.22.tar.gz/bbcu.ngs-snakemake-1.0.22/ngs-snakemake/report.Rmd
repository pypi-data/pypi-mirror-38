...
a. Histogram showing the percent of the uniquely mapped reads that mapped to genes (genes included must have at least 5 reads).

b. Histogram showing the percent of reads that mapped uniquely and not uniquely per sample.
