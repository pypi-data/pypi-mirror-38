...
#. Build and publish Python Source Distribution::
    ...
    ./deploy-scripts/upload.sh
    # For development use: ./deploy-scripts/upload-dev.sh
...
#. Build Docker image::
    ...
    export PACKY_AGENT_VERSION=`python -c 'import packy_agent; print(packy_agent.__version__)'`  # Or set manually
    export PACKY_SERVER_BASE_URL=<packy_server_base_url>  # MUST be available from inside Docker container
    # Examples:
    # export PACKY_AGENT_VERSION=2.0.0
    # export PACKY_SERVER_BASE_URL=https://dashboard.packy.io
    # export PACKY_SERVER_BASE_URL=http://172.17.0.1:8000
