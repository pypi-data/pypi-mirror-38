...
from packy_agent.domain_logic.modules.traceroute.methods.icmp import (
    receive_icmp_reply_basic, does_payload_match, get_sent_time_from_payload)
from packy_agent.domain_logic.modules.traceroute.methods.base import guess_reply_hop_number
...
def process_icmp_probe(sent_probes, id_, icmp_socket, finish_time):
    ...
    from packy_agent.domain_logic.modules.traceroute.base import ProbeResult
    return ProbeResult(
