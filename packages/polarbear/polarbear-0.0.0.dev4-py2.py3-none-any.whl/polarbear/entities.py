...
class Dataset(object):
    ...
    def add_id_in_study(self):
        ...
        self.question_metadata = self.question_metadata.append(
            {'question_id': 'id_in_study', 'full_text': 'id_in_study'},
            ignore_index=True)

        return self

    def add_value_code(self, questions, value, full_label, display_label):
    ...
    def to_spss(self, filepath):
        ...
        with SavWriter(filepath, var_names, var_types,
                       value_labels, var_labels, ioUtf8=True) as writer:
