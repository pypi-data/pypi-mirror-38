...
class lcd(object):
	def __init__(self, address=None):
		...
		namedColors = {'black':0 , 'navy':2 , 'blue':3 , 'green':24 , 'teal':27 ,
		'lime':28 , 'aqua':31 , 'maroon':192 , 'purple':195 , 'olive':219 ,
		'magenta':227 , 'yellow':252 , 'white':255}
	...
	def setForeColor(self, color=None):
		if not color: # set to white
			...
			try:
				...
				value = namedColors.get(color.lower())
