...
id = "740f502765c02805629381d2e04c760eb520781a"
date = "2018-11-26 02:08:35 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "740f502765c02805629381d2e04c760eb520781a":
        return
    msg = "Program id (740f502765c02805629381d2e04c760eb520781a) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
