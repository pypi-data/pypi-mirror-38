...
{'projection': 'GEOGCS["WGS 84",DATUM["WGS_1984",SPHEROID["WGS 84",6378137,298.257223563,AUTHORITY["EPSG","7030"]],AUTHORITY["EPSG","6326"]],PRIMEM["Greenwich",0],UNIT["degree",0.0174532925199433],AUTHORITY["EPSG","4326"]]', 'geotransform': (-180.0, 0.25, 0.0, 90.0, 0.0, -0.25), 'pixel_size': (0.25, -0.25), 'mean_pixel_size': 0.25, 'raster_size': (1440, 720), 'n_bands': 1, 'nodata': [-9999.0], 'block_size': [256, 256], 'bounding_box': [-180.0, -90.0, 180.0, 90.0], 'datatype': 6}
{'projection': 'PROJCS["World_Mollweide",GEOGCS["GCS_WGS_1984",DATUM["WGS_1984",SPHEROID["WGS_84",6378137,298.257223563]],PRIMEM["Greenwich",0],UNIT["Degree",0.017453292519943295],AUTHORITY["EPSG","4326"]],PROJECTION["Mollweide"],PARAMETER["False_Easting",0],PARAMETER["False_Northing",0],PARAMETER["Central_Meridian",0],UNIT["Meter",1]]', 'bounding_box': [-17702608.5566, -8997266.8968, 17840887.4173, 8750122.2788]}
