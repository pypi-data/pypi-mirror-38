...
class ChargebackProcessorSettings(Model):
    ...
    :param batch_settings: Optional BatchSettings. If provided the batch will
     be created with the settings in here.
     The bills generated will inherit bill headers (accounting period, invoice
     number, control code, etc ) from the batch
    ...
    def __init__(self, billing_period, filters=None, batch_settings=None, start_date_for_bill=None, end_date_for_bill=None, note=None):
