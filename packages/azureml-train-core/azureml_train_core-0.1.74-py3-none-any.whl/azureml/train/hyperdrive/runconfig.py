...
class HyperDriveRunConfig(object):
    ...
    def _get_service_address(self, service, workspace, run_name):
        ...
        service_discovery = ServiceDiscovery(project_context.get_auth())
        app_settings = AppSettings()
        service_address = service_discovery.get_service_url(project_context.get_workspace_uri_path(),
                                                            service,
                                                            app_settings.get_flight())
