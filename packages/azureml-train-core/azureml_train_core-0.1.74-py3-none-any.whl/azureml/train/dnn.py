...
class _TensorFlowRunConfiguration(MMLBaseEstimatorRunConfig):
    ...
    def __init__(self, compute_target=None, vm_size=None, vm_priority=None, vm_location=None,
...
class TensorFlow(MMLBaseEstimator):
    ...
    def __init__(self,
        ...
        if pip_requirements_file_path:
            pip_packages = MMLBaseEstimator._merge_pip_packages_and_requirements(pip_requirements_file_path,
                                                                                 pip_packages)
        estimator_config = _TensorFlowRunConfiguration(compute_target, vm_size, vm_priority, vm_location,
    ...
    @staticmethod
    def _add_conda_dependencies(conda_dependencies, framework, use_gpu):
...
class PyTorch(MMLBaseEstimator):
    ...
    def __init__(self,
        ...
        estimator_config = _PyTorchRunConfiguration(compute_target, vm_size, vm_priority, vm_location,
                                                    entry_script, script_params,
    ...
    @staticmethod
    def _add_conda_dependencies(conda_dependencies, framework):
