...
class Plot:
    ...
    def price_evolution(dfi,
        ...
        g.credits.text = 'Source: SG Markets | Futures Rollbox'
        g.credits.href = 'https://analytics-api.sgmarkets.com/frb/swagger/ui/index#!/Explore/Explore_02'
    ...
    def open_interest_analysis_2(dfi,
                                 undl,
                                 rollKey,
                                 save=False,
                                 folder_save='dump',
