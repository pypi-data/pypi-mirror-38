...
exchanges = {
    ...
    "zb":{
        ...
        "api":{
            ...
            "ticker":"http://api.zb.com/data/v1/ticker?market=%s",
            "depth":"http://api.zb.com/data/v1/depth?market=%s&size=%s",
            "kline":"http://api.zb.com/data/v1/kline?market=%s&type=%s&size=%s"
        }
    },
    "bittrex":{
        "period":{
