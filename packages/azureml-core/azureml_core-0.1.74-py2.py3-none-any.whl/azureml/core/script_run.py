...
class ScriptRun(Run):
    ...
    def _run_config(self):
        if self._run_config_object is None:
            ...
            self._run_config_object = RunConfiguration._get_runconfig_using_runid(self.experiment, self.id)
    ...
    def _from_run_dto(experiment, run_dto):
        ...
        :rtype: ScriptRun
        """
        run_dto = run_dto if isinstance(run_dto, dict) else run_dto.__dict__
