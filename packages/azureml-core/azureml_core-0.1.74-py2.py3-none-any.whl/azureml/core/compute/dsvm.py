...
# ---------------------------------------------------------
"""Module for managing DSVM Compute Targets in Azure ML"""
...
class DsvmCompute(ComputeTarget):
    """
    Class for managing DSVM objects.
    """
    ...
    def delete(self):
        """
        Removes the DSVM object from its associated workspace. If this object was created through Azure ML,
...
class DsvmProvisioningConfiguration(ComputeTargetProvisioningConfiguration):
    """
    Provisioning configuration object for DSVM compute targets. This objects is used to
