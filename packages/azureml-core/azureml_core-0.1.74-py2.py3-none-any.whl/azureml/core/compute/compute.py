...
# ---------------------------------------------------------
"""Module for managing the abstract parent class for Compute Targets in Azure ML"""
...
class ComputeTarget(ABC):
        ...
        if workspace and name:
            ...
            if compute_payload:
                ...
                for child in ComputeTarget.__subclasses__():
                    if compute_type == child._compute_type:
    ...
    def _initialize(self, compute_resource_id, name, location, compute_type, tags, description, created_on,
                    ...
                    workspace, mlc_endpoint, operation_endpoint, auth):
        """
    ...
    def create(workspace, name, provisioning_configuration):
        """
        Provisions a Compute object associated with the provided workspace. The type of object to provision is
        ...
        :raises: ComputeTargetException
        """
        if name in ["mlcompute", "local", "containerinstance"]:
    ...
    def delete(self):
        """
        Removes the Compute object from its associated workspace. If this object was created through Azure ML, the
