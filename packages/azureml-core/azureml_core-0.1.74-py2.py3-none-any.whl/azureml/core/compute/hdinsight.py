...
# ---------------------------------------------------------
"""Module for managing HDInsights Compute Targets in Azure ML"""
...
class HDInsightCompute(ComputeTarget):
    """
    Class for managing HDI Cluster target objects.
    """
    ...
    def attach(workspace, name, username, address, ssh_port='22', password='', private_key_file='',
        ...
        """
        attach_payload = HDInsightCompute._build_attach_payload(address, ssh_port, username, password,
    ...
    def delete(self):
        """
        Removes the HDICompute object from its associated workspace. If this object was created through Azure ML,
