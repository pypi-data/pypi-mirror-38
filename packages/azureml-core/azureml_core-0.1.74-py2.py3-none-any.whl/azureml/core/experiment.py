...
class Experiment(ChainedIdentity, HasExperimentPortal):
    ...
    def __init__(self, workspace, name, **kwargs):
        ...
        super(Experiment, self).__init__(experiment=self, **kwargs)
    ...
    def start_logging(self, *args, **kwargs):
        ...
        :rtype: azureml.core.Run
        """
        return Run._start_logging(self, *args, **kwargs)
    ...
    def get_runs(self, type=None, tags=None, properties=None):
        """
        ...
        :rtype: list
        """
        return Run.list(self, type=type, tags=tags, properties=properties)
