...
class JasmineClient(ExperimentClient):
    ...
    def create_jasmine_experiment(self, experiment_name):
        """
        ...
        return self._execute_with_project_arguments(
            self._client.jasmine.create_experiment,
            experiment_name)

    def post_parent_run(self, experiment_name, create_parent_run_dto=None):
        """
        ...
        """
        return self._execute_with_project_arguments(
            self._client.jasmine.create_parent_run, experiment_name, create_parent_run_dto)
    ...
    def get_pipeline(self, parent_run_id, iteration):
        ...
        :return:
        """
        dto = self._execute_with_project_arguments(
    ...
    def continue_remote_run(self, run_id, iterations):
        """
        Post a new experiment to Jasmine
        :param child_run_id: str
        :return:
