...
class CreateParentRunDto(Model):
    ...
    :param primary_metric: Possible values include: 'AUC_macro',
     'AUC_weighted', 'accuracy', 'weighted_accuracy', 'norm_macro_recall',
     'balanced_accuracy', 'spearman_correlation',
    ...
    def __init__(self, snapshot_id=None, num_iterations=None, training_type=None, acquisition_function=None, metrics=None, primary_metric=None, train_split=None, max_time_seconds=None, acquisition_parameter=None, num_cross_validation=None, target=None, raw_aml_settings_string=None, aml_settings_json_string=None, data_prep_json_string=None):
