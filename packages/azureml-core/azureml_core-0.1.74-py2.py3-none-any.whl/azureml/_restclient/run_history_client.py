...
from ._odata.runs import (get_filter_run_tags, get_filter_run_properties, get_filter_run_type,
                          get_filter_run_created_after, get_filter_run_status)
...
class RunHistoryClient(ExperimentClient):
    ...
    def get_events(self, run_id, page_size=DEFAULT_PAGE_SIZE, order_by=None,
        ...
        if self.api_route == RunHistoryClient.OLD_ROUTE:
            return self._execute_with_project_arguments(self._client.legacy_events.list, **kwargs)

        return self._execute_with_project_arguments(self._client.events.list, **kwargs)
    ...
    def create_run(self, run_id=None, script_name=None, target=None,
        ...
        if self.api_route == RunHistoryClient.OLD_ROUTE:
            return self._execute_with_project_arguments(self._client.legacy_run.create, **kwargs)

        kwargs['run_id'] = run_id
        return self._execute_with_project_arguments(self._client.run.patch, **kwargs)
    ...
    def get_child_runs(self, parent_run_id, root_run_id, recursive=False, _filter_on_server=False,
        ...
        if recursive and _filter_on_server:
            ...
            run_dtos = self._execute_with_project_arguments(
    ...
    def get_runstatus(self, run_id, caller=None, custom_headers=None, is_async=False):
        ...
        return self._execute_with_project_arguments(func, run_id=run_id, **kwargs)
    ...
    def get_metrics_by_runs(self, run_ids=None):
        ...
        if isinstance(run_ids, list):
            ...
            return self._combine_with_project_paginated_dto(self._client.legacy_runmetric.list,
