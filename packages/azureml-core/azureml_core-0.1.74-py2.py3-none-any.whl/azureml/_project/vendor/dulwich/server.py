...
class SingleAckGraphWalkerImpl(object):
    ...
    def handle_done(self, done_required, done_received):
        ...
        if not done_received and not self._common:
            ...
            # to pull from a source that has no base_sdk_common base_commit.
...
class MultiAckGraphWalkerImpl(object):
    ...
    def handle_done(self, done_required, done_received):
        ...
        # don't nak unless no base_sdk_common commits were found, even if not
...
class MultiAckDetailedGraphWalkerImpl(object):
    ...
    def ack(self, have_ref):
        # Should only be called iff have_ref is base_sdk_common
        self._common.append(have_ref)
        self.walker.send_ack(have_ref, b'base_sdk_common')
