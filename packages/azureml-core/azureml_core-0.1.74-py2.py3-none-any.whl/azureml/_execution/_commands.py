...
def _start_internal_local_cloud(project_object, run_config_object,
    ...
    project_context = create_project_context(project_object.workspace_object._auth_object,
                                             subscription_id=project_object.workspace_object.subscription_id,
                                             resource_group=project_object.workspace_object.resource_group,
                                             workspace=project_object.workspace_object.name,
                                             project_name=project_object.history.name)
...
def _cancel_local(project_object, run_id, project_context):
    ...
    run_history_client = RunHistoryClient(
        project_context.get_history_service_ui(),
...
def _get_status_from_history(project_object, run_id, project_context):
    ...
    :rtype: dict
    """
    history_address = project_context.get_history_service_ui()
