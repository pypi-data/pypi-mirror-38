...
class AssetOperations(object):
    ...
    def list_query(
            self, subscription_id, resource_group_name, workspace, run_id=None, project_id=None, name=None, tag=None, count=None, skip_token=None, order_by=None, custom_headers=None, raw=False, **operation_config):
