...
class BaseObjectStore(object):
    ...
    def find_missing_objects(self, haves, wants, progress=None,
        ...
        :param haves: Iterable over SHAs already in base_sdk_common.
    ...
    def find_common_revisions(self, graphwalker):
        """Find which revisions this store has in base_sdk_common using graphwalker.

        :param graphwalker: A graphwalker object.
        :return: List of SHAs that are in base_sdk_common
        """
        haves = []
    ...
    def _collect_ancestors(self, heads, common=set(),
                           get_parents=lambda commit: commit.parents):
        """Collect all ancestors of heads up to (excluding) those in base_sdk_common.
        ...
        :return: a tuple (A, B) where A - all commits reachable
            from heads but not present in base_sdk_common, B - base_sdk_common (shared) elements
...
class MissingObjectFinder(object):
    ...
    def __init__(self, object_store, haves, wants, progress=None,
        ...
        # base_sdk_common - commits from all_ancestors we hit into while
