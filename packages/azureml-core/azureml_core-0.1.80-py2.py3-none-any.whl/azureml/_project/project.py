...
class Project(object):
    ...
    def _take_snapshot(self):
        ...
        project_context = create_project_context(self.workspace_object._auth_object,
                                                 self.workspace_object.subscription_id,
                                                 self.workspace_object.resource_group,
                                                 self.workspace_object.name,
                                                 self.history.name,
                                                 self.workspace_object._workspace_id)
    ...
    def _snapshot_restore(self, snapshot_id, path=None):
        ...
        project_context = create_project_context(self._workspace_object._auth_object,
                                                 self._workspace_object.subscription_id,
                                                 self._workspace_object.resource_group,
                                                 self._workspace_object.name,
                                                 self.history.name,
                                                 self.workspace_object._workspace_id)
