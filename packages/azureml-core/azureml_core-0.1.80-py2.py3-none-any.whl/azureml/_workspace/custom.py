...
def ml_workspace_create_resources(auth, client, resource_group_name, workspace_name,
                                  ...
                                  containerRegistry=None, batchai_workspace=None, exist_ok=False):
    """
    ...
    try:
        ...
        if batchai_workspace is None:
            try:
                batchai_workspace_arm_id = get_arm_resourceId(subscription_id, resource_group_name,
                                                              'Microsoft.BatchAI/Workspaces',
                                                              batchai_workspace)
                delete_batchai_workspace_armId(auth, batchai_workspace_arm_id)
            except Exception:
                pass
