            ...
            if compute_payload:
                ...
                for child in ComputeTarget.__subclasses__():
                    if is_attached and compute_type == 'VirtualMachine' and child.__name__ == 'DsvmCompute':
                        ...
                        continue
                    elif is_attached and compute_type == 'BatchAI' and child.__name__ == 'AmlCompute':
                        # Cannot attach AmlCompute
                        continue
                    elif not is_attached and compute_type == 'BatchAI' and child.__name__ == 'BatchAiCompute':
                        # All creates should be AmlCompute moving forward
                        continue
