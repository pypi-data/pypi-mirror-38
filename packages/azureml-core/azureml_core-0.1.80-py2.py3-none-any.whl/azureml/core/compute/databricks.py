...
class DatabricksCompute(ComputeTarget):
    ...
    def attach(workspace, name, resource_id, access_token):
        ...
        """
        print('WARNING: this method is DEPRECATED! Please use the following method to attach a Databricks compute '
              'resource.\n'
              '    config = DatabricksCompute.attach_configuration(resource_group, workspace_name, access_token)\n'
    ...
    @staticmethod
    def attach_configuration(resource_group, workspace_name, access_token):
        """
        ...
        """
        config = DatabricksAttachConfiguration(resource_group, workspace_name, access_token)
        return config
...
class DatabricksAttachConfiguration(ComputeTargetAttachConfiguration):
    ...
    :rtype: DatabricksAttachConfiguration
    """
    def __init__(self, resource_group, workspace_name, access_token):
        """
