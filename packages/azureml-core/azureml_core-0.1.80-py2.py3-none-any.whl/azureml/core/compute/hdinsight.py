...
class HDInsightCompute(ComputeTarget):
    ...
    def attach(workspace, name, username, address, ssh_port='22', password='', private_key_file='',
        ...
        """
        print('WARNING: this method is DEPRECATED! Please use the following method to attach a HDI compute '
              'resource.\n'
              '    config = HDInsightCompute.attach_configuration(username, address, ssh_port, password, '
