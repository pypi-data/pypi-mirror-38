...
class DataFactoryCompute(ComputeTarget):
    ...
    def attach(workspace, name, resource_id):
        ...
        """
        print('WARNING: this method is DEPRECATED! Please use the following method to attach a DataFactory compute '
              'resource.\n'
              '    config = DataFactoryCompute.attach_configuration(resource_group, factory_name)\n'
    ...
    @staticmethod
    def attach_configuration(resource_group, factory_name):
        """
        ...
        """
        config = DataFactoryAttachConfiguration(resource_group, factory_name)
        return config
...
class DataFactoryAttachConfiguration(ComputeTargetAttachConfiguration):
    ...
    :rtype: DataFactoryAttachConfiguration
    """
    def __init__(self, resource_group, factory_name):
        """
