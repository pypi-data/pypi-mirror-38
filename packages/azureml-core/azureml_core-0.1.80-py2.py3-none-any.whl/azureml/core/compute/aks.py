...
class AksCompute(ComputeTarget):
    ...
    def attach(workspace, name, resource_id):
        ...
        """
        print('WARNING: this method is DEPRECATED! Please use the following method to attach a AKS compute '
              'resource.\n'
              '    config = AksCompute.attach_configuration(resource_group, cluster_name)\n'
    ...
    @staticmethod
    def attach_configuration(resource_group, cluster_name):
        """
        ...
        """
        config = AksAttachConfiguration(resource_group, cluster_name)
        return config
