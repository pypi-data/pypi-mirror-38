...
class LZNLP(object):
    ...
    def get_supermind_corpus(self, corpus_list=None):
        ...
        >>> import lznlp
        >>> nlp = lznlp.LZNLP()
        >>> nlp.get_supermind_corpus(corpusList=[{"indexJobId":"5bebc2b698a4736e989253fe","corpusCollectionId":"5bebc1c098a4736e989253f6"}])

        """
        url = '/supermind/corpus/'
        params = {"corpusList": json.dumps(corpus_list)}
