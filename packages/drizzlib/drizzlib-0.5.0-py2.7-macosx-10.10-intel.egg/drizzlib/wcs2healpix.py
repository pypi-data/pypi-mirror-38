...
# Note: IDEs such as PyCharm tend to not understand where the method comes.
from optimized import intersection_area, get_weights_for_hpixs

# Our private utils
from utils import _project_hpix_polys_to_wcs, _log, _wpix2hpix, _human_file_size
...
def wcs2healpix(wcs_files, nside=32, write_to=None, clobber=False,
    ...
    for wcs_filepath in wcs_files:
        ...
        # CAR (plate carrée) projections are special cases :
