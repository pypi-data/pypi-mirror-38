...
class Machine(object):
    ...
    def create(self, cloudspace_id, machine_name, description, 
            size_id, image_id, disk_size, data_disks):
        """
    ...
    def update(self, machine_id, machine_name, description, size_id):
        """
        Updates the machine
        """
        body_data = {}
