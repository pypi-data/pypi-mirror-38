...
MODIFICATION HISTORY:
    ...
    V1.0.2: Dropped legacy Python 2.7 support. MC, Oxford, 10 May 2018
    V1.0.3: Raise an error if one tries to tie parameters to themselves.
        Thanks to Kyle Westfall (Univ. Santa Cruz) for the feedback.
        Use Python 3.6 f-strings. MC, Oxford, 20 September 2018
