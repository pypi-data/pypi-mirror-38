...
class APIWrapper(AuthHelpers):
    ...
    def find_watch_tray_item_with_long_synopsis(
        ...
        for item in filtered_data:
            ...
            print("=== before ==== " + str(len(
                media.get(category).encode('utf8'))))
    ...
    def get_genre_all_metadata(self, genre='TV', auth=False, alpha=None,
        ...
        if device_type == 'roku':
            ...
            endpoint = '/Service.svc/browse/{0}/full/{1}/alpha-{2}/{3}'.format(
                genre, genre_id, alpha, self.configuration.geo_code)
        else:
            endpoint = (
    ...
    def get_genre_metadata_roku(
            self, genre='TV', genre_type='Comedy', alpha='asc'):
