...
class MyStrategy(StrategyTemplate):
    ...
    def OnBar(self, data):
        ...
        print("bar11",data.Symbol,data.LocalTime,data.Exchange)
        ...
        #    self.isfirst = 1
        #    resp4 =
        #    strategy.SendOrder(data.Symbol,data.Exchange,OrderSide.Sell,data.LastPx,1,OrderType.LMT,Offset.Close)
