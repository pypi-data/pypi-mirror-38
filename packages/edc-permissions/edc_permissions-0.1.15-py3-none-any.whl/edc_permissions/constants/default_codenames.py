...
DEFAULT_CODENAMES = {
    ...
    AUDITOR: [
        ...
        'edc_action_item.view_actionitemupdate',
        'edc_action_item.view_actiontype',
        'edc_action_item.view_historicalactionitem',
        'edc_action_item.view_historicalactionitemupdate',
