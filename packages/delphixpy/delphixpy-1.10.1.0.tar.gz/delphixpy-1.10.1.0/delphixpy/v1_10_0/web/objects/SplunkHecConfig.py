    ...
    *(extends* :py:class:`v1_10_0.web.vo.UserObject` *)* Splunk HTTP Event
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._metrics_push_frequency[0] is not None and obj._metrics_push_frequency[0] is not obj.__undef__:
            assert isinstance(obj._metrics_push_frequency[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._metrics_push_frequency[0]))
        ...
        if obj._main_index[0] is not None and obj._main_index[0] is not obj.__undef__:
            assert isinstance(obj._main_index[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._main_index[0]))
        ...
        if obj._events_push_frequency[0] is not None and obj._events_push_frequency[0] is not obj.__undef__:
            assert isinstance(obj._events_push_frequency[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._events_push_frequency[0]))
        ...
        if obj._hec_port[0] is not None and obj._hec_port[0] is not obj.__undef__:
            assert isinstance(obj._hec_port[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._hec_port[0]))
        ...
        if obj._hec_token[0] is not None and obj._hec_token[0] is not obj.__undef__:
            assert isinstance(obj._hec_token[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._hec_token[0]))
        ...
        if obj._enable_metrics[0] is not None and obj._enable_metrics[0] is not obj.__undef__:
            assert isinstance(obj._enable_metrics[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._enable_metrics[0]))
        ...
        if obj._enable_ssl[0] is not None and obj._enable_ssl[0] is not obj.__undef__:
            assert isinstance(obj._enable_ssl[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._enable_ssl[0]))
        ...
        if obj._metrics_index[0] is not None and obj._metrics_index[0] is not obj.__undef__:
            assert isinstance(obj._metrics_index[0], basestring), ("Expected one of [u'string', u'null'], but got %s" % type(obj._metrics_index[0]))
        ...
        if obj._performance_metrics_resolution[0] is not None and obj._performance_metrics_resolution[0] is not obj.__undef__:
            assert isinstance(obj._performance_metrics_resolution[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._performance_metrics_resolution[0]))
