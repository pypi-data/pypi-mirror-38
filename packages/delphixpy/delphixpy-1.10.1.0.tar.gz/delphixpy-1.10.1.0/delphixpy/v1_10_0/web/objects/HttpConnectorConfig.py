    ...
    *(extends* :py:class:`v1_10_0.web.vo.TypedObject` *)* Configuration for the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._http_port[0] is not None and obj._http_port[0] is not obj.__undef__:
            assert isinstance(obj._http_port[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._http_port[0]))
        ...
        if obj._https_port[0] is not None and obj._https_port[0] is not obj.__undef__:
            assert isinstance(obj._https_port[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._https_port[0]))
