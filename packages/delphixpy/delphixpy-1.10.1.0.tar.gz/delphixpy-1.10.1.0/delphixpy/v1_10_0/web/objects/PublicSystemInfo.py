    ...
    *(extends* :py:class:`v1_10_0.web.vo.TypedObject` *)* Retrieve static
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._vendor_phone_number[0] is not None and obj._vendor_phone_number[0] is not obj.__undef__:
            assert isinstance(obj._vendor_phone_number[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._vendor_phone_number[0]))
        ...
        if obj._vendor_url[0] is not None and obj._vendor_url[0] is not obj.__undef__:
            assert isinstance(obj._vendor_url[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._vendor_url[0]))
        ...
        if obj._support_url[0] is not None and obj._support_url[0] is not obj.__undef__:
            assert isinstance(obj._support_url[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._support_url[0]))
        ...
        if obj._vendor_email[0] is not None and obj._vendor_email[0] is not obj.__undef__:
            assert isinstance(obj._vendor_email[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._vendor_email[0]))
        ...
        if obj._engine_qualifier[0] is not None and obj._engine_qualifier[0] is not obj.__undef__:
            assert isinstance(obj._engine_qualifier[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._engine_qualifier[0]))
        ...
        if obj._vendor_name[0] is not None and obj._vendor_name[0] is not obj.__undef__:
            assert isinstance(obj._vendor_name[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._vendor_name[0]))
        ...
        if obj._kernel_name[0] is not None and obj._kernel_name[0] is not obj.__undef__:
            assert isinstance(obj._kernel_name[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._kernel_name[0]))
