    ...
    *(extends* :py:class:`v1_10_0.web.vo.TypedObject` *)* Parameters needed to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._master_server_name[0] is not None and obj._master_server_name[0] is not obj.__undef__:
            assert isinstance(obj._master_server_name[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._master_server_name[0]))
        ...
        if obj._source_client_name[0] is not None and obj._source_client_name[0] is not obj.__undef__:
            assert isinstance(obj._source_client_name[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._source_client_name[0]))
