    ...
    *(extends* :py:class:`v1_10_0.web.vo.TypedObject` *)* The parameters for
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._keystore_type[0] is not None and obj._keystore_type[0] is not obj.__undef__:
            assert isinstance(obj._keystore_type[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._keystore_type[0]))
        ...
        if obj._storepass[0] is not None and obj._storepass[0] is not obj.__undef__:
            assert isinstance(obj._storepass[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._storepass[0]))
        ...
        if obj._keypass[0] is not None and obj._keypass[0] is not obj.__undef__:
            assert isinstance(obj._keypass[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._keypass[0]))
