    ...
    *(extends* :py:class:`v1_10_0.web.vo.UserObject` *)* Public Key
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._not_before[0] is not None and obj._not_before[0] is not obj.__undef__:
            assert isinstance(obj._not_before[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._not_before[0]))
        ...
        if obj._not_after[0] is not None and obj._not_after[0] is not obj.__undef__:
            assert isinstance(obj._not_after[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._not_after[0]))
        ...
        if obj._issuer[0] is not None and obj._issuer[0] is not obj.__undef__:
            assert isinstance(obj._issuer[0], basestring), ("Expected one of [u'string', u'null'], but got %s" % type(obj._issuer[0]))
