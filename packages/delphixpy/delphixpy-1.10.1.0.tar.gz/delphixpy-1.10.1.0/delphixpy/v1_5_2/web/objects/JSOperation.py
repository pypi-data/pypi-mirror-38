    ...
    *(extends* :py:class:`v1_5_2.web.vo.NamedUserObject` *)* An operation that
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._undo_time[0] is not None and obj._undo_time[0] is not obj.__undef__:
            assert isinstance(obj._undo_time[0], basestring), ("Expected one of [u'string', u'null'], but got %s" % type(obj._undo_time[0]))
        ...
        if obj._operation[0] is not None and obj._operation[0] is not obj.__undef__:
            ...
            assert obj._operation[0] in [u'REFRESH', u'RESET', u'CREATE_BRANCH', u'DELETE_BRANCH', u'CREATE_BOOKMARK', u'DELETE_BOOKMARK', u'ENABLE', u'DISABLE', u'ACTIVATE', u'DEACTIVATE', u'RECOVER', u'RESTORE'], "Expected enum [u'REFRESH', u'RESET', u'CREATE_BRANCH', u'DELETE_BRANCH', u'CREATE_BOOKMARK', u'DELETE_BOOKMARK', u'ENABLE', u'DISABLE', u'ACTIVATE', u'DEACTIVATE', u'RECOVER', u'RESTORE'] but got %s" % obj._operation[0]
