    ...
    *(extends* :py:class:`v1_10_1.web.vo.PublicSystemInfo` *)* Retrieve system-
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._memory_reservation[0] is not None and obj._memory_reservation[0] is not obj.__undef__:
            assert isinstance(obj._memory_reservation[0], float), ("Expected one of [u'number'], but got %s" % type(obj._memory_reservation[0]))
        ...
        if obj._cpu_reservation[0] is not None and obj._cpu_reservation[0] is not obj.__undef__:
            assert isinstance(obj._cpu_reservation[0], float), ("Expected one of [u'number'], but got %s" % type(obj._cpu_reservation[0]))
        ...
        if obj._hotfixes[0] is not None and obj._hotfixes[0] is not obj.__undef__:
            assert isinstance(obj._hotfixes[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._hotfixes[0]))
