    ...
    *(extends* :py:class:`v1_4_2.web.vo.TypedObject` *)* The capacity
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._referenced_externally[0] is not None and obj._referenced_externally[0] is not obj.__undef__:
            assert isinstance(obj._referenced_externally[0], float), ("Expected one of [u'number'], but got %s" % type(obj._referenced_externally[0]))
        ...
        if obj._referenced_by_branches[0] is not None and obj._referenced_by_branches[0] is not obj.__undef__:
            assert isinstance(obj._referenced_by_branches[0], float), ("Expected one of [u'number'], but got %s" % type(obj._referenced_by_branches[0]))
        ...
        if obj._referenced_by_bookmarks[0] is not None and obj._referenced_by_bookmarks[0] is not obj.__undef__:
            assert isinstance(obj._referenced_by_bookmarks[0], float), ("Expected one of [u'number'], but got %s" % type(obj._referenced_by_bookmarks[0]))
