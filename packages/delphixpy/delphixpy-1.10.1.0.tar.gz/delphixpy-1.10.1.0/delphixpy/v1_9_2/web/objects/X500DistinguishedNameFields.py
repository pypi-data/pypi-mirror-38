    ...
    *(extends* :py:class:`v1_9_2.web.vo.X500DistinguishedName` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._city[0] is not None and obj._city[0] is not obj.__undef__:
            assert isinstance(obj._city[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._city[0]))
        ...
        if obj._common_name[0] is not None and obj._common_name[0] is not obj.__undef__:
            assert isinstance(obj._common_name[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._common_name[0]))
        ...
        if obj._organization_unit[0] is not None and obj._organization_unit[0] is not obj.__undef__:
            assert isinstance(obj._organization_unit[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._organization_unit[0]))
        ...
        if obj._state_region[0] is not None and obj._state_region[0] is not obj.__undef__:
            assert isinstance(obj._state_region[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._state_region[0]))
        ...
        if obj._organization[0] is not None and obj._organization[0] is not obj.__undef__:
            assert isinstance(obj._organization[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._organization[0]))
