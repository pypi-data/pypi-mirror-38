    ...
    *(extends* :py:class:`v1_9_2.web.vo.KeyPair` *)* A key pair generated using
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._key_size[0] is not None and obj._key_size[0] is not obj.__undef__:
            assert isinstance(obj._key_size[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._key_size[0]))
        ...
        if obj._signature_algorithm[0] is not None and obj._signature_algorithm[0] is not obj.__undef__:
            assert isinstance(obj._signature_algorithm[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._signature_algorithm[0]))
