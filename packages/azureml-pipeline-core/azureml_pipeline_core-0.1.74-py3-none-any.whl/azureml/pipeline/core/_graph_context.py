...
class _GraphContext(object):
    ...
    def __init__(self, experiment_name, workspace=None, targets=None, default_source_directory=None,
        ...
        :param targets: Dictionary of compute targets to associate with the _GraphContext
        :type targets: dict
