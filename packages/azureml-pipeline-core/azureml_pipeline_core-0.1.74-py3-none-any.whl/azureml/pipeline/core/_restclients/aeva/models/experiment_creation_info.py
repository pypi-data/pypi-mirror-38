...
class ExperimentCreationInfo(Model):
    ...
    _attribute_map = {
        ...
        'history_name': {'key': 'HistoryName', 'type': 'str'},
    ...
    def __init__(self, description=None, continue_experiment_on_node_failure=None, parameter_assignments=None, history_name=None, data_path_assignments=None, run_source=None, run_type=None, run_history_experiment_name=None):
