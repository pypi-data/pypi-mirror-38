...
class ExperimentEntity(Model):
    """ExperimentEntity.

    :param description:
    :type description: str
    :param status:
    :type status: ~swagger.models.ExperimentStatus
    :param graph_id:
    :type graph_id: str
    :param is_submitted:
    ...
    def __init__(self, description=None, status=None, graph_id=None, is_submitted=None, has_errors=None, has_warnings=None, upload_state=None, parameter_assignments=None, run_history_experiment_name=None, pipeline_id=None, run_source=None, run_type=None, total_run_steps=None, id=None, etag=None, created_date=None, last_modified_date=None, entity_status=None):
        super(ExperimentEntity, self).__init__()
