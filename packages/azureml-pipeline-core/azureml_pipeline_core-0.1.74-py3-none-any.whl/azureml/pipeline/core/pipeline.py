...
class Pipeline(object):
    ...
    def __init__(self, workspace, steps, description=None,
        ...
        # get dictionary of MLC computes
        targets = workspace.compute_targets
        self._graph_context = _GraphContext("placeholder", workspace=workspace, targets=targets,
    ...
    def submit(self, experiment_name, pipeline_parameters=None, continue_on_step_failure=False,
        ...
        :param regenerate_outputs: Whether to force regeneration of all step outputs (and disallow data reuse).
        :type regenerate_outputs: bool
    ...
    def publish(self, name=None, description=None, version=None, default_parameters=None):
        """
        ...
        :type version: str
        :param default_parameters: Default parameters for pipeline execution, dictionary of {name: value}
