...
class Node(ABC):
    ...
    def _attach_pipeline_parameters(self, pipeline_params_implicit, pipeline_params_in_step_params,
        ...
        if pipeline_params_runconfig is not None:
            for pipeline_param_name, pipeline_param in pipeline_params_runconfig.items():
                self.get_param(pipeline_param_name).set_value(pipeline_params_runconfig[pipeline_param_name])
