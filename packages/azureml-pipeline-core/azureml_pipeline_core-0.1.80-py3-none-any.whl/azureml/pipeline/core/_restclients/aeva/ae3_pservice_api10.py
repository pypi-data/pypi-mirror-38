...
class AE3PServiceAPI10Configuration(Configuration):
    """Configuration for AE3PServiceAPI10
    ...
    def __init__(
        ...
        super(AE3PServiceAPI10Configuration, self).__init__(base_url)

        self.add_user_agent('ae3pserviceapi10/{}'.format(VERSION))


class AE3PServiceAPI10(object):
    """AE3PServiceAPI10

    :ivar config: Configuration for client.
    :vartype config: AE3PServiceAPI10Configuration
    ...
    def __init__(
        ...
        self.config = AE3PServiceAPI10Configuration(base_url)
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_data_sources_by_id_upload_location_get(
            self, subscription_id, resource_group_name, workspace_name, id, custom_headers=None, raw=False, **operation_config):
        """GetDataSourceUploadLocation.
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_data_sources_by_id_upload_location_get.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_data_sources_by_id_upload_location_get.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/DataSources/{id}/UploadLocation'}
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_submit_by_experiment_id_post(
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_submit_by_experiment_id_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        if raw:
            ...
            return client_raw_response
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_submit_by_experiment_id_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/Submit/{experimentId}'}
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_unsubmitted_creation_info_with_graph_post(
        ...
        :type creation_info_with_graph:
         ~swagger.models.ExperimentCreationInfoWithGraph
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: ExperimentEntity or ClientRawResponse if raw=true
        :rtype: ~swagger.models.ExperimentEntity or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException`
        """
        ...
        if creation_info_with_graph is not None:
            body_content = self._serialize.body(creation_info_with_graph, 'ExperimentCreationInfoWithGraph')
        else:
            body_content = None
        ...
        if response.status_code == 200:
            deserialized = self._deserialize('ExperimentEntity', response)
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_get(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, custom_headers=None, raw=False, **operation_config):
        """GetExperimentAsync.
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_get.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_get.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_put(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, updated=None, custom_headers=None, raw=False, **operation_config):
        """UpdateUnsubmittedExperimentAsync.
        ...
        :param experiment_id: The experiment id
        :type experiment_id: str
        :param updated: The Experiment
        :type updated: ~swagger.models.ExperimentEntity
        :param dict custom_headers: headers that will be added to the request
        :param bool raw: returns the direct response alongside the
         deserialized response
        :param operation_config: :ref:`Operation configuration
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_put.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        # Construct body
        if updated is not None:
            body_content = self._serialize.body(updated, 'ExperimentEntity')
        else:
            body_content = None
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_put.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_execution_delete(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_execution_delete.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        if raw:
            client_raw_response = ClientRawResponse(None, response)
            return client_raw_response
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_execution_delete.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Execution'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_all_nodes_status_code_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_all_nodes_status_code_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_all_nodes_status_code_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Graph/AllNodes/StatusCode'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_all_nodes_status_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_all_nodes_status_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_all_nodes_status_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Graph/AllNodes/Status'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_outputs_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        """GetOutputsAsync.
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_outputs_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_outputs_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Outputs'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_node_status_code_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_node_status_code_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_node_status_code_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Graph/Node/StatusCode'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_node_status_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        """GetNodeStatusAsync.
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_node_status_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_node_status_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Graph/Node/Status'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_stdout_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_stdout_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
    ...
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_stdout_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Graph/Shareable/STDOUT'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_stderr_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_stderr_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return bytes.decode(response.content)
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_stderr_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Graph/Shareable/STDERR'}

    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_job_log_post(
            self, subscription_id, resource_group_name, workspace_name, experiment_id, node_id_path=None, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_job_log_post.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("subscription_id", subscription_id, 'str'),
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return bytes.decode(response.content)
    api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_by_experiment_id_graph_shareable_job_log_post.metadata = {'url': '/api/v1.0/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningServices/workspaces/{workspaceName}/PipelineRuns/{experimentId}/Graph/Shareable/JobLog'}
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_template_submit_by_template_id_post(
        ...
        :param workspace_name: The workspace name
        :type workspace_name: str
        :param template_id: The experiment id
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_pipeline_submit_by_pipeline_id_post(
        ...
        :rtype: ~swagger.models.ExperimentEntity or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException<msrest.exceptions.ErrorResponseException>`
        """
        # Construct URL
    ...
    def api_v10_subscriptions_by_subscription_id_resource_groups_by_resource_group_name_providers_microsoft_machine_learning_services_workspaces_by_workspace_name_experiments_pipeline_by_pipeline_id_get(
        ...
        :param operation_config: :ref:`Operation configuration
         overrides<msrest:optionsforoperations>`.
        :return: list or ClientRawResponse if raw=true
        :rtype: list[~swagger.models.ExperimentEntity] or
         ~msrest.pipeline.ClientRawResponse
        :raises:
         :class:`ErrorResponseException`
        """
