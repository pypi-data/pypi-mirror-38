...
class PSDFit(object):
    ...
    def collective_psd_fit(self,
        ...
        for name in names:
            ...
            fres = FitResult(name=name + ' (cltv)',
                             ...
                             D_err=params['D_' + name].stderr if params['D_' + name].stderr not None else nan,
                             f_c=params['f_c_' + name].value,
                             f_c_err=params['f_c_' + name].stderr if params['f_c_' + name].stderr not None else nan,
                             freq=freq,
                             eval=mod_,
                             residuals=res_,
                             chi2=chi2,
    ...
    def fit_psd(self,
        ...
        FR = FitResult(name=name,
                       ...
                       D_err=params['D'].stderr * deb if params['D'].stderr not None else nan,
                       D_unit='V**2/s',
                       f_c=params['f_c'].value,
                       f_c_err=params['f_c'].stderr if params['f_c'].stderr not None else nan,
                       freq=freq,
                       freq_unit='Hz',
