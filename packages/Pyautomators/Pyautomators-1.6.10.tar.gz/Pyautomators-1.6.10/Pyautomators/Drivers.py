...
class DockerChrome():
    def __init__(self):
        self._driver=BrowserWebDriverContainer(webdriver.DesiredCapabilities.CHROME)
...
class DockerFirefox():
    def __init__(self):
        self._driver=BrowserWebDriverContainer(webdriver.DesiredCapabilities.FIREFOX)
