...
class Xanity:
    ...
    def _parse_args(self):
        ...
        if self.paths.experiments in self.command or self.paths.experiments in self.command:
...
########################################################
    ...
    def freeze_conda(self):
        conda_hash = digest_file(self.conf_files.conda_env)
        pickle.dump(conda_hash, open(self.conf_files.conda_hash,'wb'))
