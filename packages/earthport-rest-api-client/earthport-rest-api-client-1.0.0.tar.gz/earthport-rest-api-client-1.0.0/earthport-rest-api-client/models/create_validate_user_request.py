...
class CreateValidateUserRequest(object):

    """Implementation of the 'CreateValidateUserRequest' model.
    ...
    def __init__(self,
                 ...
                 payer_identity=None):
        """Constructor for the CreateValidateUserRequest class"""
