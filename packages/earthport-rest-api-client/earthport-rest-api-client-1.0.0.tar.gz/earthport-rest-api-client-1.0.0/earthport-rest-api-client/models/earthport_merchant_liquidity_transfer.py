...
class EarthportMerchantLiquidityTransfer(object):

    """Implementation of the 'EarthportMerchantLiquidityTransfer' model.
    ...
    def __init__(self,
                 ...
                 description=None):
        """Constructor for the EarthportMerchantLiquidityTransfer class"""
