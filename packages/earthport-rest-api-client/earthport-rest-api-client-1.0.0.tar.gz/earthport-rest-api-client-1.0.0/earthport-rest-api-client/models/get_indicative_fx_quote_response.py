...
class GetIndicativeFXQuoteResponse(object):

    """Implementation of the 'Get Indicative FX QuoteResponse' model.
    ...
    def __init__(self,
                 fx_detail=None):
        """Constructor for the GetIndicativeFXQuoteResponse class"""
