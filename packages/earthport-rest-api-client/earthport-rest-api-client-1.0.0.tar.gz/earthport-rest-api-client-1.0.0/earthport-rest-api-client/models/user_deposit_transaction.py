...
class UserDepositTransaction(object):
    ...
    def from_dictionary(cls,
        ...
        amount_deposited_by_user = earthport-rest-api-client.models.monetary_value.MonetaryValue.from_dictionary(dictionary.get('amountDepositedByUser')) if dictionary.get('amountDepositedByUser') else None
        amount_deposited_to_merchant = earthport-rest-api-client.models.monetary_value.MonetaryValue.from_dictionary(dictionary.get('amountDepositedToMerchant')) if dictionary.get('amountDepositedToMerchant') else None
