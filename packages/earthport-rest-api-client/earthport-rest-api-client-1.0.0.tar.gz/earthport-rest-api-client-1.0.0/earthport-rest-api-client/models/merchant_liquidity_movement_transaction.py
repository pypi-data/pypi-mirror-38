...
class MerchantLiquidityMovementTransaction(object):
    ...
    Attributes:
        ...
        statement_details (list of StatementDetail): TODO: type description
            here.
        fx_executed_detail (FXDetail): Represents the details of an FX
            transaction, encapsulating the sellAmount, buyAmount and fxRate
            into a single type.
    ...
    def from_dictionary(cls,
        ...
        fx_executed_detail = earthport-rest-api-client.models.fx_detail.FXDetail.from_dictionary(dictionary.get('fxExecutedDetail')) if dictionary.get('fxExecutedDetail') else None
