"""
代码较多的依赖requests，参考文档：http://docs.python-requests.org/zh_CN/latest/user/quickstart.html
"""
import  requests
import  time
...
def getpage(url, **kwargs):
    ...
    DEFAULT_TIMEOUT = 60
    MAX_TRY_COUNT = 4
    headers     = kwargs['headers']     if 'heards' in kwargs else {'user-agent':get_agent()}
