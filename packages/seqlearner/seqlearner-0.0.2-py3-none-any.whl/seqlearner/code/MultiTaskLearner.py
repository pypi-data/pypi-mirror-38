...
class MultiTaskLearner:
    ...
    def __get_next_batch(self):
        self.whole_data_labeled = pd.read_csv(self.file_labeled)
        self.whole_data_unlabeled = pd.read_csv(self.file_unlabeled)
    ...
    def classify(self, embedding_path="../data/uniprot/", embedding="Freq2Vec", method="SVM",
        ...
        return pd.DataFrame(
            {"Accuracy": scores[:, 0], "Sensitivity": scores[:, 1], "Specificity": scores[:, 2]}), random_classes
