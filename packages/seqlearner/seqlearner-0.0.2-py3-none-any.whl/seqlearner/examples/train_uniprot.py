...
def preprocess():
    ...
    pd.DataFrame.to_csv(labeled_data, data_path + "labeled_batch.csv", header=["sequence", "label"])
    pd.DataFrame.to_csv(pd.DataFrame(unlabeled_data["Sequence"]), data_path + "unlabeled_batch.csv",
                        header=["sequence"])
