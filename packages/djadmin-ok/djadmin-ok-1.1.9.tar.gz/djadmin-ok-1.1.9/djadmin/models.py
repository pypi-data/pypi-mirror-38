...
class Visitor(models.Model):
    ...
    browser = models.CharField(_('Browser'), max_length=100, null=True)
    browser_version = models.CharField(_('Browser Version'), max_length=200, null=True)
    ipaddress = models.CharField(_('IP Address'), max_length=200, null=True)
    os_info = models.CharField(_('OS Information'), max_length=30, null=True)
    os_info_version = models.CharField(_('OS Version'), max_length=200, null=True)
    device_type = models.CharField(_('Device Type'), max_length=200,
                                   null=True)
    device_name = models.CharField(_('Device Name'), max_length=200, null=True)
    device_name_brand = models.CharField(_('Device Brand Name'), max_length=200, null=True)
    device_name_model = models.CharField(_('Device Model Name'), max_length=200, null=True)
