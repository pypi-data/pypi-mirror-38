...
# -*- coding: utf-8 -*-
#
# transit_chem documentation build configuration file, created by
...
project = u'transit-chem'
copyright = u"2018, Evan M Curtin"
author = u"Evan M Curtin"
...
htmlhelp_basename = 'transit_chemdoc'
