...
if __name__ == '__main__':
    ...
    for currents_rw in [w7x.config.Defaults.MagneticConfig.low_iota_rw]:  # TODO
        ...
        initial_run = Run.vacuum(
            magnetic_config=magnetic_config,
            parent='w7x_v_0.1.0.dev6_id_1000_1000_1000_1000_+0250_+0250_pres_00_it_1')
        # initial_run = Run('w7x_v_0.1.0.dev6_id_1000_1000_1000_1000_+0000_+0000_pres_00_it_3')
        initial_run = initial_run.converge()

        for i_tor in [0.]:
            #[0. + i * 5000 for i in range(100) if i * 5000 < 51000]:
