...
def verify_user_manage_rights(loggeduser, targetuser = None, targetdomain = None):
    if loggeduser != None and loggeduser == targetuser:
        return True
...
def change_user_logins(uuid):
    ...
    verify_user_manage_rights(loggeduser, targetuser = targetuser)    
