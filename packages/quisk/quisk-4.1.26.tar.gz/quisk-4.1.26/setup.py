...
fp = open("__init__.py", "wb")	# write title string
...
""",
	...
	packages = ['quisk', 'quisk.sdriqpkg', 'quisk.n2adr', 'quisk.softrock', 'quisk.usb', 'quisk.usb.backend',
			'quisk.freedvpkg', 'quisk.hermes', 'quisk.hiqsdr'],
	package_dir =  {'quisk' : '.'},
	package_data = {'' : ['*.txt', '*.html', '*.so', '*.dll'], 'quisk.usb' : ['*']},
