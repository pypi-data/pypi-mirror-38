...
class MSO_X_3000(DSO):
    ...
    def __init__(self, instrument):
        ...
        self.api = [
            ...
            ("measure.phase", self.query_value, "MEAS:PHAS? {self._store[source1]},{self._store[source2]}"),
            ("measure.vratio.cycle", self.query_value, "MEAS:VRAT? CYCL,{self._store[source1]},{self._store[source2]}"),
            ("measure.vratio.display", self.query_value,
