...
def arrayfileinfo(fname, number_of_arrays, number_of_rows, number_of_columns):
    """arrayfileinfo(char const * fname, int & number_of_arrays, int & number_of_rows, int & number_of_columns)"""
    return _oalib.arrayfileinfo(fname, number_of_arrays, number_of_rows, number_of_columns)
...
def array2eigenMainEffects(al, verbose=1):
    """
    array2eigenMainEffects(array_link al, int verbose=1) -> MatrixFloat
    array2eigenMainEffects(array_link al) -> MatrixFloat
    """
    return _oalib.array2eigenMainEffects(al, verbose)

def array2eigenModelMatrixMixed(al, verbose=1):
    """
    array2eigenModelMatrixMixed(array_link al, int verbose=1) -> pairEigenMatrix
    array2eigenModelMatrixMixed(array_link al) -> pairEigenMatrix
    """
...
def extend_arraylist(*args):
    ...
    extend_arraylist(arraylist_t alist, arraydata_t fullad, OAextend oaextend_options) -> arraylist_t
...
def transformGraph(graph, tr, verbose=1):
    """
    transformGraph(array_link graph, intVector tr, int verbose=1) -> array_link
    transformGraph(array_link graph, intVector tr) -> array_link
    """
    return _oalib.transformGraph(graph, tr, verbose)
...
def print_cperm(c, msg=None):
    """
    print_cperm(charVector c, char const * msg=None)
    ...
    """
    return _oalib.print_cperm(c, msg)

def showCandidates(cc):
    """
    showCandidates(conference_columnVector cc)
...
class DconferenceFilter(object):
    ...
    def filterListJ2last(self, lst):
        """
        filterListJ2last(DconferenceFilter self, conference_columnVector lst) -> conference_columnVector
