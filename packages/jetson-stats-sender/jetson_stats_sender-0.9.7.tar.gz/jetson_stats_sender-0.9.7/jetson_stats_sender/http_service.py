...
def initialize_global_stats_sender(api_key, destination_address, camera_key=None, log_level=logging.INFO):
    global global_http_service
    global_http_service = HttpService(api_key, destination_address, camera_key)
    logging.basicConfig(filename='jetson_stats_sender.log',level=log_level)
