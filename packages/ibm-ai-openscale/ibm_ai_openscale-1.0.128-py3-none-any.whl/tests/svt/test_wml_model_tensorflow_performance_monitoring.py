...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_03_bind_wml(self):
        TestAIOpenScaleClient.binding_id = TestAIOpenScaleClient.ai_client.data_mart.bindings.add("Tensorflow performance instance", WatsonMachineLearningInstance(self.wml_credentials))
    ...
    def test_07_create_deployment(self):
        ...
        deployment_details = self.wml_client.deployments.create(artifact_uid=TestAIOpenScaleClient.model_uid, name="Tensorflow perf deployment", asynchronous=False)
