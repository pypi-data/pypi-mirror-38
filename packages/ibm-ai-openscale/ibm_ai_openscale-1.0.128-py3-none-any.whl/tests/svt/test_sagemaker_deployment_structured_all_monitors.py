...
import boto3
import time
from models.Sagemaker import Sagemaker
...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_12_setup_quality_monitoring(self):
        TestAIOpenScaleClient.subscription.quality_monitoring.enable(evaluation_method='binary', threshold=0.8, min_records=5)
    ...
    def test_14_send_feedback_data(self):
        ...
        request, response, response_time = self.sagemaker.get_latest_scoring()
        ...
        TestAIOpenScaleClient.subscription.feedback_logging.store(feedback_data=records_list)
    ...
    def test_24_setup_performance_monitoring(self):
    ...
    def test_25_get_performance_monitoring_details(self):
        TestAIOpenScaleClient.subscription.performance_monitoring.get_details()

    def test_26_score(self):
        request, response, response_time = self.sagemaker.get_latest_scoring()
    ...
    def test_27_stats_on_performance_monitoring_table(self):
    ...
    def test_28_disable_performance_monitoring(self):
    ...
    def test_29_disable_explainability(self):
        TestAIOpenScaleClient.subscription.explainability.disable()

    def test_30_disable_quality_monitoring(self):
    ...
    def test_35_delete_data_mart(self):
