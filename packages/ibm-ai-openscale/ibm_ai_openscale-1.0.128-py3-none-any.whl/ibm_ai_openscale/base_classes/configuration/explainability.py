...
class Explainability(TableViewer):
    ...
    def enable(self, model_type, input_data_type, label_column, feature_columns, training_data_reference=None, categorical_columns=None):
        """
        ...
        :param input_data_type: model input data type
        ...
        >>> from ibm_ai_openscale.supporting_classes.enums import ExplainabilityModelType, ExplainabilityInputDataType
        >>>
        >>> subscription.explainability.enable(
        >>>            model_type=ExplainabilityModelType.CLASSIFICATION,
        >>>            input_data_type=ExplainabilityInputDataType.STRUCTURED,
        ...
        validate_type(input_data_type, 'model_data_type', str, True)
        validate_enum(input_data_type, 'model_data_type', ExplainabilityInputDataType, True)
        ...
        # TODO model_type, input_data_type should be read from asset_properties in first place. Args should be made optional

        params = {
            "model_type": model_type,
            "model_data_type": input_data_type,
            "model_source": "wml", # TODO maybe it should be detected?
            "label_column": label_column,
            "feature_columns": feature_columns,
            "training_data_reference": training_data_reference_config if training_data_reference is not None else {}
        }
