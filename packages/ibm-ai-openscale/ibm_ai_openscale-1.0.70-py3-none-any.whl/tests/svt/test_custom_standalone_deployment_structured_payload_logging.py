...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_03_bind_custom(self):
        TestAIOpenScaleClient.binding_uid = TestAIOpenScaleClient.ai_client.data_mart.bindings.add("Black box engine", CustomMachineLearningInstance())
    ...
    def test_06_subscribe_custom_deployment(self):
        ...
        subscription = TestAIOpenScaleClient.ai_client.data_mart.subscriptions.add(CustomMachineLearningDeployment(name=name, scoring_url=scoring_url, scoring_header=scoring_header, binding_uid=TestAIOpenScaleClient.binding_uid))
    ...
    def test_10_score_model_and_log_payload(self):
        ...
        scoring_url = self.custom_credentials['url'] + "/v1/deployments/action/online"
