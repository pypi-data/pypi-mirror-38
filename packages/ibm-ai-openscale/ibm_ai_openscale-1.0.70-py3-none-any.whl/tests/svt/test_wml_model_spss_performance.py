...
class TestSPSSPerformance(unittest.TestCase):
    ...
    def test_02_setup_data_mart(self):
        TestSPSSPerformance.ai_client.data_mart.setup(db_credentials=self.postgres_credentials,
    ...
    def test_14_unsubscribe(self):
        ...
        wait_until_deleted(TestSPSSPerformance.ai_client, subscription_uid=TestSPSSPerformance.subscription.uid)
    ...
    def test_16_unbind(self):
        ...
        wait_until_deleted(TestSPSSPerformance.ai_client, binding_uid=TestSPSSPerformance.subscription.binding_uid)

    def test_17_delete_data_mart(self):
        TestSPSSPerformance.ai_client.data_mart.delete()
        wait_until_deleted(TestSPSSPerformance.ai_client, data_mart=True)
