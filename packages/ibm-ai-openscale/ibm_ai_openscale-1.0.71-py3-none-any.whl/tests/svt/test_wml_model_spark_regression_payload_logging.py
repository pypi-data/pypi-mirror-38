...
class TestSparkRegressionPayloadLogging(unittest.TestCase):
    ...
    def test_02_setup_data_mart(self):
        TestSparkRegressionPayloadLogging.ai_client.data_mart.setup(db_credentials=self.postgres_credentials,
    ...
    def test_14_unsubscribe(self):
        TestSparkRegressionPayloadLogging.ai_client.data_mart.subscriptions.delete(TestSparkRegressionPayloadLogging.subscription.uid)
        wait_until_deleted(TestSparkRegressionPayloadLogging.ai_client, subscription_uid=TestSparkRegressionPayloadLogging.subscription.uid)
    ...
    def test_16_unbind(self):
        ...
        wait_until_deleted(TestSparkRegressionPayloadLogging.ai_client, binding_uid=TestSparkRegressionPayloadLogging.subscription.binding_uid)

    def test_17_delete_data_mart(self):
        TestSparkRegressionPayloadLogging.ai_client.data_mart.delete()
        wait_until_deleted(TestSparkRegressionPayloadLogging.ai_client, data_mart=True)
