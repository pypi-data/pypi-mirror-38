...
class TestSparkRegressionExplainability(unittest.TestCase):
    ...
    def test_02_setup_data_mart(self):
        TestSparkRegressionExplainability.ai_client.data_mart.setup(db_credentials=self.postgres_credentials, schema=get_schema_name())
    ...
    def test_14_unsubscribe(self):
        ...
        wait_until_deleted(TestSparkRegressionExplainability.ai_client, subscription_uid=TestSparkRegressionExplainability.subscription.uid)
    ...
    def test_16_unbind(self):
        ...
        wait_until_deleted(TestSparkRegressionExplainability.ai_client, binding_uid=TestSparkRegressionExplainability.subscription.binding_uid)

    def test_17_delete_data_mart(self):
        TestSparkRegressionExplainability.ai_client.data_mart.delete()
        wait_until_deleted(TestSparkRegressionExplainability.ai_client, data_mart=True)
