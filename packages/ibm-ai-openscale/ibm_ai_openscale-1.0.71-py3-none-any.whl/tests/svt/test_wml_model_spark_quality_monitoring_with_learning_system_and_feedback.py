...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_05_prepare_model(self):
        ...
        TestAIOpenScaleClient.wml_client.learning_system.setup(model_uid=TestAIOpenScaleClient.model_uid, meta_props=system_config)
    ...
    def test_08_setup_quality_monitoring(self):
        TestAIOpenScaleClient.subscription.quality_monitoring.enable(evaluation_method='multiclass', threshold=0.8, min_records=5, spark_credentials=self.spark_credentials)
    ...
    def test_11b_stats_on_feedback_logging_table(self):
        self.assertRaises(ClientError, TestAIOpenScaleClient.subscription.feedback_logging.print_table_schema)
        self.assertRaises(ClientError, TestAIOpenScaleClient.subscription.feedback_logging.show_table)
        self.assertRaises(ClientError, TestAIOpenScaleClient.subscription.feedback_logging.describe_table)
        self.assertRaises(ClientError, TestAIOpenScaleClient.subscription.feedback_logging.get_table_content)
