...
class TestSparkRegressionPerformance(unittest.TestCase):
    ...
    def test_02_setup_data_mart(self):
        TestSparkRegressionPerformance.ai_client.data_mart.setup(db_credentials=self.postgres_credentials,
    ...
    def test_14_unsubscribe(self):
        TestSparkRegressionPerformance.ai_client.data_mart.subscriptions.delete(TestSparkRegressionPerformance.subscription.uid)
        wait_until_deleted(TestSparkRegressionPerformance.ai_client, subscription_uid=TestSparkRegressionPerformance.subscription.uid)
    ...
    def test_16_unbind(self):
        ...
        wait_until_deleted(TestSparkRegressionPerformance.ai_client, binding_uid=TestSparkRegressionPerformance.subscription.binding_uid)

    def test_17_delete_data_mart(self):
        TestSparkRegressionPerformance.ai_client.data_mart.delete()
        wait_until_deleted(TestSparkRegressionPerformance.ai_client, data_mart=True)
