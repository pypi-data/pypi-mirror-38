...
def umfpack_dl_solve(sys, Ap, Ai, Ax, X, B, Numeric, Control, Info):
    """umfpack_dl_solve(SuiteSparse_long sys, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double [] X, double const [] B, void * Numeric, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_zl_solve(sys, Ap, Ai, Ax, Az, Xx, Xz, Bx, Bz, Numeric, Control, Info):
    """umfpack_zl_solve(SuiteSparse_long sys, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [] Az, double [] Xx, double [] Xz, double const [] Bx, double const [] Bz, void * Numeric, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_dl_triplet_to_col(n_row, n_col, nz, Ti, Tj, Tx, Ap, Ai, Ax, Map):
    """umfpack_dl_triplet_to_col(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long nz, SuiteSparse_long const [] Ti, SuiteSparse_long const [] Tj, double const [] Tx, SuiteSparse_long [] Ap, SuiteSparse_long [] Ai, double [] Ax, SuiteSparse_long [] Map) -> SuiteSparse_long"""
...
def umfpack_zl_triplet_to_col(n_row, n_col, nz, Ti, Tj, Tx, Tz, Ap, Ai, Ax, Az, Map):
    """umfpack_zl_triplet_to_col(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long nz, SuiteSparse_long const [] Ti, SuiteSparse_long const [] Tj, double const [] Tx, double const [] Tz, SuiteSparse_long [] Ap, SuiteSparse_long [] Ai, double [] Ax, double [] Az, SuiteSparse_long [] Map) -> SuiteSparse_long"""
...
def umfpack_dl_transpose(n_row, n_col, Ap, Ai, Ax, P, Q, Rp, Ri, Rx):
    """umfpack_dl_transpose(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, SuiteSparse_long const [] P, SuiteSparse_long const [] Q, SuiteSparse_long [] Rp, SuiteSparse_long [] Ri, double [] Rx) -> SuiteSparse_long"""
...
def umfpack_zl_transpose(n_row, n_col, Ap, Ai, Ax, Az, P, Q, Rp, Ri, Rx, Rz, do_conjugate):
    """umfpack_zl_transpose(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [] Az, SuiteSparse_long const [] P, SuiteSparse_long const [] Q, SuiteSparse_long [] Rp, SuiteSparse_long [] Ri, double [] Rx, double [] Rz, SuiteSparse_long do_conjugate) -> SuiteSparse_long"""
...
def umfpack_dl_symbolic(n_row, n_col, Ap, Ai, Ax, Control, Info):
    """umfpack_dl_symbolic(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_zl_symbolic(n_row, n_col, Ap, Ai, Ax, Az, Control, Info):
    """umfpack_zl_symbolic(SuiteSparse_long n_row, SuiteSparse_long n_col, SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [] Az, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_dl_numeric(Ap, Ai, Ax, Symbolic, Control, Info):
    """umfpack_dl_numeric(SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, void * Symbolic, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_zl_numeric(Ap, Ai, Ax, Az, Symbolic, Control, Info):
    """umfpack_zl_numeric(SuiteSparse_long const [] Ap, SuiteSparse_long const [] Ai, double const [] Ax, double const [] Az, void * Symbolic, double const [20] Control, double [90] Info) -> SuiteSparse_long"""
...
def umfpack_dl_get_numeric(Lp, Lj, Lx, Up, Ui, Ux, P, Q, Dx, Rs, Numeric):
    """umfpack_dl_get_numeric(SuiteSparse_long [] Lp, SuiteSparse_long [] Lj, double [] Lx, SuiteSparse_long [] Up, SuiteSparse_long [] Ui, double [] Ux, SuiteSparse_long [] P, SuiteSparse_long [] Q, double [] Dx, double [] Rs, void * Numeric) -> SuiteSparse_long"""
...
def umfpack_zl_get_numeric(Lp, Lj, Lx, Lz, Up, Ui, Ux, Uz, P, Q, Dx, Dz, Rs, Numeric):
    """umfpack_zl_get_numeric(SuiteSparse_long [] Lp, SuiteSparse_long [] Lj, double [] Lx, double [] Lz, SuiteSparse_long [] Up, SuiteSparse_long [] Ui, double [] Ux, double [] Uz, SuiteSparse_long [] P, SuiteSparse_long [] Q, double [] Dx, double [] Dz, double [] Rs, void * Numeric) -> SuiteSparse_long"""
