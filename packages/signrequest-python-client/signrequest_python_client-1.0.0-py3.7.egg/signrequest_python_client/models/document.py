...
from signrequest_python_client.models.document_attachment import DocumentAttachment  # noqa: F401,E501
from signrequest_python_client.models.file_from_sf import FileFromSf  # noqa: F401,E501
from signrequest_python_client.models.inline_integration_data import InlineIntegrationData  # noqa: F401,E501
from signrequest_python_client.models.inline_prefill_tags import InlinePrefillTags  # noqa: F401,E501
from signrequest_python_client.models.inline_sign_request import InlineSignRequest  # noqa: F401,E501
from signrequest_python_client.models.user import User  # noqa: F401,E501
...
class Document(object):
    ...
    def status(self):
        ...
        `co`: converting, `ne`: new, `se`: sent, `vi`: viewed, `si`: signed, `do`: downloaded, `sd`: signed and downloaded, `ca`: cancelled, `de`: declined, `ec`: error converting, `es`: error sending  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["co", "ne", "se", "vi", "si", "do", "sd", "ca", "de", "ec", "es"]  # noqa: E501
