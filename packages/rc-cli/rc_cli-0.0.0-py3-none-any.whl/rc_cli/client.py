...
@click.option('--readfile', '-r', help='Read the files to copy from a given file')
@click.pass_context
def copy(context, source_file, destination_directories, name, force, interactive, readfile):
    """
    ...
    copier = Copier(get_config(context), source_file, destination_directories, name, force, interactive, readfilee)
    copier.execute()
