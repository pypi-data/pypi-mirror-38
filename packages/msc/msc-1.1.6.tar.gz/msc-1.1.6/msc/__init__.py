...
class microservice(db):
    ...
    def __startConsumer(self,function,config={}):
        if self.__conecctMQ() == True:
            ...
            try:
                #loopito = asyncio.new_event_loop()
                #t = Thread(target=f, args=(loopito,))
                #t.start()
                #_thread.start_new_thread(self.f,(loopito,))
                ...
                for message in self.__consumer:
                    try:
                        ...
                        try:
                            ...
                            _thread.start_new_thread(self.__functionBridge,(function,config,objeto,self.__llamar_worker_asincrono,))
                            
                        except TypeError as e:
                            print(e)
                            #la libreria asyncio mostraba un msj warn
                            pass
                        except Exception as e:
                            print(e)
                            pass
