...
class Repository:
    ...
    async def make_friendships(self, friendships: List[Tuple[str, str]]) -> List[dict]:
    ...
    def _get_recommendation(self, reco_data: list) -> Recommendations:
        return Recommendations(reco_data[0], reco_data[1])

    async def get_person_recommendations(self, person_name: str) -> Union[Recommendations, None]:
