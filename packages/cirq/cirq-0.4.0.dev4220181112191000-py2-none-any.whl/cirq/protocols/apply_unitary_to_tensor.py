...
def apply_unitary_to_tensor(val,
                            target_tensor,
                            available_buffer,
                            axes,
    ...
    getter = getattr(val, u'_apply_unitary_to_tensor_', None)
    ...
    raise TypeError(u"object of type '{}' "
                    u"has no _apply_unitary_to_tensor_ "
                    u"or _unitary_ methods "
                    u"(or they returned NotImplemented).".format(type(val)))
