...
def test_qasm_two_qubit_gate_repr():
    ...
    assert repr(gate) == (u'cirq.QasmTwoQubitGate('
                          u'cirq.QasmUGate(0.1, 0.2, 0.3), '
                          u'cirq.QasmUGate(0.4, 0.5, 0.6), '
                          u'0.7, 0.8, 0.9, '
                          u'cirq.QasmUGate(1.0, 1.1, 1.2), '
                          u'cirq.QasmUGate(1.3, 1.4, 1.5))')
