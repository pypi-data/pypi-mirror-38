...
def assert_has_consistent_apply_unitary(
    ...
    u"""Tests whether a value's _apply_unitary_to_tensor_ is correct.
...
def assert_eigen_gate_has_consistent_apply_unitary(
    ...
    else: global_shifts = (0, 0.5, -0.5)
    if 'exponents' in _3to2kwargs: exponents = _3to2kwargs['exponents']; del _3to2kwargs['exponents']
    else: exponents = (1, -0.5, 0.5, 0.25, -0.25, 0.1, -1, value.Symbol(u's'))
    u"""Tests whether an EigenGate type's _apply_unitary_to_tensor_ is correct.
...
def assert_has_consistent_apply_unitary_for_various_exponents(
    ...
    if 'exponents' in _3to2kwargs: exponents = _3to2kwargs['exponents']; del _3to2kwargs['exponents']
    else: exponents = (1, -0.5, 0.5, 0.25, -0.25, 0.1, value.Symbol(u's'))
    u"""Tests whether a value's _apply_unitary_to_tensor_ is correct.
