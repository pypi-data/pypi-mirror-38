...
class AsymmetricDepolarizingChannel(raw_types.Gate):
    ...
    def __init__(self, p_x, p_y, p_z):
        u"""The asymmmetric depolarizing channel.
...
def asymmetric_depolarize(
    ...
    u"""Returns a AsymmetricDepolarizingChannel with given parameter.
...
class DepolarizingChannel(raw_types.Gate):
    ...
    def __init__(self, p):
        u"""The symmetric depolarizing channel.
...
def depolarize(p):
    u"""Returns a DepolarizingChannel with given probability of error.
...
class GeneralizedAmplitudeDampingChannel(raw_types.Gate):
    ...
    def __init__(self, p, gamma):
        u"""The generalized amplitude damping channel.
...
class AmplitudeDampingChannel(raw_types.Gate):
    ...
    def __init__(self, gamma):
        u"""The amplitude damping channel.
...
class BitFlipChannel(raw_types.Gate):
    u"""Probabilistically flip a qubit from 1 to 0 state or vice versa."""

    def __init__(self, p):
        u"""The bit flip channel.
