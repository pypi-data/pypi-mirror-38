...
@pytest.mark.parametrize(u'phase_exponent,exponent', [
    (p, e)
    for p in [0, 0.25, 0.5, -0.5, 0.75, 0.333, cirq.Symbol(u'p')]
    for e in [0, 0.25, 0.5, -0.5, -0.75, 0.333, cirq.Symbol(u'e')]
])
def test_qasm(phase_exponent, exponent):
