...
class CZPowGate(eigen_gate.EigenGate,
    ...
    def __init__(self, **_3to2kwargs):
        ...
        Args:
            ...
            e^{i pi exponent}).
        """
        super(CZPowGate, self).__init__(exponent=exponent)
    ...
    def __init__(self, **_3to2kwargs):
        ...
        Args:
            ...
            global_shift: Offsets the eigenvalues of the gate.
                ...
                one (i.e. a 180 degree rotation).
        """
        super(ZPowGate, self).__init__(exponent=exponent,
                         global_shift=global_shift)
...
class HPowGate(eigen_gate.EigenGate, gate_features.SingleQubitGate):
    ...
    def __init__(self, **_3to2kwargs):
        ...
        """
        super(HPowGate, self).__init__(exponent=exponent)
    ...
    def __init__(self, **_3to2kwargs):
        ...
        Args:
            exponent: The 't' in 'CNOT**t'. Determines how much the |1-⟩ state
                gets phased.
        """
        super(CNotPowGate, self).__init__(exponent=exponent)
...
class SwapPowGate(eigen_gate.EigenGate,
    ...
    def __init__(self, **_3to2kwargs):
        ...
        super(SwapPowGate, self).__init__(exponent=exponent)
