...
"""hyper_drive_step.py, module for adding HyperDrive run as a pipeline step."""
import json
...
from azureml.train.hyperdrive import HyperDriveRunConfig, _search
...
class HyperDriveStep(PipelineStep):
    ...
    def create_node(self, graph, default_datastore, context):
        ...
        for param_name in self._params:
            ...
            param_def = ParamDef(param_name, self._params[param_name], is_metadata_param=is_metadata_param)
    ...
    def _get_hyperdrive_run_config(self, workspace, experiment_name):
        hyperdrive_dto = _search._create_experiment_dto(self._hyperdrive_run_config, workspace, experiment_name)
