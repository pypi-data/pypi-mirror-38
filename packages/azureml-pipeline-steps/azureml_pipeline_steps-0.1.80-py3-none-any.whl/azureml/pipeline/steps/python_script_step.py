...
class PythonScriptStep(PipelineStep):
    ...
    :type compute_target: azureml.core.compute.DsvmCompute, azureml.core.compute.BatchAiCompute,
    ...
    def __init__(self, script_name, name=None, arguments=None, compute_target=None, runconfig=None,
        ...
        :type compute_target: DsvmCompute, BatchAiCompute, RemoteTarget, HDIClusterTarget, BatchAITarget, str
