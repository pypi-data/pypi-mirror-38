...
class EstimatorStep(PythonScriptStep):
    ...
    def __init__(self, name=None, estimator=None, estimator_entry_script_arguments=None, inputs=None, outputs=None,
                 target=None, allow_reuse=True, version=None):
        """
        ...
        :type target: azureml.core.compute.DsvmCompute, azureml.core.compute.BatchAiCompute,
            azureml.core.compute.RemoteTarget, azureml.core.compute_target.BatchAITarget, str
        :param allow_reuse: whether to allow reuse
        :type allow_reuse: bool
        :param version: version
        :type version: str
        ...
        if None in [estimator, target]:
            raise ValueError("Estimator, target parameters are required")
        ...
        # resetting target, arguments and data refs as they will not be used in EstimatorStep
        ...
        super(EstimatorStep, self).__init__(name=name, script_name=script_name,
                                            arguments=estimator_entry_script_arguments, target=target,
