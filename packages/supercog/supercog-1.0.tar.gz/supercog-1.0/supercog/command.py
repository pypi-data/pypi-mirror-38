...
class Parameter:
    ...
    def __init__(self, *, info = None, optional = None, acceptedParameters = None, parameterDict = None):
        ...
        The following tags are optional:
            \"acceptedParameters\" (Defaults to an empty dictionary)
        
        Parameters:
            info (str): The description of this parameter.
            optional (bool): Whether or not the parameter is optional.
            acceptedParameters (dict): A dictionary of `AcceptedParameter` objects.
        """

        # Setup optional fields (defaults)
        self._acceptedParameters = {}

        # Check if all parameters are None
        if (info == None or optional == None or acceptedParameters == None) and parameterDict == None:
        ...
        if info != None and optional != None:
            ...
            if acceptedParameters != None:
                self._acceptedParameters = acceptedParameters
        ...
        # parameterDict parameter exists
            ...
            if "acceptedParameters" in parameterDict:
                self._acceptedParameters = parameterDict["acceptedParameters"]
    ...
    def getAcceptedParameters(self):
        ...
        return self._acceptedParameters
    ...
    def getAcceptedParameter(self, acceptedParameter):
        ...
        Raises:
            NoSuchAcceptedParameterException - when the `acceptedParameter` parameter does not exist in this `Parameter` object.
        """

        if acceptedParameter in self._acceptedParameters:
            return self._acceptedParameters[acceptedParameter]
...
class Command:
    ...
    def getHelp(self, *, inDepth = False, isNSFW = False, maxFieldLength = 1000):
        ...
        The help dictionary will have the following tags:
            ...
            \"fields\": The accepted parameter information. (An empty list if it is not inDepth)
        ...
        if inDepth:
            ...
            for parameter in acceptedParameters:
                ...
                for param in acceptedParams:
                    ...
                    accepted = censor(parameter) if not isNSFW else param
                    accepted += "\n"
        ...
        for parameter in self.getParameters():
            ...
            if len(parameterObject.getAcceptedParameters()) > 0:
                html += (
                    ...
                    "" if parameterStyle == None else "id=\"" + parameterStyle + "\"",
                    "" if parameterStyle == None else "id=\"" + parameterStyle + "\"", "Accepted Parameters for `" + parameterName + "`"
                    "" if parameterStyle == None else "id=\"" + parameterStyle + "\"", parameterObject.getInfo()
                )
                ...
                for acceptedParameter in parameterObject.getAcceptedParameters():
                    ...
                    html += (
                        ...
                        "" if parameterStyle == None else "id=\"" + parameterStyle + "\"",
                        "" if parameterStyle == None else "id=\"" + parameterStyle + "\"", " | ".join(acceptedObject.getAlternatives()),
                        "" if parameterStyle == None else "id=\"" + parameterStyle + "\"", acceptedObject.getInfo()
                    )
