...
class Category:
    ...
    def getHTML(self, *, categoryStyle = None, commandStyle = None, parameterStyle = None):
        """Returns the HTML rendering text for the `Category`

        The `categoryStyle`, `commandStyle`, `parameterStyle` parameters are CSS attributes inside an HTML
        ...
        for command in self.getCommands():
            html += command.getHTML(commandStyle = commandStyle, parameterStyle = parameterStyle) + "\n"
