    ...
    def __init__(self, *, info = None, optional = None, acceptedParameters = None, parameterDict = None):
        ...
        # parameterDict parameter exists
            ...
            if "acceptedParameters" in parameterDict:
                for parameter in parameterDict["acceptedParameters"]:
                    self._acceptedParameters[parameter] = AcceptedParameter(acceptedParameterDict = parameterDict["acceptedParameters"][parameter])
