...
class Command:
    ...
    def getHTML(self, *, commandStyle = None, parameterStyle = None, noBorderStyle = None):
        """Returns the HTML rendering text for the `Command`.

        The `commandStyle`, `parameterStyle`, and `noBorderStyle` parameters are CSS attributes inside an HTML
        ...
        html += (
            ...
            "" if commandStyle == None else "id=\"" + commandStyle + "\"", self.getInfo(True),
        ...
        for parameter in self.getParameters():
            ...
            if len(parameterObject.getAcceptedParameters()) > 0:
                html += (
                    ...
                    "" if noBorderStyle  == None else "id=\"{}\"".format(noBorderStyle),
                    "" if parameterStyle == None else "id=\"{}\"".format(parameterStyle), "Accepted Parameters for <strong><code>{}</code></strong>".format(parameterName),
                    "" if parameterStyle == None else "id=\"{}\"".format(parameterStyle), parameterObject.getInfo(True)
                )
                ...
                for acceptedParameter in parameterObject.getAcceptedParameters():
                    ...
                    html += (
                        ...
                        "" if parameterStyle == None else "id=\"{}\"".format(parameterStyle), acceptedObject.getInfo(True)
                    )
