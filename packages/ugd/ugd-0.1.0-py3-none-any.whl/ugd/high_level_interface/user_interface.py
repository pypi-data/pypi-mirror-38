...
def digraph_hyp_test(adj_m, var_dict=None, stat_f=None, test_variable=None, controlls=None, mixing_time=None,
    ...
    return hyp_test(adj_m, var_dict, stat_f, test_variable, controlls, mixing_time, anz_sim, show_polt,
                    is_directed=True)
...
def graph_hyp_test(adj_m, var_dict=None, stat_f=None, test_variable=None, controlls=None, mixing_time=None,
    ...
    PURPUSE: generation of random Graphs with a given degree-sequence and restrictions induced by the node-attributes
             in order to estimate the distribution of a test-statistic under the 0 Hypotheses.
    ...
    :param controlls:     List of variable names, the number of arrows crossing the groups induced by the controls is
