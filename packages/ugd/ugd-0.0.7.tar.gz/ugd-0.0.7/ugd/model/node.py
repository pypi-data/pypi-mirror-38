class Node():
    ...
    -  Active and passive outnodes, for easaly iterativly find new nodes in path.
    -  Marks for easy look up edges already visited (earlier Schlaufen) / nodes in path-creation already visited
    -  The edge-marks have the schlaufen number saved, such that later a reconstruction of the Schlaufen found is possible
    '''
