...
'''
The DiGraph contains the information on the degrees and arrows, 
The RstDiGraph contains in addition information on the restrictions (here, the number of arrows between node groups, or node partitions) 
'''
