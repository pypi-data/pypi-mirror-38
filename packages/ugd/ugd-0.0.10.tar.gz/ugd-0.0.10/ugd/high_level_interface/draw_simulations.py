...
def hyp_test(adj_m, var_dict, stat_f, test_variable, controlls, mixing_time, anz_sim, show_polt, is_directed):
    ...
    plt, info_dict = postprocess(adj_m_original=adj_m, stats_list=stats_list, var_dict=var_dict, stat_f=stat_f, show_polt=show_polt, test_variable=test_variable, edges_changed_per_draw=edges_changed_per_draw)

    return {'graph': graphs, 'stats_list': stats_list, 'plot': plt, 'info_dict':info_dict}
