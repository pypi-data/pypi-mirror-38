...
import hippodamia_service.Monitoringservice
...
#hippodamia_service.Monitoringservice.Monitoringservice.dump_schema(extract_path("config_schema.json"))

setup(
    name='Hippodamia',
    version=hippodamia_service.version,
