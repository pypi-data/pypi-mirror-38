    ...
    if not utils.check_file_exists(os.path.join(params.name, package_file) if params.name else package_file):
        ...
        if params.env:
            ...
            if not utils.cmd_with_check_os_value(cmd_string):
                utils.cmd_with_check_os_value(os.path.join(os.getcwd(), os.path.dirname(os.path.join(params.name, package_file) if params.name else package_file), 'ENV', 'bin', 'activate'))
