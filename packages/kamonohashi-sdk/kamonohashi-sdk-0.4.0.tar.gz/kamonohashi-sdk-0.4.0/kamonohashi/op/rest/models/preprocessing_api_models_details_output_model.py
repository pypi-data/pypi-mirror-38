...
class PreprocessingApiModelsDetailsOutputModel(object):
    ...
    def __init__(self, container_image=None, created_at=None, created_by=None, entry_point=None, git_model=None, id=None, is_locked=None, memo=None, modified_at=None, modified_by=None, name=None):  # noqa: E501
