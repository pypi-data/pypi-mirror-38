...
class List(Block):
    ...
    def _read_line(self, line, **kwargs):
        ...
        Examples
            ...
            >>> import transcoding as tc
            >>> from more_itertools import peekable
            >>> line = ' FTOL_ARRAY = 1.00E-05 1.00E-08 3.70E-10 9.50E-11 3.0E-11 1.00E-15'
            >>> l_tolerance = tc.List(
            ...
            {'forceToleranceLevels': [1e-05, 1e-08, 3.7e-10, 9.5e-11, 3e-11, 1e-15]}
        ...
        list_vals = merge([super(List, self)._read_line(entry,
                                                       **kwargs)
