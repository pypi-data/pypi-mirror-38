...
####+BEGIN: bx:icm:python:cmnd:classHead :cmndName "bxpBaseDir_LibOverview" :comment "" :parsMand "" :parsOpt "" :argsMin "0" :argsMax "3" :asFunc "" :interactiveP ""
"""
...
####+BEGIN: bx:icm:python:func :funcName "icmsPkgBase_dir" :funcType "anyOrNone" :retType "bool" :deco "" :argsList ""
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Func-anyOrNone :: /icmsPkgBase_dir/ retType=bool argsList=nil  [[elisp:(org-cycle)][| ]]
"""
def icmsPkgBase_dir():
####+END:
    """
...
####+BEGIN: bx:icm:python:func :funcName "pkgBase_siteDir" :funcType "anyOrNone" :retType "bool" :deco "" :argsList ""
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(org-show-subtree)][|=]] [[elisp:(show-children 10)][|V]] [[elisp:(org-tree-to-indirect-buffer)][|>]] [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || Func-anyOrNone :: /pkgBase_siteDir/ retType=bool argsList=nil  [[elisp:(org-cycle)][| ]]
"""
def pkgBase_siteDir():
####+END:
    """
...
"""
    icmsModulePath = os.path.dirname(__file__)
    icmsPkgBaseDir = "{}-site".format(icmsModulePath)
    return icmsPkgBaseDir
