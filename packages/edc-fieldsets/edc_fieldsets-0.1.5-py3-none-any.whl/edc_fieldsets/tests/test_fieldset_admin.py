...
class TestFieldsetAdmin(TestCase):
    ...
    def test_fieldset_excluded(self):
        ...
        self.assertIn('form-row field-f1',
                      rendered_change_form.rendered_content)
        self.assertIn('form-row field-f2',
                      rendered_change_form.rendered_content)
        self.assertIn('form-row field-f3',
                      rendered_change_form.rendered_content)
        self.assertNotIn('form-row field-f4',
                         rendered_change_form.rendered_content)
        self.assertNotIn('form-row field-f5',
                         rendered_change_form.rendered_content)
    ...
    def test_fieldset_included(self):
        ...
        self.assertIn('form-row field-f3',
                      rendered_change_form.rendered_content)
        self.assertIn('form-row field-f4',
                      rendered_change_form.rendered_content)
        self.assertIn('form-row field-f5',
                      rendered_change_form.rendered_content)
