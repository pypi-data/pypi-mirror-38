...
class TestJsonDoc(unittest2.TestCase):
    ...
    def test_json_doc_exception(self):
        with self.assertRaises(Exception):
            json_doc(self.doc_get, '', do='get')
    ...
    def test_json_doc_get(self):
        ...
        # test: a
        self.assertEqual(json_doc_get(self.doc_get, '/a'), {'deep': {'nested': {'string': 'value'}}})
        self.assertEqual(json_doc_get(self.doc_get, '/a/deep'), {'nested': {'string': 'value'}})
        self.assertEqual(json_doc_get(self.doc_get, '/a/deep/nested'), {'string': 'value'})
        self.assertEqual(json_doc_get(self.doc_get, '/a/deep/nested/string'), 'value')
        self.assertEqual(json_doc_get(self.doc_get, '/a/deep/nested/string/not-found'), None)

        # test: b
        self.assertEqual(json_doc_get(self.doc_get, '/b'), {'deep': {'nested': {'list': [1, 2, 3, {'dict': 'OK'}],
                                                                                'string': 'string',
                                                                                'hex': 0x010101}}})
        self.assertEqual(json_doc_get(self.doc_get, '/b/deep'), {'nested': {'list': [1, 2, 3, {'dict': 'OK'}],
                                                                            'string': 'string',
        ...
        self.assertEqual(json_doc_get(self.doc_get, '/b/deep/nested/list/3'), {'dict': 'OK'})
        self.assertEqual(json_doc_get(self.doc_get, '/b/deep/nested/list/3/dict'), 'OK')
        self.assertEqual(json_doc_get(self.doc_get, '/b/deep/nested/string'), 'string')
        self.assertEqual(json_doc_get(self.doc_get, '/b/deep/nested/hex'), 0x010101)
        ...
        # test: list_str
        self.assertEqual(json_doc_get(self.doc_get, '/list_str'), ['a', 'b', 'c'])
        ...
        # test: list_mix
        self.assertEqual(json_doc_get(self.doc_get, '/list_mix'), [1, 'b', {'c': 0}])
        ...
        # test: list_dic
        self.assertEqual(json_doc_get(self.doc_get, '/list_dict'), [{'dict_1': 1}, {'dict_2': [{'dict_3': '3'}]}])
        self.assertEqual(json_doc_get(self.doc_get, '/list_dict/0'), {'dict_1': 1})
        self.assertEqual(json_doc_get(self.doc_get, '/list_dict/0/dict_1'), 1)
        self.assertEqual(json_doc_get(self.doc_get, '/list_dict/1'), {'dict_2': [{'dict_3': '3'}]})
        self.assertEqual(json_doc_get(self.doc_get, '/list_dict/1/dict_2'), [{'dict_3': '3'}])
        self.assertEqual(json_doc_get(self.doc_get, '/list_dict/1/dict_2/0'), {'dict_3': '3'})
    ...
    def test_json_doc_set(self):
        # test: set
        self.assertEqual(json_doc_set(self.doc_set, '/set-int', 123)['set-int'], 123)
        self.assertEqual(json_doc_set(self.doc_set, '/set-hex', 0x010101)['set-hex'], 0x010101)
        self.assertEqual(json_doc_set(self.doc_set, '/set-str', 'str')['set-str'], 'str')
        self.assertEqual(json_doc_set(self.doc_set, '/set-list', ['a', 'list'])['set-list'], ['a', 'list'])
        self.assertEqual(json_doc_set(self.doc_set, '/set-dict', {'a': 'dict'})['set-dict'], {'a': 'dict'})
        ...
        self.assertEqual(json_doc_set(self.doc_set, '/set-1', [123])['set-1'], [123])
        self.assertEqual(json_doc_set(self.doc_set, '/set-1/0', 'list-1')['set-1'], ['list-1'])
        self.assertEqual(json_doc_set(self.doc_set, '/set-2', [123])['set-2'], [123])
        self.assertEqual(json_doc_set(self.doc_set, '/set-2/0', [123])['set-2'], [[123]])
        self.assertEqual(json_doc_set(self.doc_set, '/set-2/0/0', [123])['set-2'], [[[123]]])
        self.assertEqual(json_doc_set(self.doc_set, '/set-2/0/0/0', [123])['set-2'], [[[[123]]]])

        # test: create list elements with sub dicts
        self.assertEqual(json_doc_set(self.doc_set, '/set-3', [])['set-3'], [])
        self.assertEqual(json_doc_set(self.doc_set, '/set-3', [{}])['set-3'], [{}, ])
        self.assertEqual(json_doc_set(self.doc_set, '/set-3/0/list', [{}])['set-3'][0], {'list': [{}]})
        self.assertEqual(json_doc_set(self.doc_set, '/set-3/0/list/0/dict/list',
                                      ['A', 'B', 'C'])['set-3'][0]['list'][0], {'dict': {'list': ['A', 'B', 'C']}})
        self.assertEqual(json_doc_set(self.doc_set, '/set-3/0/list/0/dict/list/1',
    ...
    def test_json_doc_pop(self):
        ...
        # test: mixed tree
        self.assertTrue(json_doc_pop(self.doc_pop, '/b/deep/nested/list/3/dict'))
    ...
    def test_json_doc_has(self):
        ...
        self.assertTrue(json_doc_has(self.doc_get, '/b/deep/nested/list/3/dict'))
        self.assertTrue(json_doc_has(self.doc_get, '/b/deep/nested/list/3/dict', 'OK'))
    ...
    def test_json_doc_append(self):
        self.assertListEqual(json_doc_append(self.doc_get, '/0/1/2/3', 5)['0']['1']['2']['3'], [4, 5])

    def test_json_doc_extend(self):
        self.assertDictEqual(json_doc_extend(self.doc_get, '/0/1/2/3', [5, 6])['0']['1']['2'], {'3': [4, 5, 6]})

    def test_json_doc_replace(self):
        self.assertDictEqual(json_doc_replace(self.doc_get, '/0/1/2/3', 22, 4)['0'], {'1': {'2': {'3': [22]}}})

    def test_json_doc_replace_re(self):
        self.assertEqual(json_doc_replace_re(self.doc_get, '/list_str', 'aa', 'a')['list_str'][0], 'aa')
        self.assertEqual(json_doc_replace_re(self.doc_get, '/list_str', 'aaa', '^a')['list_str'][0], 'aaa')
        self.assertListEqual(json_doc_replace_re(self.doc_get, '/list_str', 'aaa', '[ab]')['list_str'],
                             ['aaa', 'aaa', 'c'])

        self.assertEqual(json_doc_replace_re(self.doc_get, '/list_num', 111, '^1$')['list_num'][0], 111)
